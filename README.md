...
**All 349/349 tests pass as of 2026-05-19** (247 wasic + Go-by-Example tests + 102 bindgen tests). Stage 0 Canonical ABI alignment complete — wasic now exports `cabi_realloc` and uses the out-parameter string return convention.
