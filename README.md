...
**All 446/446 tests pass as of 2026-05-25** (270 wasic + Go-by-Example tests + 103 bindgen tests + 73 jstyper tests). Stage 0 Canonical ABI alignment complete — wasic now exports `cabi_realloc` and uses the out-parameter string return convention.
