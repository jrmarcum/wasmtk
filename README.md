...
**All 356/356 tests pass as of 2026-05-24** (253 wasic + Go-by-Example tests + 103 bindgen tests). Stage 0 Canonical ABI alignment complete — wasic now exports `cabi_realloc` and uses the out-parameter string return convention.
...
- [x] Run full test suite and verify 356/356 PASS
