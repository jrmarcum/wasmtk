...
| [compiler-bugs.md](compiler-bugs.md) | Live bug log — **no open bugs** (suite **286/286**); Phase 51 (2026-06-05) closed 3 class gaps surfaced by `instanceof` — module-level class instances, class-instance array literals, single-physical-line class/constructor bodies; earlier: single-line brace `if {…}` fixed 2026-06-03, the 7 long-standing failures fixed 2026-06-02 (value-fallthru + wabt-ts 1.3.1 hex-float), merge OOB-charCodeAt trap fixed 2026-06-02 (short-circuit `&&`/`||`) |
