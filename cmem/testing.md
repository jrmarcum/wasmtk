...
**288 files, 37365 passing assertions, 15 files pinned WITH failures, 0 unrunnable** (re-recorded
2026-09-19 after the vendored `proposals/threads/` patches AND the `assert_malformed` stage split;
