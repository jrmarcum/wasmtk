...
> | Suite | Result |
> | --- | --- |
> | `tests/wasi/wasm_wasi` (`wasi_tests.ts`) | **399 / 399**, 0 failed |
...
>
> **How 375 → 399:** +8 stress tests in the 22/24/25/26 batch
...
> unqualified references to a namespace's own members were never rewritten.
