...
Live record of bugs found + fixed. Newest first. **✅ NO SUITE-FAILING BUGS — full suite 330/330**
...
type+auto-merge / `18r` GC Part 1 auto-grow heap / `18s`-`18v` GC Parts 2-4b (free-list / cell registry / mark / shadow-stack). 4 known wasic gaps are OPEN but worked around in the dynrt library — see next
