...
Live record of bugs found + fixed. Newest first. **✅ NO SUITE-FAILING BUGS — full suite 368/368** (`bindgen` 131/131, `jstyper` 73/73, `dync` conformance 3/3) as of **2026-06-30** (#14 Route A `18zh`–`18zz` + the 5 low-priority-gap regressions `62_Gap*` + 3 discovered-bug regressions `63_Gap*`).
