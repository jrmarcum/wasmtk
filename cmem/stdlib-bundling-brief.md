...
fixed 2026-06-02** → full `tests/wasm_wasi` **278/278** (now **306/306** as of 2026-06-12):
...
regressions** (historical snapshot — those 7 were all fixed 2026-06-02; suite is now 306/306).
...
306/306 as of 2026-06-12). (Detailed in cmem/capabilities.md (JSON).)
