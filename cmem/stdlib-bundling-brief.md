...
fixed 2026-06-02** → full `tests/wasm_wasi` **278/278** (now **286/286**, +`48_SingleLineBraceIf`
...
regressions** (historical snapshot — those 7 were all fixed 2026-06-02; suite is now 286/286).
...
286/286). (Detailed in cmem/capabilities.md (JSON).)
