 ...
 * );
 * ```
 */ export function insertSpace(x = 1) {
  return `\x1b[${x}@`;
}
/**
 ...
 * );
 * ```
 */ export function deleteCharacters(x = 1) {
  return `\x1b[${x}P`;
}
/**
 ...
 * );
 * ```
 */ export function eraseCharacters(x = 1) {
  return `\x1b[${x}X`;
}
/**
 ...
 * );
 * ```
 */ export function insertLines(x = 1) {
  return `\x1b[${x}L`;
}
/**
 ...
 * ```
 */ export function deleteLines(x = 1) {
  return `\x1b[${x}M`;
}
/**
 ...
 * ```
 */ export function moveCursorUp(x = 1) {
  return `\x1b[${x}A`;
}
/**
 ...
 * ```
 */ export function moveCursorUpStart(x = 1) {
  return `\x1b[${x}F`;
}
/**
 ...
 * );
 * ```
 */ export function moveCursorDown(x = 1) {
  return `\x1b[${x}B`;
}
/**
 ...
 * );
 * ```
 */ export function moveCursorDownStart(x = 1) {
  return `\x1b[${x}E`;
}
/**
 ...
 * ```
 */ export function moveCursorRight(x = 1) {
  return `\x1b[${x}C`;
}
/**
 ...
 * ```
 */ export function moveCursorRightTab(x = 1) {
  return `\x1b[${x}I`;
}
/**
 ...
 * );
 * ```
 */ export function moveCursorLeft(x = 1) {
  return `\x1b[${x}D`;
}
/**
 ...
 * );
 * ```
 */ export function moveCursorLeftTab(x = 1) {
  return `\x1b[${x}Z`;
}
/**
 ...
 * );
 * ```
 */ export function setCursorColumn(x = 1) {
  return `\x1b[${x}G`;
}
/**
 ...
 * ```
 */ export function setCursorLine(x = 1) {
  return `\x1b[${x}d`;
}
/**
 ...
 * );
 * ```
 */ export function setCursorPosition(x = 1, y = 1) {
  return `\x1b[${x};${y}H`;
}
/**
 ...
 * ```
 */ export function shiftUpAndInsert(x = 1) {
  return `\x1b[${x}S`;
}
/**
 ...
 * ```
 */ export function shiftDownAndInsert(x = 1) {
  return `\x1b[${x}T`;
}
/**
 ...
 * ```
 */ export function repeatLastCharacter(x = 1) {
  return `\x1b[${x}b`;
}
/**
 ...
 * ```
 */ export function setCursorStyle(x) {
  return `\x1b[${x} q`;
}
/**
 ...
 * ```
 */ export function setScrollableRegion(x = 1, y) {
 ...
 * console.log(Ansi.setCursorStyle(Ansi.CursorStyle.BlinkingUnderline));
 * ```
 */ export var CursorStyle = /*#__PURE__*/ function(CursorStyle) {
  CursorStyle[CursorStyle["Default"] = 0] = "Default";
  CursorStyle[CursorStyle["BlinkingBlock"] = 1] = "BlinkingBlock";
  CursorStyle[CursorStyle["SteadyBlock"] = 2] = "SteadyBlock";
  CursorStyle[CursorStyle["BlinkingUnderline"] = 3] = "BlinkingUnderline";
  CursorStyle[CursorStyle["SteadyUnderline"] = 4] = "SteadyUnderline";
  CursorStyle[CursorStyle["BlinkingBar"] = 5] = "BlinkingBar";
  CursorStyle[CursorStyle["SteadyBar"] = 6] = "SteadyBar";
  return CursorStyle;
}({});
//# sourceMappingURL=unstable_ansi.js.map