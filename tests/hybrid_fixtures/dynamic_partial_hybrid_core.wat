(module
  ...
  (func $goodDynamic (export "goodDynamic") (param $n f64) (result f64)
    (local $x i32)
    (local.set $x (call $dynrt_dynEval (i32.const 260) (i32.const 5)))
    (return (f64.add (call $dynrt_dynNumberValue (local.get $x)) (local.get $n)))
  )

  (func $plus1 (export "plus1") (param $x f64) (result f64)
    (return (f64.add (local.get $x) (f64.const 1)))
  )
