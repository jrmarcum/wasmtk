(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 622))
  ...
  (func $evalScaled (export "evalScaled") (param $n f64) (result f64)
    (local $base i32)
    (local $scaled i32)
    (local.set $base (call $dynrt_dynEval (i32.const 260) (i32.const 5)))
    (local.set $scaled (call $dynrt_dynAdd (local.get $base) (call $dynrt_dynNumber (local.get $n))))
    (return (call $dynrt_dynNumberValue (local.get $scaled)))
  )

  (func $double (export "double") (param $x f64) (result f64)
    (return (f64.mul (local.get $x) (f64.const 2)))
  )
  ...
  (func $dynrt_dynResetSideEffects
    i32.const 0
    global.set $dynrt_global7)
  (func $dynrt__fn64 (param i32 i32 i32 i32) (result i32)
    (local i32)
    local.get 1
    local.get 3
    i32.ne
  ...
  (func $dynrt__fn67 (param i32 i32) (result i32)
    ...
    i32.const 0
    return)
  (func $dynrt__fn68 (param i32 i32)
    (local i32) (local i32)
    i32.const 1
    local.set 2
    block  ;; label = @1
  ...
  (func $dynrt_dynRun (param i32 i32 i32) (result i32)
    ...
    return)
  ;; data from dynrt
  (data (;0;) (i32.const 525) "")
  (data (;1;) (i32.const 525) "false")
  (data (;2;) (i32.const 530) "true")
  (data (;3;) (i32.const 534) "null")
  (data (;4;) (i32.const 538) "undefined")
  (data (;5;) (i32.const 547) "abs")
  (data (;6;) (i32.const 550) "sqrt")
  (data (;7;) (i32.const 554) "floor")
  (data (;8;) (i32.const 559) "ceil")
  (data (;9;) (i32.const 563) "round")
  (data (;10;) (i32.const 568) "min")
  (data (;11;) (i32.const 571) "max")
  (data (;12;) (i32.const 574) "len")
  (data (;13;) (i32.const 577) "inc")
  (data (;14;) (i32.const 580) "length")
  (data (;15;) (i32.const 586) "else")
  (data (;16;) (i32.const 590) "let")
  (data (;17;) (i32.const 593) "const")
  (data (;18;) (i32.const 598) "var")
  (data (;19;) (i32.const 601) "if")
  (data (;20;) (i32.const 603) "while")
  (data (;21;) (i32.const 608) "return")
  (data (;22;) (i32.const 614) "function")
)