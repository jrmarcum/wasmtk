(module
  ...
  (func $_start (export "_start")
    ...
    (local.set $m (call $map_lib_modc_mapNew ))
    (call $map_lib_modc_mapSet (local.get $m) (i32.const 10) (i32.const 100))
    (call $map_lib_modc_mapSet (local.get $m) (i32.const 20) (i32.const 200))
    (call $map_lib_modc_mapSet (local.get $m) (i32.const 30) (i32.const 300))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 6) (call $__i32_to_str (call $map_lib_modc_mapSize (local.get $m)) (i32.const 138))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $check (if (result i32) (i32.eq (call $map_lib_modc_mapSize (local.get $m)) (i32.const 3)) (then (i32.const 1)) (else (i32.const 0))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 8) (call $__i32_to_str (call $map_lib_modc_mapGet (local.get $m) (i32.const 20) (i32.const -1)) (i32.const 140))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $check (if (result i32) (i32.eq (call $map_lib_modc_mapGet (local.get $m) (i32.const 20) (i32.const -1)) (i32.const 200)) (then (i32.const 1)) (else (i32.const 0))))
    (call $map_lib_modc_mapSet (local.get $m) (i32.const 20) (i32.const 222))
    (call $check (if (result i32) (i32.eq (call $map_lib_modc_mapSize (local.get $m)) (i32.const 3)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $map_lib_modc_mapGet (local.get $m) (i32.const 20) (i32.const -1)) (i32.const 222)) (then (i32.const 1)) (else (i32.const 0))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 103))
          (i32.store8 (i32.const 133) (i32.const 101))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 21) (call $__i32_to_str (call $map_lib_modc_mapGet (local.get $m) (i32.const 20) (i32.const -1)) (i32.const 153))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 135) (i32.const 32))
          (i32.store8 (i32.const 136) (i32.const 51))
          (i32.store8 (i32.const 137) (i32.const 48))
          (i32.store8 (i32.const 138) (i32.const 58))
          (i32.store8 (i32.const 139) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 8) (call $__i32_to_str (call $map_lib_modc_mapHas (local.get $m) (i32.const 30)) (i32.const 140))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 138) (i32.const 58))
          (i32.store8 (i32.const 139) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 8) (call $__i32_to_str (call $map_lib_modc_mapHas (local.get $m) (i32.const 99)) (i32.const 140))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $check (call $map_lib_modc_mapHas (local.get $m) (i32.const 30)))
    (call $check (if (result i32) (i32.eq (call $map_lib_modc_mapHas (local.get $m) (i32.const 99)) (i32.const 0)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $map_lib_modc_mapGet (local.get $m) (i32.const 99) (i32.const -7)) (i32.const -7)) (then (i32.const 1)) (else (i32.const 0))))
    (block $break_0
      (loop $loop_0
        (br_if $break_0 (i32.eqz (i32.lt_s (global.get $i) (i32.const 140))))
        (block $cont_0
          (call $map_lib_modc_mapSet (local.get $m) (global.get $i) (i32.mul (global.get $i) (i32.const 2)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 17) (call $__i32_to_str (call $map_lib_modc_mapSize (local.get $m)) (i32.const 149))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $check (if (result i32) (i32.eq (call $map_lib_modc_mapSize (local.get $m)) (i32.const 43)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $map_lib_modc_mapGet (local.get $m) (i32.const 10) (i32.const -1)) (i32.const 100)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $map_lib_modc_mapGet (local.get $m) (i32.const 137) (i32.const -1)) (i32.const 274)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $map_lib_modc_mapGet (local.get $m) (i32.const 20) (i32.const -1)) (i32.const 222)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $map_lib_modc_mapHas (local.get $m) (i32.const 200)) (i32.const 0)) (then (i32.const 1)) (else (i32.const 0))))
    (call $map_lib_modc_mapSet (local.get $m) (i32.const -5) (i32.const -50))
    (call $map_lib_modc_mapSet (local.get $m) (i32.const -5) (i32.const -55))
    (call $check (if (result i32) (i32.eq (call $map_lib_modc_mapGet (local.get $m) (i32.const -5) (i32.const 0)) (i32.const -55)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $map_lib_modc_mapSize (local.get $m)) (i32.const 44)) (then (i32.const 1)) (else (i32.const 0))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 103))
          (i32.store8 (i32.const 133) (i32.const 101))
          ...
          (i32.store8 (i32.const 138) (i32.const 58))
          (i32.store8 (i32.const 139) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 8) (call $__i32_to_str (call $map_lib_modc_mapGet (local.get $m) (i32.const -5) (i32.const 0)) (i32.const 140))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 12) (call $__i32_to_str (call $map_lib_modc_mapSize (local.get $m)) (i32.const 144))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 260) "\6d\61\70\20\6f\6b\0a")

  ;; globals from map_lib_modc
  (global $map_lib_modc_global1 i32 (i32.const 8))
  ;; functions from map_lib_modc
  (func $map_lib_modc__fn1 (param i32) (result i32)
    (local i32) (local i32)
    i32.const 8
    local.get 0
    i32.const 2
    ...
    local.tee 2
    return)
  (func $map_lib_modc_mapNew (result i32)
    (local i32) (local i32)
    i32.const 28
    call $__malloc
    local.set 0
    ...
    i32.const 4
    i32.add
    global.get $map_lib_modc_global1
    i32.store
    local.get 0
    i32.const 8
    i32.add
    ...
    local.tee 1
    return)
  (func $map_lib_modc__fn3 (param i32)
    ...
    local.get 9
    i32.store)
  (func $map_lib_modc_mapSet (param i32 i32 i32)
    ...
    i32.add
    i32.store)
  (func $map_lib_modc_mapGet (param i32 i32 i32) (result i32)
    ...
    local.get 2
    return)
  (func $map_lib_modc_mapHas (param i32 i32) (result i32)
    ...
    i32.const 0
    return)
  (func $map_lib_modc_mapSize (param i32) (result i32)
    (local i32)
    local.get 0
    local.set 1
    local.get 1
