(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 541))
  ...
  (func $_start (export "_start")
    ...
    (call $reloc_lib_modc_banner )
    (call $check (if (result i32) (i32.eq (call $reloc_lib_modc_modByInRange (i32.const 1000)) (i32.const 194)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $reloc_lib_modc_modByInRange (i32.const 542)) (i32.const 7)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $reloc_lib_modc_modByInRange (i32.const 271)) (i32.const 7)) (then (i32.const 1)) (else (i32.const 0))))
  ...
  (data (i32.const 260) "\72\65\6c\6f\63\2d\61\72\69\74\68\2d\63\6f\6e\73\74\20\4f\4b\0a")

  ;; globals from reloc_lib_modc
  (global $reloc_lib_modc_global0 i32 (i32.const 7))
  ;; functions from reloc_lib_modc
  (func $reloc_lib_modc_modByInRange (param i32) (result i32)
    local.get 0
    i32.const 271
    i32.rem_s
    global.get $reloc_lib_modc_global0
    i32.add
    return)
  (func $reloc_lib_modc_banner
    (local i32)
    i32.const 0
    i32.const 541
    i32.store
    ...
    call $fd_write
    drop)
  ;; data from reloc_lib_modc
  (data (;0;) (i32.const 541) "Reloc capability library banner string v1\0a")
)