(module
  ...
  (func $lib_square (param $x i32) (result i32)
    (return (i32.mul (local.get $x) (local.get $x)))
  )

  (func $lib_negate (param $x i32) (result i32)
    (return (i32.sub (i32.const 0) (local.get $x)))
  )

  (func $lib_compute (param $a i32) (param $b i32) (result i32)
    (return (i32.add (local.get $a) (local.get $b)))
  )

  (func $mathutils_double (param $x i32) (result i32)
    (return (i32.mul (local.get $x) (i32.const 2)))
  )

  (func $mathutils_triple (param $x i32) (result i32)
  ...
  (func $_start (export "_start")
    ...
    (local $d i32)
    (local $e i32)
    (local.set $a (call $lib_compute (i32.const 3) (i32.const 4)))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $b (call $mathutils_double (i32.const 5)))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $c (call $mathutils_triple (i32.const 3)))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $d (call $lib_square (i32.const 4)))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $e (call $lib_negate (i32.const 6)))
        (i32.store (i32.const 0) (i32.const 132))
