(module
  ...
  (func $dynrt__fn46 (param i32)
    ...
    global.set $dynrt_global2
    return)
  (func $dynrt__fn47 (param i32 i32 i32) (result i32)
    (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32)
    local.get 0
    local.set 3
    local.get 3
  ...
  (func $dynrt_dynBuiltin (param i32) (result i32)
    ...
    local.tee 2
    return)
  (func $dynrt__fn71 (param i32 i32 i32) (result i32)
    (local i32) (local i32)
    call $dynrt__fn21
    local.set 3
    local.get 3
  ...
  (func $dynrt_dynMakeFunc (param i32 i32 i32 i32) (result i32)
    ...
    call $dynrt__fn71
    return)
  (func $dynrt__fn73 (param i32 i32 i32) (result i32)
    (local i32) (local i32) (local i32)
    local.get 0
    local.set 3
    block  ;; label = @1
  ...
  (func $dynrt_dynResetSideEffects
    i32.const 0
    global.set $dynrt_global10)
  (func $dynrt__fn82 (param i32 i32 i32 i32) (result i32)
    (local i32)
    local.get 1
    local.get 3
    i32.ne
  ...
  (func $dynrt__fn89 (param i32 i32) (result i32)
    ...
    call $dynrt_dynNumber
    return)
  (func $dynrt__fn90 (param i32 i32) (result i32)
  ...
  (func $dynrt_dynEvalEnv (param i32 i32 i32) (result i32)
    ...
    call $dynrt__fn100
    return)
  (func $dynrt__fn103 (param i32 i32)
    (local i32) (local i32) (local i32) (local i32)
    global.get $dynrt_global7
    local.tee 4
    local.set 2
    ...
    global.set $dynrt_global2
    return)
  (func $dynrt__fn104 (param i32 i32)
    (local i32) (local i32) (local i32)
    local.get 0
    local.get 1
    call $dynrt__fn86
