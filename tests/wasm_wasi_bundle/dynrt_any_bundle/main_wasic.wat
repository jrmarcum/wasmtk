(module
  ...
  (global $dynrt_global7 (mut i32) (i32.const -1))
  ...
  (func $dynrt__fn40 (param i32)
    ...
    global.set $dynrt_global2
    return)
  (func $dynrt__fn41 (param i32 i32 i32) (result i32)
    (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32)
    local.get 0
    local.set 3
    local.get 3
  ...
  (func $dynrt_dynBuiltin (param i32) (result i32)
    ...
    local.tee 2
    return)
  (func $dynrt__fn65 (param i32 i32 i32) (result i32)
    (local i32) (local i32)
    call $dynrt__fn21
    local.set 3
    local.get 3
  ...
  (func $dynrt_dynResetSideEffects
    i32.const 0
    global.set $dynrt_global9)
  (func $dynrt__fn76 (param i32 i32 i32 i32) (result i32)
    (local i32)
    local.get 1
    local.get 3
    i32.ne
  ...
  (func $dynrt__fn79 (param i32 i32) (result i32)
    ...
    i32.const 0
    return)
  (func $dynrt__fn80 (param i32 i32)
    (local i32) (local i32)
    i32.const 1
    local.set 2
    block  ;; label = @1
  ...
  (func $dynrt__fn85 (param i32 i32) (result i32)
    ...
    call $dynrt_dynUndefined
    return)
  (func $dynrt__fn86 (param i32 i32) (result i32)
  ...
  (func $dynrt__fn99 (param i32 i32)
    (local i32) (local i32)
    local.get 0
    local.get 1
    call $dynrt__fn80
  ...
  (func $dynrt__fn100 (param i32 i32)
    (local i32) (local i32) (local i32) (local i32) (local i32)
    global.get $dynrt_global8
    local.set 2
    local.get 0
  ...
  (func $dynrt__fn101 (param i32 i32)
