(module
  ...
  (func $transform_scale (param $x i32) (result i32)
    (return (i32.mul (local.get $x) (;? constants_SCALE;) (i32.const 0)))
  )

  (func $transform_shift (param $x i32) (result i32)
    (return (i32.add (local.get $x) (;? constants_OFFSET;) (i32.const 0)))
  )

  (func $main  
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $transform_scale (i32.const 3)) (i32.const 132)))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $transform_shift (i32.const 7)) (i32.const 132)))
          (i32.store (i32.const 8) (i32.const 260))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $transform_scale (call $transform_shift (i32.const 2))) (i32.const 132)))
          (i32.store (i32.const 8) (i32.const 260))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
