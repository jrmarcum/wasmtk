(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 592))
  ...
  (func $dynrt__fn2 (param i32 i32 i32 i32) (result i32 i32)
    ...
    local.get 5
    local.tee 11)
  (func $dynrt__fn3 (param i32 i32 i32) (result i32)
    local.get 2
    i32.const 0
    i32.lt_s
    if  ;; label = @1
    ...
    i32.add
    i32.load8_u)
  (func $dynrt__fn4 (param i32) (result f64)
    local.get 0
    i32.const 0
    i32.le_s
    if  ;; label = @1
  ...
  (func $dynrt__fn5 (param f64 i32) (result i32)
    ...
    local.tee 28
    i32.sub)
  (func $dynrt__fn6 (param i64 i32) (result i32)
  ...
  (func $dynrt__fn12 (result i32)
    ...
    local.tee 1
    return)
  (func $dynrt__fn13 (param i32) (result i32)
    (local i32)
    local.get 0
    local.set 1
    local.get 1
    ...
    i32.load
    return)
  (func $dynrt__fn14 (param i32 i32) (result i32)
    (local i32)
    local.get 0
    local.set 2
    local.get 2
    ...
    i32.load
    return)
  (func $dynrt__fn15 (param i32 i32 i32)
    (local i32)
    local.get 0
    local.set 3
    local.get 3
  ...
  (func $dynrt__fn28 (param i32)
    ...
    global.set $dynrt_global2
    return)
  (func $dynrt__fn29 (param i32 i32 i32) (result i32)
    (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32)
    local.get 0
    local.set 3
    local.get 3
