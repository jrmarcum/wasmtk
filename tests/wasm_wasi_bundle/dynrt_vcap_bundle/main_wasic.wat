(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 659))
  ...
  (func $dynrt__fn30 (param i32)
    ...
    global.set $dynrt_global2
    return)
  (func $dynrt__fn31 (param i32 i32 i32) (result i32)
    (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32)
    local.get 0
    local.set 3
    local.get 3
  ...
  (func $dynrt_dynResetSideEffects
    i32.const 0
    global.set $dynrt_global7)
  (func $dynrt__fn56 (param i32 i32 i32 i32) (result i32)
    (local i32)
    local.get 1
    local.get 3
    i32.ne
    ...
    i32.const 1
    return)
  (func $dynrt__fn57 (param i32 i32 i32) (result i32)
    (local i32) (local i32)
    local.get 0
    local.set 3
    local.get 3
    ...
    call $dynrt_dynUndefined
    return)
  (func $dynrt__fn58 (param i32 i32) (result i32)
    ...
    call $dynrt_dynUndefined
    return)
  (func $dynrt__fn59 (param i32 i32) (result i32)
    local.get 0
    i32.const 65
    i32.ge_s
    if (result i32)  ;; label = @1
    ...
    i32.const 0
    return)
  (func $dynrt__fn60 (param i32 i32)
    (local i32) (local i32)
    i32.const 1
    local.set 2
    block  ;; label = @1
  ...
  (func $dynrt__fn61 (param i32 i32) (result i32)
    (local i32)
    global.get $dynrt_global4
    local.get 1
    i32.ge_s
  ...
  (func $dynrt__fn63 (param i32 i32) (result i32)
    ...
    call $dynrt_dynNumber
    return)
  (func $dynrt__fn64 (param i32 i32) (result i32)
  ...
  (func $dynrt_dynEvalEnv (param i32 i32 i32) (result i32)
    ...
    call $dynrt__fn74
    return)
  (func $dynrt__fn77 (param i32 i32)
    (local i32) (local i32) (local i32) (local i32)
    global.get $dynrt_global4
    local.tee 4
    local.set 2
    ...
    global.set $dynrt_global2
    return)
  (func $dynrt__fn78 (param i32 i32)
    (local i32) (local i32) (local i32)
    local.get 0
    local.get 1
    call $dynrt__fn60
  ...
  (func $dynrt__fn79 (param i32 i32)
    (local i32) (local i32)
    local.get 0
    local.get 1
    call $dynrt__fn60
