(module
    ...
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 260))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $areaResult (call $18_MathLibrary_Modc_computeScaledArea (i32.const 10) (i32.const 4)))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 144) (i32.const 82))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 20) (call $__i32_to_str (local.get $areaResult) (i32.const 152))))
  ...
  (data (;0;) (i32.const 606) "Library Version: v1.8.0-core\0a")
)