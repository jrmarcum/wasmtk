(module
  ...
  (func $mathlib_add (param $a i32) (param $b i32) (result i32)
    (return (i32.add (local.get $a) (local.get $b)))
  )

  (func $mathlib_multiply (param $a i32) (param $b i32) (result i32)
    (return (i32.mul (local.get $a) (local.get $b)))
  )

  (func $mathlib_subtract (param $a i32) (param $b i32) (result i32)
    (return (i32.sub (local.get $a) (local.get $b)))
  )

  (func $myotherlib_add (param $a i32) (param $b i32) (result i32)
    (return (i32.add (i32.mul (local.get $a) (i32.const 10)) (local.get $b)))
  )

  (func $myotherlib_negate (param $a i32) (result i32)
    (return (i32.sub (i32.const 0) (local.get $a)))
  )

  (func $main  
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $mathlib_add (i32.const 3) (i32.const 4)) (i32.const 132)))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $mathlib_multiply (i32.const 6) (i32.const 7)) (i32.const 132)))
          (i32.store (i32.const 8) (i32.const 260))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $mathlib_subtract (i32.const 10) (i32.const 3)) (i32.const 132)))
          (i32.store (i32.const 8) (i32.const 260))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $myotherlib_add (i32.const 2) (i32.const 5)) (i32.const 132)))
          (i32.store (i32.const 8) (i32.const 260))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $myotherlib_negate (i32.const 9)) (i32.const 132)))
          (i32.store (i32.const 8) (i32.const 260))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
