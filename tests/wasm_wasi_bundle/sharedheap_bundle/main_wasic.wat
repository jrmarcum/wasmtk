(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 780))
  ...
  (func $_start (export "_start")
    ...
    (local.set $lenA (call $lib_a_modc_makeBufferA (global.get $SIZE)))
    (local.set $lenB (call $lib_b_modc_makeBufferB (global.get $SIZE)))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 6) (call $__i32_to_str (local.get $lenA) (i32.const 138))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 136) (i32.const 58))
          (i32.store8 (i32.const 137) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 6) (call $__i32_to_str (local.get $lenB) (i32.const 138))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  ;; functions from lib_a_modc
  (func $lib_a_modc__fn1 (param i32 i32) (result i32)
    ...
    local.get 2
    local.tee 6)
  (func $lib_a_modc__fn2 (param i32 i32) (result i32)
    ...
    local.get 0
    local.tee 5)
  (func $lib_a_modc_makeBufferA (param i32) (result i32)
    (local i32) (local i32) (local i32) (local i32)
    i32.const 40
    call $__malloc
    local.set 1
  ...
  ;; functions from lib_b_modc
  (func $lib_b_modc__fn1 (param i32 i32) (result i32)
    (local i32) (local i32) (local i32) (local i32) (local i32)
    local.get 0
    i32.load
    local.set 3
    ...
    local.get 2
    local.tee 6)
  (func $lib_b_modc__fn2 (param i32 i32) (result i32)
    (local i32) (local i32) (local i32) (local i32)
    local.get 0
    i32.load
    local.set 2
    ...
    local.get 0
    local.tee 5)
  (func $lib_b_modc_makeBufferB (param i32) (result i32)
    (local i32) (local i32) (local i32) (local i32)
    i32.const 40
    call $__malloc
    local.set 1
