(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 1400))
  ...
  (func $_start (export "_start")
    ...
    (call $dynrt_lib_modc_dynGcPushRoot (local.get $arr))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynGcRootCount ) (i32.const 1)) (then (i32.const 1)) (else (i32.const 0))))
    (call $dynrt_lib_modc_dynGcMarkRoots )
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynGcMarkedCount ) (i32.const 4)) (then (i32.const 1)) (else (i32.const 0))))
    (call $dynrt_lib_modc_dynGcPopRoot )
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynGcRootCount ) (i32.const 0)) (then (i32.const 1)) (else (i32.const 0))))
    (local.set $e (call $dynrt_lib_modc_dynObject ))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynGcRootCount ) (i32.const 0)) (then (i32.const 1)) (else (i32.const 0))))
    (drop (call $dynrt_lib_modc_dynRun (i32.const 260) (i32.const 65) (local.get $e)))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynGcRootCount ) (i32.const 0)) (then (i32.const 1)) (else (i32.const 0))))
    (local.set $e2 (call $dynrt_lib_modc_dynObject ))
    (local.set $closure (call $dynrt_lib_modc_dynRun (i32.const 325) (i32.const 95) (local.get $e2)))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynGcRootCount ) (i32.const 0)) (then (i32.const 1)) (else (i32.const 0))))
    (call $dynrt_lib_modc_dynGcMarkClear )
    (call $dynrt_lib_modc_dynGcMark (local.get $closure))
    (call $check (if (result i32) (i32.ge_s (call $dynrt_lib_modc_dynGcMarkedCount ) (i32.const 5)) (then (i32.const 1)) (else (i32.const 0))))
        (i32.store (i32.const 0) (i32.const 420))
  ...
  (data (i32.const 260) "\66\75\6e\63\74\69\6f\6e\20\66\28\6e\29\7b\20\69\66\28\6e\3c\31\29\7b\20\72\65\74\75\72\6e\20\30\3b\20\7d\20\72\65\74\75\72\6e\20\66\28\6e\2d\31\29\3b\20\7d\20\72\65\74\75\72\6e\20\66\28\34\29\3b")
  (data (i32.const 325) "\66\75\6e\63\74\69\6f\6e\20\6f\75\74\65\72\28\29\7b\20\6c\65\74\20\63\61\70\20\3d\20\34\32\3b\20\66\75\6e\63\74\69\6f\6e\20\69\6e\6e\65\72\28\29\7b\20\72\65\74\75\72\6e\20\63\61\70\3b\20\7d\20\72\65\74\75\72\6e\20\69\6e\6e\65\72\3b\20\7d\20\72\65\74\75\72\6e\20\6f\75\74\65\72\28\29\3b")
  (data (i32.const 420) "\47\43\20\50\61\72\74\34\62\20\73\68\61\64\6f\77\2d\73\74\61\63\6b\3a\20\72\6f\6f\74\73\20\76\65\72\69\66\69\65\64\0a")
  ...
  (global $dynrt_lib_modc_global5 i32 (i32.const 971))
  ...
  (global $dynrt_lib_modc_global13 (mut i32) (i32.const 971))
  ...
  (data (;0;) (i32.const 719) "")
  (data (;1;) (i32.const 719) "false")
  (data (;2;) (i32.const 724) "true")
  (data (;3;) (i32.const 728) "null")
  (data (;4;) (i32.const 732) "undefined")
  (data (;5;) (i32.const 741) "push")
  (data (;6;) (i32.const 745) "indexOf")
  (data (;7;) (i32.const 752) "includes")
  (data (;8;) (i32.const 760) "join")
  (data (;9;) (i32.const 764) ",")
  (data (;10;) (i32.const 765) "slice")
  (data (;11;) (i32.const 770) "concat")
  (data (;12;) (i32.const 776) "reverse")
  (data (;13;) (i32.const 783) "pop")
  (data (;14;) (i32.const 786) "shift")
  (data (;15;) (i32.const 791) "unshift")
  (data (;16;) (i32.const 798) "at")
  (data (;17;) (i32.const 800) "lastIndexOf")
  (data (;18;) (i32.const 811) "map")
  (data (;19;) (i32.const 814) "filter")
  (data (;20;) (i32.const 820) "forEach")
  (data (;21;) (i32.const 827) "reduce")
  (data (;22;) (i32.const 833) "find")
  (data (;23;) (i32.const 837) "findIndex")
  (data (;24;) (i32.const 846) "some")
  (data (;25;) (i32.const 850) "every")
  (data (;26;) (i32.const 855) "sort")
  (data (;27;) (i32.const 859) "charAt")
  (data (;28;) (i32.const 865) "charCodeAt")
  (data (;29;) (i32.const 875) "toUpperCase")
  (data (;30;) (i32.const 886) "toLowerCase")
  (data (;31;) (i32.const 897) "trim")
  (data (;32;) (i32.const 901) "startsWith")
  (data (;33;) (i32.const 911) "endsWith")
  (data (;34;) (i32.const 919) "repeat")
  (data (;35;) (i32.const 925) "padStart")
  (data (;36;) (i32.const 933) " ")
  (data (;37;) (i32.const 934) "padEnd")
  (data (;38;) (i32.const 940) "split")
  (data (;39;) (i32.const 945) "match")
  (data (;40;) (i32.const 950) "__regex")
  (data (;41;) (i32.const 957) "create")
  (data (;42;) (i32.const 963) "keys")
  (data (;43;) (i32.const 967) "values")
  (data (;44;) (i32.const 973) "entries")
  (data (;45;) (i32.const 980) "assign")
  (data (;46;) (i32.const 986) "floor")
  (data (;47;) (i32.const 991) "ceil")
  (data (;48;) (i32.const 995) "round")
  (data (;49;) (i32.const 1000) "abs")
  (data (;50;) (i32.const 1003) "sqrt")
  (data (;51;) (i32.const 1007) "sign")
  (data (;52;) (i32.const 1011) "trunc")
  (data (;53;) (i32.const 1016) "max")
  (data (;54;) (i32.const 1019) "min")
  (data (;55;) (i32.const 1022) "pow")
  (data (;56;) (i32.const 1025) "\22")
  (data (;57;) (i32.const 1026) "\5c\22")
  (data (;58;) (i32.const 1028) "\5c\5c")
  (data (;59;) (i32.const 1030) "\5cn")
  (data (;60;) (i32.const 1032) "\5cr")
  (data (;61;) (i32.const 1034) "\5ct")
  (data (;62;) (i32.const 1036) "[")
  (data (;63;) (i32.const 1037) "]")
  (data (;64;) (i32.const 1038) "{")
  (data (;65;) (i32.const 1039) ":")
  (data (;66;) (i32.const 1040) "}")
  (data (;67;) (i32.const 1041) "__mapk")
  (data (;68;) (i32.const 1047) "__mapv")
  (data (;69;) (i32.const 1053) "__setk")
  (data (;70;) (i32.const 1059) "set")
  (data (;71;) (i32.const 1062) "get")
  (data (;72;) (i32.const 1065) "has")
  (data (;73;) (i32.const 1068) "delete")
  (data (;74;) (i32.const 1074) "add")
  (data (;75;) (i32.const 1077) "test")
  (data (;76;) (i32.const 1081) "exec")
  (data (;77;) (i32.const 1085) "next")
  (data (;78;) (i32.const 1089) "__genv")
  (data (;79;) (i32.const 1095) "__geni")
  (data (;80;) (i32.const 1101) "value")
  (data (;81;) (i32.const 1106) "done")
  (data (;82;) (i32.const 1110) "this")
  (data (;83;) (i32.const 1114) "len")
  (data (;84;) (i32.const 1117) "inc")
  (data (;85;) (i32.const 1120) "size")
  (data (;86;) (i32.const 1124) "__get_")
  (data (;87;) (i32.const 1130) "length")
  (data (;88;) (i32.const 1136) "__set_")
  (data (;89;) (i32.const 1142) "function")
  (data (;90;) (i32.const 1150) "yield")
  (data (;91;) (i32.const 1155) "Object")
  (data (;92;) (i32.const 1161) "Math")
  (data (;93;) (i32.const 1165) "PI")
  (data (;94;) (i32.const 1167) "E")
  (data (;95;) (i32.const 1168) "JSON")
  (data (;96;) (i32.const 1172) "parse")
  (data (;97;) (i32.const 1177) "stringify")
  (data (;98;) (i32.const 1186) "new")
  (data (;99;) (i32.const 1189) "Map")
  (data (;100;) (i32.const 1192) "Set")
  (data (;101;) (i32.const 1195) "RegExp")
  (data (;102;) (i32.const 1201) "super")
  (data (;103;) (i32.const 1206) "__superclass")
  (data (;104;) (i32.const 1218) "__ctor")
  (data (;105;) (i32.const 1224) "__superproto")
  (data (;106;) (i32.const 1236) "boolean")
  (data (;107;) (i32.const 1243) "number")
  (data (;108;) (i32.const 1249) "string")
  (data (;109;) (i32.const 1255) "object")
  (data (;110;) (i32.const 1261) "typeof")
  (data (;111;) (i32.const 1267) "else")
  (data (;112;) (i32.const 1271) "const")
  (data (;113;) (i32.const 1276) "let")
  (data (;114;) (i32.const 1279) "var")
  (data (;115;) (i32.const 1282) "of")
  (data (;116;) (i32.const 1284) "in")
  (data (;117;) (i32.const 1286) "case")
  (data (;118;) (i32.const 1290) "default")
  (data (;119;) (i32.const 1297) "catch")
  (data (;120;) (i32.const 1302) "finally")
  (data (;121;) (i32.const 1309) "extends")
  (data (;122;) (i32.const 1316) "__proto")
  (data (;123;) (i32.const 1323) "static")
  (data (;124;) (i32.const 1329) "constructor")
  (data (;125;) (i32.const 1340) "this.")
  (data (;126;) (i32.const 1345) " = ")
  (data (;127;) (i32.const 1348) "; ")
  (data (;128;) (i32.const 1350) "if")
  (data (;129;) (i32.const 1352) "while")
  (data (;130;) (i32.const 1357) "do")
  (data (;131;) (i32.const 1359) "for")
  (data (;132;) (i32.const 1362) "switch")
  (data (;133;) (i32.const 1368) "try")
  (data (;134;) (i32.const 1371) "throw")
  (data (;135;) (i32.const 1376) "return")
  (data (;136;) (i32.const 1382) "class")
  (data (;137;) (i32.const 1387) "break")
  (data (;138;) (i32.const 1392) "continue")
)