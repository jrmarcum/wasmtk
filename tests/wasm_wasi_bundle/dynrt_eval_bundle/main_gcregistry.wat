(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 1203))
  ...
  (func $bulk (param $n i32) 
    ...
    (block $break_0
      (loop $loop_0
        ...
        (block $cont_0
          (local.set $v (call $dynrt_lib_modc_dynNumber (f64.convert_i32_s (local.get $i))))
  ...
  (func $_start (export "_start")
    ...
    (local.set $a (call $dynrt_lib_modc_dynNumber (f64.const 1)))
    (local.set $b (call $dynrt_lib_modc_dynNumber (f64.const 2)))
    (local.set $s (call $dynrt_lib_modc_dynString (i32.const 260) (i32.const 2)))
    (local.set $arr (call $dynrt_lib_modc_dynArray ))
    (call $check (if (result i32) (i32.eq (i32.sub (call $dynrt_lib_modc_dynGcCellCount ) (local.get $before)) (i32.const 4)) (then (i32.const 1)) (else (i32.const 0))))
    (local.set $c0 (call $dynrt_lib_modc_dynGcCellCount ))
    (call $bulk (i32.const 20000))
    (call $check (if (result i32) (i32.eq (i32.sub (call $dynrt_lib_modc_dynGcCellCount ) (local.get $c0)) (i32.const 20000)) (then (i32.const 1)) (else (i32.const 0))))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 139) (i32.const 51))
          ...
          (i32.store8 (i32.const 148) (i32.const 103))
          (i32.store8 (i32.const 149) (i32.const 105))
          (i32.store8 (i32.const 150) (i32.const 115))
          (i32.store8 (i32.const 151) (i32.const 116))
          (i32.store8 (i32.const 152) (i32.const 114))
          (i32.store8 (i32.const 153) (i32.const 121))
          (i32.store8 (i32.const 154) (i32.const 58))
          (i32.store8 (i32.const 155) (i32.const 32))
          (i32.store8 (i32.const 156) (i32.const 116))
          (i32.store8 (i32.const 157) (i32.const 114))
          (i32.store8 (i32.const 158) (i32.const 97))
          (i32.store8 (i32.const 159) (i32.const 99))
          (i32.store8 (i32.const 160) (i32.const 107))
          (i32.store8 (i32.const 161) (i32.const 101))
          (i32.store8 (i32.const 162) (i32.const 100))
          (i32.store8 (i32.const 163) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 32) (call $__i32_to_str (call $dynrt_lib_modc_dynGcCellCount) (i32.const 164))))
          ...
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 6))) (i32.const 10))
  ...
  (global $dynrt_lib_modc_global5 i32 (i32.const 774))
  ...
  (global $dynrt_lib_modc_global13 (mut i32) (i32.const 774))
  ...
  (data (;1;) (i32.const 522) "false")
  (data (;2;) (i32.const 527) "true")
  (data (;3;) (i32.const 531) "null")
  (data (;4;) (i32.const 535) "undefined")
  (data (;5;) (i32.const 544) "push")
  (data (;6;) (i32.const 548) "indexOf")
  (data (;7;) (i32.const 555) "includes")
  (data (;8;) (i32.const 563) "join")
  (data (;9;) (i32.const 567) ",")
  (data (;10;) (i32.const 568) "slice")
  (data (;11;) (i32.const 573) "concat")
  (data (;12;) (i32.const 579) "reverse")
  (data (;13;) (i32.const 586) "pop")
  (data (;14;) (i32.const 589) "shift")
  (data (;15;) (i32.const 594) "unshift")
  (data (;16;) (i32.const 601) "at")
  (data (;17;) (i32.const 603) "lastIndexOf")
  (data (;18;) (i32.const 614) "map")
  (data (;19;) (i32.const 617) "filter")
  (data (;20;) (i32.const 623) "forEach")
  (data (;21;) (i32.const 630) "reduce")
  (data (;22;) (i32.const 636) "find")
  (data (;23;) (i32.const 640) "findIndex")
  (data (;24;) (i32.const 649) "some")
  (data (;25;) (i32.const 653) "every")
  (data (;26;) (i32.const 658) "sort")
  (data (;27;) (i32.const 662) "charAt")
  (data (;28;) (i32.const 668) "charCodeAt")
  (data (;29;) (i32.const 678) "toUpperCase")
  (data (;30;) (i32.const 689) "toLowerCase")
  (data (;31;) (i32.const 700) "trim")
  (data (;32;) (i32.const 704) "startsWith")
  (data (;33;) (i32.const 714) "endsWith")
  (data (;34;) (i32.const 722) "repeat")
  (data (;35;) (i32.const 728) "padStart")
  (data (;36;) (i32.const 736) " ")
  (data (;37;) (i32.const 737) "padEnd")
  (data (;38;) (i32.const 743) "split")
  (data (;39;) (i32.const 748) "match")
  (data (;40;) (i32.const 753) "__regex")
  (data (;41;) (i32.const 760) "create")
  (data (;42;) (i32.const 766) "keys")
  (data (;43;) (i32.const 770) "values")
  (data (;44;) (i32.const 776) "entries")
  (data (;45;) (i32.const 783) "assign")
  (data (;46;) (i32.const 789) "floor")
  (data (;47;) (i32.const 794) "ceil")
  (data (;48;) (i32.const 798) "round")
  (data (;49;) (i32.const 803) "abs")
  (data (;50;) (i32.const 806) "sqrt")
  (data (;51;) (i32.const 810) "sign")
  (data (;52;) (i32.const 814) "trunc")
  (data (;53;) (i32.const 819) "max")
  (data (;54;) (i32.const 822) "min")
  (data (;55;) (i32.const 825) "pow")
  (data (;56;) (i32.const 828) "\22")
  (data (;57;) (i32.const 829) "\5c\22")
  (data (;58;) (i32.const 831) "\5c\5c")
  (data (;59;) (i32.const 833) "\5cn")
  (data (;60;) (i32.const 835) "\5cr")
  (data (;61;) (i32.const 837) "\5ct")
  (data (;62;) (i32.const 839) "[")
  (data (;63;) (i32.const 840) "]")
  (data (;64;) (i32.const 841) "{")
  (data (;65;) (i32.const 842) ":")
  (data (;66;) (i32.const 843) "}")
  (data (;67;) (i32.const 844) "__mapk")
  (data (;68;) (i32.const 850) "__mapv")
  (data (;69;) (i32.const 856) "__setk")
  (data (;70;) (i32.const 862) "set")
  (data (;71;) (i32.const 865) "get")
  (data (;72;) (i32.const 868) "has")
  (data (;73;) (i32.const 871) "delete")
  (data (;74;) (i32.const 877) "add")
  (data (;75;) (i32.const 880) "test")
  (data (;76;) (i32.const 884) "exec")
  (data (;77;) (i32.const 888) "next")
  (data (;78;) (i32.const 892) "__genv")
  (data (;79;) (i32.const 898) "__geni")
  (data (;80;) (i32.const 904) "value")
  (data (;81;) (i32.const 909) "done")
  (data (;82;) (i32.const 913) "this")
  (data (;83;) (i32.const 917) "len")
  (data (;84;) (i32.const 920) "inc")
  (data (;85;) (i32.const 923) "size")
  (data (;86;) (i32.const 927) "__get_")
  (data (;87;) (i32.const 933) "length")
  (data (;88;) (i32.const 939) "__set_")
  (data (;89;) (i32.const 945) "function")
  (data (;90;) (i32.const 953) "yield")
  (data (;91;) (i32.const 958) "Object")
  (data (;92;) (i32.const 964) "Math")
  (data (;93;) (i32.const 968) "PI")
  (data (;94;) (i32.const 970) "E")
  (data (;95;) (i32.const 971) "JSON")
  (data (;96;) (i32.const 975) "parse")
  (data (;97;) (i32.const 980) "stringify")
  (data (;98;) (i32.const 989) "new")
  (data (;99;) (i32.const 992) "Map")
  (data (;100;) (i32.const 995) "Set")
  (data (;101;) (i32.const 998) "RegExp")
  (data (;102;) (i32.const 1004) "super")
  (data (;103;) (i32.const 1009) "__superclass")
  (data (;104;) (i32.const 1021) "__ctor")
  (data (;105;) (i32.const 1027) "__superproto")
  (data (;106;) (i32.const 1039) "boolean")
  (data (;107;) (i32.const 1046) "number")
  (data (;108;) (i32.const 1052) "string")
  (data (;109;) (i32.const 1058) "object")
  (data (;110;) (i32.const 1064) "typeof")
  (data (;111;) (i32.const 1070) "else")
  (data (;112;) (i32.const 1074) "const")
  (data (;113;) (i32.const 1079) "let")
  (data (;114;) (i32.const 1082) "var")
  (data (;115;) (i32.const 1085) "of")
  (data (;116;) (i32.const 1087) "in")
  (data (;117;) (i32.const 1089) "case")
  (data (;118;) (i32.const 1093) "default")
  (data (;119;) (i32.const 1100) "catch")
  (data (;120;) (i32.const 1105) "finally")
  (data (;121;) (i32.const 1112) "extends")
  (data (;122;) (i32.const 1119) "__proto")
  (data (;123;) (i32.const 1126) "static")
  (data (;124;) (i32.const 1132) "constructor")
  (data (;125;) (i32.const 1143) "this.")
  (data (;126;) (i32.const 1148) " = ")
  (data (;127;) (i32.const 1151) "; ")
  (data (;128;) (i32.const 1153) "if")
  (data (;129;) (i32.const 1155) "while")
  (data (;130;) (i32.const 1160) "do")
  (data (;131;) (i32.const 1162) "for")
  (data (;132;) (i32.const 1165) "switch")
  (data (;133;) (i32.const 1171) "try")
  (data (;134;) (i32.const 1174) "throw")
  (data (;135;) (i32.const 1179) "return")
  (data (;136;) (i32.const 1185) "class")
  (data (;137;) (i32.const 1190) "break")
  (data (;138;) (i32.const 1195) "continue")
)