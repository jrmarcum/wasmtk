(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 1267))
  ...
  (func $_start (export "_start")
    ...
    (local.set $u (call $dynrt_lib_modc_dynUndefined ))
    (local.set $nul (call $dynrt_lib_modc_dynNull ))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 143) (i32.const 102))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 18) (call $__i32_to_str (call $dynrt_lib_modc_dynTypeof (local.get $u)) (i32.const 150))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynTypeof (local.get $u)) (i32.const 0)) (then (i32.const 1)) (else (i32.const 0))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 116))
          (i32.store8 (i32.const 133) (i32.const 121))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 13) (call $__i32_to_str (call $dynrt_lib_modc_dynTypeof (local.get $nul)) (i32.const 145))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynTypeof (local.get $nul)) (i32.const 1)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynTag (local.get $u)) (i32.const 0)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynTag (local.get $nul)) (i32.const 1)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynToBool (local.get $u)) (i32.const 0)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynToBool (local.get $nul)) (i32.const 0)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (f64.eq (call $dynrt_lib_modc_dynToNumber (local.get $nul)) (f64.const 0)) (then (i32.const 1)) (else (i32.const 0))))
    (local.set $bt (call $dynrt_lib_modc_dynBool (i32.const 1)))
    (local.set $bf (call $dynrt_lib_modc_dynBool (i32.const 0)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 116))
          (i32.store8 (i32.const 133) (i32.const 121))
          ...
          (i32.store8 (i32.const 143) (i32.const 58))
          (i32.store8 (i32.const 144) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 13) (call $__i32_to_str (call $dynrt_lib_modc_dynTypeof (local.get $bt)) (i32.const 145))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynTypeof (local.get $bt)) (i32.const 2)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynBoolValue (local.get $bt)) (i32.const 1)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynToBool (local.get $bt)) (i32.const 1)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynToBool (local.get $bf)) (i32.const 0)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (f64.eq (call $dynrt_lib_modc_dynToNumber (local.get $bt)) (f64.const 1)) (then (i32.const 1)) (else (i32.const 0))))
    (local.set $num (call $dynrt_lib_modc_dynNumber (f64.const 42.5)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 116))
          (i32.store8 (i32.const 133) (i32.const 121))
          ...
          (i32.store8 (i32.const 139) (i32.const 110))
          (i32.store8 (i32.const 140) (i32.const 117))
          (i32.store8 (i32.const 141) (i32.const 109))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 15) (call $__i32_to_str (call $dynrt_lib_modc_dynTypeof (local.get $num)) (i32.const 147))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynTypeof (local.get $num)) (i32.const 3)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (f64.eq (call $dynrt_lib_modc_dynNumberValue (local.get $num)) (f64.const 42.5)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynToBool (local.get $num)) (i32.const 1)) (then (i32.const 1)) (else (i32.const 0))))
    (local.set $zero (call $dynrt_lib_modc_dynNumber (f64.const 0)))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynToBool (local.get $zero)) (i32.const 0)) (then (i32.const 1)) (else (i32.const 0))))
    (local.set $s (call $dynrt_lib_modc_dynString (i32.const 260) (i32.const 2)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 116))
          (i32.store8 (i32.const 133) (i32.const 121))
          ...
          (i32.store8 (i32.const 144) (i32.const 103))
          (i32.store8 (i32.const 145) (i32.const 58))
          (i32.store8 (i32.const 146) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 15) (call $__i32_to_str (call $dynrt_lib_modc_dynTypeof (local.get $s)) (i32.const 147))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynTypeof (local.get $s)) (i32.const 4)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynStrLen (local.get $s)) (i32.const 2)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynStrCharAt (local.get $s) (i32.const 0)) (i32.const 104)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynStrCharAt (local.get $s) (i32.const 1)) (i32.const 105)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynToBool (local.get $s)) (i32.const 1)) (then (i32.const 1)) (else (i32.const 0))))
    (local.set $empty (call $dynrt_lib_modc_dynString (i32.const 262) (i32.const 0)))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynToBool (local.get $empty)) (i32.const 0)) (then (i32.const 1)) (else (i32.const 0))))
    (local.set $obj (call $dynrt_lib_modc_dynObject ))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynObjLen (local.get $obj)) (i32.const 0)) (then (i32.const 1)) (else (i32.const 0))))
    (call $dynrt_lib_modc_dynSet (local.get $obj) (i32.const 262) (i32.const 1) (call $dynrt_lib_modc_dynNumber (f64.const 10)))
    (call $dynrt_lib_modc_dynSet (local.get $obj) (i32.const 263) (i32.const 1) (call $dynrt_lib_modc_dynString (i32.const 264) (i32.const 5)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 111))
          (i32.store8 (i32.const 133) (i32.const 98))
          (i32.store8 (i32.const 134) (i32.const 106))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 9) (call $__i32_to_str (call $dynrt_lib_modc_dynObjLen (local.get $obj)) (i32.const 141))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynObjLen (local.get $obj)) (i32.const 2)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynHas (local.get $obj) (i32.const 262) (i32.const 1)) (i32.const 1)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynHas (local.get $obj) (i32.const 269) (i32.const 7)) (i32.const 0)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynGet (local.get $obj) (i32.const 269) (i32.const 7)) (i32.const -1)) (then (i32.const 1)) (else (i32.const 0))))
    (local.set $gx (call $dynrt_lib_modc_dynGet (local.get $obj) (i32.const 262) (i32.const 1)))
    (call $check (if (result i32) (f64.eq (call $dynrt_lib_modc_dynNumberValue (local.get $gx)) (f64.const 10)) (then (i32.const 1)) (else (i32.const 0))))
    (local.set $gy (call $dynrt_lib_modc_dynGet (local.get $obj) (i32.const 263) (i32.const 1)))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynTypeof (local.get $gy)) (i32.const 4)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynStrLen (local.get $gy)) (i32.const 5)) (then (i32.const 1)) (else (i32.const 0))))
    (call $dynrt_lib_modc_dynSet (local.get $obj) (i32.const 262) (i32.const 1) (call $dynrt_lib_modc_dynNumber (f64.const 99)))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynObjLen (local.get $obj)) (i32.const 2)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (f64.eq (call $dynrt_lib_modc_dynNumberValue (call $dynrt_lib_modc_dynGet (local.get $obj) (i32.const 262) (i32.const 1))) (f64.const 99)) (then (i32.const 1)) (else (i32.const 0))))
    (local.set $arr (call $dynrt_lib_modc_dynArray ))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynArrLen (local.get $arr)) (i32.const 0)) (then (i32.const 1)) (else (i32.const 0))))
    (block $break_0
      (loop $loop_0
        (br_if $break_0 (i32.eqz (i32.lt_s (global.get $i) (i32.const 10))))
        (block $cont_0
          (call $dynrt_lib_modc_dynPush (local.get $arr) (call $dynrt_lib_modc_dynNumber (f64.convert_i32_s (i32.mul (global.get $i) (i32.const 2)))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 139) (i32.const 58))
          (i32.store8 (i32.const 140) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 9) (call $__i32_to_str (call $dynrt_lib_modc_dynArrLen (local.get $arr)) (i32.const 141))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynArrLen (local.get $arr)) (i32.const 10)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (f64.eq (call $dynrt_lib_modc_dynNumberValue (call $dynrt_lib_modc_dynArrGet (local.get $arr) (i32.const 0))) (f64.const 0)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (f64.eq (call $dynrt_lib_modc_dynNumberValue (call $dynrt_lib_modc_dynArrGet (local.get $arr) (i32.const 9))) (f64.const 18)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (f64.eq (call $dynrt_lib_modc_dynNumberValue (call $dynrt_lib_modc_dynArrGet (local.get $arr) (i32.const 5))) (f64.const 10)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynStrictEq (call $dynrt_lib_modc_dynNumber (f64.const 5)) (call $dynrt_lib_modc_dynNumber (f64.const 5))) (i32.const 1)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynStrictEq (call $dynrt_lib_modc_dynNumber (f64.const 5)) (call $dynrt_lib_modc_dynNumber (f64.const 6))) (i32.const 0)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynStrictEq (call $dynrt_lib_modc_dynString (i32.const 276) (i32.const 2)) (call $dynrt_lib_modc_dynString (i32.const 276) (i32.const 2))) (i32.const 1)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynStrictEq (call $dynrt_lib_modc_dynString (i32.const 276) (i32.const 2)) (call $dynrt_lib_modc_dynString (i32.const 278) (i32.const 2))) (i32.const 0)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynStrictEq (call $dynrt_lib_modc_dynBool (i32.const 1)) (call $dynrt_lib_modc_dynBool (i32.const 1))) (i32.const 1)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynStrictEq (call $dynrt_lib_modc_dynNull ) (call $dynrt_lib_modc_dynNull )) (i32.const 1)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynStrictEq (call $dynrt_lib_modc_dynNull ) (call $dynrt_lib_modc_dynUndefined )) (i32.const 0)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynStrictEq (call $dynrt_lib_modc_dynNumber (f64.const 5)) (call $dynrt_lib_modc_dynString (i32.const 280) (i32.const 1))) (i32.const 0)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynStrictEq (local.get $obj) (local.get $obj)) (i32.const 1)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynStrictEq (call $dynrt_lib_modc_dynObject ) (call $dynrt_lib_modc_dynObject )) (i32.const 0)) (then (i32.const 1)) (else (i32.const 0))))
    (local.set $sum (call $dynrt_lib_modc_dynAdd (call $dynrt_lib_modc_dynNumber (f64.const 3)) (call $dynrt_lib_modc_dynNumber (f64.const 4))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 51))
          ...
          (i32.store8 (i32.const 138) (i32.const 61))
          (i32.store8 (i32.const 139) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 8) (call $__f64_to_str (call $dynrt_lib_modc_dynNumberValue (local.get $sum)) (i32.const 140))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynTypeof (local.get $sum)) (i32.const 3)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (f64.eq (call $dynrt_lib_modc_dynNumberValue (local.get $sum)) (f64.const 7)) (then (i32.const 1)) (else (i32.const 0))))
    (local.set $cat (call $dynrt_lib_modc_dynAdd (call $dynrt_lib_modc_dynString (i32.const 281) (i32.const 3)) (call $dynrt_lib_modc_dynString (i32.const 284) (i32.const 3))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 12) (call $__i32_to_str (call $dynrt_lib_modc_dynStrLen (local.get $cat)) (i32.const 144))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynTypeof (local.get $cat)) (i32.const 4)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynStrLen (local.get $cat)) (i32.const 6)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynStrCharAt (local.get $cat) (i32.const 0)) (i32.const 102)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynStrCharAt (local.get $cat) (i32.const 3)) (i32.const 98)) (then (i32.const 1)) (else (i32.const 0))))
    (local.set $mixed (call $dynrt_lib_modc_dynAdd (call $dynrt_lib_modc_dynString (i32.const 287) (i32.const 2)) (call $dynrt_lib_modc_dynBool (i32.const 1))))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynTypeof (local.get $mixed)) (i32.const 4)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $dynrt_lib_modc_dynStrLen (local.get $mixed)) (i32.const 6)) (then (i32.const 1)) (else (i32.const 0))))
  ...
  (data (i32.const 260) "\68\69")
  (data (i32.const 262) "")
  (data (i32.const 262) "\78")
  (data (i32.const 263) "\79")
  (data (i32.const 264) "\68\65\6c\6c\6f")
  (data (i32.const 269) "\6d\69\73\73\69\6e\67")
  (data (i32.const 276) "\61\62")
  (data (i32.const 278) "\61\63")
  (data (i32.const 280) "\35")
  (data (i32.const 281) "\66\6f\6f")
  (data (i32.const 284) "\62\61\72")
  (data (i32.const 287) "\76\3d")
  (data (i32.const 289) "\64\79\6e\72\74\20\76\61\6c\75\65\2d\6d\6f\64\65\6c\3a\20\61\6c\6c\20\63\68\65\63\6b\73\20\70\61\73\73\65\64\0a")
  ...
  (global $dynrt_lib_modc_global5 i32 (i32.const 838))
  ...
  (global $dynrt_lib_modc_global13 (mut i32) (i32.const 838))
  ...
  (func $dynrt_lib_modc__fn121 (param i32 i32 i32 i32) (result i32)
    ...
    call $dynrt_lib_modc_dynUndefined
    return)
  (func $dynrt_lib_modc__fn122 (param i32 i32 i32)
  ...
  (func $dynrt_lib_modc_dynBuiltin (param i32) (result i32)
    ...
    local.tee 2
    return)
  (func $dynrt_lib_modc__fn136 (param i32 i32 i32) (result i32)
    (local i32) (local i32)
  ...
  (func $dynrt_lib_modc_dynMakeFn (param i32 i32 i32 i32) (result i32)
    ...
    return)
  (func $dynrt_lib_modc__fn140 (param i32 i32 i32) (result i32)
    (local i32) (local i32) (local i32)
    local.get 0
    local.set 3
    block  ;; label = @1
    ...
    i32.const -1
    return)
  (func $dynrt_lib_modc__fn141 (param i32) (result i32)
    (local i32) (local i32) (local i32) (local i32)
    call $dynrt_lib_modc_dynObject
    local.set 1
    local.get 1
  ...
  (func $dynrt_lib_modc_dynApply (param i32 i32) (result i32)
    ...
    return)
  (func $dynrt_lib_modc__fn145 (param i32 i32 i32) (result i32)
  ...
  (func $dynrt_lib_modc_dynResetSideEffects
    i32.const 0
    global.set $dynrt_lib_modc_global22)
  (func $dynrt_lib_modc__fn153 (param i32 i32 i32 i32) (result i32)
    (local i32)
    local.get 1
    local.get 3
    i32.ne
  ...
  (func $dynrt_lib_modc_dynMember (param i32 i32 i32) (result i32)
    ...
    call $dynrt_lib_modc_dynUndefined
    return)
  (func $dynrt_lib_modc__fn155 (param i32 i32 i32 i32)
    (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32)
    local.get 0
    local.tee 10
    local.set 4
  ...
  (func $dynrt_lib_modc__fn159 (param i32 i32) (result i32)
    ...
    call $dynrt_lib_modc__fn8
    return)
  (func $dynrt_lib_modc__fn160 (param i32 i32) (result i32)
    (local i32)
    global.get $dynrt_lib_modc_global19
    i32.const 1
    i32.add
    ...
    call $dynrt_lib_modc__fn8
    return)
  (func $dynrt_lib_modc__fn161 (param i32 i32) (result i32)
    (local i32) (local i32) (local i32)
    global.get $dynrt_lib_modc_global19
    local.tee 4
    local.set 2
  ...
  (func $dynrt_lib_modc__fn164 (param i32 i32) (result i32)
    ...
    local.get 2
    return)
  (func $dynrt_lib_modc__fn165 (param i32) (result i32)
    (local i32)
    local.get 0
    local.set 1
    local.get 1
  ...
  (func $dynrt_lib_modc__fn178 (param i32 i32)
    (local i32) (local i32)
    local.get 0
    local.get 1
    call $dynrt_lib_modc__fn158
  ...
  (func $dynrt_lib_modc__fn179 (param i32 i32)
    (local i32) (local i32) (local i32) (local i32) (local i32)
    global.get $dynrt_lib_modc_global21
    local.set 2
    local.get 0
  ...
  (func $dynrt_lib_modc__fn182 (param i32 i32)
    ...
    local.tee 15
    global.set $dynrt_lib_modc_global20)
  (func $dynrt_lib_modc__fn183 (param i32 i32 i32 i32 i32 i32)
    (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32)
    global.get $dynrt_lib_modc_global20
    local.set 6
    local.get 0
  ...
  (func $dynrt_lib_modc__fn184 (param i32 i32 i32 i32 i32 i32)
    (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32)
    global.get $dynrt_lib_modc_global20
    local.set 6
    local.get 0
  ...
  (func $dynrt_lib_modc__fn185 (param i32 i32 i32 i32)
  ...
  (func $dynrt_lib_modc__fn190 (param i32 i32) (result i32)
    (local i32) (local i32) (local i32) (local i32)
    call $dynrt_lib_modc_dynArray
    local.set 2
    local.get 0
    ...
    local.get 2
    return)
  (func $dynrt_lib_modc__fn191 (param i32 i32) (result i32)
    (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32)
    global.get $dynrt_lib_modc_global19
    local.tee 12
    i32.const 1
    ...
    call $dynrt_lib_modc_dynString
    return)
  (func $dynrt_lib_modc__fn192 (param i32 i32) (result i32)
    (local i32) (local i32) (local i32)
    local.get 0
    local.get 1
    call $dynrt_lib_modc__fn158
    ...
    call $dynrt_lib_modc_dynString
    return)
  (func $dynrt_lib_modc__fn193 (param i32 i32) (result i32)
    (local i32) (local i32)
    local.get 0
    local.get 1
    call $dynrt_lib_modc__fn158
    ...
    call $dynrt_lib_modc__fn136
    return)
  (func $dynrt_lib_modc__fn194 (param i32 i32) (result i32)
    (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32) (local i32)
    global.get $dynrt_lib_modc_global19
    local.set 2
    i32.const 0
  ...
  (data (;0;) (i32.const 586) "")
  (data (;1;) (i32.const 586) "false")
  (data (;2;) (i32.const 591) "true")
  (data (;3;) (i32.const 595) "null")
  (data (;4;) (i32.const 599) "undefined")
  (data (;5;) (i32.const 608) "push")
  (data (;6;) (i32.const 612) "indexOf")
  (data (;7;) (i32.const 619) "includes")
  (data (;8;) (i32.const 627) "join")
  (data (;9;) (i32.const 631) ",")
  (data (;10;) (i32.const 632) "slice")
  (data (;11;) (i32.const 637) "concat")
  (data (;12;) (i32.const 643) "reverse")
  (data (;13;) (i32.const 650) "pop")
  (data (;14;) (i32.const 653) "shift")
  (data (;15;) (i32.const 658) "unshift")
  (data (;16;) (i32.const 665) "at")
  (data (;17;) (i32.const 667) "lastIndexOf")
  (data (;18;) (i32.const 678) "map")
  (data (;19;) (i32.const 681) "filter")
  (data (;20;) (i32.const 687) "forEach")
  (data (;21;) (i32.const 694) "reduce")
  (data (;22;) (i32.const 700) "find")
  (data (;23;) (i32.const 704) "findIndex")
  (data (;24;) (i32.const 713) "some")
  (data (;25;) (i32.const 717) "every")
  (data (;26;) (i32.const 722) "sort")
  (data (;27;) (i32.const 726) "charAt")
  (data (;28;) (i32.const 732) "charCodeAt")
  (data (;29;) (i32.const 742) "toUpperCase")
  (data (;30;) (i32.const 753) "toLowerCase")
  (data (;31;) (i32.const 764) "trim")
  (data (;32;) (i32.const 768) "startsWith")
  (data (;33;) (i32.const 778) "endsWith")
  (data (;34;) (i32.const 786) "repeat")
  (data (;35;) (i32.const 792) "padStart")
  (data (;36;) (i32.const 800) " ")
  (data (;37;) (i32.const 801) "padEnd")
  (data (;38;) (i32.const 807) "split")
  (data (;39;) (i32.const 812) "match")
  (data (;40;) (i32.const 817) "__regex")
  (data (;41;) (i32.const 824) "create")
  (data (;42;) (i32.const 830) "keys")
  (data (;43;) (i32.const 834) "values")
  (data (;44;) (i32.const 840) "entries")
  (data (;45;) (i32.const 847) "assign")
  (data (;46;) (i32.const 853) "floor")
  (data (;47;) (i32.const 858) "ceil")
  (data (;48;) (i32.const 862) "round")
  (data (;49;) (i32.const 867) "abs")
  (data (;50;) (i32.const 870) "sqrt")
  (data (;51;) (i32.const 874) "sign")
  (data (;52;) (i32.const 878) "trunc")
  (data (;53;) (i32.const 883) "max")
  (data (;54;) (i32.const 886) "min")
  (data (;55;) (i32.const 889) "pow")
  (data (;56;) (i32.const 892) "\22")
  (data (;57;) (i32.const 893) "\5c\22")
  (data (;58;) (i32.const 895) "\5c\5c")
  (data (;59;) (i32.const 897) "\5cn")
  (data (;60;) (i32.const 899) "\5cr")
  (data (;61;) (i32.const 901) "\5ct")
  (data (;62;) (i32.const 903) "[")
  (data (;63;) (i32.const 904) "]")
  (data (;64;) (i32.const 905) "{")
  (data (;65;) (i32.const 906) ":")
  (data (;66;) (i32.const 907) "}")
  (data (;67;) (i32.const 908) "__mapk")
  (data (;68;) (i32.const 914) "__mapv")
  (data (;69;) (i32.const 920) "__setk")
  (data (;70;) (i32.const 926) "set")
  (data (;71;) (i32.const 929) "get")
  (data (;72;) (i32.const 932) "has")
  (data (;73;) (i32.const 935) "delete")
  (data (;74;) (i32.const 941) "add")
  (data (;75;) (i32.const 944) "test")
  (data (;76;) (i32.const 948) "exec")
  (data (;77;) (i32.const 952) "next")
  (data (;78;) (i32.const 956) "__genv")
  (data (;79;) (i32.const 962) "__geni")
  (data (;80;) (i32.const 968) "value")
  (data (;81;) (i32.const 973) "done")
  (data (;82;) (i32.const 977) "this")
  (data (;83;) (i32.const 981) "len")
  (data (;84;) (i32.const 984) "inc")
  (data (;85;) (i32.const 987) "size")
  (data (;86;) (i32.const 991) "__get_")
  (data (;87;) (i32.const 997) "length")
  (data (;88;) (i32.const 1003) "__set_")
  (data (;89;) (i32.const 1009) "function")
  (data (;90;) (i32.const 1017) "yield")
  (data (;91;) (i32.const 1022) "Object")
  (data (;92;) (i32.const 1028) "Math")
  (data (;93;) (i32.const 1032) "PI")
  (data (;94;) (i32.const 1034) "E")
  (data (;95;) (i32.const 1035) "JSON")
  (data (;96;) (i32.const 1039) "parse")
  (data (;97;) (i32.const 1044) "stringify")
  (data (;98;) (i32.const 1053) "new")
  (data (;99;) (i32.const 1056) "Map")
  (data (;100;) (i32.const 1059) "Set")
  (data (;101;) (i32.const 1062) "RegExp")
  (data (;102;) (i32.const 1068) "super")
  (data (;103;) (i32.const 1073) "__superclass")
  (data (;104;) (i32.const 1085) "__ctor")
  (data (;105;) (i32.const 1091) "__superproto")
  (data (;106;) (i32.const 1103) "boolean")
  (data (;107;) (i32.const 1110) "number")
  (data (;108;) (i32.const 1116) "string")
  (data (;109;) (i32.const 1122) "object")
  (data (;110;) (i32.const 1128) "typeof")
  (data (;111;) (i32.const 1134) "else")
  (data (;112;) (i32.const 1138) "const")
  (data (;113;) (i32.const 1143) "let")
  (data (;114;) (i32.const 1146) "var")
  (data (;115;) (i32.const 1149) "of")
  (data (;116;) (i32.const 1151) "in")
  (data (;117;) (i32.const 1153) "case")
  (data (;118;) (i32.const 1157) "default")
  (data (;119;) (i32.const 1164) "catch")
  (data (;120;) (i32.const 1169) "finally")
  (data (;121;) (i32.const 1176) "extends")
  (data (;122;) (i32.const 1183) "__proto")
  (data (;123;) (i32.const 1190) "static")
  (data (;124;) (i32.const 1196) "constructor")
  (data (;125;) (i32.const 1207) "this.")
  (data (;126;) (i32.const 1212) " = ")
  (data (;127;) (i32.const 1215) "; ")
  (data (;128;) (i32.const 1217) "if")
  (data (;129;) (i32.const 1219) "while")
  (data (;130;) (i32.const 1224) "do")
  (data (;131;) (i32.const 1226) "for")
  (data (;132;) (i32.const 1229) "switch")
  (data (;133;) (i32.const 1235) "try")
  (data (;134;) (i32.const 1238) "throw")
  (data (;135;) (i32.const 1243) "return")
  (data (;136;) (i32.const 1249) "class")
  (data (;137;) (i32.const 1254) "break")
  (data (;138;) (i32.const 1259) "continue")
)