(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 295))
  ...
  (func $_start (export "_start")
    ...
    (local.set $p1 (call $__malloc (i32.const 64)))
    (local.set $p2 (call $__malloc (i32.const 64)))
    (local.set $afterAlloc (global.get $__heap_ptr))
    (call $check (if (result i32) (i32.ne (local.get $p1) (local.get $p2)) (then (i32.const 1)) (else (i32.const 0))))
    (call $__free (local.get $p1) (i32.const 64))
    (local.set $p3 (call $__malloc (i32.const 64)))
    (call $check (if (result i32) (i32.eq (local.get $p3) (local.get $p1)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (global.get $__heap_ptr) (local.get $afterAlloc)) (then (i32.const 1)) (else (i32.const 0))))
    (call $__free (local.get $p3) (i32.const 64))
    (local.set $p4 (call $__malloc (i32.const 32)))
    (call $check (if (result i32) (i32.eq (local.get $p4) (local.get $p3)) (then (i32.const 1)) (else (i32.const 0))))
    (local.set $p5 (call $__malloc (i32.const 48)))
    (call $check (if (result i32) (i32.ne (local.get $p5) (local.get $p4)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.gt_s (global.get $__heap_ptr) (local.get $afterAlloc)) (then (i32.const 1)) (else (i32.const 0))))
  ...
  (data (i32.const 260) "\47\43\20\50\61\72\74\32\20\66\72\65\65\2d\6c\69\73\74\3a\20\72\65\75\73\65\20\76\65\72\69\66\69\65\64\0a")
)