(module
  ...
  (func $vec_dot (param $a f64) (param $b f64) (result f64)
    (return (f64.add (f64.mul (;? a.x;) (f64.const 0) (;? b.x;) (f64.const 0)) (f64.mul (;? a.y;) (f64.const 0) (;? b.y;) (f64.const 0))))
  )

  (func $vec_lengthSq (param $v f64) (result f64)
    (return (f64.add (f64.mul (;? v.x;) (f64.const 0) (;? v.x;) (f64.const 0)) (f64.mul (;? v.y;) (f64.const 0) (;? v.y;) (f64.const 0))))
  )

  (func $main  
    (local $a f64)
    (local $b f64)
    (local.set $a (;? { x: 3.0, y: 4.0 };) (f64.const 0))
    (local.set $b (;? { x: 1.0, y: 2.0 };) (f64.const 0))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (call $vec_lengthSq (local.get $a)) (i32.const 132)))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (call $vec_dot (local.get $a) (local.get $b)) (i32.const 132)))
          (i32.store (i32.const 8) (i32.const 260))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
