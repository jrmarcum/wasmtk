(module
  ...
  (func $greet (param $name_ptr i32) (param $name_len i32) 
    ...
    (local.set $__ret_str_ptr (i32.const 260))
      ...
      (call $__str_concat (local.get $__ret_str_ptr) (local.get $__ret_str_len) (i32.const 267) (i32.const 1))
      (local.set $__ret_str_len)
      (local.set $__ret_str_ptr)
  ...
  (func $shout (param $msg_ptr i32) (param $msg_len i32) 
    ...
    (local.set $__ret_str_ptr (local.get $msg_ptr))
      (local.set $__ret_str_len (local.get $msg_len))
      (call $__str_concat (local.get $__ret_str_ptr) (local.get $__ret_str_len) (local.get $msg_ptr) (local.get $msg_len))
      (local.set $__ret_str_len)
      (local.set $__ret_str_ptr)
      (global.set $__str_ret_ptr (local.get $__ret_str_ptr))
      (global.set $__str_ret_len (local.get $__ret_str_len))
  ...
  (func $greet__cabi (export "greet") (param $name_ptr i32) (param $name_len i32) (result i32)
    (local $__ret i32)
  ...
  (func $cabi_post_greet (export "cabi_post_greet") (param $__ret i32))
  (func $shout__cabi (export "shout") (param $msg_ptr i32) (param $msg_len i32) (result i32)
    (local $__ret i32)
    (local.set $__ret (call $cabi_realloc (i32.const 0) (i32.const 0) (i32.const 4) (i32.const 8)))
  ...
  (func $cabi_post_shout (export "cabi_post_shout") (param $__ret i32))
