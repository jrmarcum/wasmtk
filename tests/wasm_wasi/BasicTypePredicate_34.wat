(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 382))
  ...
  (func $isCircle (param $s i32) (result i32)
    (return (i32.eq (i32.load (local.get $s)) (i32.const 0)))
  )

  (func $isRect (param $s i32) (result i32)
    (return (i32.eq (i32.load (local.get $s)) (i32.const 1)))
  )
  ...
  (func $main  
    ...
    (local.set $r (i32.const 292))
        (i32.store (i32.const 0) (if (result i32) (call $isCircle (local.get $c)) (then (i32.const 324)) (else (i32.const 328))))
          (i32.store (i32.const 4) (if (result i32) (call $isCircle (local.get $c)) (then (i32.const 4)) (else (i32.const 5))))
          ...
          (drop (call $fd_write
            ...
            (i32.const 2)
            (i32.const 128)))
        (i32.store (i32.const 0) (if (result i32) (call $isCircle (local.get $r)) (then (i32.const 324)) (else (i32.const 328))))
          (i32.store (i32.const 4) (if (result i32) (call $isCircle (local.get $r)) (then (i32.const 4)) (else (i32.const 5))))
          (i32.store (i32.const 8) (i32.const 333))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 2)
            (i32.const 128)))
        (i32.store (i32.const 0) (if (result i32) (call $isRect (local.get $r)) (then (i32.const 324)) (else (i32.const 328))))
          (i32.store (i32.const 4) (if (result i32) (call $isRect (local.get $r)) (then (i32.const 4)) (else (i32.const 5))))
          (i32.store (i32.const 8) (i32.const 333))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 2)
            (i32.const 128)))
        (i32.store (i32.const 0) (if (result i32) (call $isRect (local.get $c)) (then (i32.const 324)) (else (i32.const 328))))
          (i32.store (i32.const 4) (if (result i32) (call $isRect (local.get $c)) (then (i32.const 4)) (else (i32.const 5))))
          (i32.store (i32.const 8) (i32.const 333))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (if (call $isCircle (local.get $c))
      (then
          ...
          (i32.store (i32.const 4) (call $__f64_to_str (f64.load (i32.add (i32.const 260) (i32.const 8))) (i32.const 132)))
    ...
    (if (call $isRect (local.get $r))
      (then
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
          (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (f64.load (i32.add (i32.const 292) (i32.const 16))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
          (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (f64.load (i32.add (i32.const 292) (i32.const 24))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (if (i32.eqz (call $isCircle (local.get $r)))
      (then
    ...
    (if (call $isCircle (local.get $r))
      ...
      (else
          (i32.store (i32.const 0) (i32.const 369))
  ...
  (data (i32.const 324) "\74\72\75\65")
  (data (i32.const 328) "\66\61\6c\73\65")
  (data (i32.const 333) "\0a")
  (data (i32.const 334) "\69\73\20\63\69\72\63\6c\65\0a")
  (data (i32.const 344) "\69\73\20\72\65\63\74\0a")
  (data (i32.const 352) "\6e\6f\74\20\63\69\72\63\6c\65\0a")
  (data (i32.const 363) "\77\72\6f\6e\67\0a")
  (data (i32.const 369) "\63\6f\72\72\65\63\74\20\65\6c\73\65\0a")
  (data (i32.const 260) "\00\00\00\00\00\00\00\00\00\00\00\00\00\00\14\40\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
  (data (i32.const 292) "\01\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\10\40\00\00\00\00\00\00\08\40")
)