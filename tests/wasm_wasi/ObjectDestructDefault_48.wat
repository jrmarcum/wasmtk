(module
  ...
  (func $main  
    ...
    (local.set $x (if (result f64) (f64.eq (f64.load (i32.add (i32.const 260) (i32.const 0))) (f64.const 0.0)) (then (f64.const 1.0)) (else (f64.load (i32.add (i32.const 260) (i32.const 0))))))
      (local.set $y (if (result f64) (f64.eq (f64.load (i32.add (i32.const 260) (i32.const 8))) (f64.const 0.0)) (then (f64.const 2.0)) (else (f64.load (i32.add (i32.const 260) (i32.const 8))))))
    ...
    (local.set $a (if (result i32) (i32.eqz (i32.load (i32.add (i32.const 276) (i32.const 0)))) (then (i32.const 10)) (else (i32.load (i32.add (i32.const 276) (i32.const 0))))))
      (local.set $b (if (result i32) (i32.eqz (i32.load (i32.add (i32.const 276) (i32.const 4)))) (then (i32.const 20)) (else (i32.load (i32.add (i32.const 276) (i32.const 4))))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (local.get $a) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $q (i32.const 284))
    (local.set $qa (if (result i32) (i32.eqz (i32.load (i32.add (i32.const 284) (i32.const 0)))) (then (i32.const 100)) (else (i32.load (i32.add (i32.const 284) (i32.const 0))))))
      (local.set $qb (if (result i32) (i32.eqz (i32.load (i32.add (i32.const 284) (i32.const 4)))) (then (i32.const 200)) (else (i32.load (i32.add (i32.const 284) (i32.const 4))))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (local.get $qa) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (local.get $qb) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 260) "\00\00\00\00\00\00\0c\40\00\00\00\00\00\00\00\00")
  (data (i32.const 276) "\05\00\00\00\00\00\00\00")
  (data (i32.const 284) "\00\00\00\00\07\00\00\00")
)