(module
  ...
  (func $testNestedDestructuring (export "testNestedDestructuring")  
    (local $points i32)
    (local $leadPoint i32)
    (local $trailingPoints i32)
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 304))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $points (i32.const 284))
    (local.set $leadPoint (i32.load (i32.const 292)))
      (local.set $trailingPoints (call $__malloc (i32.const 40)))
      (i32.store (local.get $trailingPoints) (i32.const 2))
      (i32.store offset=4 (local.get $trailingPoints) (i32.const 8))
      (i32.store offset=8 (local.get $trailingPoints) (i32.load (i32.const 296)))
      (i32.store offset=12 (local.get $trailingPoints) (i32.load (i32.const 300)))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 137) (i32.const 88))
          (i32.store8 (i32.const 138) (i32.const 32))
          (i32.store8 (i32.const 139) (i32.const 67))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 14) (call $__i32_to_str (i32.load (i32.add (local.get $leadPoint) (i32.const 0))) (i32.const 146))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 139) (i32.const 103))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 16) (call $__i32_to_str (i32.load (local.get $trailingPoints)) (i32.const 148))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 138) (i32.const 84))
          ...
          (i32.store8 (i32.const 147) (i32.const 89))
          (i32.store8 (i32.const 148) (i32.const 58))
          (i32.store8 (i32.const 149) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 18) (call $__i32_to_str (i32.load (i32.add (i32.load (i32.add (i32.add (local.get $trailingPoints) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 2)))) (i32.const 4))) (i32.const 150))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 304) "\2d\2d\2d\20\54\65\73\74\20\33\3a\20\4e\65\73\74\65\64\20\44\65\73\74\72\75\63\74\75\72\69\6e\67\20\4d\69\78\20\2d\2d\2d\0a")
  (data (i32.const 260) "\01\00\00\00\0a\00\00\00")
  (data (i32.const 268) "\02\00\00\00\14\00\00\00")
  (data (i32.const 276) "\03\00\00\00\1e\00\00\00")
  (data (i32.const 284) "\03\00\00\00\03\00\00\00\04\01\00\00\0c\01\00\00\14\01\00\00")
)