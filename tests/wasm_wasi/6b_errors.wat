  ...
  (func $_start (export "_start")
    ...
    (block $break_0
      (loop $loop_0
        ...
        (block $cont_0
          ...
          (if (i32.load (i32.add (local.get $r) (i32.const 16)))
            (then
          ...
          (call $__str_gather (i32.load offset=8 (local.get $r)) (i32.load offset=12 (local.get $r)) (i32.const 143))
          (i32.store (i32.const 4) (i32.add (i32.const 11) (i32.load offset=12 (local.get $r))))
    ...
    (block $break_1
      (loop $loop_1
        ...
        (block $cont_1
          ...
          (call $__str_gather (i32.load offset=8 (i32.load (i32.add (local.get $r) (i32.const 8)))) (i32.load offset=12 (i32.load (i32.add (local.get $r) (i32.const 8)))) (i32.add (i32.const 132) (i32.load (i32.const 4))))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.load offset=12 (i32.load (i32.add (local.get $r) (i32.const 8))))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (if (i32.load (i32.add (local.get $ae) (i32.const 12)))
      (then
          ...
          (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (i32.load offset=8 (i32.load (i32.add (local.get $ae) (i32.const 8)))) (i32.load offset=12 (i32.load (i32.add (local.get $ae) (i32.const 8)))) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (i32.load offset=12 (i32.load (i32.add (local.get $ae) (i32.const 8))))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
