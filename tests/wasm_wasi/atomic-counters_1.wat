(module
  ...
  (global $ops (mut f64) (f64.const 0))
  ...
  (func $_start (export "_start")
    ...
    (block $break_0
      (loop $loop_0
        (br_if $break_0 (i32.eqz (f64.lt (local.get $i) (f64.const 50))))
        (block $cont_0
          (local.set $j (f64.const 0))
          (block $break_1
            (loop $loop_1
              (br_if $break_1 (i32.eqz (f64.lt (local.get $j) (f64.const 1000))))
              (block $cont_1
                (global.set $ops (f64.add (global.get $ops) (f64.const 1)))
              )
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 5) (call $__f64_to_str (global.get $ops) (i32.const 137))))
