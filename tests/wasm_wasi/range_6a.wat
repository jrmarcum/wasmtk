(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 365))
  ...
  (func $_start (export "_start")
    ...
    (block $break_0
      (loop $loop_0
        (br_if $break_0 (i32.eqz (f64.lt (local.get $idx) (f64.convert_i32_s (i32.const 3)))))
        (block $cont_0
          (global.set $sum (f64.add (global.get $sum) (f64.load (i32.add (i32.add (i32.const 260) (i32.const 8)) (i32.shl (i32.trunc_f64_s (local.get $idx)) (i32.const 3))))))
        )
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 5) (call $__f64_to_str (global.get $sum) (i32.const 137))))
    ...
    (block $break_1
      (loop $loop_1
        (br_if $break_1 (i32.eqz (f64.lt (local.get $idx) (f64.convert_i32_s (i32.const 3)))))
        (block $cont_1
          (if (f64.eq (f64.load (i32.add (i32.add (i32.const 260) (i32.const 8)) (i32.shl (i32.trunc_f64_s (local.get $idx)) (i32.const 3)))) (f64.const 3))
            (then
                (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 7) (call $__f64_to_str (local.get $idx) (i32.const 139))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (local.set $kvKeys (i32.const 294))
    (local.set $kvVals (i32.const 329))
    (local.set $i (f64.const 0))
    (block $break_2
      (loop $loop_2
        (br_if $break_2 (i32.eqz (f64.lt (local.get $i) (f64.convert_i32_s (i32.const 2)))))
        (block $cont_2
              (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (i32.load (i32.add (i32.add (i32.const 294) (i32.const 8)) (i32.shl (i32.trunc_f64_s (local.get $i)) (i32.const 3)))) (i32.load offset=4 (i32.add (i32.add (i32.const 294) (i32.const 8)) (i32.shl (i32.trunc_f64_s (local.get $i)) (i32.const 3)))) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (i32.load offset=4 (i32.add (i32.add (i32.const 294) (i32.const 8)) (i32.shl (i32.trunc_f64_s (local.get $i)) (i32.const 3))))))
          ...
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 2))) (i32.const 62))
          ...
          (call $__str_gather (i32.load (i32.add (i32.add (i32.const 329) (i32.const 8)) (i32.shl (i32.trunc_f64_s (local.get $i)) (i32.const 3)))) (i32.load offset=4 (i32.add (i32.add (i32.const 329) (i32.const 8)) (i32.shl (i32.trunc_f64_s (local.get $i)) (i32.const 3)))) (i32.add (i32.const 132) (i32.load (i32.const 4))))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.load offset=4 (i32.add (i32.add (i32.const 329) (i32.const 8)) (i32.shl (i32.trunc_f64_s (local.get $i)) (i32.const 3))))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (block $break_3
      (loop $loop_3
        (br_if $break_3 (i32.eqz (f64.lt (local.get $i) (f64.convert_i32_s (i32.const 2)))))
        (block $cont_3
              (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store8 (i32.const 135) (i32.const 58))
          (i32.store8 (i32.const 136) (i32.const 32))
          (call $__str_gather (i32.load (i32.add (i32.add (i32.const 294) (i32.const 8)) (i32.shl (i32.trunc_f64_s (local.get $i)) (i32.const 3)))) (i32.load offset=4 (i32.add (i32.add (i32.const 294) (i32.const 8)) (i32.shl (i32.trunc_f64_s (local.get $i)) (i32.const 3)))) (i32.const 137))
          (i32.store (i32.const 4) (i32.add (i32.const 5) (i32.load offset=4 (i32.add (i32.add (i32.const 294) (i32.const 8)) (i32.shl (i32.trunc_f64_s (local.get $i)) (i32.const 3))))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 353))
  ...
  (data (i32.const 292) "\61")
  (data (i32.const 293) "\62")
  (data (i32.const 318) "\61\70\70\6c\65")
  (data (i32.const 323) "\62\61\6e\61\6e\61")
  (data (i32.const 353) "\30\20\31\30\33\0a")
  (data (i32.const 359) "\31\20\31\31\31\0a")
  (data (i32.const 260) "\03\00\00\00\03\00\00\00\00\00\00\00\00\00\00\40\00\00\00\00\00\00\08\40\00\00\00\00\00\00\10\40")
  (data (i32.const 294) "\02\00\00\00\02\00\00\00\24\01\00\00\01\00\00\00\25\01\00\00\01\00\00\00")
  (data (i32.const 329) "\02\00\00\00\02\00\00\00\3e\01\00\00\05\00\00\00\43\01\00\00\06\00\00\00")
)