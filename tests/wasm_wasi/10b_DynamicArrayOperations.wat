(module
  ...
  (func $testDynamicOps (export "testDynamicOps")  (result i32)
    ...
    (local.set $nums (call $__dynarr_push_i32 (local.get $nums) (i32.const 30)))
    (local.set $_first (call $__dynarr_shift_i32 (local.get $nums)))
    (return (i32.load (local.get $nums)))
  )
  (func $_start (export "_start")
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $testDynamicOps) (i32.const 132)))
