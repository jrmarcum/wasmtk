(module
  ...
  (func $count (param $s_ptr i32) (param $s_len i32) (param $sub_ptr i32) (param $sub_len i32) (result f64)
    ...
    (block $break_0
      (loop $loop_0
        ...
        (block $cont_0
          (local.set $idx (f64.convert_i32_s (call $__str_indexof (local.get $s_ptr) (local.get $s_len) (local.get $sub_ptr) (local.get $sub_len))))
  ...
  (func $hasPrefix (param $s_ptr i32) (param $s_len i32) (param $prefix_ptr i32) (param $prefix_len i32) (result i32)
    (local $__iface_tmp i32)
    (return (i32.and (i32.ge_s (local.get $s_len) (local.get $prefix_len)) (i32.eq (;? s.slice(0, prefix.length) ;) (i32.const 0) (i32.gt_s (local.get $prefix_len) (i32.const 0)))))
  )

  (func $hasSuffix (param $s_ptr i32) (param $s_len i32) (param $suffix_ptr i32) (param $suffix_len i32) (result i32)
    (local $__iface_tmp i32)
    (return (i32.and (i32.ge_s (local.get $s_len) (local.get $suffix_len)) (i32.eq (;? s.slice(s.length - suffix.length) ;) (i32.const 0) (i32.gt_s (local.get $suffix_len) (i32.const 0)))))
  )
  ...
  (func $join (param $arr i32) (param $sep_ptr i32) (param $sep_len i32) 
    ...
    (block $break_1
      ...
      (local.set $r_ptr)
          ...
          (call $__str_concat (local.get $r_ptr) (local.get $r_len) (i32.const 0) (i32.const 0))
      (local.set $r_len)
      (local.set $r_ptr)
        )
  ...
  (func $replace (param $s_ptr i32) (param $s_len i32) (param $old_ptr i32) (param $old_len i32) (param $nw_ptr i32) (param $nw_len i32) 
    ...
    (call $__str_slice (local.get $s_ptr) (local.get $s_len) (i32.const 0) (i32.add (;? idx) + nw + s.slice(idx ;) (i32.const 0) (local.get $old_len)))
  ...
  (func $split (param $s_ptr i32) (param $s_len i32) (param $sep_ptr i32) (param $sep_len i32) (result i32)
    ...
    (block $break_3
      (loop $loop_3
        ...
        (block $cont_3
          (local.set $idx (f64.convert_i32_s (call $__str_indexof (local.get $s_ptr) (local.get $s_len) (local.get $sep_ptr) (local.get $sep_len))))
          (if (f64.lt (local.get $idx) (f64.const 0))
            (then
            (local.set $parts (call $__dynarr_push_string (local.get $parts) (;? s.slice(pos) ;) (i32.const 0)))
            (br $break_3)
            )
          )
          (local.set $parts (call $__dynarr_push_string (local.get $parts) (;? s.slice(pos, idx) ;) (i32.const 0)))
  ...
  (func $_start (export "_start")
    (local $__iface_tmp i32)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 142) (i32.const 32))
          (i32.store8 (i32.const 143) (i32.const 32))
          (call $join (;? ["a", "b"] ;) (i32.const 0) (i32.const 321) (i32.const 1))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 142) (i32.const 32))
          (i32.store8 (i32.const 143) (i32.const 32))
          (call $repeat (i32.const 322) (i32.const 1) (f64.const 5))
          (call $__str_gather (global.get $__str_ret_ptr) (global.get $__str_ret_len) (i32.const 144))
          (i32.store (i32.const 4) (i32.add (i32.const 12) (global.get $__str_ret_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 142) (i32.const 32))
          (i32.store8 (i32.const 143) (i32.const 32))
          (call $replaceAll (i32.const 323) (i32.const 3) (i32.const 326) (i32.const 1) (i32.const 327) (i32.const 1))
          (call $__str_gather (global.get $__str_ret_ptr) (global.get $__str_ret_len) (i32.const 144))
          (i32.store (i32.const 4) (i32.add (i32.const 12) (global.get $__str_ret_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 142) (i32.const 32))
          (i32.store8 (i32.const 143) (i32.const 32))
          (call $replace (i32.const 323) (i32.const 3) (i32.const 326) (i32.const 1) (i32.const 327) (i32.const 1))
          (call $__str_gather (global.get $__str_ret_ptr) (global.get $__str_ret_len) (i32.const 144))
          (i32.store (i32.const 4) (i32.add (i32.const 12) (global.get $__str_ret_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 142) (i32.const 32))
          (i32.store8 (i32.const 143) (i32.const 32))
          (call $strArrStr (call $split (i32.const 328) (i32.const 9) (i32.const 321) (i32.const 1)))
          (call $__str_gather (global.get $__str_ret_ptr) (global.get $__str_ret_len) (i32.const 144))
          (i32.store (i32.const 4) (i32.add (i32.const 12) (global.get $__str_ret_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 133) (i32.const 111))
          (i32.store8 (i32.const 134) (i32.const 76))
          ...
          (i32.store8 (i32.const 142) (i32.const 32))
          (i32.store8 (i32.const 143) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 12) (call $__f64_to_str (;? "TEST".toLowerCase() ;) (f64.const 0) (i32.const 144))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 132) (i32.const 84))
          (i32.store8 (i32.const 133) (i32.const 111))
          (i32.store8 (i32.const 134) (i32.const 85))
          ...
          (i32.store8 (i32.const 142) (i32.const 32))
          (i32.store8 (i32.const 143) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 12) (call $__f64_to_str (;? "test".toUpperCase() ;) (f64.const 0) (i32.const 144))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 321) "\2d")
  (data (i32.const 322) "\61")
  (data (i32.const 323) "\66\6f\6f")
  (data (i32.const 326) "\6f")
  (data (i32.const 327) "\30")
  (data (i32.const 328) "\61\2d\62\2d\63\2d\64\2d\65")
)