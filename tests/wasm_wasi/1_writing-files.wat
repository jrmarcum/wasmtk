(module
  ...
  (global $n2 f64 (f64.const 5))
  (global $n3 f64 (f64.const 7))
  (global $n4 f64 (f64.const 9))
  ...
  (func $_start (export "_start")
    ...
    (local $__tmpl_num_len i32)
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 6) (call $__f64_to_str (global.get $n2) (i32.const 138))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 136) (i32.const 101))
          (i32.store8 (i32.const 137) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 6) (call $__f64_to_str (global.get $n3) (i32.const 138))))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 32))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 1))) (i32.const 98))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 2))) (i32.const 121))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 3))) (i32.const 116))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 136) (i32.const 101))
          (i32.store8 (i32.const 137) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 6) (call $__f64_to_str (global.get $n4) (i32.const 138))))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 32))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 1))) (i32.const 98))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 2))) (i32.const 121))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 3))) (i32.const 116))
