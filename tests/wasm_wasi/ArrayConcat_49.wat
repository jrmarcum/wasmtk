(module
  ...
  ;; Dynamic array concat_f64: alloc new array = arrA ++ arrB.
  (func $__dynarr_concat_f64 (param $a i32) (param $b i32) (result i32)
    (local $lenA i32)
    (local $lenB i32)
    (local $newlen i32)
    (local $cap i32)
    ...
    (if (i32.lt_u (local.get $cap) (i32.const 8)) (then (local.set $cap (i32.const 8))))
    (local.set $newptr (call $__malloc
      (i32.add (i32.const 8) (i32.shl (local.get $cap) (i32.const 3)))))
    (i32.store (local.get $newptr) (local.get $newlen))
    (i32.store offset=4 (local.get $newptr) (local.get $cap))
    (local.set $i (i32.const 0))
    (block $doneA
      (loop $lpA
        ...
        (f64.store
          ...
          (f64.load (i32.add (i32.add (local.get $a) (i32.const 8)) (i32.shl (local.get $i) (i32.const 3)))))
        (local.set $i (i32.add (local.get $i) (i32.const 1)))
        (br $lpA)
      )
    )
    ...
    (block $doneB
      (loop $lpB
        ...
        (f64.store
          (i32.add (i32.add (local.get $newptr) (i32.const 8))
            (i32.shl (i32.add (local.get $i) (local.get $lenA)) (i32.const 3)))
          (f64.load (i32.add (i32.add (local.get $b) (i32.const 8)) (i32.shl (local.get $i) (i32.const 3)))))
        (local.set $i (i32.add (local.get $i) (i32.const 1)))
        (br $lpB)
      )
    )
    ...
    (local.set $c (call $__dynarr_concat_i32 (local.get $a) (local.get $b)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $c) (i32.const 8)) (i32.shl (i32.const 5) (i32.const 2)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $x (call $__malloc (i32.const 72)))
      (i32.store (local.get $x) (i32.const 2))
      (i32.store offset=4 (local.get $x) (i32.const 8))
      (f64.store offset=8 (local.get $x) (f64.const 1.5))
      (f64.store offset=16 (local.get $x) (f64.const 2.5))
    (local.set $y (i32.const 280))
    (local.set $z (call $__dynarr_concat_f64 (local.get $x) (local.get $y)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (local.get $z)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (f64.load (i32.add (i32.add (local.get $z) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 3)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (f64.load (i32.add (i32.add (local.get $z) (i32.const 8)) (i32.shl (i32.const 3) (i32.const 3)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $e (i32.const 304))
    (local.set $d (call $__dynarr_concat_i32 (local.get $a) (local.get $e)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (local.get $d)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 260) "\03\00\00\00\03\00\00\00\04\00\00\00\05\00\00\00\06\00\00\00")
  (data (i32.const 280) "\02\00\00\00\02\00\00\00\00\00\00\00\00\00\0c\40\00\00\00\00\00\00\12\40")
