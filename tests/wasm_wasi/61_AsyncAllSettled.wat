(module
  ...
  (func $__drain_microtasks
    ...
    (block $done
      (loop $L
        ...
        (br $L))))
  (func $__promise_allsettled_0 (param $p0 i32) (param $p1 i32) (param $p2 i32) (result i32)
    (local $res i32) (local $arr i32) (local $rec i32)
    (call $__drain_microtasks)
    (local.set $arr (call $__malloc (i32.const 20)))
    (i32.store (local.get $arr) (i32.const 3))
    (i32.store offset=4 (local.get $arr) (i32.const 3))
    (local.set $rec (call $__malloc (i32.const 20)))
    (if (i32.eq (i32.load offset=8 (local.get $p0)) (i32.const 1))
      (then
        (i32.store (local.get $rec) (i32.const 269))
        (i32.store offset=4 (local.get $rec) (i32.const 8))
        (i32.store offset=12 (local.get $rec) (i32.load offset=16 (local.get $p0)))
        (i32.store offset=16 (local.get $rec) (i32.load offset=24 (local.get $p0))))
      (else
        (i32.store (local.get $rec) (i32.const 260))
        (i32.store offset=4 (local.get $rec) (i32.const 9))
        (i32.store offset=8 (local.get $rec) (i32.load offset=16 (local.get $p0)))))
    (i32.store offset=8 (local.get $arr) (local.get $rec))
    (local.set $rec (call $__malloc (i32.const 20)))
    (if (i32.eq (i32.load offset=8 (local.get $p1)) (i32.const 1))
      (then
        (i32.store (local.get $rec) (i32.const 269))
        (i32.store offset=4 (local.get $rec) (i32.const 8))
        (i32.store offset=12 (local.get $rec) (i32.load offset=16 (local.get $p1)))
        (i32.store offset=16 (local.get $rec) (i32.load offset=24 (local.get $p1))))
      (else
        (i32.store (local.get $rec) (i32.const 260))
        (i32.store offset=4 (local.get $rec) (i32.const 9))
        (i32.store offset=8 (local.get $rec) (i32.load offset=16 (local.get $p1)))))
    (i32.store offset=12 (local.get $arr) (local.get $rec))
    (local.set $rec (call $__malloc (i32.const 20)))
    (if (i32.eq (i32.load offset=8 (local.get $p2)) (i32.const 1))
      (then
        (i32.store (local.get $rec) (i32.const 269))
        (i32.store offset=4 (local.get $rec) (i32.const 8))
        (i32.store offset=12 (local.get $rec) (i32.load offset=16 (local.get $p2)))
        (i32.store offset=16 (local.get $rec) (i32.load offset=24 (local.get $p2))))
      (else
        (i32.store (local.get $rec) (i32.const 260))
        (i32.store offset=4 (local.get $rec) (i32.const 9))
        (i32.store offset=8 (local.get $rec) (i32.load offset=16 (local.get $p2)))))
    (i32.store offset=16 (local.get $arr) (local.get $rec))
    (local.set $res (call $__promise_alloc))
    (i32.store (local.get $res) (i32.const 1))
    (i32.store offset=4 (local.get $res) (i32.const 3))
    (i32.store offset=16 (local.get $res) (local.get $arr))
    (local.get $res))
  (func $compute (param $n i32) (result i32)
    (return (call $__promise_resolve_i32 (i32.mul (local.get $n) (i32.const 10))))
  )
  ...
  (func $main  
    ...
    (local $__arr_tmp i32)
    (local.set $results (call $__promise_await_i32 (call $__promise_allsettled_0 (call $compute (i32.const 1)) (call $__promise_reject (i32.const 277) (i32.const 3)) (call $compute (i32.const 3)))))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 5) (call $__i32_to_str (i32.load (local.get $results)) (i32.const 137))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (call $__str_gather (i32.load offset=0 (i32.load (i32.add (i32.add (local.get $results) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 2))))) (i32.load offset=4 (i32.load (i32.add (i32.add (local.get $results) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 2))))) (i32.const 136))
          (i32.store (i32.const 4) (i32.add (i32.const 4) (i32.load offset=4 (i32.load (i32.add (i32.add (local.get $results) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 2)))))))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 32))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 1))) (i32.const 118))
          ...
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 4))) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 5)))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (call $__i32_to_str (i32.load (i32.add (i32.load (i32.add (i32.add (local.get $results) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 2)))) (i32.const 8))) (i32.add (i32.const 132) (i32.load (i32.const 4))))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 134) (i32.const 58))
          (i32.store8 (i32.const 135) (i32.const 32))
          (call $__str_gather (i32.load offset=0 (i32.load (i32.add (i32.add (local.get $results) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 2))))) (i32.load offset=4 (i32.load (i32.add (i32.add (local.get $results) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 2))))) (i32.const 136))
          (i32.store (i32.const 4) (i32.add (i32.const 4) (i32.load offset=4 (i32.load (i32.add (i32.add (local.get $results) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 2)))))))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 32))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 1))) (i32.const 114))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 2))) (i32.const 49))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 3))) (i32.const 58))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 4))) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 5)))
          (call $__str_gather (i32.load offset=12 (i32.load (i32.add (i32.add (local.get $results) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 2))))) (i32.load offset=16 (i32.load (i32.add (i32.add (local.get $results) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 2))))) (i32.add (i32.const 132) (i32.load (i32.const 4))))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.load offset=16 (i32.load (i32.add (i32.add (local.get $results) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 2)))))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 134) (i32.const 58))
          (i32.store8 (i32.const 135) (i32.const 32))
          (call $__str_gather (i32.load offset=0 (i32.load (i32.add (i32.add (local.get $results) (i32.const 8)) (i32.shl (i32.const 2) (i32.const 2))))) (i32.load offset=4 (i32.load (i32.add (i32.add (local.get $results) (i32.const 8)) (i32.shl (i32.const 2) (i32.const 2))))) (i32.const 136))
          (i32.store (i32.const 4) (i32.add (i32.const 4) (i32.load offset=4 (i32.load (i32.add (i32.add (local.get $results) (i32.const 8)) (i32.shl (i32.const 2) (i32.const 2)))))))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 32))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 1))) (i32.const 118))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 2))) (i32.const 50))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 3))) (i32.const 58))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 4))) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 5)))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (call $__i32_to_str (i32.load (i32.add (i32.load (i32.add (i32.add (local.get $results) (i32.const 8)) (i32.shl (i32.const 2) (i32.const 2)))) (i32.const 8))) (i32.add (i32.const 132) (i32.load (i32.const 4))))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (table 1 funcref)
  (data (i32.const 260) "\66\75\6c\66\69\6c\6c\65\64")
  (data (i32.const 269) "\72\65\6a\65\63\74\65\64")
  (data (i32.const 277) "\62\61\64")
  (data (i32.const 280) "\64\6f\6e\65\0a")
)