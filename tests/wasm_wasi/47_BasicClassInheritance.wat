(module
  ...
  (func $Animal_constructor (param $__self i32) (param $a i32) (param $w f64) 
    (i32.store (i32.add (local.get $__self) (i32.const 4)) (local.get $a))
    (f64.store (i32.add (local.get $__self) (i32.const 12)) (local.get $w))
  )

  (func $Animal_describe (param $__self i32) 
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 5) (call $__i32_to_str (i32.load (i32.add (local.get $__self) (i32.const 4))) (i32.const 137))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 8) (call $__f64_to_str (f64.load (i32.add (local.get $__self) (i32.const 12))) (i32.const 140))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $Dog_constructor (param $__self i32) (param $a i32) (param $w f64) (param $l i32) 
    (call $Animal_constructor (local.get $__self) (local.get $a) (local.get $w))
    (i32.store (i32.add (local.get $__self) (i32.const 20)) (local.get $l))
  )

  (func $Dog_bark (param $__self i32) 
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 87))
          ...
          (i32.store8 (i32.const 136) (i32.const 33))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 12) (call $__i32_to_str (i32.load (i32.add (local.get $__self) (i32.const 20))) (i32.const 144))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $main  
    ...
    (local.set $d (i32.const 260))
      (call $Dog_constructor (i32.const 260) (i32.const 3) (f64.const 15.5) (i32.const 4))
    (call $Animal_describe (i32.const 260) )
    (call $Dog_bark (i32.const 260) )
        (i32.store (i32.const 0) (i32.const 132))
  ...
  (data (i32.const 260) "\02\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
)