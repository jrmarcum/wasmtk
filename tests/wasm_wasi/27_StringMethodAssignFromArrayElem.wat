(module
  ...
  (func $_start (export "_start")
    ...
    (local.set $words (i32.const 269))
    (call $__str_to_upper (i32.load (i32.add (i32.add (i32.const 269) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 3)))) (i32.load offset=4 (i32.add (i32.add (i32.const 269) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 3)))))
      (local.set $u_len)
      (local.set $u_ptr)
    (call $__str_to_lower (i32.load (i32.add (i32.add (i32.const 269) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 3)))) (i32.load offset=4 (i32.add (i32.add (i32.const 269) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 3)))))
      (local.set $l_len)
      (local.set $l_ptr)
    (call $__str_to_upper (i32.load (i32.add (i32.add (i32.const 269) (i32.const 8)) (i32.shl (i32.const 2) (i32.const 3)))) (i32.load offset=4 (i32.add (i32.add (i32.const 269) (i32.const 8)) (i32.shl (i32.const 2) (i32.const 3)))))
      (local.set $u2_len)
      (local.set $u2_ptr)
    (local.set $plain_ptr (i32.load (i32.add (i32.add (i32.const 269) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 3)))))
      (local.set $plain_len (i32.load offset=4 (i32.add (i32.add (i32.const 269) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 3)))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (local.get $u_ptr) (local.get $u_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $u_len)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (local.get $l_ptr) (local.get $l_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $l_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (local.get $u2_ptr) (local.get $u2_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $u2_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (local.get $plain_ptr) (local.get $plain_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $plain_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (call $__str_gather (local.get $u_ptr) (local.get $u_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $u_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 45))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (call $__str_gather (local.get $l_ptr) (local.get $l_len) (i32.add (i32.const 132) (i32.load (i32.const 4))))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (local.get $l_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 263) "\64\65\66")
  (data (i32.const 266) "\67\68\69")
