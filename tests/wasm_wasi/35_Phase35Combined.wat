(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 425))
  ...
  (func $printField (param $key_ptr i32) (param $key_len i32) 
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (call $__str_gather (local.get $key_ptr) (local.get $key_len) (i32.const 139))
          (i32.store (i32.const 4) (i32.add (i32.const 7) (local.get $key_len)))
  ...
  (func $applySettings (param $key_ptr i32) (param $key_len i32) (param $val i32) 
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (call $__str_gather (local.get $key_ptr) (local.get $key_len) (i32.const 141))
          (i32.store (i32.const 4) (i32.add (i32.const 9) (local.get $key_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 137) (i32.const 58))
          (i32.store8 (i32.const 138) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 7) (call $__i32_to_str (local.get $val) (i32.const 139))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $describeVar (param $n i32) (param $d f64) (param $s_ptr i32) (param $s_len i32) (param $b i32) 
    (local $tn_ptr i32)
    (local $tn_len i32)
    (local $td_ptr i32)
    (local $td_len i32)
    ...
    (local $tb_len i32)
    (local $__iface_tmp i32)
    (local.set $tn_ptr (i32.const 260))
      (local.set $tn_len (i32.const 6))
    (local.set $td_ptr (i32.const 260))
      (local.set $td_len (i32.const 6))
    (local.set $ts_ptr (i32.const 266))
      (local.set $ts_len (i32.const 6))
    (local.set $tb_ptr (i32.const 272))
      (local.set $tb_len (i32.const 7))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 110))
          (i32.store8 (i32.const 133) (i32.const 58))
          (i32.store8 (i32.const 134) (i32.const 32))
          (call $__str_gather (local.get $tn_ptr) (local.get $tn_len) (i32.const 135))
          (i32.store (i32.const 4) (i32.add (i32.const 3) (local.get $tn_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 133) (i32.const 58))
          (i32.store8 (i32.const 134) (i32.const 32))
          (call $__str_gather (local.get $td_ptr) (local.get $td_len) (i32.const 135))
          (i32.store (i32.const 4) (i32.add (i32.const 3) (local.get $td_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 133) (i32.const 58))
          (i32.store8 (i32.const 134) (i32.const 32))
          (call $__str_gather (local.get $ts_ptr) (local.get $ts_len) (i32.const 135))
          (i32.store (i32.const 4) (i32.add (i32.const 3) (local.get $ts_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 133) (i32.const 58))
          (i32.store8 (i32.const 134) (i32.const 32))
          (call $__str_gather (local.get $tb_ptr) (local.get $tb_len) (i32.const 135))
          (i32.store (i32.const 4) (i32.add (i32.const 3) (local.get $tb_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $main  
    (local $rectKey_ptr i32)
    (local $rectKey_len i32)
    (local $count i32)
    (local $ratio f64)
    (local $tag_ptr i32)
    (local $tag_len i32)
    (local $enabled i32)
    (local $tcount_ptr i32)
    (local $tcount_len i32)
    (local $ttag_ptr i32)
    (local $ttag_len i32)
    (local $sk_ptr i32)
    (local $sk_len i32)
    (local $__iface_tmp i32)
    (local.set $rectKey_ptr (i32.const 279))
      (local.set $rectKey_len (i32.const 5))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (call $__str_gather (local.get $rectKey_ptr) (local.get $rectKey_len) (i32.const 137))
          (i32.store (i32.const 4) (i32.add (i32.const 5) (local.get $rectKey_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $printField (i32.const 284) (i32.const 6))
    (call $printField (i32.const 279) (i32.const 5))
    (call $applySettings (i32.const 290) (i32.const 6) (i32.const 80))
    (call $applySettings (i32.const 296) (i32.const 10) (i32.const 50))
    (local.set $count (i32.const 5))
    (local.set $ratio (f64.const 0.75))
    (local.set $tag_ptr (i32.const 306))
      (local.set $tag_len (i32.const 4))
    (local.set $enabled (i32.const 1))
    (if (i32.const 1)
      (then
    ...
    (local.set $tcount_ptr (i32.const 260))
      (local.set $tcount_len (i32.const 6))
    (local.set $ttag_ptr (i32.const 266))
      (local.set $ttag_len (i32.const 6))
    (if (i32.eqz (call $__str_cmp (local.get $tcount_ptr) (local.get $tcount_len) (i32.const 260) (i32.const 6)))
      (then
    ...
    (if (i32.eqz (call $__str_cmp (local.get $ttag_ptr) (local.get $ttag_len) (i32.const 266) (i32.const 6)))
      (then
    ...
    (call $describeVar (i32.const 1) (f64.const 2.0) (i32.const 410) (i32.const 2) (i32.const 0))
    (local.set $sk_ptr (i32.const 290))
      (local.set $sk_len (i32.const 6))
    (if (i32.eqz (call $__str_cmp (local.get $sk_ptr) (local.get $sk_len) (i32.const 290) (i32.const 6)))
      (then
          (i32.store (i32.const 0) (i32.const 412))
  ...
  (data (i32.const 279) "\77\69\64\74\68")
  (data (i32.const 284) "\68\65\69\67\68\74")
  (data (i32.const 290) "\76\6f\6c\75\6d\65")
  (data (i32.const 296) "\62\72\69\67\68\74\6e\65\73\73")
  (data (i32.const 306) "\74\65\73\74")
  (data (i32.const 310) "\63\6f\75\6e\74\20\6e\6f\74\20\73\74\72\69\6e\67\0a")
  (data (i32.const 327) "\72\61\74\69\6f\20\6e\6f\74\20\62\6f\6f\6c\65\61\6e\0a")
  (data (i32.const 345) "\74\61\67\20\69\73\20\73\74\72\69\6e\67\0a")
  (data (i32.const 359) "\65\6e\61\62\6c\65\64\20\69\73\20\62\6f\6f\6c\65\61\6e\0a")
  (data (i32.const 378) "\74\63\6f\75\6e\74\20\69\73\20\6e\75\6d\62\65\72\0a")
  (data (i32.const 395) "\74\74\61\67\20\69\73\20\73\74\72\69\6e\67\0a")
  (data (i32.const 410) "\68\69")
  (data (i32.const 412) "\73\6b\20\69\73\20\76\6f\6c\75\6d\65\0a")
)