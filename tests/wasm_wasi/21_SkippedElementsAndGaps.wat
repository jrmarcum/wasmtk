(module
  ...
  (func $testSkippedTupleElements (export "testSkippedTupleElements")  
    ...
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 276))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $coordinates (i32.const 260))
    (local.set $coordX (i32.load (i32.add (i32.const 260) (i32.const 0))))
      (local.set $coordY (i32.load (i32.add (i32.const 260) (i32.const 8))))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 142) (i32.const 88))
          (i32.store8 (i32.const 143) (i32.const 58))
          (i32.store8 (i32.const 144) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 13) (call $__i32_to_str (local.get $coordX) (i32.const 145))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 140) (i32.const 100))
          (i32.store8 (i32.const 141) (i32.const 32))
          (i32.store8 (i32.const 142) (i32.const 89))
          (i32.store8 (i32.const 143) (i32.const 58))
          (i32.store8 (i32.const 144) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 13) (call $__i32_to_str (local.get $coordY) (i32.const 145))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    (call $testSkippedTupleElements )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 276) "\2d\2d\2d\20\54\65\73\74\20\32\3a\20\53\6b\69\70\70\65\64\20\45\6c\65\6d\65\6e\74\73\20\26\20\47\61\70\73\20\2d\2d\2d\0a")
  (data (i32.const 260) "\0a\00\00\00\e7\03\00\00\14\00\00\00\78\03\00\00")
)