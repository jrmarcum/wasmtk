(module
  ...
  (func $clamp (param $v f64) (param $lo f64) (param $hi f64) (result f64)
    (if (f64.lt (local.get $v) (local.get $lo))
      (then
      (return (local.get $lo))
      )
    )
    (if (f64.gt (local.get $v) (local.get $hi))
      (then
      (return (local.get $hi))
      )
    )
  ...
  (func $countDigits (param $n i32) (result i32)
    ...
    (local.set $x (if (result i32) (i32.lt_s (local.get $n) (i32.const 0)) (then (i32.sub (i32.const 0) (local.get $n))) (else (local.get $n))))
    (block $break_0
      (loop $loop_0
        (br_if $break_0 (i32.eqz (i32.gt_s (local.get $x) (i32.const 0))))
        (block $cont_0
          (local.set $count (i32.add (local.get $count) (i32.const 1)))
          (local.set $x (i32.or (i32.div_s (local.get $x) (i32.const 10)) (i32.const 0)))
        )
        (br $loop_0)
      )
    )
  ...
  (func $inRange (param $v f64) (param $lo f64) (param $hi f64) (result i32)
  ...
  (func $_start (export "_start")
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (call $clamp (f64.const 5.0) (f64.const 0.0) (f64.const 3.0)) (i32.const 132)))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (call $clamp (f64.const -1.0) (f64.const 0.0) (f64.const 10.0)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (call $clamp (f64.const 7.0) (f64.const 0.0) (f64.const 10.0)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $countDigits (i32.const 0)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $countDigits (i32.const 12345)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $countDigits (i32.const 9)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
        (i32.store (i32.const 0) (if (result i32) (call $inRange (f64.const 5.0) (f64.const 0.0) (f64.const 10.0)) (then (i32.const 260)) (else (i32.const 264))))
          (i32.store (i32.const 4) (if (result i32) (call $inRange (f64.const 5.0) (f64.const 0.0) (f64.const 10.0)) (then (i32.const 4)) (else (i32.const 5))))
          ...
          (drop (call $fd_write
            ...
            (i32.const 2)
            (i32.const 128)))
        (i32.store (i32.const 0) (if (result i32) (call $inRange (f64.const 15.0) (f64.const 0.0) (f64.const 10.0)) (then (i32.const 260)) (else (i32.const 264))))
          (i32.store (i32.const 4) (if (result i32) (call $inRange (f64.const 15.0) (f64.const 0.0) (f64.const 10.0)) (then (i32.const 4)) (else (i32.const 5))))
          (i32.store (i32.const 8) (i32.const 269))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
