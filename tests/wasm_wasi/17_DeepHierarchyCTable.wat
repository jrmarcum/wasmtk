(module
  ...
  (func $Account_constructor (param $__self i32) (param $id i32) (param $initial i32) 
    (i32.store (i32.add (local.get $__self) (i32.const 4)) (local.get $id))
    (i32.store (i32.add (local.get $__self) (i32.const 8)) (local.get $initial))
  )

  (func $Account_calculateBonus (param $__self i32) (result i32)
    (return (i32.div_s (i32.load (i32.add (local.get $__self) (i32.const 8))) (i32.const 100)))
  )

  (func $PremiumAccount_constructor (param $__self i32) (param $id i32) (param $initial i32) (param $mult i32) 
    (call $Account_constructor (local.get $__self) (local.get $id) (local.get $initial))
    (i32.store (i32.add (local.get $__self) (i32.const 12)) (local.get $mult))
  )

  (func $PremiumAccount_calculateBonus (param $__self i32) (result i32)
    (return (i32.mul (i32.div_s (i32.load (i32.add (local.get $__self) (i32.const 8))) (i32.const 100)) (i32.load (i32.add (local.get $__self) (i32.const 12)))))
  )

  (func $ExecutiveAccount_constructor (param $__self i32) (param $id i32) (param $initial i32) (param $mult i32) (param $flat i32) 
    (call $PremiumAccount_constructor (local.get $__self) (local.get $id) (local.get $initial) (local.get $mult))
    (i32.store (i32.add (local.get $__self) (i32.const 16)) (local.get $flat))
  )

  (func $ExecutiveAccount_calculateBonus (param $__self i32) (result i32)
    (local $__iface_tmp i32)
    (return (i32.add (call $PremiumAccount_calculateBonus (local.get $__self) ) (i32.load (i32.add (local.get $__self) (i32.const 16)))))
  )

  (func $testVTableHierarchy (export "testVTableHierarchy")  
    (local $acc1 i32)
    (local $acc2 i32)
    (local $acc3 i32)
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 308))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $acc1 (i32.const 260))
      (call $Account_constructor (i32.const 260) (i32.const 1) (i32.const 1000))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 137) (i32.const 66))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 12) (call $__i32_to_str (call $Account_calculateBonus (i32.const 260) ) (i32.const 144))))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $acc2 (i32.const 272))
      (call $PremiumAccount_constructor (i32.const 272) (i32.const 2) (i32.const 1000) (i32.const 3))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store8 (i32.const 137) (i32.const 117))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 15) (call $__i32_to_str (call $PremiumAccount_calculateBonus (i32.const 272) ) (i32.const 147))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $acc3 (i32.const 288))
      (call $ExecutiveAccount_constructor (i32.const 288) (i32.const 3) (i32.const 1000) (i32.const 3) (i32.const 50))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store8 (i32.const 139) (i32.const 118))
          (i32.store8 (i32.const 140) (i32.const 101))
          (i32.store8 (i32.const 141) (i32.const 32))
          (i32.store8 (i32.const 142) (i32.const 66))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 17) (call $__i32_to_str (call $ExecutiveAccount_calculateBonus (i32.const 288) ) (i32.const 149))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    (call $testVTableHierarchy )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 308) "\2d\2d\2d\20\54\65\73\74\20\31\3a\20\44\65\65\70\20\56\54\61\62\6c\65\20\48\69\65\72\61\72\63\68\79\20\2d\2d\2d\0a")
  (data (i32.const 260) "\01\00\00\00\00\00\00\00\00\00\00\00")
  (data (i32.const 272) "\02\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
  (data (i32.const 288) "\03\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
)