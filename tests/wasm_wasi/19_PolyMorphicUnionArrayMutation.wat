(module
  ...
  (func $testUnionArrayOps (export "testUnionArrayOps")  
    (local $cluster i32)
    (local $combinedWeight i32)
    (local $i i32)
    (local $node i32)
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 260))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $cluster (call $__malloc (i32.const 40)))
      (i32.store (local.get $cluster) (i32.const 0))
      (i32.store offset=4 (local.get $cluster) (i32.const 8))
    (local.set $cluster (call $__dynarr_push_i32 (local.get $cluster) (i32.const 300)))
    (local.set $cluster (call $__dynarr_push_i32 (local.get $cluster) (i32.const 316)))
    (local.set $cluster (call $__dynarr_push_i32 (local.get $cluster) (i32.const 332)))
    (i32.store (i32.add (i32.add (local.get $cluster) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 2))) (i32.const 348))
    (local.set $combinedWeight (i32.const 0))
    (local.set $i (i32.const 0))
    (block $break_0
      (loop $loop_0
        (br_if $break_0 (i32.eqz (i32.lt_s (local.get $i) (i32.load (local.get $cluster)))))
        (block $cont_0
          (local.set $node (i32.load (i32.add (i32.add (local.get $cluster) (i32.const 8)) (i32.shl (local.get $i) (i32.const 2)))))
          (if (i32.eq (i32.load (local.get $node)) (i32.const 0))
            (then
            (local.set $combinedWeight (i32.add (local.get $combinedWeight) (i32.load (i32.add (local.get $node) (i32.const 4)))))
            )
            (else
            (local.set $combinedWeight (i32.add (local.get $combinedWeight) (i32.load (i32.add (local.get $node) (i32.const 8)))))
            )
          )
        )
        (local.set $i (i32.add (local.get $i) (i32.const 1)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 152) (i32.const 87))
          (i32.store8 (i32.const 153) (i32.const 101))
          (i32.store8 (i32.const 154) (i32.const 105))
          (i32.store8 (i32.const 155) (i32.const 103))
          (i32.store8 (i32.const 156) (i32.const 104))
          (i32.store8 (i32.const 157) (i32.const 116))
          (i32.store8 (i32.const 158) (i32.const 58))
          (i32.store8 (i32.const 159) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 28) (call $__i32_to_str (local.get $combinedWeight) (i32.const 160))))
  ...
  (func $_start (export "_start")
    (call $testUnionArrayOps )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 260) "\2d\2d\2d\20\54\65\73\74\20\33\3a\20\50\6f\6c\79\6d\6f\72\70\68\69\63\20\55\6e\69\6f\6e\20\41\72\72\61\79\20\2d\2d\2d\0a")
  (data (i32.const 300) "\00\00\00\00\2d\00\00\00\00\00\00\00\00\00\00\00")
  (data (i32.const 316) "\01\00\00\00\00\00\00\00\04\00\00\00\01\00\00\00")
  (data (i32.const 332) "\00\00\00\00\37\00\00\00\00\00\00\00\00\00\00\00")
  (data (i32.const 348) "\00\00\00\00\0c\00\00\00\00\00\00\00\00\00\00\00")
)