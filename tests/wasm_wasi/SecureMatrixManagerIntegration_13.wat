(module
  ...
  (func $createSecureMatrix (export "createSecureMatrix")  (result f64)
    (local $data i32)
    (local $__2d_tmp i32)
    ...
    (return (;? { ;) (f64.const 0))
    (;; (row: i32, val: i32) => {;)
    (if (i32.ge_s (;? row ;) (i32.const 0) (i32.load (local.get $data)))
      (then
      (throw $__exn_tag (i32.const 260) (i32.const 19))
      )
    )
    (i32.store (i32.add (i32.add (local.get $data) (i32.const 8)) (i32.shl (;? row ;) (i32.const 0) (i32.const 2))) (call $__dynarr_push_i32 (i32.load (i32.add (i32.add (local.get $data) (i32.const 8)) (i32.shl (;? row ;) (i32.const 0) (i32.const 2)))) (;? val ;) (i32.const 0)))
    (;; },;)
    (;; (row: i32) => {;)
    (if (i32.ge_s (;? row ;) (i32.const 0) (i32.load (local.get $data)))
      (then
    ...
    (return (i32.load (i32.add (i32.add (local.get $data) (i32.const 8)) (i32.shl (;? row ;) (i32.const 0) (i32.const 2)))))
  )
  ...
  (func $_start (export "_start")  
    ...
    (;; sm.addValue(0, 42);;)
    (local.set $row0 (;? sm.getRow(0) ;) (f64.const 0))
