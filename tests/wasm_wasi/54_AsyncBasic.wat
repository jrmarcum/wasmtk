(module
  ...
  (func $getN  (result i32)
    (return (call $__promise_resolve_i32 (i32.const 42)))
  )

  (func $doubleAsync (param $n i32) (result i32)
    (return (call $__promise_resolve_i32 (i32.mul (local.get $n) (i32.const 2))))
  )

  (func $half (param $x f64) (result i32)
    (return (call $__promise_resolve_f64 (f64.div (local.get $x) (f64.const 2.0))))
  )
  ...
  (func $run  
    ...
    (local.set $a (call $__promise_await_i32 (call $getN )))
    (local.set $b (call $__promise_await_i32 (call $doubleAsync (local.get $a))))
    (local.set $c (call $__promise_await_i32 (call $__promise_resolve_i32 (i32.const 8))))
    (local.set $inferred (call $__promise_await_i32 (call $getN )))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 10) (call $__i32_to_str (local.get $inferred) (i32.const 142))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 5) (call $__i32_to_str (i32.add (i32.add (i32.add (local.get $a) (local.get $b)) (local.get $c)) (local.get $inferred)) (i32.const 137))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $x (call $__promise_await_f64 (call $half (f64.const 10.0))))
    (local.set $y (call $__promise_await_f64 (call $__promise_resolve_f64 (f64.const 2.5))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 120))
          (i32.store8 (i32.const 133) (i32.const 58))
          (i32.store8 (i32.const 134) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 3) (call $__f64_to_str (local.get $x) (i32.const 135))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 133) (i32.const 58))
          (i32.store8 (i32.const 134) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 3) (call $__f64_to_str (local.get $y) (i32.const 135))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 6) (call $__f64_to_str (f64.add (local.get $x) (local.get $y)) (i32.const 138))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
