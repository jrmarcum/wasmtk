(module
  ...
  (func $testRestSplitting (export "testRestSplitting")  
    (local $source i32)
    (local $alpha i32)
    (local $beta i32)
    (local $omega i32)
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 284))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $source (i32.const 260))
    (local.set $alpha (i32.load (i32.const 268)))
      (local.set $beta (i32.load (i32.const 272)))
      (local.set $omega (call $__malloc (i32.const 40)))
      (i32.store (local.get $omega) (i32.const 2))
      (i32.store offset=4 (local.get $omega) (i32.const 8))
      (i32.store offset=8 (local.get $omega) (i32.load (i32.const 276)))
      (i32.store offset=12 (local.get $omega) (i32.load (i32.const 280)))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 15) (call $__i32_to_str (local.get $alpha) (i32.const 147))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 14) (call $__i32_to_str (local.get $beta) (i32.const 146))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 19) (call $__i32_to_str (i32.load (local.get $omega)) (i32.const 151))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 144) (i32.const 58))
          (i32.store8 (i32.const 145) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 14) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $omega) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 2)))) (i32.const 146))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 144) (i32.const 58))
          (i32.store8 (i32.const 145) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 14) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $omega) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 2)))) (i32.const 146))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    (call $testRestSplitting )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 284) "\2d\2d\2d\20\54\65\73\74\20\31\3a\20\41\72\72\61\79\20\52\65\73\74\20\53\70\6c\69\74\74\69\6e\67\20\2d\2d\2d\0a")
  (data (i32.const 260) "\04\00\00\00\04\00\00\00\64\00\00\00\c8\00\00\00\2c\01\00\00\90\01\00\00")
)