(module
  ...
  (func $build (param $p i32) 
    ...
    (block $break_0
      (loop $loop_0
        (br_if $break_0 (i32.eqz (i32.lt_s (local.get $i) (i32.load (i32.load (i32.add (local.get $p) (i32.const 0)))))))
        (block $cont_0
          (local.set $s_ptr (local.get $s_ptr))
      (local.set $s_len (local.get $s_len))
      (call $__str_concat (local.get $s_ptr) (local.get $s_len) (i32.load (i32.add (i32.add (i32.load (i32.add (local.get $p) (i32.const 0))) (i32.const 8)) (i32.shl (local.get $i) (i32.const 3)))) (i32.load offset=4 (i32.add (i32.add (i32.load (i32.add (local.get $p) (i32.const 0))) (i32.const 8)) (i32.shl (local.get $i) (i32.const 3)))))
      (local.set $s_len)
      (local.set $s_ptr)
        )
        (local.set $i (i32.add (local.get $i) (i32.const 1)))
  ...
  (func $total (param $n i32) (result i32)
    (local $t i32)
    (local $i i32)
    ...
    (block $break_1
      (loop $loop_1
        (br_if $break_1 (i32.eqz (i32.lt_s (local.get $i) (i32.load (i32.load (i32.add (local.get $n) (i32.const 0)))))))
        (block $cont_1
          (local.set $t (i32.add (local.get $t) (i32.load (i32.add (i32.add (i32.load (i32.add (local.get $n) (i32.const 0))) (i32.const 8)) (i32.shl (local.get $i) (i32.const 2))))))
        )
        (local.set $i (i32.add (local.get $i) (i32.const 1)))
        (br $loop_1)
      )
    ...
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $total (i32.const 299)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 266) "\63")
  (data (i32.const 267) "\03\00\00\00\03\00\00\00\08\01\00\00\01\00\00\00\09\01\00\00\01\00\00\00\0a\01\00\00\01\00\00\00")
  (data (i32.const 260) "\0b\01\00\00")
  (data (i32.const 303) "\03\00\00\00\03\00\00\00\03\00\00\00\04\00\00\00\05\00\00\00")
  (data (i32.const 299) "\2f\01\00\00")
)