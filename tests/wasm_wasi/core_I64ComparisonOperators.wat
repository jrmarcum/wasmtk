(module
  ...
  (func $testBigIntComparisons (export "testBigIntComparisons") (param $val i64) 
    ...
    (if (i64.eq (local.get $val) (local.get $limit))
      (then
          ...
          (i32.store (i32.const 4) (call $__i64_to_str (i64.const 1) (i32.const 132)))
    ...
    (if (i64.gt_s (local.get $val) (i64.const 0))
      (then
          (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i64_to_str (i64.const 2) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (if (i64.lt_s (local.get $val) (i64.const -100))
      (then
          (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i64_to_str (i64.const 3) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (local.set $isLarge (i64.ge_s (local.get $val) (local.get $limit)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (if (result i32) (local.get $isLarge) (then (i32.const 260)) (else (i32.const 264))) (if (result i32) (local.get $isLarge) (then (i32.const 4)) (else (i32.const 5))) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (if (result i32) (local.get $isLarge) (then (i32.const 4)) (else (i32.const 5)))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    (call $testBigIntComparisons (i64.const 6000000000))
