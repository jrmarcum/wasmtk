(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 498))
  ...
  (func $jsonStrArr (param $arr i32) 
    ...
    (block $break_0
      ...
      (local.set $s_ptr)
          ...
          (call $__str_concat (local.get $s_ptr) (local.get $s_len) (call $jsonStr (i32.const 0) (i32.const 0)) (global.get $__str_ret_ptr) (global.get $__str_ret_len))
      (local.set $s_len)
      (local.set $s_ptr)
        )
    ...
    (call $__str_concat (local.get $s_ptr) (local.get $s_len) (i32.const 301) (i32.const 1))
      (local.set $__ret_str_len)
      (local.set $__ret_str_ptr)
      (global.set $__str_ret_ptr (local.get $__ret_str_ptr))
      (global.set $__str_ret_len (local.get $__ret_str_len))
  ...
  (func $_start (export "_start")
    ...
    (local $__iface_tmp i32)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $jsonStr (i32.const 322) (i32.const 6))
          (call $__str_gather (global.get $__str_ret_ptr) (global.get $__str_ret_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (global.get $__str_ret_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
    ...
    (local.set $slcD (i32.const 302))
        ...
        (i32.store (i32.const 0) (i32.const 352))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 397))
          (i32.store (i32.const 4) (i32.const 45))
          (drop (call $fd_write
            (i32.const 1)
            (i32.const 0)
    ...
    (local.set $byt_ptr (i32.const 260))
      (local.set $byt_len (i32.const 29))
        (i32.store (i32.const 0) (i32.const 442))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 467))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 472))
        ...
        (i32.store (i32.const 0) (i32.const 474))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 492))
  ...
  (data (i32.const 322) "\76\65\63\74\6f\72")
  (data (i32.const 328) "\7b\22\61\70\70\6c\65\22\3a\35\2c\22\6c\65\74\74\75\63\65\22\3a\37\7d\0a")
  (data (i32.const 352) "\7b\22\50\61\67\65\22\3a\31\2c\22\46\72\75\69\74\73\22\3a\5b\22\61\70\70\6c\65\22\2c\22\70\65\61\63\68\22\2c\22\70\65\61\72\22\5d\7d\0a")
  (data (i32.const 397) "\7b\22\70\61\67\65\22\3a\31\2c\22\66\72\75\69\74\73\22\3a\5b\22\61\70\70\6c\65\22\2c\22\70\65\61\63\68\22\2c\22\70\65\61\72\22\5d\7d\0a")
  (data (i32.const 442) "\7b\6e\75\6d\3a\20\36\2e\31\33\2c\20\73\74\72\73\3a\20\5b\61\20\62\5d\7d\0a")
  (data (i32.const 467) "\36\2e\31\33\0a")
  (data (i32.const 472) "\61\0a")
  (data (i32.const 474) "\7b\31\20\5b\61\70\70\6c\65\20\70\65\61\63\68\5d\7d\0a")
  (data (i32.const 492) "\61\70\70\6c\65\0a")
  (data (i32.const 302) "\03\00\00\00\03\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
)