(module
  ...
  (func $Animal_speak (param $__self i32) 
  ...
  (func $Animal_getAge (param $__self i32) (result i32)
  ...
  (func $Dog_speak (param $__self i32) 
    (local $__iface_tmp i32)
  ...
  (func $Cat_speak (param $__self i32) 
    (local $__iface_tmp i32)
  ...
  (func $main  
    ...
    (local $c i32)
    (local $__iface_tmp i32)
    (local.set $a1 (i32.const 274))
      (call $Dog_constructor (i32.const 274) (i32.const 3))
    (local.set $a2 (i32.const 282))
      (call $Cat_constructor (i32.const 282) (i32.const 5))
    (call $Dog_speak (i32.const 274) )
    (call $Cat_speak (i32.const 282) )
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $Animal_getAge (i32.const 274) ) (i32.const 132)))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $Animal_getAge (i32.const 282) ) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $d (i32.const 290))
      (call $Dog_constructor (i32.const 290) (i32.const 7))
    (local.set $c (i32.const 298))
      (call $Cat_constructor (i32.const 298) (i32.const 9))
    (call $Dog_speak (i32.const 290) )
    (call $Cat_speak (i32.const 298) )
  )
  (func $_start (export "_start")
    (call $main)
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 260) "\2e\2e\2e\0a")
  (data (i32.const 264) "\57\6f\6f\66\0a")
  (data (i32.const 269) "\4d\65\6f\77\0a")
  (data (i32.const 274) "\02\00\00\00\00\00\00\00")
  (data (i32.const 282) "\03\00\00\00\00\00\00\00")
  (data (i32.const 290) "\02\00\00\00\00\00\00\00")
  (data (i32.const 298) "\03\00\00\00\00\00\00\00")
)