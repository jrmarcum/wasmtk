(module
  ...
  (func $testNestedLabels (export "testNestedLabels") (param $target i32) (result i32)
    ...
    (block $break_outer
      (loop $loop_outer
        (br_if $break_outer (i32.eqz (i32.lt_s (local.get $i) (i32.const 10))))
        (block $cont_outer
          (local.set $j (i32.const 0))
          (block $break_0
            (loop $loop_0
              (br_if $break_0 (i32.eqz (i32.lt_s (local.get $j) (i32.const 10))))
              (block $cont_0
                (local.set $iterations (i32.add (local.get $iterations) (i32.const 1)))
                (if (i32.eq (i32.add (local.get $i) (local.get $j)) (local.get $target))
                  (then
                  (br $break_outer)
                  )
                )
    ...
    (return (local.get $iterations))
  )
  (func $_start (export "_start")
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $testNestedLabels (i32.const 7)) (i32.const 132)))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $testNestedLabels (i32.const 15)) (i32.const 132)))
          (i32.store (i32.const 8) (i32.const 260))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
