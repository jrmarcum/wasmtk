(module
  ...
  (func $addNested (param $__pd_0 i32) (result i32)
    (local $a i32)
    (local $b i32)
    (local $c i32)
    (local.set $a (i32.load (i32.add (i32.add (local.get $__pd_0) (i32.const 0)) (i32.const 0))))
      (local.set $b (i32.load (i32.add (i32.add (local.get $__pd_0) (i32.const 0)) (i32.const 4))))
      (local.set $c (i32.load (i32.add (local.get $__pd_0) (i32.const 8))))
  ...
  (func $main  
    ...
    (local.set $t (call $__malloc (i32.const 12)))
      (i32.store offset=0 (local.get $t) (i32.const 1))
      (i32.store offset=4 (local.get $t) (i32.const 2))
      (i32.store offset=8 (local.get $t) (i32.const 3))
    (local.set $a (i32.load (i32.add (i32.add (local.get $t) (i32.const 0)) (i32.const 0))))
      (local.set $b (i32.load (i32.add (i32.add (local.get $t) (i32.const 0)) (i32.const 4))))
      (local.set $c (i32.load (i32.add (local.get $t) (i32.const 8))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $u (call $__malloc (i32.const 20)))
      (f64.store offset=0 (local.get $u) (f64.const 1.5))
      (f64.store offset=8 (local.get $u) (f64.const 2.5))
      (i32.store offset=16 (local.get $u) (i32.const 7))
    (local.set $ux (f64.load (i32.add (i32.add (local.get $u) (i32.const 0)) (i32.const 0))))
      (local.set $uy (f64.load (i32.add (i32.add (local.get $u) (i32.const 0)) (i32.const 8))))
      (local.set $uz (i32.load (i32.add (local.get $u) (i32.const 16))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 4) (call $__f64_to_str (local.get $ux) (i32.const 136))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 134) (i32.const 58))
          (i32.store8 (i32.const 135) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 4) (call $__f64_to_str (local.get $uy) (i32.const 136))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 117))
          (i32.store8 (i32.const 133) (i32.const 122))
          (i32.store8 (i32.const 134) (i32.const 58))
          (i32.store8 (i32.const 135) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 4) (call $__i32_to_str (local.get $uz) (i32.const 136))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (local.set $px (i32.load (i32.add (i32.const 260) (i32.const 0))))
      (local.set $py (i32.load (i32.add (i32.const 260) (i32.const 4))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store8 (i32.const 134) (i32.const 58))
          (i32.store8 (i32.const 135) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 4) (call $__i32_to_str (local.get $px) (i32.const 136))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 134) (i32.const 58))
          (i32.store8 (i32.const 135) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 4) (call $__i32_to_str (local.get $py) (i32.const 136))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 11) (call $__i32_to_str (call $addNested (local.get $t)) (i32.const 143))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
