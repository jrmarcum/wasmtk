(module
  ...
  (func $Shape_constructor (param $__self i32) (param $x i32) 
    (i32.store (i32.add (local.get $__self) (i32.const 4)) (local.get $x))
  )
  ...
  (func $Shape_label (param $__self i32) 
  ...
  (func $Circle_constructor (param $__self i32) (param $x i32) (param $r i32) 
    (call $Shape_constructor (local.get $__self) (local.get $x))
    (i32.store (i32.add (local.get $__self) (i32.const 8)) (local.get $r))
  )

  (func $Circle_area (param $__self i32) (result i32)
    (return (i32.mul (i32.mul (i32.load (i32.add (local.get $__self) (i32.const 8))) (i32.load (i32.add (local.get $__self) (i32.const 8)))) (i32.const 3)))
  )

  (func $Circle_label (param $__self i32) 
    (local $__iface_tmp i32)
  ...
  (func $ColoredCircle_constructor (param $__self i32) (param $x i32) (param $r i32) (param $c i32) 
    (call $Circle_constructor (local.get $__self) (local.get $x) (local.get $r))
    (i32.store (i32.add (local.get $__self) (i32.const 12)) (local.get $c))
  )

  (func $ColoredCircle_area (param $__self i32) (result i32)
    (return (i32.add (i32.mul (i32.mul (i32.load (i32.add (local.get $__self) (i32.const 8))) (i32.load (i32.add (local.get $__self) (i32.const 8)))) (i32.const 3)) (i32.load (i32.add (local.get $__self) (i32.const 12)))))
  )

  (func $ColoredCircle_label (param $__self i32) 
    (local $__iface_tmp i32)
  ...
  (func $main  
    ...
    (local $cc i32)
    (local $__iface_tmp i32)
    (local.set $s (i32.const 287))
      (call $Shape_constructor (i32.const 287) (i32.const 0))
    (local.set $c (i32.const 295))
      (call $Circle_constructor (i32.const 295) (i32.const 0) (i32.const 5))
    (local.set $cc (i32.const 307))
      (call $ColoredCircle_constructor (i32.const 307) (i32.const 0) (i32.const 4) (i32.const 10))
    (call $Shape_label (i32.const 287) )
    (call $Circle_label (i32.const 295) )
    (call $ColoredCircle_label (i32.const 307) )
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $Shape_area (i32.const 287) ) (i32.const 132)))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $Circle_area (i32.const 295) ) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $ColoredCircle_area (i32.const 307) ) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.const 295) (i32.const 4))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.const 307) (i32.const 4))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.const 307) (i32.const 8))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 260) "\53\68\61\70\65\0a")
  (data (i32.const 266) "\43\69\72\63\6c\65\0a")
  (data (i32.const 273) "\43\6f\6c\6f\72\65\64\43\69\72\63\6c\65\0a")
  (data (i32.const 287) "\01\00\00\00\00\00\00\00")
  (data (i32.const 295) "\02\00\00\00\00\00\00\00\00\00\00\00")
  (data (i32.const 307) "\03\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
)