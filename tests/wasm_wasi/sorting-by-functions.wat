(module
        ...
        (block $cont_1
          ...
          (block $break_2
            (loop $loop_2
              ...
              (block $cont_2
                (if (i32.load (i32.load (i32.add (i32.add (local.get $arr) (i32.const 8)) (i32.shl (i32.gt_s (;? j].length ;) (i32.const 0) (i32.add (;? arr[j ;) (i32.const 0) (string.const 1))) (i32.const 2)))))
                  (then
        ...
        (block $cont_3
          ...
          (block $break_4
            (loop $loop_4
              ...
              (block $cont_4
                (if (i32.gt_s (;? arr[j].age ;) (i32.const 0) (i32.add (;? arr[j ;) (i32.const 0) (;? 1].age ;) (i32.const 0)))
                  (then
                  (local.set $tmp (i32.load (i32.add (i32.add (local.get $arr) (i32.const 8)) (i32.shl (i32.trunc_f64_s (i32.trunc_f64_s (local.get $j))) (i32.const 2)))))
                  (i32.store (i32.add (i32.add (local.get $arr) (i32.const 8)) (i32.shl (i32.trunc_f64_s (i32.trunc_f64_s (local.get $j))) (i32.const 2))) (i32.load (i32.add (i32.add (local.get $arr) (i32.const 8)) (i32.shl (i32.trunc_f64_s (f64.add (local.get $j) (f64.const 1))) (i32.const 2)))))
  ...
  (func $_start (export "_start")
    ...
    (local.set $fruits (i32.const 263))
    (call $sortByLen (local.get $fruits))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $people (call $__malloc (i32.const 40)))
      (i32.store (local.get $people) (i32.const 0))
      (i32.store offset=4 (local.get $people) (i32.const 8))
    (;; { name: "Alice", age: 25 },;)
    (;; { name: "Eve", age: 2 },;)
    (;; { name: "Bob", age: 35 },;)
    (;; ];;)
    ...
    (block $break_5
      (loop $loop_5
        (br_if $break_5 (i32.eqz (f64.lt (local.get $i) (f64.convert_i32_s (i32.load (local.get $people))))))
        (block $cont_5
          (if (f64.gt (local.get $i) (f64.const 0))
            (then
      ...
      (local.set $pStr_ptr)
          ...
          (call $__str_concat (local.get $pStr_ptr) (local.get $pStr_len) (i32.const 0) (i32.const 0))
      (local.set $pStr_len)
      (local.set $pStr_ptr)
        )
        (local.set $i (f64.add (local.get $i) (f64.const 1)))
