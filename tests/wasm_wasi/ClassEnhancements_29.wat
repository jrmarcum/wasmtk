(module
  ...
  (global $Rectangle_count (mut i32) (i32.const 0))
  ...
  (func $Rectangle_constructor (param $__self i32) (param $w f64) (param $h f64) 
    (f64.store (i32.add (local.get $__self) (i32.const 0)) (local.get $w))
    (f64.store (i32.add (local.get $__self) (i32.const 8)) (local.get $h))
    (global.set $Rectangle_count (i32.add (global.get $Rectangle_count) (i32.const 1)))
  )

  (func $Rectangle_get_width (param $__self i32) (result f64)
    (return (f64.load (i32.add (local.get $__self) (i32.const 0))))
  )

  (func $Rectangle_set_width (param $__self i32) (param $val f64) 
    (f64.store (i32.add (local.get $__self) (i32.const 0)) (local.get $val))
  )

  (func $Rectangle_get_area (param $__self i32) (result f64)
    (return (f64.mul (f64.load (i32.add (local.get $__self) (i32.const 0))) (f64.load (i32.add (local.get $__self) (i32.const 8)))))
  )

  (func $Rectangle_getCount  (result i32)
    (return (global.get $Rectangle_count))
  )
  ...
  (func $main  
    ...
    (local.set $dir_ptr (i32.const 292))
      (local.set $dir_len (i32.const 2))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (call $__str_gather (local.get $dir_ptr) (local.get $dir_len) (i32.const 143))
          (i32.store (i32.const 4) (i32.add (i32.const 11) (local.get $dir_len)))
        ...
        (i32.store (i32.const 0) (i32.const 294))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $r1 (i32.const 260))
      (call $Rectangle_constructor (i32.const 260) (f64.const 3.0) (f64.const 4.0))
    (local.set $r2 (i32.const 276))
      (call $Rectangle_constructor (i32.const 276) (f64.const 5.0) (f64.const 6.0))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 7) (call $__f64_to_str (;? Rectangle.count ;) (f64.const 0) (i32.const 139))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 8) (call $__i32_to_str (call $Rectangle_getCount ) (i32.const 140))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 137) (i32.const 58))
          (i32.store8 (i32.const 138) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 7) (call $__f64_to_str (call $Rectangle_get_width (i32.const 260)) (i32.const 139))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 6) (call $__f64_to_str (call $Rectangle_get_area (i32.const 260)) (i32.const 138))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $Rectangle_set_width (i32.const 260) (f64.const 10.0))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 78))
          (i32.store8 (i32.const 133) (i32.const 101))
          (i32.store8 (i32.const 134) (i32.const 119))
          (i32.store8 (i32.const 135) (i32.const 32))
          (i32.store8 (i32.const 136) (i32.const 119))
          ...
          (i32.store8 (i32.const 141) (i32.const 58))
          (i32.store8 (i32.const 142) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 11) (call $__f64_to_str (call $Rectangle_get_width (i32.const 260)) (i32.const 143))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 10) (call $__f64_to_str (call $Rectangle_get_area (i32.const 260)) (i32.const 142))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 292) "\75\70")
  (data (i32.const 294) "\64\6f\77\6e\0a")
  (data (i32.const 260) "\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
  (data (i32.const 276) "\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
)