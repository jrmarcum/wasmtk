(module
  ...
  (func $Shape_constructor (param $__self i32) (param $s i32) 
    (i32.store (i32.add (local.get $__self) (i32.const 4)) (local.get $s))
  )

  (func $Shape_getArea (param $__self i32) (result i32)
    (return (i32.const 0))
  )

  (func $Square_constructor (param $__self i32) (param $l i32) 
    (call $Shape_constructor (local.get $__self) (i32.const 4))
    (i32.store (i32.add (local.get $__self) (i32.const 8)) (local.get $l))
  )

  (func $Square_getArea (param $__self i32) (result i32)
    (return (i32.mul (i32.load (i32.add (local.get $__self) (i32.const 8))) (i32.load (i32.add (local.get $__self) (i32.const 8)))))
  )

  (func $Rectangle_constructor (param $__self i32) (param $w i32) (param $h i32) 
    (call $Shape_constructor (local.get $__self) (i32.const 4))
    (i32.store (i32.add (local.get $__self) (i32.const 8)) (local.get $w))
    (i32.store (i32.add (local.get $__self) (i32.const 12)) (local.get $h))
  )

  (func $Rectangle_getArea (param $__self i32) (result i32)
    (return (i32.mul (i32.load (i32.add (local.get $__self) (i32.const 8))) (i32.load (i32.add (local.get $__self) (i32.const 12)))))
  )

  (func $testPolymorphicArray (export "testPolymorphicArray")  
    (local $inventory i32)
    (local $totalArea i32)
    (local $i i32)
    ...
    (local $__str_op_len i32)
        (i32.store (i32.const 0) (i32.const 260))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $inventory (call $__malloc (i32.const 40)))
      (i32.store (local.get $inventory) (i32.const 0))
      (i32.store offset=4 (local.get $inventory) (i32.const 8))
    (local.set $inventory (call $__dynarr_push_i32 (local.get $inventory) (block (result i32) (call $Square_constructor (i32.const 301) (i32.const 5)) (i32.const 301))))
    (local.set $inventory (call $__dynarr_push_i32 (local.get $inventory) (block (result i32) (call $Rectangle_constructor (i32.const 313) (i32.const 4) (i32.const 6)) (i32.const 313))))
    (local.set $inventory (call $__dynarr_push_i32 (local.get $inventory) (block (result i32) (call $Shape_constructor (i32.const 329) (i32.const 0)) (i32.const 329))))
    (local.set $totalArea (i32.const 0))
    (local.set $i (i32.const 0))
    (block $break_0
      (loop $loop_0
        (br_if $break_0 (i32.eqz (i32.lt_s (local.get $i) (i32.load (local.get $inventory)))))
        (block $cont_0
          (local.set $totalArea (i32.add (local.get $totalArea) (if (result i32) (i32.eq (i32.load (i32.load (i32.add (i32.add (local.get $inventory) (i32.const 8)) (i32.shl (local.get $i) (i32.const 2))))) (i32.const 1)) (then (call $Shape_getArea (i32.load (i32.add (i32.add (local.get $inventory) (i32.const 8)) (i32.shl (local.get $i) (i32.const 2)))) )) (else (if (result i32) (i32.eq (i32.load (i32.load (i32.add (i32.add (local.get $inventory) (i32.const 8)) (i32.shl (local.get $i) (i32.const 2))))) (i32.const 2)) (then (call $Square_getArea (i32.load (i32.add (i32.add (local.get $inventory) (i32.const 8)) (i32.shl (local.get $i) (i32.const 2)))) )) (else (call $Rectangle_getArea (i32.load (i32.add (i32.add (local.get $inventory) (i32.const 8)) (i32.shl (local.get $i) (i32.const 2)))) )))))))
        )
        (local.set $i (i32.add (local.get $i) (i32.const 1)))
        (br $loop_0)
      )
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 147) (i32.const 65))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 21) (call $__i32_to_str (local.get $totalArea) (i32.const 153))))
  ...
  (func $_start (export "_start")
    (call $testPolymorphicArray )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 260) "\2d\2d\2d\20\54\65\73\74\20\33\3a\20\50\6f\6c\79\6d\6f\72\70\68\69\63\20\41\72\72\61\79\20\53\74\72\69\64\65\20\2d\2d\2d\0a")
  (data (i32.const 301) "\02\00\00\00\00\00\00\00\00\00\00\00")
  (data (i32.const 313) "\03\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
  (data (i32.const 329) "\01\00\00\00\00\00\00\00")
)