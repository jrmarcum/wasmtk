(module
  ...
  (global $gOffset i32 (i32.const 5))
  ...
  (func $addOffset (param $val i32) (result i32)
    (return (i32.add (local.get $val) (global.get $gOffset)))
  )

  (func $mapArray (param $arr i32) (param $fn i32) (result i32)
    (local $result i32)
    (local $i i32)
    ...
    (block $break_0
      (loop $loop_0
        ...
        (block $cont_0
          (local.set $result (call $__dynarr_push_i32 (local.get $result) (call_indirect (type $ftype_i32_r_i32) (i32.load (i32.add (i32.add (local.get $arr) (i32.const 8)) (i32.shl (local.get $i) (i32.const 2)))) (local.get $fn))))
        )
        (local.set $i (i32.add (local.get $i) (i32.const 1)))
        (br $loop_0)
      )
  ...
  (func $testGenericInterfacePipeline (export "testGenericInterfacePipeline")  
    (local $numbers i32)
    (local $output i32)
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 280))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $numbers (i32.const 260))
    (local.set $output (call $mapArray (local.get $numbers) (i32.const 0)))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 21) (call $__i32_to_str (i32.load (local.get $output)) (i32.const 153))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 15) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $output) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 2)))) (i32.const 147))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 145) (i32.const 58))
          (i32.store8 (i32.const 146) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 15) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $output) (i32.const 8)) (i32.shl (i32.const 2) (i32.const 2)))) (i32.const 147))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    (call $testGenericInterfacePipeline )
    (call $proc_exit (i32.const 0))
  )
  (table 1 funcref)
  (elem (i32.const 0) $addOffset)
  (data (i32.const 280) "\2d\2d\2d\20\54\65\73\74\20\32\3a\20\47\65\6e\65\72\69\63\20\49\6e\74\65\72\66\61\63\65\20\50\69\70\65\6c\69\6e\65\20\2d\2d\2d\0a")
