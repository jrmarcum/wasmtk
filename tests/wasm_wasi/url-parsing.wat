(module
  ...
  (func $getScheme (param $u_ptr i32) (param $u_len i32) 
    ...
    (;; string assignment from complex expression not yet supported: __ret_str = idx >= 0 ? u.slice(0, idx) : "";)
  ...
  (func $getUserInfo (param $u_ptr i32) (param $u_len i32) 
    ...
    (local.set $__ret_str_ptr (i32.const 310))
...
(local.set $host_ptr (global.get $__str_ret_ptr))
  ...
  (func $getFragment (param $u_ptr i32) (param $u_len i32) 
    ...
    (;; string assignment from complex expression not yet supported: __ret_str = idx >= 0 ? u.slice(idx + 1) : "";)
      (global.set $__str_ret_ptr (local.get $__ret_str_ptr))
      (global.set $__str_ret_len (local.get $__ret_str_len))
      (return)
  )
  ...
  (func $getRawQuery (param $u_ptr i32) (param $u_len i32) 
    ...
    (;; string assignment from complex expression not yet supported: __ret_str = hIdx >= 0 ? u.slice(qIdx + 1, hIdx) : u.slice(qIdx + 1);)
      (global.set $__str_ret_ptr (local.get $__ret_str_ptr))
      (global.set $__str_ret_len (local.get $__ret_str_len))
      (return)
  )
