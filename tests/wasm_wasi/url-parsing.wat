    ...
    (local.set $hostParts (call $__str_split (local.get $host_ptr) (local.get $host_len) (i32.const 312) (i32.const 1)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (if (result i32) (i32.gt_s (i32.load (local.get $userParts)) (i32.const 1)) (then (i32.load (i32.add (i32.add (local.get $userParts) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 2))))) (else (;? "" ;) (i32.const 0))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (if (result i32) (i32.gt_s (i32.load (local.get $hostParts)) (i32.const 1)) (then (i32.load (i32.add (i32.add (local.get $hostParts) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 2))))) (else (;? "" ;) (i32.const 0))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
