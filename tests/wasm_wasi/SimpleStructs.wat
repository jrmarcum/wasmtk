(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 298))
  ...
  (func $isActive (param $p i32) (result i32)
    (return (i32.load (i32.add (local.get $p) (i32.const 12))))
  )
  ...
  (func $_start (export "_start")  
    ...
    (local.set $v (i32.const 260))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 8) (i32.const 292))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (call $magnitude (local.get $v)) (i32.const 132)))
          (i32.store (i32.const 8) (i32.const 292))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 2)
            (i32.const 128)))
    (f64.store (i32.add (i32.const 260) (i32.const 0)) (f64.const 6.0))
    (f64.store (i32.add (i32.const 260) (i32.const 8)) (f64.const 8.0))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (f64.load (i32.add (i32.const 260) (i32.const 0))) (i32.const 132)))
          (i32.store (i32.const 8) (i32.const 292))
          (i32.store (i32.const 12) (i32.const 1))
    ...
    (local.set $p (i32.const 276))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.const 276) (i32.const 8))) (i32.const 132)))
          (i32.store (i32.const 8) (i32.const 292))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.const 276) (i32.const 12))) (i32.const 132)))
          (i32.store (i32.const 8) (i32.const 292))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 2)
            (i32.const 128)))
    (i32.store (i32.add (i32.const 276) (i32.const 12)) (i32.const 0))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $isActive (local.get $p)) (i32.const 132)))
          (i32.store (i32.const 8) (i32.const 292))
          (i32.store (i32.const 12) (i32.const 1))
        ...
        (i32.store (i32.const 0) (i32.const 293))
          ...
          (i32.store (i32.const 12) (call $__f64_to_str (f64.load (i32.add (i32.const 260) (i32.const 0))) (i32.const 132)))
          (i32.store (i32.const 16) (i32.const 295))
          (i32.store (i32.const 20) (i32.const 3))
          (i32.store (i32.const 24) (i32.const 164))
          (i32.store (i32.const 28) (call $__f64_to_str (f64.load (i32.add (i32.const 260) (i32.const 8))) (i32.const 164)))
          (i32.store (i32.const 32) (i32.const 292))
  ...
  (data (i32.const 293) "\78\3d")
  (data (i32.const 295) "\20\79\3d")
  (data (i32.const 260) "\00\00\00\00\00\00\08\40\00\00\00\00\00\00\10\40")
  (data (i32.const 276) "\8b\3d\07\c8\a9\79\b2\39\ff\ff\ff\ff\01\00\00\00")
)