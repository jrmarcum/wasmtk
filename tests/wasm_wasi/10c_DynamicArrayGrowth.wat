(module
  ...
  (func $_start (export "_start")
    ...
    (local.set $nums (call $__dynarr_push_i32 (local.get $nums) (i32.const 4)))
    (local.set $nums (call $__dynarr_push_i32 (local.get $nums) (i32.const 5)))
    (local.set $nums (call $__dynarr_push_i32 (local.get $nums) (i32.const 6)))
    (local.set $nums (call $__dynarr_push_i32 (local.get $nums) (i32.const 7)))
    (local.set $nums (call $__dynarr_push_i32 (local.get $nums) (i32.const 8)))
    (local.set $nums (call $__dynarr_push_i32 (local.get $nums) (i32.const 9)))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $nums) (i32.const 8)) (i32.shl (i32.const 8) (i32.const 2)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $nums (call $__dynarr_push_i32 (local.get $nums) (i32.const 10)))
    (local.set $nums (call $__dynarr_push_i32 (local.get $nums) (i32.const 11)))
    (local.set $nums (call $__dynarr_push_i32 (local.get $nums) (i32.const 12)))
    (local.set $nums (call $__dynarr_push_i32 (local.get $nums) (i32.const 13)))
    (local.set $nums (call $__dynarr_push_i32 (local.get $nums) (i32.const 14)))
    (local.set $nums (call $__dynarr_push_i32 (local.get $nums) (i32.const 15)))
    (local.set $nums (call $__dynarr_push_i32 (local.get $nums) (i32.const 16)))
    (local.set $nums (call $__dynarr_unshift_i32 (local.get $nums) (i32.const 0)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $nums) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 2)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $last (call $__dynarr_pop_i32 (local.get $nums)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (local.get $last) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (local.set $scores (call $__malloc (i32.const 72)))
      (i32.store (local.get $scores) (i32.const 3))
      (i32.store offset=4 (local.get $scores) (i32.const 8))
      (f64.store offset=8 (local.get $scores) (f64.const 1))
      (f64.store offset=16 (local.get $scores) (f64.const 2))
      (f64.store offset=24 (local.get $scores) (f64.const 3))
    (local.set $scores (call $__dynarr_push_f64 (local.get $scores) (f64.const 4.0)))
    (local.set $scores (call $__dynarr_push_f64 (local.get $scores) (f64.const 5.0)))
    (local.set $scores (call $__dynarr_push_f64 (local.get $scores) (f64.const 6.0)))
    (local.set $scores (call $__dynarr_push_f64 (local.get $scores) (f64.const 7.0)))
    (local.set $scores (call $__dynarr_push_f64 (local.get $scores) (f64.const 8.0)))
    (local.set $scores (call $__dynarr_push_f64 (local.get $scores) (f64.const 9.0)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (f64.load (i32.add (i32.add (local.get $scores) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 3)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (f64.load (i32.add (i32.add (local.get $scores) (i32.const 8)) (i32.shl (i32.const 8) (i32.const 3)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
