  ...
  (func $jsonStrArr (param $arr i32) 
    ...
    (block $break_0
      ...
      (local.set $s_ptr)
          ...
          (local.set $s_ptr (local.get $s_ptr))
      (local.set $s_len (local.get $s_len))
      (call $jsonStr (i32.load (i32.add (i32.add (local.get $arr) (i32.const 8)) (i32.shl (i32.trunc_f64_s (local.get $i)) (i32.const 3)))) (i32.load offset=4 (i32.add (i32.add (local.get $arr) (i32.const 8)) (i32.shl (i32.trunc_f64_s (local.get $i)) (i32.const 3)))))
      (call $__str_concat (local.get $s_ptr) (local.get $s_len) (global.get $__str_ret_ptr) (global.get $__str_ret_len))
      (local.set $s_len)
      (local.set $s_ptr)
        )
