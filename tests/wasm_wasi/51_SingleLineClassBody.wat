(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 330))
  ...
  (func $Animal_describe (param $__self i32) (result i32)
    (return (i32.load (i32.add (local.get $__self) (i32.const 4))))
  )

  (func $Dog_constructor (param $__self i32) (param $a i32) (param $l i32) 
    (call $Animal_constructor (local.get $__self) (local.get $a))
    (i32.store (i32.add (local.get $__self) (i32.const 8)) (local.get $l))
  )

  (func $Point_constructor (param $__self i32) (param $a i32) (param $b i32) 
    (i32.store (i32.add (local.get $__self) (i32.const 4)) (local.get $a))
    (i32.store (i32.add (local.get $__self) (i32.const 8)) (local.get $b))
  )

  (func $Point_maxc (param $__self i32) (result i32)
    (if (i32.gt_s (i32.load (i32.add (local.get $__self) (i32.const 4))) (i32.load (i32.add (local.get $__self) (i32.const 8))))
      (then
      (return (i32.load (i32.add (local.get $__self) (i32.const 4))))
      )
    )
    (return (i32.load (i32.add (local.get $__self) (i32.const 8))))
  )
  ...
  (func $main  
    ...
    (local.set $a (i32.const 260))
      (call $Animal_constructor (i32.const 260) (i32.const 11))
    (call $check (if (result i32) (i32.eq (i32.load (i32.add (i32.const 260) (i32.const 4))) (i32.const 11)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $Animal_describe (i32.const 260) ) (i32.const 11)) (then (i32.const 1)) (else (i32.const 0))))
    (local.set $d (i32.const 268))
      (call $Dog_constructor (i32.const 268) (i32.const 3) (i32.const 4))
    (call $check (if (result i32) (i32.eq (i32.load (i32.add (i32.const 268) (i32.const 4))) (i32.const 3)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (i32.load (i32.add (i32.const 268) (i32.const 8))) (i32.const 4)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.or (i32.eq (i32.load (i32.const 268)) (i32.const 1)) (i32.eq (i32.load (i32.const 268)) (i32.const 2))) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (i32.load (i32.const 268)) (i32.const 2)) (then (i32.const 1)) (else (i32.const 0))))
    (local.set $base (i32.const 280))
      (call $Dog_constructor (i32.const 280) (i32.const 7) (i32.const 2))
    (call $check (if (result i32) (i32.eq (i32.load (i32.const 280)) (i32.const 2)) (then (i32.const 1)) (else (i32.const 0))))
    (local.set $p (i32.const 292))
      (call $Point_constructor (i32.const 292) (i32.const 3) (i32.const 9))
    (call $check (if (result i32) (i32.eq (i32.load (i32.add (i32.const 292) (i32.const 4))) (i32.const 3)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (i32.load (i32.add (i32.const 292) (i32.const 8))) (i32.const 9)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $Point_maxc (i32.const 292) ) (i32.const 9)) (then (i32.const 1)) (else (i32.const 0))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 97))
          (i32.store8 (i32.const 133) (i32.const 103))
          (i32.store8 (i32.const 134) (i32.const 101))
          (i32.store8 (i32.const 135) (i32.const 58))
          (i32.store8 (i32.const 136) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 5) (call $__i32_to_str (i32.load (i32.add (i32.const 260) (i32.const 4))) (i32.const 137))))
          ...
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 3))) (i32.const 103))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 4))) (i32.const 115))
          ...
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (call $__i32_to_str (i32.load (i32.add (i32.const 268) (i32.const 8))) (i32.add (i32.const 132) (i32.load (i32.const 4))))))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 32))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 1))) (i32.const 109))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 2))) (i32.const 97))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 3))) (i32.const 120))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 4))) (i32.const 58))
          ...
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (call $__i32_to_str (call $Point_maxc (i32.const 292) ) (i32.add (i32.const 132) (i32.load (i32.const 4))))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 304) "\73\69\6e\67\6c\65\2d\6c\69\6e\65\20\63\6c\61\73\73\20\62\6f\64\79\20\6f\6b\0a")
  (data (i32.const 260) "\01\00\00\00\00\00\00\00")
  (data (i32.const 268) "\02\00\00\00\00\00\00\00\00\00\00\00")
  (data (i32.const 280) "\02\00\00\00\00\00\00\00\00\00\00\00")
  (data (i32.const 292) "\03\00\00\00\00\00\00\00\00\00\00\00")
)