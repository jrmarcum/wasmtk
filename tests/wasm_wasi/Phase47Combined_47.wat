(module
  ...
  (func $Vehicle_constructor (param $__self i32) (param $s i32) 
    (i32.store (i32.add (local.get $__self) (i32.const 4)) (local.get $s))
  )

  (func $Vehicle_move (param $__self i32) 
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 15) (call $__i32_to_str (i32.load (i32.add (local.get $__self) (i32.const 4))) (i32.const 147))))
  ...
  (func $Vehicle_maxSpeed (param $__self i32) (result i32)
    (return (i32.load (i32.add (local.get $__self) (i32.const 4))))
  )

  (func $Car_constructor (param $__self i32) (param $s i32) (param $d i32) 
    (call $Vehicle_constructor (local.get $__self) (local.get $s))
    (i32.store (i32.add (local.get $__self) (i32.const 8)) (local.get $d))
  )

  (func $Car_move (param $__self i32) 
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store8 (i32.const 137) (i32.const 86))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 14) (call $__i32_to_str (i32.load (i32.add (local.get $__self) (i32.const 4))) (i32.const 146))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $ElectricCar_constructor (param $__self i32) (param $s i32) (param $d i32) (param $b i32) 
    (call $Car_constructor (local.get $__self) (local.get $s) (local.get $d))
    (i32.store (i32.add (local.get $__self) (i32.const 12)) (local.get $b))
  )

  (func $ElectricCar_move (param $__self i32) 
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 23) (call $__i32_to_str (i32.load (i32.add (local.get $__self) (i32.const 4))) (i32.const 155))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $Node_constructor (param $__self i32) (param $v i32) 
    (i32.store (i32.add (local.get $__self) (i32.const 4)) (local.get $v))
  )

  (func $Node_getValue (param $__self i32) (result i32)
    (return (i32.load (i32.add (local.get $__self) (i32.const 4))))
  )

  (func $LeafNode_constructor (param $__self i32) (param $v i32) (param $d i32) 
    (call $Node_constructor (local.get $__self) (local.get $v))
    (i32.store (i32.add (local.get $__self) (i32.const 8)) (local.get $d))
  )

  (func $BranchNode_constructor (param $__self i32) (param $v i32) (param $d i32) (param $c i32) 
    (call $LeafNode_constructor (local.get $__self) (local.get $v) (local.get $d))
  ...
  (func $main  
    ...
    (local.set $v (i32.const 260))
      (call $Vehicle_constructor (i32.const 260) (i32.const 100))
    (local.set $c (i32.const 268))
      (call $Car_constructor (i32.const 268) (i32.const 200) (i32.const 4))
    (local.set $ec (i32.const 280))
      (call $ElectricCar_constructor (i32.const 280) (i32.const 150) (i32.const 2) (i32.const 80))
    (call $Vehicle_move (i32.const 260) )
    (call $Car_move (i32.const 268) )
    (call $ElectricCar_move (i32.const 280) )
    (local.set $v2 (i32.const 296))
      (call $Car_constructor (i32.const 296) (i32.const 300) (i32.const 4))
    (local.set $v3 (i32.const 308))
      (call $ElectricCar_constructor (i32.const 308) (i32.const 250) (i32.const 2) (i32.const 100))
    (call $Car_move (i32.const 296) )
    (call $ElectricCar_move (i32.const 308) )
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $Vehicle_maxSpeed (i32.const 280) ) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $Vehicle_maxSpeed (i32.const 296) ) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $b (i32.const 324))
      (call $BranchNode_constructor (i32.const 324) (i32.const 42) (i32.const 3) (i32.const 5))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $Node_getValue (i32.const 324) ) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.const 324) (i32.const 8))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.const 324) (i32.const 12))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 280) "\03\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
  (data (i32.const 296) "\02\00\00\00\00\00\00\00\00\00\00\00")
  (data (i32.const 308) "\03\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
  (data (i32.const 324) "\06\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
)