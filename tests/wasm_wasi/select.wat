(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 266))
  ...
  (func $makeMessage (param $tag_ptr i32) (param $tag_len i32) 
    (local $__ret_str_ptr i32)
    (local $__ret_str_len i32)
    (local.set $__ret_str_ptr (local.get $tag_ptr))
      (local.set $__ret_str_len (local.get $tag_len))
  ...
  (func $_start (export "_start")
    ...
    (call $makeMessage (i32.const 260) (i32.const 3))
(local.set $c1_ptr (global.get $__str_ret_ptr))
      (local.set $c1_len (global.get $__str_ret_len))
    (call $makeMessage (i32.const 263) (i32.const 3))
(local.set $c2_ptr (global.get $__str_ret_ptr))
      (local.set $c2_len (global.get $__str_ret_len))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (call $__str_gather (local.get $c1_ptr) (local.get $c1_len) (i32.const 141))
          (i32.store (i32.const 4) (i32.add (i32.const 9) (local.get $c1_len)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 139) (i32.const 100))
          (i32.store8 (i32.const 140) (i32.const 32))
          (call $__str_gather (local.get $c2_ptr) (local.get $c2_len) (i32.const 141))
          (i32.store (i32.const 4) (i32.add (i32.const 9) (local.get $c2_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 260) "\6f\6e\65")
  (data (i32.const 263) "\74\77\6f")
)