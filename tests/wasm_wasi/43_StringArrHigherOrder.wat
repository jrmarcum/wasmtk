(module
  ...
  (func $anyMatch (param $arr i32) (param $pred i32) (result i32)
    (local $i i32)
    (local.set $i (i32.const 0))
    (block $break_0
      (loop $loop_0
  ...
  (func $allMatch (param $arr i32) (param $pred i32) (result i32)
    (local $i i32)
    (local.set $i (i32.const 0))
    (block $break_1
      (loop $loop_1
  ...
  (func $countMatch (param $arr i32) (param $pred i32) (result i32)
    (local $count i32)
    (local $i i32)
  ...
  (func $startsWithA (param $s_ptr i32) (param $s_len i32) (result i32)
    (return (i32.eq (call $__str_char_code_at (local.get $s_ptr) (local.get $s_len) (i32.const 0)) (i32.const 97)))
  )

  (func $isLong (param $s_ptr i32) (param $s_len i32) (result i32)
    (return (i32.gt_s (local.get $s_len) (i32.const 3)))
  )
  (func $_start (export "_start")
    (local $names i32)
    (local $__iface_tmp i32)
    (local.set $names (i32.const 279))
        (i32.store (i32.const 0) (if (result i32) (call $anyMatch (local.get $names) (i32.const 0)) (then (i32.const 319)) (else (i32.const 323))))
          (i32.store (i32.const 4) (if (result i32) (call $anyMatch (local.get $names) (i32.const 0)) (then (i32.const 4)) (else (i32.const 5))))
          (i32.store (i32.const 8) (i32.const 328))
          ...
          (drop (call $fd_write
            ...
            (i32.const 2)
            (i32.const 128)))
        (i32.store (i32.const 0) (if (result i32) (call $allMatch (local.get $names) (i32.const 0)) (then (i32.const 319)) (else (i32.const 323))))
          (i32.store (i32.const 4) (if (result i32) (call $allMatch (local.get $names) (i32.const 0)) (then (i32.const 4)) (else (i32.const 5))))
          (i32.store (i32.const 8) (i32.const 328))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 2)
            (i32.const 128)))
        (i32.store (i32.const 0) (if (result i32) (call $anyMatch (local.get $names) (i32.const 1)) (then (i32.const 319)) (else (i32.const 323))))
          (i32.store (i32.const 4) (if (result i32) (call $anyMatch (local.get $names) (i32.const 1)) (then (i32.const 4)) (else (i32.const 5))))
          (i32.store (i32.const 8) (i32.const 328))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 2)
            (i32.const 128)))
        (i32.store (i32.const 0) (if (result i32) (call $allMatch (local.get $names) (i32.const 1)) (then (i32.const 319)) (else (i32.const 323))))
          (i32.store (i32.const 4) (if (result i32) (call $allMatch (local.get $names) (i32.const 1)) (then (i32.const 4)) (else (i32.const 5))))
          (i32.store (i32.const 8) (i32.const 328))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $countMatch (local.get $names) (i32.const 0)) (i32.const 132)))
  ...
  (table 2 funcref)
  (elem (i32.const 0) $startsWithA $isLong)
  (data (i32.const 260) "\61\6c\69\63\65")
  (data (i32.const 265) "\62\6f\62")
  (data (i32.const 268) "\63\68\61\72\6c\69\65")
  (data (i32.const 275) "\61\6e\6e\61")
  (data (i32.const 319) "\74\72\75\65")
  (data (i32.const 323) "\66\61\6c\73\65")
  (data (i32.const 328) "\0a")
  (data (i32.const 279) "\04\00\00\00\04\00\00\00\04\01\00\00\05\00\00\00\09\01\00\00\03\00\00\00\0c\01\00\00\07\00\00\00\13\01\00\00\04\00\00\00")
)