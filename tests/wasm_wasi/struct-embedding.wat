  ...
  (func $_start (export "_start")
    ...
    (local.set $co (call $newContainer (f64.const 1) (i32.const 274) (i32.const 9)))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 9) (call $__i32_to_str (;? co.base.num ;) (i32.const 0) (i32.const 141))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 10) (call $__i32_to_str (;? co.base.num ;) (i32.const 0) (i32.const 142))))
