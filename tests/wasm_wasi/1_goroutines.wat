(module
  ...
  (func $f (param $from_ptr i32) (param $from_len i32) 
    (local $i f64)
    (local $__iface_tmp i32)
    (local.set $i (f64.const 0))
    (block $break_0
      (loop $loop_0
        (br_if $break_0 (i32.eqz (f64.lt (local.get $i) (f64.const 3))))
        (block $cont_0
              (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (local.get $from_ptr) (local.get $from_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $from_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 32))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 1))) (i32.const 58))
          ...
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (call $__f64_to_str (local.get $i) (i32.add (i32.const 132) (i32.load (i32.const 4))))))
  ...
  (func $_start (export "_start")
    (local $__iface_tmp i32)
    (call $f (i32.const 260) (i32.const 6))
    (call $f (i32.const 266) (i32.const 9))
  ...
  (data (i32.const 260) "\64\69\72\65\63\74")
  (data (i32.const 266) "\67\6f\72\6f\75\74\69\6e\65")
  (data (i32.const 275) "\67\6f\69\6e\67\0a")
  (data (i32.const 281) "\64\6f\6e\65\0a")
)