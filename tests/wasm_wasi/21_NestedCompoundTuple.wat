(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 310))
  ...
  (func $NodeMetric_constructor (param $__self i32) (param $id i32) (param $min i32) (param $max i32) 
    (i32.store (i32.add (local.get $__self) (i32.const 0)) (local.get $id))
    (i32.store offset=4 (local.get $__self) (local.get $min))
      (i32.store offset=8 (local.get $__self) (local.get $max))
  )

  (func $testNestedTuple (export "testNestedTuple")  
    (local $metric i32)
    (local $lower i32)
    (local $upper i32)
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 272))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $metric (i32.const 260))
      (call $NodeMetric_constructor (i32.const 260) (i32.const 7) (i32.const 150) (i32.const 300))
    (local.set $lower (i32.load offset=4 (i32.const 260)))
      (local.set $upper (i32.load offset=8 (i32.const 260)))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 139) (i32.const 78))
          ...
          (i32.store8 (i32.const 145) (i32.const 68))
          (i32.store8 (i32.const 146) (i32.const 58))
          (i32.store8 (i32.const 147) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 16) (call $__i32_to_str (i32.load (i32.add (i32.const 260) (i32.const 0))) (i32.const 148))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 143) (i32.const 32))
          (i32.store8 (i32.const 144) (i32.const 86))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 19) (call $__i32_to_str (local.get $lower) (i32.const 151))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 149) (i32.const 58))
          (i32.store8 (i32.const 150) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 19) (call $__i32_to_str (local.get $upper) (i32.const 151))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    (call $testNestedTuple )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 272) "\2d\2d\2d\20\54\65\73\74\20\33\3a\20\4e\65\73\74\65\64\20\43\6f\6d\70\6f\75\6e\64\20\54\75\70\6c\65\20\2d\2d\2d\0a")
  (data (i32.const 260) "\00\00\00\00\00\00\00\00\00\00\00\00")
)