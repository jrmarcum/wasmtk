  ...
  (func $testEnums (export "testEnums")  
    ...
    (if (i32.eq (local.get $currentStatus) (i32.const 6))
      (then
          ...
          (i32.store (i32.const 4) (call $__i32_to_str (i32.const 1) (i32.const 132)))
    ...
    (local.set $myColor (i32.const 20))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (local.get $myColor) (i32.const 132)))
          (i32.store (i32.const 8) (i32.const 260))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
