(module
  ...
  (func $__anon_0__factory (param $x i32) (result i32)
  ...
  (func $__anon_0__factory__trampoline (param $__closure_ptr i32) (result i32)
    ...
    (call $__anon_0 (local.get $__cap_x))
  )
  (func $_start (export "_start")
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $testShadowing (i32.const 42)) (i32.const 132)))
