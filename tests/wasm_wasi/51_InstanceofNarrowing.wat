(module
  ...
  (func $describe (param $s i32) (result i32)
    (if (i32.eq (i32.load (local.get $s)) (i32.const 2))
      (then
      (return (i32.mul (i32.load (i32.add (local.get $s) (i32.const 8))) (i32.const 10)))
      )
    )
    (if (i32.eq (i32.load (local.get $s)) (i32.const 3))
      (then
      (return (i32.mul (i32.load (i32.add (local.get $s) (i32.const 8))) (i32.const 100)))
      )
    )
    (return (i32.const -1))
  )
  ...
  (func $main  
    ...
    (local $poly i32)
    (local $__iface_tmp i32)
    (local.set $sq (i32.const 260))
      (call $Square_constructor (i32.const 260) (i32.const 1) (i32.const 4))
    (local.set $ci (i32.const 272))
      (call $Circle_constructor (i32.const 272) (i32.const 2) (i32.const 5))
    (local.set $sh (i32.const 284))
      (call $Shape_constructor (i32.const 284) (i32.const 3))
    (call $check (if (result i32) (i32.eq (call $describe (local.get $sq)) (i32.const 40)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $describe (local.get $ci)) (i32.const 500)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $describe (local.get $sh)) (i32.const -1)) (then (i32.const 1)) (else (i32.const 0))))
    (local.set $poly (i32.const 292))
      (call $Square_constructor (i32.const 292) (i32.const 9) (i32.const 6))
    (call $check (if (result i32) (i32.eq (i32.load (i32.const 292)) (i32.const 2)) (then (i32.const 1)) (else (i32.const 0))))
    (if (i32.eq (i32.load (i32.const 292)) (i32.const 2))
      (then
      (call $check (if (result i32) (i32.eq (i32.load (i32.add (i32.const 292) (i32.const 8))) (i32.const 6)) (then (i32.const 1)) (else (i32.const 0))))
      )
    )
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 13) (call $__i32_to_str (call $describe (local.get $sq)) (i32.const 145))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 143) (i32.const 58))
          (i32.store8 (i32.const 144) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 13) (call $__i32_to_str (call $describe (local.get $ci)) (i32.const 145))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 304) "\6e\61\72\72\6f\77\69\6e\67\20\69\6e\73\74\61\6e\63\65\6f\66\20\6f\6b\0a")
