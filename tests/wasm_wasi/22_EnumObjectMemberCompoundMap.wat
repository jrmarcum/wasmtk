(module
  ...
  (func $NetworkNode_constructor (param $__self i32) (param $id i32) 
    (i32.store (i32.add (local.get $__self) (i32.const 0)) (local.get $id))
    (i32.store (i32.add (local.get $__self) (i32.const 4)) (i32.const 0))
  )

  (func $NetworkNode_updateStatus (param $__self i32) (param $next i32) 
    (i32.store (i32.add (local.get $__self) (i32.const 4)) (local.get $next))
  )

  (func $testEnumClassIntegration (export "testEnumClassIntegration")  
    (local $router i32)
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 268))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $router (i32.const 260))
      (call $NetworkNode_constructor (i32.const 260) (i32.const 101))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 147) (i32.const 86))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 22) (call $__i32_to_str (i32.load (i32.add (i32.const 260) (i32.const 4))) (i32.const 154))))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $NetworkNode_updateStatus (i32.const 260) (i32.const 2))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
  ...
  (func $_start (export "_start")
    (call $testEnumClassIntegration )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 268) "\2d\2d\2d\20\54\65\73\74\20\33\3a\20\45\6e\75\6d\20\50\72\6f\70\65\72\74\79\20\49\6e\74\65\67\72\61\74\69\6f\6e\20\2d\2d\2d\0a")
