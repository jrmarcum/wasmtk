    ...
    (try
      ...
      (catch $__exn_tag
        ...
        (;; string assignment from complex expression not yet supported: msg = r instanceof Error ? r.message : `${r}`;)
          ...
          (i32.store8 (i32.const 149) (i32.const 92))
          (i32.store8 (i32.const 150) (i32.const 110))
          (i32.store8 (i32.const 151) (i32.const 32))
          (call $__str_gather (local.get $msg_ptr) (local.get $msg_len) (i32.const 152))
          (i32.store (i32.const 4) (i32.add (i32.const 20) (local.get $msg_len)))
