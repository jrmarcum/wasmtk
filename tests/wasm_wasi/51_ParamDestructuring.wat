(module
  ...
  (func $sum2 (param $__pd_0 i32) (result f64)
    (local $x f64)
    (local $y f64)
    (local.set $x (f64.load (i32.add (local.get $__pd_0) (i32.const 0))))
      (local.set $y (f64.load (i32.add (local.get $__pd_0) (i32.const 8))))
    (return (f64.add (local.get $x) (local.get $y)))
  )

  (func $diff (param $__pd_1 i32) (result i32)
    (local $lo i32)
    (local $hi i32)
    (local.set $lo (i32.load (i32.add (local.get $__pd_1) (i32.const 0))))
      (local.set $hi (i32.load (i32.add (local.get $__pd_1) (i32.const 4))))
    (return (i32.sub (local.get $hi) (local.get $lo)))
  )

  (func $scaleX (param $__pd_2 i32) (param $factor f64) (result f64)
    (local $x f64)
    (local $y f64)
    (local.set $x (f64.load (i32.add (local.get $__pd_2) (i32.const 0))))
      (local.set $y (f64.load (i32.add (local.get $__pd_2) (i32.const 8))))
    (return (f64.add (f64.mul (local.get $x) (local.get $factor)) (local.get $y)))
  )

  (func $addPair (param $__pd_3 i32) (result i32)
    (local $p i32)
    (local $q i32)
    (local.set $p (i32.load (i32.add (local.get $__pd_3) (i32.const 0))))
      (local.set $q (i32.load (i32.add (local.get $__pd_3) (i32.const 4))))
    (return (i32.add (local.get $p) (local.get $q)))
  )

  (func $combine (param $__pd_4 i32) (param $__pd_5 i32) (result f64)
    (local $x f64)
    (local $y f64)
    (local $a i32)
    (local $b i32)
    (local.set $x (f64.load (i32.add (local.get $__pd_4) (i32.const 0))))
      (local.set $y (f64.load (i32.add (local.get $__pd_4) (i32.const 8))))
    (local.set $a (i32.load (i32.add (local.get $__pd_5) (i32.const 0))))
      (local.set $b (i32.load (i32.add (local.get $__pd_5) (i32.const 4))))
    (return (f64.add (f64.add (f64.add (local.get $x) (local.get $y)) (f64.convert_i32_s (local.get $a))) (f64.convert_i32_s (local.get $b))))
  )
  (func $_start (export "_start")
    ...
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 135) (i32.const 50))
          (i32.store8 (i32.const 136) (i32.const 58))
          (i32.store8 (i32.const 137) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 6) (call $__f64_to_str (call $sum2 (i32.const 284)) (i32.const 138))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 136) (i32.const 58))
          (i32.store8 (i32.const 137) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 6) (call $__i32_to_str (call $diff (i32.const 300)) (i32.const 138))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 8) (call $__f64_to_str (call $scaleX (i32.const 308) (f64.const 3.0)) (i32.const 140))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (local.set $v (i32.const 260))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 136) (i32.const 86))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 9) (call $__f64_to_str (call $sum2 (local.get $v)) (i32.const 141))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (local.set $pair (i32.const 276))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 139) (i32.const 58))
          (i32.store8 (i32.const 140) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 9) (call $__i32_to_str (call $addPair (local.get $pair)) (i32.const 141))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 139) (i32.const 58))
          (i32.store8 (i32.const 140) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 9) (call $__f64_to_str (call $combine (i32.const 324) (i32.const 340)) (i32.const 141))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 260) "\00\00\00\00\00\00\24\40\00\00\00\00\00\00\34\40")
  (data (i32.const 276) "\08\00\00\00\09\00\00\00")
  (data (i32.const 284) "\00\00\00\00\00\00\0c\40\00\00\00\00\00\00\10\40")
  (data (i32.const 300) "\04\00\00\00\0a\00\00\00")
  (data (i32.const 308) "\00\00\00\00\00\00\00\40\00\00\00\00\00\00\f0\3f")
  (data (i32.const 324) "\00\00\00\00\00\00\f8\3f\00\00\00\00\00\00\04\40")
  (data (i32.const 340) "\03\00\00\00\04\00\00\00")
)