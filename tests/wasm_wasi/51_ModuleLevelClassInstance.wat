(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 331))
  ...
  (func $_start (export "_start")
    ...
    (local.set $d (i32.const 260))
      (call $Dog_constructor (i32.const 260) (i32.const 3) (i32.const 4))
    (local.set $plain (i32.const 272))
      (call $Animal_constructor (i32.const 272) (i32.const 9))
    (call $check (if (result i32) (i32.eq (i32.load (i32.add (i32.const 260) (i32.const 4))) (i32.const 3)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (i32.load (i32.const 260)) (i32.const 2)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.or (i32.eq (i32.load (i32.const 260)) (i32.const 1)) (i32.eq (i32.load (i32.const 260)) (i32.const 2))) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (i32.load (i32.const 272)) (i32.const 2)) (then (i32.const 0)) (else (i32.const 1))))
    (call $check (if (result i32) (i32.eq (call $Animal_describe (i32.const 260) ) (i32.const 3)) (then (i32.const 1)) (else (i32.const 0))))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 7) (call $__i32_to_str (i32.load (i32.add (i32.const 260) (i32.const 4))) (i32.const 139))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 280))
          ...
          (i32.store (i32.const 8) (if (result i32) (i32.eq (i32.load (i32.const 260)) (i32.const 2)) (then (i32.const 290)) (else (i32.const 294))))
          (i32.store (i32.const 12) (if (result i32) (i32.eq (i32.load (i32.const 260)) (i32.const 2)) (then (i32.const 4)) (else (i32.const 5))))
          (i32.store (i32.const 16) (i32.const 299))
  ...
  (data (i32.const 280) "\64\20\69\73\20\44\6f\67\3a\20")
  (data (i32.const 290) "\74\72\75\65")
  (data (i32.const 294) "\66\61\6c\73\65")
  (data (i32.const 299) "\0a")
  (data (i32.const 300) "\6d\6f\64\75\6c\65\2d\6c\65\76\65\6c\20\63\6c\61\73\73\20\69\6e\73\74\61\6e\63\65\20\6f\6b\0a")
  (data (i32.const 260) "\02\00\00\00\00\00\00\00\00\00\00\00")
  (data (i32.const 272) "\01\00\00\00\00\00\00\00")
)