(module
  ...
  (func $testHeterogeneousTuple (export "testHeterogeneousTuple")  
    (local $record i32)
    (local $id i32)
    (local $value f64)
    (local $active i32)
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 280))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $record (i32.const 260))
    (local.set $id (i32.load (i32.add (i32.const 260) (i32.const 0))))
      (local.set $value (f64.load (i32.add (i32.const 260) (i32.const 8))))
      (local.set $active (i32.load (i32.add (i32.const 260) (i32.const 16))))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 14) (call $__i32_to_str (local.get $id) (i32.const 146))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 140) (i32.const 100))
          (i32.store8 (i32.const 141) (i32.const 32))
          (i32.store8 (i32.const 142) (i32.const 86))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 17) (call $__f64_to_str (local.get $value) (i32.const 149))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 146) (i32.const 118))
          (i32.store8 (i32.const 147) (i32.const 101))
          (i32.store8 (i32.const 148) (i32.const 58))
          (i32.store8 (i32.const 149) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 18) (call $__i32_to_str (if (result i32) (local.get $active) (then (i32.const 1)) (else (i32.const 0))) (i32.const 150))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    (call $testHeterogeneousTuple )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 280) "\2d\2d\2d\20\54\65\73\74\20\31\3a\20\48\65\74\65\72\6f\67\65\6e\65\6f\75\73\20\54\75\70\6c\65\20\44\65\73\74\72\75\63\74\75\72\69\6e\67\20\2d\2d\2d\0a")
  (data (i32.const 260) "\2a\00\00\00\00\00\00\00\6e\86\1b\f0\f9\21\09\40\01\00\00\00")
)