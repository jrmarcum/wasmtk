(module
  ...
  (func $addOptional (param $a i32) (param $b i32) (result i32)
  ...
  (func $offset (param $x f64) (param $dx f64) (param $dy f64) (result f64)
    (if (f64.eq (local.get $dx) (f64.const 0))
      (then
      (local.set $dx (f64.const 0))
      )
    )
    (if (f64.eq (local.get $dy) (f64.const 0))
      (then
      (local.set $dy (f64.const 0))
      )
    )
    (return (f64.add (f64.add (local.get $x) (local.get $dx)) (local.get $dy)))
  )

  (func $build (param $base i32) (param $step i32) (param $count i32) (result i32)
    (if (i32.eq (local.get $step) (i32.const 0))
      (then
      (local.set $step (i32.const 0))
      )
    )
    (return (i32.add (local.get $base) (i32.mul (local.get $step) (local.get $count))))
  )

  (func $_start (export "_start")  
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $addOptional (i32.const 7) (i32.const 0)) (i32.const 132)))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $addOptional (i32.const 7) (i32.const 3)) (i32.const 132)))
          (i32.store (i32.const 8) (i32.const 260))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (call $offset (f64.const 10.0) (f64.const 0) (f64.const 0)) (i32.const 132)))
          (i32.store (i32.const 8) (i32.const 260))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (call $offset (f64.const 10.0) (f64.const 1.5) (f64.const 0)) (i32.const 132)))
          (i32.store (i32.const 8) (i32.const 260))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $build (i32.const 10) (i32.const 0) (i32.const 3)) (i32.const 132)))
          (i32.store (i32.const 8) (i32.const 260))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $build (i32.const 10) (i32.const 2) (i32.const 3)) (i32.const 132)))
          (i32.store (i32.const 8) (i32.const 260))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
