(module
  ...
  (func $_start (export "_start")
    ...
    (local.set $argsWithProg (i32.const 288))
    (local.set $argsWithoutProg (i32.const 336))
    (local.set $arg_ptr (i32.load (i32.add (i32.add (i32.const 288) (i32.const 8)) (i32.shl (i32.const 3) (i32.const 3)))))
      (local.set $arg_len (i32.load offset=4 (i32.add (i32.add (i32.const 288) (i32.const 8)) (i32.shl (i32.const 3) (i32.const 3)))))
  ...
  (data (i32.const 260) "\2e\2f\63\6f\6d\6d\61\6e\64\2d\6c\69\6e\65\2d\61\72\67\75\6d\65\6e\74\73")
  (data (i32.const 284) "\61")
  (data (i32.const 285) "\62")
  (data (i32.const 286) "\63")
  (data (i32.const 287) "\64")
  (data (i32.const 288) "\05\00\00\00\05\00\00\00\04\01\00\00\18\00\00\00\1c\01\00\00\01\00\00\00\1d\01\00\00\01\00\00\00\1e\01\00\00\01\00\00\00\1f\01\00\00\01\00\00\00")
  (data (i32.const 336) "\04\00\00\00\04\00\00\00\1c\01\00\00\01\00\00\00\1d\01\00\00\01\00\00\00\1e\01\00\00\01\00\00\00\1f\01\00\00\01\00\00\00")
)