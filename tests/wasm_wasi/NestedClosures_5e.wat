(module
  ...
  (func $testNestedClosure (export "testNestedClosure") (param $multiplier i32) (result i32)
    (local $firstLevel i32)
    (local $secondLevel i32)
    (local.set $firstLevel (i32.const 0))
    (return (call $firstLevel (i32.const 10) (local.get $multiplier)))
  )

  (func $firstLevel (param $a i32) (param $multiplier i32) (result i32)
    (local $secondLevel i32)
    (local.set $secondLevel (i32.const 1))
    (return (call $secondLevel (i32.const 5) (local.get $a) (local.get $multiplier)))
  )

  (func $secondLevel (param $b i32) (param $a i32) (param $multiplier i32) (result i32)
    (return (i32.mul (i32.mul (local.get $a) (local.get $b)) (local.get $multiplier)))
  )
  (func $_start (export "_start")
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $testNestedClosure (i32.const 2)) (i32.const 132)))
  ...
  (table 2 funcref)
  (elem (i32.const 0) $firstLevel $secondLevel)
)