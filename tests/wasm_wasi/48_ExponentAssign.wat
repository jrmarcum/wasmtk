(module
  ...
  (func $main  
    ...
    (local.set $x (call $__math_pow (local.get $x) (f64.const 3)))
    ...
    (local.set $y (call $__math_pow (local.get $y) (f64.const 0.5)))
        (i32.store (i32.const 0) (i32.const 132))
    ...
    (local.set $z (call $__math_pow (local.get $z) (local.get $exp)))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (global.set $globalX (call $__math_pow (global.get $globalX) (f64.const 2)))
        (i32.store (i32.const 0) (i32.const 132))
