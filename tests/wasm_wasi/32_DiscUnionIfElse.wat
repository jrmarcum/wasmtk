(module
  ...
  (func $handleEvent (param $e i32) 
    (local $__iface_tmp i32)
    (if (i32.eq (i32.load (local.get $e)) (i32.const 0))
      (then
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 9) (call $__i32_to_str (i32.load (i32.add (local.get $e) (i32.const 4))) (i32.const 141))))
          ...
          (i32.store8 (i32.const 139) (i32.const 58))
          (i32.store8 (i32.const 140) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 9) (call $__i32_to_str (i32.load (i32.add (local.get $e) (i32.const 8))) (i32.const 141))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
      ...
      (if (i32.eq (i32.load (local.get $e)) (i32.const 1))
        (then
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 10) (call $__i32_to_str (i32.load (i32.add (local.get $e) (i32.const 12))) (i32.const 142))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (else
        (if (i32.eq (i32.load (local.get $e)) (i32.const 2))
          (then
              (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 14) (call $__f64_to_str (f64.load (i32.add (local.get $e) (i32.const 16))) (i32.const 146))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $isClick (param $e i32) (result i32)
    (if (i32.eq (i32.load (local.get $e)) (i32.const 0))
      (then
      (return (i32.const 1))
      )
  ...
  (func $_start (export "_start")
    ...
    (local.set $click (i32.const 260))
    (local.set $key (i32.const 284))
    (local.set $scroll (i32.const 308))
    (call $handleEvent (local.get $click))
    (call $handleEvent (local.get $key))
    (call $handleEvent (local.get $scroll))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $isClick (local.get $click)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $isClick (local.get $key)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 260) "\00\00\00\00\64\00\00\00\c8\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
  (data (i32.const 284) "\01\00\00\00\00\00\00\00\00\00\00\00\41\00\00\00\00\00\00\00\00\00\00\00")
  (data (i32.const 308) "\02\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\f8\bf")
)