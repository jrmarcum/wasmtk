(module
  ...
  (func $testClosure (export "testClosure") (param $multiplier i32) (result i32)
    (local $scale i32)
    (local.set $scale (call $__anon_0__factory (local.get $multiplier)))
    (return (call_indirect (type $ftype_i32_i32_r_i32) (local.get $scale) (i32.const 10) (i32.load (local.get $scale))))
  )
  ...
  (func $_start (export "_start")
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $testClosure (i32.const 5)) (i32.const 132)))
