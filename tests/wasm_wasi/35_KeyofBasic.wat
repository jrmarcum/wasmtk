(module
  ...
  (func $printKey (param $key_ptr i32) (param $key_len i32) 
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (call $__str_gather (local.get $key_ptr) (local.get $key_len) (i32.const 137))
          (i32.store (i32.const 4) (i32.add (i32.const 5) (local.get $key_len)))
  ...
  (func $lookupConfig (param $key_ptr i32) (param $key_len i32) 
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store8 (i32.const 139) (i32.const 107))
          ...
          (call $__str_gather (local.get $key_ptr) (local.get $key_len) (i32.const 144))
          (i32.store (i32.const 4) (i32.add (i32.const 12) (local.get $key_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $matchWidth (param $key_ptr i32) (param $key_len i32) (result i32)
    (return (i32.eqz (call $__str_cmp (local.get $key_ptr) (local.get $key_len) (i32.const 260) (i32.const 5))))
  )
  ...
  (func $main  
    ...
    (local $isWide i32)
    (local $__iface_tmp i32)
    (call $printKey (i32.const 265) (i32.const 1))
    (call $printKey (i32.const 266) (i32.const 1))
    (call $lookupConfig (i32.const 260) (i32.const 5))
    (call $lookupConfig (i32.const 267) (i32.const 6))
    (call $lookupConfig (i32.const 273) (i32.const 5))
    (local.set $k_ptr (i32.const 265))
      (local.set $k_len (i32.const 1))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (call $__str_gather (local.get $k_ptr) (local.get $k_len) (i32.const 140))
          (i32.store (i32.const 4) (i32.add (i32.const 8) (local.get $k_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $field_ptr (i32.const 260))
      (local.set $field_len (i32.const 5))
    (if (i32.eqz (call $__str_cmp (local.get $field_ptr) (local.get $field_len) (i32.const 260) (i32.const 5)))
      (then
    ...
    (if (i32.ne (call $__str_cmp (local.get $field_ptr) (local.get $field_len) (i32.const 267) (i32.const 6)) (i32.const 0))
      (then
    ...
    (local.set $isWide (call $matchWidth (i32.const 260) (i32.const 5)))
    (if (local.get $isWide)
      (then
  ...
  (data (i32.const 260) "\77\69\64\74\68")
  (data (i32.const 265) "\78")
  (data (i32.const 266) "\79")
  (data (i32.const 267) "\68\65\69\67\68\74")
  (data (i32.const 273) "\73\63\61\6c\65")
  (data (i32.const 278) "\69\73\20\77\69\64\74\68\0a")
  (data (i32.const 287) "\6e\6f\74\20\68\65\69\67\68\74\0a")
  (data (i32.const 298) "\6d\61\74\63\68\65\64\20\77\69\64\74\68\0a")
)