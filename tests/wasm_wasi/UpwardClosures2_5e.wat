(module
  ...
  (func $createAdder__inner (param $y i32) (param $x i32) (result i32)
    (return (i32.add (local.get $x) (local.get $y)))
  )

  (func $createAdder (param $x i32) (result i32)
  ...
  (func $createAdder__trampoline (param $__closure_ptr i32) (param $y i32) (result i32)
    (local $__cap_x i32)
    (local.set $__cap_x (i32.load offset=4 (local.get $__closure_ptr)))
    (call $createAdder__inner (local.get $y) (local.get $__cap_x))
  )
  ...
  (table 1 funcref)
  (elem (i32.const 0) $createAdder__trampoline)
)