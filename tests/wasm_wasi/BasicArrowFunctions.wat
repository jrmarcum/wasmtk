(module
  ...
  (func $_start (export "_start")  
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $getAnswer) (i32.const 132)))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i64_to_str (call $doubleBigInt (i64.const 5)) (i32.const 132)))
          (i32.store (i32.const 8) (i32.const 260))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $calculateArea (i32.const 5) (i32.const 10)) (i32.const 132)))
          (i32.store (i32.const 8) (i32.const 260))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $doubleBigInt (param $n i64) (result i64)
    (return (i64.mul (local.get $n) (i64.const 2)))
  )

  (func $calculateArea (param $width i32) (param $height i32) (result i32)
    (local $area i32)
    (local.set $area (i32.mul (local.get $width) (local.get $height)))
    (return (local.get $area))
  )
