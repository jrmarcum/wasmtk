(module
  ...
  (global $Widget_totalValue (mut f64) (f64.const 0.0))
  (global $Box_instances (mut i32) (i32.const 10))
  ...
  (func $Widget_constructor (param $__self i32) (param $id i32) (param $value f64) 
    (i32.store (i32.add (local.get $__self) (i32.const 0)) (local.get $id))
    (global.set $Widget_count (i32.add (global.get $Widget_count) (i32.const 1)))
    (global.set $Widget_totalValue (f64.add (global.get $Widget_totalValue) (local.get $value)))
  )

  (func $Widget_reset  
    (global.set $Widget_count (i32.const 0))
    (global.set $Widget_totalValue (f64.const 0.0))
  )

  (func $Widget_getCount  (result i32)
    (return (global.get $Widget_count))
  )

  (func $Widget_getTotal  (result f64)
    (return (global.get $Widget_totalValue))
  )
  ...
  (func $main  
    ...
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (global.get $Widget_count) (i32.const 132)))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (global.get $Widget_totalValue) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $w1 (i32.const 260))
      (call $Widget_constructor (i32.const 260) (i32.const 1) (f64.const 1.5))
    (local.set $w2 (i32.const 264))
      (call $Widget_constructor (i32.const 264) (i32.const 2) (f64.const 2.5))
    (local.set $w3 (i32.const 268))
      (call $Widget_constructor (i32.const 268) (i32.const 3) (f64.const 3.0))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (global.get $Widget_count) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $Widget_getCount ) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (call $Widget_getTotal ) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (call $Widget_reset )
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (global.get $Box_instances) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (global.set $Box_instances (i32.const 42))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (global.get $Box_instances) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
