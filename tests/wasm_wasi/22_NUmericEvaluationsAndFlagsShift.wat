(module
  ...
  (func $testNumericEnums (export "testNumericEnums")  
    (local $userPerm i32)
    (local $targetBit i32)
    (local $hasAccess i32)
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 260))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $userPerm (i32.const 6))
    (local.set $targetBit (i32.const 4))
    (local.set $hasAccess (i32.eq (i32.and (local.get $userPerm) (local.get $targetBit)) (local.get $targetBit)))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 138) (i32.const 70))
          ...
          (i32.store8 (i32.const 143) (i32.const 76))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 20) (call $__i32_to_str (i32.const 6) (i32.const 152))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 22) (call $__i32_to_str (i32.const 7) (i32.const 154))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 139) (i32.const 32))
          (i32.store8 (i32.const 140) (i32.const 77))
          (i32.store8 (i32.const 141) (i32.const 97))
          (i32.store8 (i32.const 142) (i32.const 115))
          (i32.store8 (i32.const 143) (i32.const 107))
          (i32.store8 (i32.const 144) (i32.const 32))
          (i32.store8 (i32.const 145) (i32.const 86))
          (i32.store8 (i32.const 146) (i32.const 101))
          (i32.store8 (i32.const 147) (i32.const 114))
          ...
          (i32.store8 (i32.const 155) (i32.const 111))
          (i32.store8 (i32.const 156) (i32.const 110))
          (i32.store8 (i32.const 157) (i32.const 58))
          (i32.store8 (i32.const 158) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 27) (call $__i32_to_str (if (result i32) (local.get $hasAccess) (then (i32.const 1)) (else (i32.const 0))) (i32.const 159))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    (call $testNumericEnums )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 260) "\2d\2d\2d\20\54\65\73\74\20\31\3a\20\4e\75\6d\65\72\69\63\20\45\6e\75\6d\20\42\69\74\20\4f\70\74\69\6d\69\7a\61\74\69\6f\6e\20\2d\2d\2d\0a")
)