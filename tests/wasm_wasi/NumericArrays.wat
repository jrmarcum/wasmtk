(module
  ...
  (func $sumArray (param $arr i32) (param $len i32) (result i32)
    ...
    (block $break_0
      (loop $loop_0
        ...
        (block $cont_0
          (local.set $total (i32.add (local.get $total) (i32.load (i32.add (local.get $arr) (i32.shl (local.get $i) (i32.const 2))))))
    ...
    (local.set $nums (i32.const 260))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (local.get $nums) (i32.shl (i32.const 0) (i32.const 2)))) (i32.const 132)))
          (i32.store (i32.const 8) (i32.const 304))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (local.get $nums) (i32.shl (i32.const 4) (i32.const 2)))) (i32.const 132)))
          (i32.store (i32.const 8) (i32.const 304))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 2)
            (i32.const 128)))
    (i32.store (i32.add (i32.const 260) (i32.shl (i32.const 2) (i32.const 2))) (i32.const 99))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (local.get $nums) (i32.shl (i32.const 2) (i32.const 2)))) (i32.const 132)))
          (i32.store (i32.const 8) (i32.const 304))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (local.set $vals (i32.const 280))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (f64.load (i32.add (local.get $vals) (i32.shl (i32.const 1) (i32.const 3)))) (i32.const 132)))
          (i32.store (i32.const 8) (i32.const 304))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 260) "\0a\00\00\00\14\00\00\00\1e\00\00\00\28\00\00\00\32\00\00\00")
  (data (i32.const 280) "\00\00\00\00\00\00\f8\3f\00\00\00\00\00\00\04\40\00\00\00\00\00\00\08\40")
)