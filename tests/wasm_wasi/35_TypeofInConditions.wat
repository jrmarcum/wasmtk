(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 405))
  ...
  (func $checkAndLog (param $n i32) (param $s_ptr i32) (param $s_len i32) (param $b i32) 
    ...
    (if (i32.const 1)
      (then
          (i32.store (i32.const 0) (i32.const 306))
  ...
  (func $storeTypes (param $x i32) (param $y f64) 
    (local $tx_ptr i32)
    (local $tx_len i32)
    (local $ty_ptr i32)
    (local $ty_len i32)
    (local $__iface_tmp i32)
    (local.set $tx_ptr (i32.const 344))
      (local.set $tx_len (i32.const 6))
    (local.set $ty_ptr (i32.const 344))
      (local.set $ty_len (i32.const 6))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (call $__str_gather (local.get $tx_ptr) (local.get $tx_len) (i32.const 147))
          (i32.store (i32.const 4) (i32.add (i32.const 15) (local.get $tx_len)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 145) (i32.const 58))
          (i32.store8 (i32.const 146) (i32.const 32))
          (call $__str_gather (local.get $ty_ptr) (local.get $ty_len) (i32.const 147))
          (i32.store (i32.const 4) (i32.add (i32.const 15) (local.get $ty_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $main  
    ...
    (local.set $msg_ptr (i32.const 350))
      (local.set $msg_len (i32.const 4))
    (local.set $active (i32.const 0))
    (local.set $pi (f64.const 3.14))
        (i32.store (i32.const 0) (i32.const 354))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 361))
          (i32.store (i32.const 4) (i32.const 7))
          (drop (call $fd_write
            (i32.const 1)
            (i32.const 0)
        ...
        (i32.store (i32.const 0) (i32.const 354))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $checkAndLog (i32.const 5) (i32.const 376) (i32.const 5) (i32.const 1))
    (call $storeTypes (i32.const 7) (f64.const 2.718))
    (local.set $val (i32.const 99))
    (if (i32.const 0)
      (then
      ...
      (else
          (i32.store (i32.const 0) (i32.const 387))
  ...
  (data (i32.const 260) "\6e\20\74\79\70\65\3a\20\6e\75\6d\62\65\72\0a")
  (data (i32.const 275) "\73\20\74\79\70\65\3a\20\73\74\72\69\6e\67\0a")
  (data (i32.const 290) "\62\20\74\79\70\65\3a\20\62\6f\6f\6c\65\61\6e\0a")
  (data (i32.const 306) "\6e\20\63\6f\6e\66\69\72\6d\65\64\20\6e\75\6d\62\65\72\0a")
  (data (i32.const 325) "\73\20\63\6f\6e\66\69\72\6d\65\64\20\73\74\72\69\6e\67\0a")
  (data (i32.const 344) "\6e\75\6d\62\65\72")
  (data (i32.const 350) "\74\65\73\74")
  (data (i32.const 354) "\6e\75\6d\62\65\72\0a")
  (data (i32.const 361) "\73\74\72\69\6e\67\0a")
  (data (i32.const 368) "\62\6f\6f\6c\65\61\6e\0a")
  (data (i32.const 376) "\68\65\6c\6c\6f")
  (data (i32.const 381) "\77\72\6f\6e\67\0a")
  (data (i32.const 387) "\76\61\6c\20\69\73\20\6e\6f\74\20\73\74\72\69\6e\67\0a")
)