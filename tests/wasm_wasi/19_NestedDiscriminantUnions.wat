(module
  ...
  (func $testNestedUnions (export "testNestedUnions")  
    ...
    (;; { type: "add", value: 15 };)
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 143) (i32.const 82))
          (i32.store8 (i32.const 144) (i32.const 101))
          (i32.store8 (i32.const 145) (i32.const 115))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 19) (call $__i32_to_str (call $evaluateResult (local.get $r1) (i32.const 10)) (i32.const 151))))
    ...
    (;; { type: "mul", value: 3 };)
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 137) (i32.const 100))
          (i32.store8 (i32.const 138) (i32.const 32))
          (i32.store8 (i32.const 139) (i32.const 77))
          ...
          (i32.store8 (i32.const 149) (i32.const 58))
          (i32.store8 (i32.const 150) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 19) (call $__i32_to_str (call $evaluateResult (local.get $r2) (i32.const 10)) (i32.const 151))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (;; 404;)
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 17) (call $__i32_to_str (call $evaluateResult (local.get $r3) (i32.const 10)) (i32.const 149))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    (call $testNestedUnions )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 312) "\2d\2d\2d\20\54\65\73\74\20\32\3a\20\4e\65\73\74\65\64\20\55\6e\69\6f\6e\20\54\61\67\73\20\2d\2d\2d\0a")
  (data (i32.const 272) "\00\00\00\00\0f\00\00\00")
  (data (i32.const 260) "\00\00\00\00\10\01\00\00\00\00\00\00")
  (data (i32.const 292) "\01\00\00\00\03\00\00\00")
  (data (i32.const 280) "\00\00\00\00\24\01\00\00\00\00\00\00")
  (data (i32.const 300) "\01\00\00\00\00\00\00\00\94\01\00\00")
)