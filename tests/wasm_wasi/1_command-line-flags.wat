(module
  ...
  (func $_start (export "_start")
    ...
    (local.set $tail (i32.const 267))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 136) (i32.const 58))
          (i32.store8 (i32.const 137) (i32.const 32))
          (call $__str_gather (if (result i32) (local.get $fork) (then (i32.const 275)) (else (i32.const 279))) (if (result i32) (local.get $fork) (then (i32.const 4)) (else (i32.const 5))) (i32.const 138))
  ...
  (data (i32.const 267) "\00\00\00\00\00\00\00\00")
)