(module
    ...
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 260))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $area (call $18_MathLibrary_Modc_computeScaledArea (i32.const 10) (i32.const 4)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 49))
          (i32.store8 (i32.const 133) (i32.const 56))
          (i32.store8 (i32.const 134) (i32.const 95))
          (i32.store8 (i32.const 135) (i32.const 77))
          ...
          (i32.store8 (i32.const 146) (i32.const 95))
          ...
          (i32.store8 (i32.const 151) (i32.const 95))
          (i32.store8 (i32.const 152) (i32.const 99))
          (i32.store8 (i32.const 153) (i32.const 111))
          (i32.store8 (i32.const 154) (i32.const 109))
          (i32.store8 (i32.const 155) (i32.const 112))
          (i32.store8 (i32.const 156) (i32.const 117))
          (i32.store8 (i32.const 157) (i32.const 116))
          (i32.store8 (i32.const 158) (i32.const 101))
          (i32.store8 (i32.const 159) (i32.const 83))
          (i32.store8 (i32.const 160) (i32.const 99))
          (i32.store8 (i32.const 161) (i32.const 97))
          (i32.store8 (i32.const 162) (i32.const 108))
          (i32.store8 (i32.const 163) (i32.const 101))
          (i32.store8 (i32.const 164) (i32.const 100))
          (i32.store8 (i32.const 165) (i32.const 65))
          (i32.store8 (i32.const 166) (i32.const 114))
          (i32.store8 (i32.const 167) (i32.const 101))
          (i32.store8 (i32.const 168) (i32.const 97))
          (i32.store8 (i32.const 169) (i32.const 40))
          (i32.store8 (i32.const 170) (i32.const 49))
          (i32.store8 (i32.const 171) (i32.const 48))
          (i32.store8 (i32.const 172) (i32.const 44))
          (i32.store8 (i32.const 173) (i32.const 32))
          (i32.store8 (i32.const 174) (i32.const 52))
          (i32.store8 (i32.const 175) (i32.const 41))
          (i32.store8 (i32.const 176) (i32.const 58))
          (i32.store8 (i32.const 177) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 46) (call $__i32_to_str (local.get $area) (i32.const 178))))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $18_MathLibrary_Modc_logLibraryVersion )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 260) "\2d\2d\2d\20\50\68\61\73\65\20\31\38\3a\20\57\41\53\4d\20\49\6d\70\6f\72\74\20\4d\65\72\67\65\20\2d\2d\2d\0a")
  ...
  (func $18_MathLibrary_Modc_logLibraryVersion
    ...
    call $fd_write
    drop)
  ;; data from 18_MathLibrary_Modc
  (data (;0;) (i32.const 556) "Library Version: v1.8.0-core\0a")
)