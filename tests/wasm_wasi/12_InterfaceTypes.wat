(module
  ...
  (func $getScores (export "getScores")  (result i32)
    ...
    (local.set $__arr_ret (call $__malloc (i32.const 40)))
      ...
      (i32.store offset=8 (local.get $__arr_ret) (i32.const 95))
      (i32.store offset=12 (local.get $__arr_ret) (i32.const 88))
      (i32.store offset=16 (local.get $__arr_ret) (i32.const 72))
  ...
  (func $_start (export "_start")
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 135) (i32.const 83))
