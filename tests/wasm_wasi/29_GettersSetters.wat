(module
  ...
  (func $Temperature_constructor (param $__self i32) (param $c f64) 
    (f64.store (i32.add (local.get $__self) (i32.const 0)) (local.get $c))
  )

  (func $Temperature_get_celsius (param $__self i32) (result f64)
    (return (f64.load (i32.add (local.get $__self) (i32.const 0))))
  )

  (func $Temperature_set_celsius (param $__self i32) (param $c f64) 
    (f64.store (i32.add (local.get $__self) (i32.const 0)) (local.get $c))
  )

  (func $Temperature_get_fahrenheit (param $__self i32) (result f64)
    (return (f64.add (f64.mul (f64.load (i32.add (local.get $__self) (i32.const 0))) (f64.const 1.8)) (f64.const 32.0)))
  )

  (func $Counter_constructor (param $__self i32) (param $max i32) 
    (i32.store (i32.add (local.get $__self) (i32.const 0)) (i32.const 0))
    (i32.store (i32.add (local.get $__self) (i32.const 4)) (local.get $max))
  )

  (func $Counter_get_value (param $__self i32) (result i32)
    (return (i32.load (i32.add (local.get $__self) (i32.const 0))))
  )

  (func $Counter_set_value (param $__self i32) (param $v i32) 
    (if (i32.gt_s (local.get $v) (i32.load (i32.add (local.get $__self) (i32.const 4))))
      (then
      (i32.store (i32.add (local.get $__self) (i32.const 0)) (i32.load (i32.add (local.get $__self) (i32.const 4))))
      )
      (else
      (i32.store (i32.add (local.get $__self) (i32.const 0)) (local.get $v))
      )
    )
  )

  (func $Counter_get_max (param $__self i32) (result i32)
  ...
  (func $main  
    ...
    (local.set $t (i32.const 260))
      (call $Temperature_constructor (i32.const 260) (f64.const 100.0))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (call $Temperature_get_celsius (i32.const 260)) (i32.const 132)))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (call $Temperature_get_fahrenheit (i32.const 260)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $Temperature_set_celsius (i32.const 260) (f64.const 0.0))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (call $Temperature_get_celsius (i32.const 260)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $Temperature_set_celsius (i32.const 260) (f64.const 20.0))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (call $Temperature_get_celsius (i32.const 260)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
    ...
    (local.set $c (i32.const 268))
      (call $Counter_constructor (i32.const 268) (i32.const 10))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $Counter_get_value (i32.const 268)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $Counter_get_max (i32.const 268)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $Counter_set_value (i32.const 268) (i32.const 5))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $Counter_get_value (i32.const 268)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $Counter_set_value (i32.const 268) (i32.const 20))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $Counter_get_value (i32.const 268)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $Counter_set_value (i32.const 268) (i32.const 3))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $Counter_get_value (i32.const 268)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
