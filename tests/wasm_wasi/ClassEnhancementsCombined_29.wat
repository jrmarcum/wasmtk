(module
  ...
  (global $Circle_count (mut i32) (i32.const 0))
  (global $Square_count (mut i32) (i32.const 0))
  ...
  (func $Circle_constructor (param $__self i32) (param $r f64) 
    (f64.store (i32.add (local.get $__self) (i32.const 0)) (local.get $r))
    (global.set $Circle_count (i32.add (global.get $Circle_count) (i32.const 1)))
  )

  (func $Circle_get_radius (param $__self i32) (result f64)
    (return (f64.load (i32.add (local.get $__self) (i32.const 0))))
  )

  (func $Circle_set_radius (param $__self i32) (param $r f64) 
    (f64.store (i32.add (local.get $__self) (i32.const 0)) (local.get $r))
  )

  (func $Circle_get_area (param $__self i32) (result f64)
    (return (f64.mul (f64.mul (f64.load (i32.add (local.get $__self) (i32.const 0))) (f64.load (i32.add (local.get $__self) (i32.const 0)))) (f64.const 3.14159265)))
  )

  (func $Circle_getCount  (result i32)
    (return (global.get $Circle_count))
  )

  (func $Square_constructor (param $__self i32) (param $s f64) 
    (f64.store (i32.add (local.get $__self) (i32.const 0)) (local.get $s))
    (global.set $Square_count (i32.add (global.get $Square_count) (i32.const 1)))
  )

  (func $Square_get_side (param $__self i32) (result f64)
    (return (f64.load (i32.add (local.get $__self) (i32.const 0))))
  )

  (func $Square_set_side (param $__self i32) (param $s f64) 
    (f64.store (i32.add (local.get $__self) (i32.const 0)) (local.get $s))
  )

  (func $Square_get_area (param $__self i32) (result f64)
    (return (f64.mul (f64.load (i32.add (local.get $__self) (i32.const 0))) (f64.load (i32.add (local.get $__self) (i32.const 0)))))
  )

  (func $Square_get_perimeter (param $__self i32) (result f64)
    (return (f64.mul (f64.load (i32.add (local.get $__self) (i32.const 0))) (f64.const 4.0)))
  )

  (func $Square_getCount  (result i32)
    (return (global.get $Square_count))
  )

  (func $main  
    (local $shapeType_ptr i32)
    (local $shapeType_len i32)
    (local $c1 i32)
    (local $c2 i32)
    (local $sq1 i32)
    (local $__iface_tmp i32)
        ...
        (i32.store (i32.const 0) (i32.const 291))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $shapeType_ptr (i32.const 298))
      (local.set $shapeType_len (i32.const 8))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (local.get $shapeType_ptr) (local.get $shapeType_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $shapeType_len)))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (global.get $Circle_count) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (global.get $Square_count) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $c1 (i32.const 260))
      (call $Circle_constructor (i32.const 260) (f64.const 5.0))
    (local.set $c2 (i32.const 268))
      (call $Circle_constructor (i32.const 268) (f64.const 3.0))
    (local.set $sq1 (i32.const 276))
      (call $Square_constructor (i32.const 276) (f64.const 4.0))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (global.get $Circle_count) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $Circle_getCount ) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $Square_getCount ) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (call $Circle_get_radius (i32.const 260)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (call $Square_get_side (i32.const 276)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (call $Square_get_perimeter (i32.const 276)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $Circle_set_radius (i32.const 260) (f64.const 10.0))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (call $Circle_get_radius (i32.const 260)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $Square_set_side (i32.const 276) (f64.const 6.0))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (call $Square_get_side (i32.const 276)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (call $Square_get_area (i32.const 276)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 284) "\63\69\72\63\6c\65\0a")
  (data (i32.const 291) "\73\71\75\61\72\65\0a")
  (data (i32.const 298) "\74\72\69\61\6e\67\6c\65")
  (data (i32.const 260) "\00\00\00\00\00\00\00\00")
  (data (i32.const 268) "\00\00\00\00\00\00\00\00")
  (data (i32.const 276) "\00\00\00\00\00\00\00\00")
)