(module
  ...
  (func $sumTwo (param $a i32) (param $b i32) (result i32)
    (local $__iface_tmp i32)
    (return (i32.add (call $Box_unwrap (local.get $a) ) (call $Box_unwrap (local.get $b) )))
  )

  (func $maxTwo (param $a i32) (param $b i32) (result i32)
    (local $__iface_tmp i32)
    (return (if (result i32) (i32.gt_s (call $Box_unwrap (local.get $a) ) (call $Box_unwrap (local.get $b) )) (then (call $Box_unwrap (local.get $a) )) (else (call $Box_unwrap (local.get $b) ))))
  )
  (func $_start (export "_start")
    ...
    (local.set $q (i32.const 264))
      (call $Box_constructor (i32.const 264) (i32.const 4))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $sumTwo (local.get $p) (local.get $q)) (i32.const 132)))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $maxTwo (local.get $p) (local.get $q)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.add (i32.add (call $Box_unwrap (i32.const 260) ) (call $Box_unwrap (i32.const 264) )) (i32.const 10)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (if (result i32) (i32.eq (call $Box_unwrap (i32.const 260) ) (call $Box_unwrap (i32.const 264) )) (then (i32.const 1)) (else (i32.const 0))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
