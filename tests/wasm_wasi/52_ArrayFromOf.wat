(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 345))
  ...
  (func $_start (export "_start")
    ...
    (local.set $a (i32.const 260))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 133) (i32.const 46))
          ...
          (i32.store8 (i32.const 139) (i32.const 104))
          (i32.store8 (i32.const 140) (i32.const 58))
          (i32.store8 (i32.const 141) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 10) (call $__i32_to_str (i32.const 3) (i32.const 142))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 97))
          (i32.store8 (i32.const 133) (i32.const 91))
          (i32.store8 (i32.const 134) (i32.const 48))
          (i32.store8 (i32.const 135) (i32.const 93))
          (i32.store8 (i32.const 136) (i32.const 58))
          (i32.store8 (i32.const 137) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 6) (call $__i32_to_str (i32.load (i32.add (i32.add (i32.const 260) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 2)))) (i32.const 138))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 136) (i32.const 58))
          (i32.store8 (i32.const 137) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 6) (call $__i32_to_str (i32.load (i32.add (i32.add (i32.const 260) (i32.const 8)) (i32.shl (i32.const 2) (i32.const 2)))) (i32.const 138))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (local.set $b (i32.const 280))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 140) (i32.const 58))
          (i32.store8 (i32.const 141) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 10) (call $__i32_to_str (i32.const 4) (i32.const 142))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 132) (i32.const 98))
          (i32.store8 (i32.const 133) (i32.const 91))
          (i32.store8 (i32.const 134) (i32.const 49))
          (i32.store8 (i32.const 135) (i32.const 93))
          (i32.store8 (i32.const 136) (i32.const 58))
          (i32.store8 (i32.const 137) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 6) (call $__i32_to_str (i32.load (i32.add (i32.add (i32.const 280) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 2)))) (i32.const 138))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (local.set $c (i32.const 304))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 7) (call $__f64_to_str (f64.add (f64.load (i32.add (i32.add (i32.const 304) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 3)))) (f64.load (i32.add (i32.add (i32.const 304) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 3))))) (i32.const 139))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (local.set $e (i32.const 328))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 140) (i32.const 58))
          (i32.store8 (i32.const 141) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 10) (call $__i32_to_str (i32.const 0) (i32.const 142))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $isArr (i32.const 1))
    (local.set $isArr2 (i32.const 1))
    (local.set $notArr (i32.const 0))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 105))
          (i32.store8 (i32.const 133) (i32.const 115))
          (i32.store8 (i32.const 134) (i32.const 65))
          (i32.store8 (i32.const 135) (i32.const 114))
          (i32.store8 (i32.const 136) (i32.const 114))
          (i32.store8 (i32.const 137) (i32.const 58))
          (i32.store8 (i32.const 138) (i32.const 32))
          (call $__str_gather (if (result i32) (local.get $isArr) (then (i32.const 336)) (else (i32.const 340))) (if (result i32) (local.get $isArr) (then (i32.const 4)) (else (i32.const 5))) (i32.const 139))
          (i32.store (i32.const 4) (i32.add (i32.const 7) (if (result i32) (local.get $isArr) (then (i32.const 4)) (else (i32.const 5)))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (call $__str_gather (if (result i32) (local.get $isArr2) (then (i32.const 336)) (else (i32.const 340))) (if (result i32) (local.get $isArr2) (then (i32.const 4)) (else (i32.const 5))) (i32.const 140))
          (i32.store (i32.const 4) (i32.add (i32.const 8) (if (result i32) (local.get $isArr2) (then (i32.const 4)) (else (i32.const 5)))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 135) (i32.const 65))
          (i32.store8 (i32.const 136) (i32.const 114))
          (i32.store8 (i32.const 137) (i32.const 114))
          (i32.store8 (i32.const 138) (i32.const 58))
          (i32.store8 (i32.const 139) (i32.const 32))
          (call $__str_gather (if (result i32) (local.get $notArr) (then (i32.const 336)) (else (i32.const 340))) (if (result i32) (local.get $notArr) (then (i32.const 4)) (else (i32.const 5))) (i32.const 140))
          (i32.store (i32.const 4) (i32.add (i32.const 8) (if (result i32) (local.get $notArr) (then (i32.const 4)) (else (i32.const 5)))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 336) "\74\72\75\65")
  (data (i32.const 340) "\66\61\6c\73\65")
  (data (i32.const 260) "\03\00\00\00\03\00\00\00\01\00\00\00\02\00\00\00\03\00\00\00")
  (data (i32.const 280) "\04\00\00\00\04\00\00\00\0a\00\00\00\14\00\00\00\1e\00\00\00\28\00\00\00")
  (data (i32.const 304) "\02\00\00\00\02\00\00\00\00\00\00\00\00\00\f8\3f\00\00\00\00\00\00\04\40")
