(module
  ...
  (func $shift (param $base i32) (param $dx i32) (param $dy i32) (result i32)
    (local $moved i32)
    (local $__rt_struct_ptr i32)
    (local.set $moved (block (result i32)
        (local.set $__rt_struct_ptr (call $__malloc (i32.const 8)))
        (i32.store offset=0 (local.get $__rt_struct_ptr) (i32.add (i32.load (i32.add (local.get $base) (i32.const 0))) (local.get $dx)))
        (i32.store offset=4 (local.get $__rt_struct_ptr) (i32.add (i32.load (i32.add (local.get $base) (i32.const 4))) (local.get $dy)))
        (local.get $__rt_struct_ptr)
      ))
    (return (i32.add (i32.load (i32.add (local.get $moved) (i32.const 0))) (i32.load (i32.add (local.get $moved) (i32.const 4)))))
  )
  (func $_start (export "_start")
    ...
    (local.set $p1 (i32.const 260))
    (local.set $p2 (block (result i32)
        (local.set $__rt_struct_ptr (call $__malloc (i32.const 8)))
        (i32.store offset=0 (local.get $__rt_struct_ptr) (i32.const 99))
        (i32.store offset=4 (local.get $__rt_struct_ptr) (i32.load offset=4 (local.get $p1)))
        (local.get $__rt_struct_ptr)
      ))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 134) (i32.const 46))
          (i32.store8 (i32.const 135) (i32.const 120))
          (i32.store8 (i32.const 136) (i32.const 58))
          (i32.store8 (i32.const 137) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 6) (call $__i32_to_str (i32.load (i32.add (i32.const 260) (i32.const 0))) (i32.const 138))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 136) (i32.const 58))
          (i32.store8 (i32.const 137) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 6) (call $__i32_to_str (i32.load (i32.add (i32.const 260) (i32.const 4))) (i32.const 138))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 136) (i32.const 58))
          (i32.store8 (i32.const 137) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 6) (call $__i32_to_str (i32.load (i32.add (local.get $p2) (i32.const 0))) (i32.const 138))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 136) (i32.const 58))
          (i32.store8 (i32.const 137) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 6) (call $__i32_to_str (i32.load (i32.add (local.get $p2) (i32.const 4))) (i32.const 138))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $p3 (block (result i32)
        (local.set $__rt_struct_ptr (call $__malloc (i32.const 8)))
        (i32.store offset=0 (local.get $__rt_struct_ptr) (global.get $nx))
        (i32.store offset=4 (local.get $__rt_struct_ptr) (i32.load offset=4 (local.get $p1)))
        (local.get $__rt_struct_ptr)
      ))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 136) (i32.const 58))
          (i32.store8 (i32.const 137) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 6) (call $__i32_to_str (i32.load (i32.add (local.get $p3) (i32.const 0))) (i32.const 138))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 136) (i32.const 58))
          (i32.store8 (i32.const 137) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 6) (call $__i32_to_str (i32.load (i32.add (local.get $p3) (i32.const 4))) (i32.const 138))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $p4 (block (result i32)
        (local.set $__rt_struct_ptr (call $__malloc (i32.const 8)))
        (i32.store offset=0 (local.get $__rt_struct_ptr) (i32.load offset=0 (local.get $p2)))
        (i32.store offset=4 (local.get $__rt_struct_ptr) (i32.load offset=4 (local.get $p2)))
        (local.get $__rt_struct_ptr)
      ))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 112))
          (i32.store8 (i32.const 133) (i32.const 52))
          (i32.store8 (i32.const 134) (i32.const 46))
          (i32.store8 (i32.const 135) (i32.const 120))
          (i32.store8 (i32.const 136) (i32.const 58))
          (i32.store8 (i32.const 137) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 6) (call $__i32_to_str (i32.load (i32.add (local.get $p4) (i32.const 0))) (i32.const 138))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 136) (i32.const 58))
          (i32.store8 (i32.const 137) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 6) (call $__i32_to_str (i32.load (i32.add (local.get $p4) (i32.const 4))) (i32.const 138))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $b1 (i32.const 268))
    (local.set $b2 (block (result i32)
        (local.set $__rt_struct_ptr (call $__malloc (i32.const 20)))
        (f64.store offset=0 (local.get $__rt_struct_ptr) (f64.load offset=0 (local.get $b1)))
        (f64.store offset=8 (local.get $__rt_struct_ptr) (f64.const 9.5))
        (i32.store offset=16 (local.get $__rt_struct_ptr) (i32.load offset=16 (local.get $b1)))
        (local.get $__rt_struct_ptr)
      ))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store8 (i32.const 136) (i32.const 58))
          (i32.store8 (i32.const 137) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 6) (call $__f64_to_str (f64.load (i32.add (local.get $b2) (i32.const 0))) (i32.const 138))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 136) (i32.const 58))
          (i32.store8 (i32.const 137) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 6) (call $__f64_to_str (f64.load (i32.add (local.get $b2) (i32.const 8))) (i32.const 138))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 10) (call $__i32_to_str (i32.load (i32.add (local.get $b2) (i32.const 16))) (i32.const 142))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 7) (call $__i32_to_str (call $shift (local.get $p1) (i32.const 5) (i32.const 3)) (i32.const 139))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $b3 (block (result i32)
        (local.set $__rt_struct_ptr (call $__malloc (i32.const 20)))
        (f64.store offset=0 (local.get $__rt_struct_ptr) (f64.load offset=0 (local.get $b2)))
        (f64.store offset=8 (local.get $__rt_struct_ptr) (f64.load offset=8 (local.get $b2)))
        (i32.store offset=16 (local.get $__rt_struct_ptr) (i32.const 100))
        (local.get $__rt_struct_ptr)
      ))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store8 (i32.const 136) (i32.const 58))
          (i32.store8 (i32.const 137) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 6) (call $__f64_to_str (f64.load (i32.add (local.get $b3) (i32.const 0))) (i32.const 138))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 136) (i32.const 58))
          (i32.store8 (i32.const 137) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 6) (call $__f64_to_str (f64.load (i32.add (local.get $b3) (i32.const 8))) (i32.const 138))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 140) (i32.const 58))
          (i32.store8 (i32.const 141) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 10) (call $__i32_to_str (i32.load (i32.add (local.get $b3) (i32.const 16))) (i32.const 142))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 260) "\0a\00\00\00\14\00\00\00")
  (data (i32.const 268) "\00\00\00\00\00\00\0c\40\00\00\00\00\00\00\10\40\07\00\00\00")
)