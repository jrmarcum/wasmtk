(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 283))
  ...
  (func $baseDescribe (param $b i32) 
    ...
    (local.set $__ret_str_ptr (i32.const 260))
      (local.set $__ret_str_len (i32.const 14))
      (local.set $__tmpl_num_ptr (call $__malloc (i32.const 32)))
      (local.set $__tmpl_num_len (call $__f64_to_str (f64.load (i32.add (local.get $b) (i32.const 0))) (local.get $__tmpl_num_ptr)))
      (call $__str_concat (local.get $__ret_str_ptr) (local.get $__ret_str_len) (local.get $__tmpl_num_ptr) (local.get $__tmpl_num_len))
  ...
  (func $newContainer (param $num f64) (param $str_ptr i32) (param $str_len i32) (result i32)
    ...
    (local.set $__obj_ret (call $__malloc (i32.const 16)))
      (local.set $__nested_ptr (call $__malloc (i32.const 8)))
      (f64.store offset=0 (local.get $__nested_ptr) (local.get $num))
      (i32.store offset=0 (local.get $__obj_ret) (local.get $__nested_ptr))
  ...
  (func $containerDescribe (param $co i32) 
    (local $__ret_str_ptr i32)
    (local $__ret_str_len i32)
    (call $baseDescribe (i32.load (i32.add (local.get $co) (i32.const 0))))
(local.set $__ret_str_ptr (global.get $__str_ret_ptr))
  ...
  (func $__anon_0 (param $co i32) 
    (local $__ret_str_ptr i32)
    (local $__ret_str_len i32)
    (call $containerDescribe (local.get $co))
(local.set $__ret_str_ptr (global.get $__str_ret_ptr))
      (local.set $__ret_str_len (global.get $__str_ret_len))
      (global.set $__str_ret_ptr (local.get $__ret_str_ptr))
      (global.set $__str_ret_len (local.get $__ret_str_len))
  ...
  (func $_start (export "_start")
    ...
    (local $__tmpl_num_ptr i32)
    (local $__tmpl_num_len i32)
    (local.set $co (call $newContainer (f64.const 1) (i32.const 274) (i32.const 9)))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 135) (i32.const 123))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 9) (call $__f64_to_str (f64.load (i32.add (i32.load (i32.add (local.get $co) (i32.const 0))) (i32.const 0))) (i32.const 141))))
          ...
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 4))) (i32.const 114))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 10) (call $__f64_to_str (f64.load (i32.add (i32.load (i32.add (local.get $co) (i32.const 0))) (i32.const 0))) (i32.const 142))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 141) (i32.const 32))
          (call $containerDescribe (local.get $co))
          (call $__str_gather (global.get $__str_ret_ptr) (global.get $__str_ret_len) (i32.const 142))
          (i32.store (i32.const 4) (i32.add (i32.const 10) (global.get $__str_ret_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $descFn (call $__anon_0__factory (local.get $co)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 100))
          (i32.store8 (i32.const 133) (i32.const 101))
          ...
          (call_indirect (type $ftype_i32_r_void) (local.get $descFn) (i32.load (local.get $descFn)))
          (call $__str_gather (global.get $__str_ret_ptr) (global.get $__str_ret_len) (i32.const 143))
          (i32.store (i32.const 4) (i32.add (i32.const 11) (global.get $__str_ret_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
