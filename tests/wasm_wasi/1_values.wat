(module
  ...
  (func $_start (export "_start")
    ...
    (local $__concat_self_len i32)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 133) (i32.const 43))
          (i32.store8 (i32.const 134) (i32.const 49))
          (i32.store8 (i32.const 135) (i32.const 32))
          (i32.store8 (i32.const 136) (i32.const 61))
          (i32.store8 (i32.const 137) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 6) (call $__f64_to_str (f64.add (f64.const 1) (f64.const 1)) (i32.const 138))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 55))
          (i32.store8 (i32.const 133) (i32.const 46))
          (i32.store8 (i32.const 134) (i32.const 48))
          (i32.store8 (i32.const 135) (i32.const 47))
          (i32.store8 (i32.const 136) (i32.const 51))
          (i32.store8 (i32.const 137) (i32.const 46))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 10) (call $__f64_to_str (f64.div (f64.const 7.0) (f64.const 3.0)) (i32.const 142))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
        (i32.store (i32.const 0) (if (result i32) (if (result i32) (i32.const 1) (then (i32.const 0)) (else (i32.const 0))) (then (i32.const 267)) (else (i32.const 271))))
          ...
          (i32.store (i32.const 8) (i32.const 276))
          ...
          (drop (call $fd_write
            ...
            (i32.const 2)
            (i32.const 128)))
        (i32.store (i32.const 0) (if (result i32) (if (result i32) (i32.const 1) (then (i32.const 1)) (else (i32.const 0))) (then (i32.const 267)) (else (i32.const 271))))
          ...
          (drop (call $fd_write
            ...
            (i32.const 2)
            (i32.const 128)))
        (i32.store (i32.const 0) (if (result i32) (i32.eqz (i32.const 1)) (then (i32.const 267)) (else (i32.const 271))))
          (i32.store (i32.const 4) (if (result i32) (i32.eqz (i32.const 1)) (then (i32.const 4)) (else (i32.const 5))))
          (i32.store (i32.const 8) (i32.const 276))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 260) "\67\6f\6c\61\6e\67\0a")
  (data (i32.const 267) "\74\72\75\65")
  (data (i32.const 271) "\66\61\6c\73\65")
  (data (i32.const 276) "\0a")
)