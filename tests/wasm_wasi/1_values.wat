(module
    ...
    (local $__iface_tmp i32)
        ...
        (i32.store (i32.const 0) (if (result i32) (i32.or (i32.const 1) (i32.const 0)) (then (i32.const 272)) (else (i32.const 276))))
          ...
          (drop (call $fd_write
            ...
            (i32.const 2)
            (i32.const 128)))
        (i32.store (i32.const 0) (if (result i32) (i32.eqz (i32.const 1)) (then (i32.const 272)) (else (i32.const 276))))
  ...
  (data (i32.const 260) "\67\6f\22\20\2b\20\22\6c\61\6e\67\0a")
  (data (i32.const 272) "\74\72\75\65")
  (data (i32.const 276) "\66\61\6c\73\65")
  (data (i32.const 281) "\0a")
)