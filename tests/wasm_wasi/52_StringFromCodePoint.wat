(module
  ...
  (func $_start (export "_start")
    ...
    (local $bc_ptr i32)
    (local $bc_len i32)
    (local $accent_ptr i32)
    (local $accent_len i32)
    (local $euro_ptr i32)
    (local $euro_len i32)
    (local $smile_ptr i32)
    (local $smile_len i32)
    ...
    (local.set $a_ptr (i32.const 260))
      (local.set $a_len (i32.const 1))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (call $__str_gather (local.get $a_ptr) (local.get $a_len) (i32.const 135))
          (i32.store (i32.const 4) (i32.add (i32.const 3) (local.get $a_len)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 10) (call $__i32_to_str (local.get $a_len) (i32.const 142))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $bc_ptr (i32.const 261))
      (local.set $bc_len (i32.const 2))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (call $__str_gather (local.get $bc_ptr) (local.get $bc_len) (i32.const 136))
          (i32.store (i32.const 4) (i32.add (i32.const 4) (local.get $bc_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $accent_ptr (i32.const 263))
      (local.set $accent_len (i32.const 2))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 97))
          (i32.store8 (i32.const 133) (i32.const 99))
          ...
          (call $__str_gather (local.get $accent_ptr) (local.get $accent_len) (i32.const 140))
          (i32.store (i32.const 4) (i32.add (i32.const 8) (local.get $accent_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $euro_ptr (i32.const 265))
      (local.set $euro_len (i32.const 3))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (call $__str_gather (local.get $euro_ptr) (local.get $euro_len) (i32.const 138))
          (i32.store (i32.const 4) (i32.add (i32.const 6) (local.get $euro_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $smile_ptr (i32.const 268))
      (local.set $smile_len (i32.const 4))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (call $__str_gather (local.get $smile_ptr) (local.get $smile_len) (i32.const 139))
          (i32.store (i32.const 4) (i32.add (i32.const 7) (local.get $smile_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $__str_from_codepoint (global.get $code))
      (local.set $r_len)
      (local.set $r_ptr)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store8 (i32.const 133) (i32.const 58))
          (i32.store8 (i32.const 134) (i32.const 32))
          (call $__str_gather (local.get $r_ptr) (local.get $r_len) (i32.const 135))
          (i32.store (i32.const 4) (i32.add (i32.const 3) (local.get $r_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $word_ptr (i32.const 272))
      (local.set $word_len (i32.const 1))
      (call $__str_concat (local.get $word_ptr) (local.get $word_len) (i32.const 273) (i32.const 1))
      (local.set $word_len)
      (local.set $word_ptr)
      (call $__str_concat (local.get $word_ptr) (local.get $word_len) (i32.const 274) (i32.const 1))
      (local.set $word_len)
      (local.set $word_ptr)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
  ...
  (data (i32.const 261) "\42\43")
  (data (i32.const 263) "\c3\a9")
  (data (i32.const 265) "\e2\82\ac")
  (data (i32.const 268) "\f0\9f\98\80")
  (data (i32.const 272) "\78")
  (data (i32.const 273) "\59")
  (data (i32.const 274) "\7a")
)