(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 278))
  ...
  (func $doIncrement (param $c i32) (param $name_ptr i32) (param $name_len i32) (param $n f64) 
    (local $i f64)
    (local.set $i (f64.const 0))
    (block $break_0
      (loop $loop_0
        (br_if $break_0 (i32.eqz (f64.lt (local.get $i) (local.get $n))))
        (block $cont_0
  ...
  (func $_start (export "_start")
    ...
    (local.set $c (i32.const 261))
    (call $doIncrement (local.get $c) (i32.const 260) (i32.const 1) (f64.const 10000))
    (call $doIncrement (local.get $c) (i32.const 260) (i32.const 1) (f64.const 10000))
    (call $doIncrement (local.get $c) (i32.const 277) (i32.const 1) (f64.const 10000))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 135) (i32.const 91))
          (i32.store8 (i32.const 136) (i32.const 97))
          (i32.store8 (i32.const 137) (i32.const 58))
          (i32.store (i32.const 4) (i32.add (i32.const 6) (call $__f64_to_str (f64.load (i32.add (i32.const 261) (i32.const 0))) (i32.const 138))))
          ...
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (call $__f64_to_str (f64.load (i32.add (i32.const 261) (i32.const 8))) (i32.add (i32.const 132) (i32.load (i32.const 4))))))
  ...
  (data (i32.const 277) "\62")
  (data (i32.const 261) "\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
)