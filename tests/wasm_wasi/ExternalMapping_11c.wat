(module
  ...
  (func $LoggerProvider_log (param $_msgPtr i32) 
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (local.get $_msgPtr) (i32.const 132)))
  ...
  (func $testExternalCall (export "testExternalCall") (param $msgPtr i32) 
    (call $LoggerProvider_log (local.get $msgPtr))
  )
  (func $_start (export "_start")
    (call $testExternalCall (i32.const 10))
