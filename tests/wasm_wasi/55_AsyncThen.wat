(module
  ...
  (func $__drain_microtasks
    ...
    (block $done
      (loop $L
        ...
        (br $L))))
  (func $__then_tramp_0 (param $src i32) (param $result i32)
    (call $onR (i32.load offset=16 (local.get $src)))
    (i32.store (local.get $result) (i32.const 1)))
  (func $__then_tramp_1 (param $src i32) (param $result i32)
    (call $onR (i32.load offset=16 (local.get $src)))
    (i32.store (local.get $result) (i32.const 1)))
  (func $__then_tramp_2 (param $src i32) (param $result i32)
    (i32.store offset=16 (local.get $result) (call $triple (i32.load offset=16 (local.get $src))))
    (i32.store (local.get $result) (i32.const 1)))
  (func $__then_tramp_3 (param $src i32) (param $result i32)
    (i32.store offset=16 (local.get $result) (call $addTen (i32.load offset=16 (local.get $src))))
    (i32.store (local.get $result) (i32.const 1)))
  (func $__then_tramp_4 (param $src i32) (param $result i32)
    (i32.store offset=16 (local.get $result) (call $triple (i32.load offset=16 (local.get $src))))
    (i32.store (local.get $result) (i32.const 1)))
  (func $__then_tramp_5 (param $src i32) (param $result i32)
  ...
  (func $main  
    ...
    (local $z f64)
    (local $__iface_tmp i32)
    (drop (call $__promise_then (call $__promise_resolve_i32 (i32.const 10)) (i32.const 0)))
    (drop (call $__promise_then (call $__promise_resolve_i32 (i32.const 20)) (i32.const 1)))
        (i32.store (i32.const 0) (i32.const 260))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $x (call $__promise_await_i32 (call $__promise_then (call $__promise_resolve_i32 (i32.const 5)) (i32.const 2))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $y (call $__promise_await_i32 (call $__promise_then (call $__promise_then (call $__promise_resolve_i32 (i32.const 2)) (i32.const 4)) (i32.const 3))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $z (call $__promise_await_f64 (call $__promise_then (call $__promise_resolve_f64 (f64.const 9.0)) (i32.const 5))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
