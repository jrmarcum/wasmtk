(module
  ...
  (func $__then_tramp_0 (param $env i32) (param $src i32) (param $result i32)
    (if (i32.eqz (i32.load offset=8 (local.get $src)))
      (then
    (call $onR (i32.load offset=16 (local.get $src)))
  ...
  (func $__then_tramp_2 (param $env i32) (param $src i32) (param $result i32)
    (if (i32.eqz (i32.load offset=8 (local.get $src)))
      (then
    (i32.store offset=16 (local.get $result) (call $triple (i32.load offset=16 (local.get $src))))
    (i32.store (local.get $result) (i32.const 1)))
      (else
    (i32.store (local.get $result) (i32.load (local.get $src)))
    (i32.store offset=4 (local.get $result) (i32.load offset=4 (local.get $src)))
    ...
    (i64.store offset=16 (local.get $result) (i64.load offset=16 (local.get $src)))
    (i32.store offset=24 (local.get $result) (i32.load offset=24 (local.get $src))))))
  (func $__then_tramp_3 (param $env i32) (param $src i32) (param $result i32)
    (if (i32.eqz (i32.load offset=8 (local.get $src)))
      (then
    (i32.store offset=16 (local.get $result) (call $addTen (i32.load offset=16 (local.get $src))))
    (i32.store (local.get $result) (i32.const 1)))
      (else
    (i32.store (local.get $result) (i32.load (local.get $src)))
    (i32.store offset=4 (local.get $result) (i32.load offset=4 (local.get $src)))
    ...
    (i64.store offset=16 (local.get $result) (i64.load offset=16 (local.get $src)))
    (i32.store offset=24 (local.get $result) (i32.load offset=24 (local.get $src))))))
  (func $__then_tramp_4 (param $env i32) (param $src i32) (param $result i32)
    (if (i32.eqz (i32.load offset=8 (local.get $src)))
      (then
    (i32.store offset=16 (local.get $result) (call $triple (i32.load offset=16 (local.get $src))))
    (i32.store (local.get $result) (i32.const 1)))
    ...
    (i64.store offset=16 (local.get $result) (i64.load offset=16 (local.get $src)))
    (i32.store offset=24 (local.get $result) (i32.load offset=24 (local.get $src))))))
  (func $__then_tramp_5 (param $env i32) (param $src i32) (param $result i32)
    (if (i32.eqz (i32.load offset=8 (local.get $src)))
      (then
    (f64.store offset=16 (local.get $result) (call $halve (f64.load offset=16 (local.get $src))))
  ...
  (func $triple (param $v i32) (result i32)
    (return (i32.mul (local.get $v) (i32.const 3)))
  )

  (func $addTen (param $v i32) (result i32)
    (return (i32.add (local.get $v) (i32.const 10)))
  )

  (func $onR (param $v i32) 
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 5) (call $__i32_to_str (local.get $v) (i32.const 137))))
  ...
  (func $halve (param $v f64) (result f64)
    (return (f64.div (local.get $v) (f64.const 2.0)))
  )
  ...
  (func $main  
    ...
    (local $z f64)
    (local $__iface_tmp i32)
    (drop (call $__promise_then (call $__promise_resolve_i32 (i32.const 10)) (i32.const 0) (i32.const 0)))
    (drop (call $__promise_then (call $__promise_resolve_i32 (i32.const 20)) (i32.const 1) (i32.const 0)))
        (i32.store (i32.const 0) (i32.const 260))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $x (call $__promise_await_i32 (call $__promise_then (call $__promise_resolve_i32 (i32.const 5)) (i32.const 2) (i32.const 0))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 120))
          (i32.store8 (i32.const 133) (i32.const 58))
          (i32.store8 (i32.const 134) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 3) (call $__i32_to_str (local.get $x) (i32.const 135))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $y (call $__promise_await_i32 (call $__promise_then (call $__promise_then (call $__promise_resolve_i32 (i32.const 2)) (i32.const 4) (i32.const 0)) (i32.const 3) (i32.const 0))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 121))
          (i32.store8 (i32.const 133) (i32.const 58))
          (i32.store8 (i32.const 134) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 3) (call $__i32_to_str (local.get $y) (i32.const 135))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $z (call $__promise_await_f64 (call $__promise_then (call $__promise_resolve_f64 (f64.const 9.0)) (i32.const 5) (i32.const 0))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 122))
          (i32.store8 (i32.const 133) (i32.const 58))
          (i32.store8 (i32.const 134) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 3) (call $__f64_to_str (local.get $z) (i32.const 135))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (table 6 funcref)
  (elem (i32.const 0) $__then_tramp_0 $__then_tramp_1 $__then_tramp_2 $__then_tramp_3 $__then_tramp_4 $__then_tramp_5)
  (data (i32.const 260) "\73\79\6e\63\0a")
)