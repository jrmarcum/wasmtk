(module
  ...
  (func $Box_constructor (param $__self i32) (param $x i32) 
    (i32.store (i32.add (local.get $__self) (i32.const 0)) (local.get $x))
  )

  (func $Bag_constructor (param $__self i32) (param $x i32) 
    (i32.store (i32.add (local.get $__self) (i32.const 0)) (local.get $x))
  )
  ...
  (func $main  
    ...
    (local.set $b (i32.const 260))
      (call $Box_constructor (i32.const 260) (i32.const 7))
    (local.set $g (i32.const 264))
      (call $Bag_constructor (i32.const 264) (i32.const 9))
    (call $check (if (result i32) (i32.const 1) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.const 0) (then (i32.const 0)) (else (i32.const 1))))
    (call $check (if (result i32) (i32.const 1) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.const 0) (then (i32.const 0)) (else (i32.const 1))))
    (local.set $bIsBox (i32.const 1))
    (local.set $bIsBag (i32.const 0))
    (call $check (if (result i32) (local.get $bIsBox) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (local.get $bIsBag) (then (i32.const 0)) (else (i32.const 1))))
        (i32.store (i32.const 0) (i32.const 268))
          (i32.store (i32.const 4) (i32.const 18))
          (i32.store (i32.const 8) (if (result i32) (i32.const 1) (then (i32.const 286)) (else (i32.const 290))))
          (i32.store (i32.const 12) (if (result i32) (i32.const 1) (then (i32.const 4)) (else (i32.const 5))))
          (i32.store (i32.const 16) (i32.const 295))
        ...
        (i32.store (i32.const 0) (i32.const 296))
          (i32.store (i32.const 4) (i32.const 18))
          (i32.store (i32.const 8) (if (result i32) (i32.const 0) (then (i32.const 286)) (else (i32.const 290))))
          (i32.store (i32.const 12) (if (result i32) (i32.const 0) (then (i32.const 4)) (else (i32.const 5))))
          (i32.store (i32.const 16) (i32.const 295))
          (i32.store (i32.const 20) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 3)
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 314))
  ...
  (data (i32.const 268) "\62\20\69\6e\73\74\61\6e\63\65\6f\66\20\42\6f\78\3a\20")
  (data (i32.const 286) "\74\72\75\65")
  (data (i32.const 290) "\66\61\6c\73\65")
  (data (i32.const 295) "\0a")
  (data (i32.const 296) "\62\20\69\6e\73\74\61\6e\63\65\6f\66\20\42\61\67\3a\20")
  (data (i32.const 314) "\6e\6f\2d\69\6e\68\65\72\69\74\61\6e\63\65\20\69\6e\73\74\61\6e\63\65\6f\66\20\6f\6b\0a")
