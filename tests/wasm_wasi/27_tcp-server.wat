(module
  ...
  (func $handleConnection (param $msg_ptr i32) (param $msg_len i32) 
    ...
    (call $__str_to_upper (local.get $trimmed_ptr) (local.get $trimmed_len))
      (local.set $upper_len)
      (local.set $upper_ptr)
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 134) (i32.const 75))
          (i32.store8 (i32.const 135) (i32.const 58))
          (i32.store8 (i32.const 136) (i32.const 32))
          (call $__str_gather (local.get $upper_ptr) (local.get $upper_len) (i32.const 137))
          (i32.store (i32.const 4) (i32.add (i32.const 5) (local.get $upper_len)))
  ...
  (func $_start (export "_start")
    (call $handleConnection (i32.const 260) (i32.const 9))
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 260) "\68\65\6c\6c\6f\20\74\63\70")
)