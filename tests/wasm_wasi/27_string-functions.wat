(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 393))
  ...
  (func $_start (export "_start")
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 266))
          ...
          (i32.store (i32.const 8) (if (result i32) (call $contains (i32.const 260) (i32.const 4) (i32.const 264) (i32.const 2)) (then (i32.const 278)) (else (i32.const 282))))
          (i32.store (i32.const 12) (if (result i32) (call $contains (i32.const 260) (i32.const 4) (i32.const 264) (i32.const 2)) (then (i32.const 4)) (else (i32.const 5))))
          (i32.store (i32.const 16) (i32.const 287))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 12) (call $__f64_to_str (call $count (i32.const 260) (i32.const 4) (i32.const 288) (i32.const 1)) (i32.const 144))))
        ...
        (i32.store (i32.const 0) (i32.const 291))
          (i32.store (i32.const 4) (i32.const 12))
          (i32.store (i32.const 8) (if (result i32) (call $hasPrefix (i32.const 260) (i32.const 4) (i32.const 289) (i32.const 2)) (then (i32.const 278)) (else (i32.const 282))))
          (i32.store (i32.const 12) (if (result i32) (call $hasPrefix (i32.const 260) (i32.const 4) (i32.const 289) (i32.const 2)) (then (i32.const 4)) (else (i32.const 5))))
          (i32.store (i32.const 16) (i32.const 287))
          (i32.store (i32.const 20) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 305))
          (i32.store (i32.const 4) (i32.const 12))
          (i32.store (i32.const 8) (if (result i32) (call $hasSuffix (i32.const 260) (i32.const 4) (i32.const 303) (i32.const 2)) (then (i32.const 278)) (else (i32.const 282))))
          (i32.store (i32.const 12) (if (result i32) (call $hasSuffix (i32.const 260) (i32.const 4) (i32.const 303) (i32.const 2)) (then (i32.const 4)) (else (i32.const 5))))
          (i32.store (i32.const 16) (i32.const 287))
          (i32.store (i32.const 20) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 142) (i32.const 32))
          (i32.store8 (i32.const 143) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 12) (call $__f64_to_str (call $strIndex (i32.const 260) (i32.const 4) (i32.const 317) (i32.const 1)) (i32.const 144))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 142) (i32.const 32))
          (i32.store8 (i32.const 143) (i32.const 32))
          (call $join (i32.const 320) (i32.const 344) (i32.const 1))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 142) (i32.const 32))
          (i32.store8 (i32.const 143) (i32.const 32))
          (call $repeat (i32.const 318) (i32.const 1) (f64.const 5))
          (call $__str_gather (global.get $__str_ret_ptr) (global.get $__str_ret_len) (i32.const 144))
          (i32.store (i32.const 4) (i32.add (i32.const 12) (global.get $__str_ret_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 142) (i32.const 32))
          (i32.store8 (i32.const 143) (i32.const 32))
          (call $replaceAll (i32.const 345) (i32.const 3) (i32.const 348) (i32.const 1) (i32.const 349) (i32.const 1))
          (call $__str_gather (global.get $__str_ret_ptr) (global.get $__str_ret_len) (i32.const 144))
          (i32.store (i32.const 4) (i32.add (i32.const 12) (global.get $__str_ret_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 142) (i32.const 32))
          (i32.store8 (i32.const 143) (i32.const 32))
          (call $replace (i32.const 345) (i32.const 3) (i32.const 348) (i32.const 1) (i32.const 349) (i32.const 1))
          (call $__str_gather (global.get $__str_ret_ptr) (global.get $__str_ret_len) (i32.const 144))
          (i32.store (i32.const 4) (i32.add (i32.const 12) (global.get $__str_ret_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 142) (i32.const 32))
          (i32.store8 (i32.const 143) (i32.const 32))
          (call $strArrStr (call $split (i32.const 350) (i32.const 9) (i32.const 344) (i32.const 1)))
          (call $__str_gather (global.get $__str_ret_ptr) (global.get $__str_ret_len) (i32.const 144))
          (i32.store (i32.const 4) (i32.add (i32.const 12) (global.get $__str_ret_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
  ...
  (data (i32.const 260) "")
  (data (i32.const 260) "\74\65\73\74")
  (data (i32.const 264) "\65\73")
  (data (i32.const 266) "\43\6f\6e\74\61\69\6e\73\3a\20\20\20")
  (data (i32.const 278) "\74\72\75\65")
  (data (i32.const 282) "\66\61\6c\73\65")
  (data (i32.const 287) "\0a")
  (data (i32.const 288) "\74")
  (data (i32.const 289) "\74\65")
  (data (i32.const 291) "\48\61\73\50\72\65\66\69\78\3a\20\20")
  (data (i32.const 303) "\73\74")
  (data (i32.const 305) "\48\61\73\53\75\66\66\69\78\3a\20\20")
  (data (i32.const 317) "\65")
  (data (i32.const 318) "\61")
  (data (i32.const 319) "\62")
  (data (i32.const 344) "\2d")
  (data (i32.const 345) "\66\6f\6f")
  (data (i32.const 348) "\6f")
  (data (i32.const 349) "\30")
  (data (i32.const 350) "\61\2d\62\2d\63\2d\64\2d\65")
  (data (i32.const 359) "\54\6f\4c\6f\77\65\72\3a\20\20\20\20\74\65\73\74\0a")
  (data (i32.const 376) "\54\6f\55\70\70\65\72\3a\20\20\20\20\54\45\53\54\0a")
  (data (i32.const 320) "\02\00\00\00\02\00\00\00\3e\01\00\00\01\00\00\00\3f\01\00\00\01\00\00\00")
)