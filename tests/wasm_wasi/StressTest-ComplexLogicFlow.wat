(module
  ...
  (func $complexFlow (export "complexFlow") (param $input i32) (result i32)
    (local $x i32)
    (local $i i32)
        ...
        (block $cont_0
          (block $switch_exit_1
            (block $case_default_1
              (block $case_1_1
                (block $case_1_0
                  (br_if $case_1_0 (i32.eq (i32.rem_s (local.get $i) (i32.const 3)) (i32.const 0)))
                  (br_if $case_1_1 (i32.eq (i32.rem_s (local.get $i) (i32.const 3)) (i32.const 1)))
                  (br $case_default_1)
                )
  ...
  (func $_start (export "_start")
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $complexFlow (i32.const 10)) (i32.const 132)))
