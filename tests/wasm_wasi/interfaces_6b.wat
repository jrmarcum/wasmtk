(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 275))
  ...
  (func $newRect (param $w f64) (param $h f64) (result i32)
    ...
    (local.set $__obj_ret (call $__malloc (i32.const 24)))
      ...
      (f64.store offset=8 (local.get $__obj_ret) (local.get $w))
      (f64.store offset=16 (local.get $__obj_ret) (local.get $h))
  ...
  (func $newCircle (param $r f64) (result i32)
    ...
    (local.set $__obj_ret (call $__malloc (i32.const 24)))
      ...
      (f64.store offset=8 (local.get $__obj_ret) (local.get $r))
      (f64.store offset=16 (local.get $__obj_ret) (f64.const 0))
      (return (local.get $__obj_ret))
  )

  (func $area (param $g i32) (result f64)
    (if (i32.eqz (call $__str_cmp (i32.load offset=0 (local.get $g)) (i32.load offset=4 (local.get $g)) (i32.const 260) (i32.const 4)))
      (then
      (return (f64.mul (f64.load (i32.add (local.get $g) (i32.const 8))) (f64.load (i32.add (local.get $g) (i32.const 16)))))
      )
    )
    (if (i32.eqz (call $__str_cmp (i32.load offset=0 (local.get $g)) (i32.load offset=4 (local.get $g)) (i32.const 264) (i32.const 6)))
      (then
      (return (f64.mul (f64.mul (global.get $PI) (f64.load (i32.add (local.get $g) (i32.const 8)))) (f64.load (i32.add (local.get $g) (i32.const 8)))))
      )
    )
    (return (f64.const 0))
  )

  (func $perim (param $g i32) (result f64)
    (if (i32.eqz (call $__str_cmp (i32.load offset=0 (local.get $g)) (i32.load offset=4 (local.get $g)) (i32.const 260) (i32.const 4)))
      (then
      (return (f64.add (f64.mul (f64.const 2) (f64.load (i32.add (local.get $g) (i32.const 8)))) (f64.mul (f64.const 2) (f64.load (i32.add (local.get $g) (i32.const 16))))))
      )
    )
    (if (i32.eqz (call $__str_cmp (i32.load offset=0 (local.get $g)) (i32.load offset=4 (local.get $g)) (i32.const 264) (i32.const 6)))
      (then
      (return (f64.mul (f64.mul (f64.const 2) (global.get $PI)) (f64.load (i32.add (local.get $g) (i32.const 8)))))
      )
    )
    (return (f64.const 0))
  )

  (func $geomStr (param $g i32) 
    ...
    (if (i32.eqz (call $__str_cmp (i32.load offset=0 (local.get $g)) (i32.load offset=4 (local.get $g)) (i32.const 260) (i32.const 4)))
      (then
      (local.set $__ret_str_ptr (i32.const 270))
      (local.set $__ret_str_len (i32.const 1))
      (local.set $__tmpl_num_ptr (call $__malloc (i32.const 32)))
      (local.set $__tmpl_num_len (call $__f64_to_str (f64.load (i32.add (local.get $g) (i32.const 8))) (local.get $__tmpl_num_ptr)))
      ...
      (call $__str_concat (local.get $__ret_str_ptr) (local.get $__ret_str_len) (i32.const 271) (i32.const 1))
      (local.set $__ret_str_len)
      (local.set $__ret_str_ptr)
      (local.set $__tmpl_num_ptr (call $__malloc (i32.const 32)))
      (local.set $__tmpl_num_len (call $__f64_to_str (f64.load (i32.add (local.get $g) (i32.const 16))) (local.get $__tmpl_num_ptr)))
      (call $__str_concat (local.get $__ret_str_ptr) (local.get $__ret_str_len) (local.get $__tmpl_num_ptr) (local.get $__tmpl_num_len))
      (local.set $__ret_str_len)
      (local.set $__ret_str_ptr)
      (call $__str_concat (local.get $__ret_str_ptr) (local.get $__ret_str_len) (i32.const 272) (i32.const 1))
      (local.set $__ret_str_len)
      (local.set $__ret_str_ptr)
    ...
    (local.set $__ret_str_ptr (i32.const 273))
      (local.set $__ret_str_len (i32.const 2))
      (global.set $__str_ret_ptr (local.get $__ret_str_ptr))
      (global.set $__str_ret_len (local.get $__ret_str_len))
      (return)
  )

  (func $measure (param $g i32) 
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $geomStr (local.get $g))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (call $area (local.get $g)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (call $perim (local.get $g)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    (local $r i32)
    (local $c i32)
    (local.set $r (call $newRect (f64.const 3) (f64.const 4)))
    (local.set $c (call $newCircle (f64.const 5)))
    (call $measure (local.get $r))
  ...
  (data (i32.const 271) "\20")
  (data (i32.const 272) "\7d")
  (data (i32.const 273) "\7b\7d")
)