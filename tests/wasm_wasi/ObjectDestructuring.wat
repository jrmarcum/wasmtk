(module
  ...
  (func $sumCoords (param $v i32) (result f64)
    (local $x f64)
    (local $y f64)
    (local.set $x (f64.load (i32.add (local.get $v) (i32.const 0))))
      (local.set $y (f64.load (i32.add (local.get $v) (i32.const 8))))
    (return (f64.add (local.get $x) (local.get $y)))
  )

  (func $chargeSign (param $p i32) (result i32)
    (local $c i32)
    (local.set $c (i32.load (i32.add (local.get $p) (i32.const 8))))
  ...
  (func $_start (export "_start")  
      ...
      (local.set $y (f64.load (i32.add (i32.const 260) (i32.const 8))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 2)
            (i32.const 128)))
    (local.set $vx (f64.load (i32.add (i32.const 260) (i32.const 0))))
      (local.set $vy (f64.load (i32.add (i32.const 260) (i32.const 8))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (local.get $vx) (i32.const 132)))
          (i32.store (i32.const 8) (i32.const 292))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (local.get $vy) (i32.const 132)))
          (i32.store (i32.const 8) (i32.const 292))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 2)
            (i32.const 128)))
    (local.set $px (f64.load (i32.add (i32.const 260) (i32.const 0))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (local.get $px) (i32.const 132)))
          (i32.store (i32.const 8) (i32.const 292))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (call $sumCoords (local.get $v)) (i32.const 132)))
          (i32.store (i32.const 8) (i32.const 292))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (local.set $charge (i32.load (i32.add (i32.const 276) (i32.const 8))))
      (local.set $active (i32.load (i32.add (i32.const 276) (i32.const 12))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (local.get $charge) (i32.const 132)))
          (i32.store (i32.const 8) (i32.const 292))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (local.get $active) (i32.const 132)))
          (i32.store (i32.const 8) (i32.const 292))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $chargeSign (local.get $p)) (i32.const 132)))
          (i32.store (i32.const 8) (i32.const 292))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 276) "\00\00\00\00\00\00\f0\3f\ff\ff\ff\ff\01\00\00\00")
)