(module
  ...
  (func $multiCapture (param $a i32) (param $b f64) (result i32)
    ...
    (local.set $__closure_ptr (call $__malloc (i32.const 16)))
    (i32.store (local.get $__closure_ptr) (i32.const 0))
    (i32.store offset=4 (local.get $__closure_ptr) (local.get $a))
    (f64.store offset=8 (local.get $__closure_ptr) (local.get $b))
    (local.get $__closure_ptr)
  )

  (func $multiCapture__trampoline (param $__closure_ptr i32) (param $val i32) (result f64)
    (local $__cap_a i32)
    (local $__cap_b f64)
  ...
  (func $_start (export "_start")
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (call $multiCapture__trampoline (call $multiCapture (i32.const 2) (f64.const 3.5)) (i32.const 4)) (i32.const 132)))
