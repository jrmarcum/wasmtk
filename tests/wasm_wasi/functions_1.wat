(module
  ...
  (func $plus (param $a f64) (param $b f64) (result f64)
    (return (f64.add (local.get $a) (local.get $b)))
  )

  (func $plusPlus (param $a f64) (param $b f64) (param $c f64) (result f64)
    (return (f64.add (f64.add (local.get $a) (local.get $b)) (local.get $c)))
  )
  (func $_start (export "_start")
    (local $res f64)
    (local $res2 f64)
    (local $__iface_tmp i32)
    (local.set $res (call $plus (f64.const 1) (f64.const 2)))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 6) (call $__f64_to_str (local.get $res) (i32.const 138))))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $res2 (call $plusPlus (f64.const 1) (f64.const 2) (f64.const 3)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 49))
          (i32.store8 (i32.const 133) (i32.const 43))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 8) (call $__f64_to_str (local.get $res2) (i32.const 140))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
