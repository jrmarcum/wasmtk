(module
  ...
  (func $describePoint (param $p i32) 
    ...
    (local.set $__ret_str_ptr (i32.const 260))
      ...
      (call $__str_concat (local.get $__ret_str_ptr) (local.get $__ret_str_len) (i32.const 261) (i32.const 2))
      (local.set $__ret_str_len)
      (local.set $__ret_str_ptr)
      (local.set $__tmpl_num_ptr (call $__malloc (i32.const 32)))
      ...
      (local.set $__ret_str_len)
      (local.set $__ret_str_ptr)
      (call $__str_concat (local.get $__ret_str_ptr) (local.get $__ret_str_len) (i32.const 263) (i32.const 1))
      (local.set $__ret_str_len)
      (local.set $__ret_str_ptr)
  ...
  (func $_start (export "_start")
    ...
    (local.set $line (i32.const 280))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $describePoint (local.get $p))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $describePoint (i32.load (i32.add (i32.const 280) (i32.const 0))))
          (call $__str_gather (global.get $__str_ret_ptr) (global.get $__str_ret_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (global.get $__str_ret_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $describePoint (i32.load (i32.add (i32.const 280) (i32.const 4))))
          (call $__str_gather (global.get $__str_ret_ptr) (global.get $__str_ret_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (global.get $__str_ret_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
  ...
  (data (i32.const 261) "\2c\20")
  (data (i32.const 263) "\29")
  (data (i32.const 264) "\00\00\00\00\00\00\08\40\00\00\00\00\00\00\10\40")
  (data (i32.const 288) "\00\00\00\00\00\00\f0\3f\00\00\00\00\00\00\00\40")
  (data (i32.const 304) "\00\00\00\00\00\00\14\40\00\00\00\00\00\00\18\40")
  (data (i32.const 280) "\20\01\00\00\30\01\00\00")
)