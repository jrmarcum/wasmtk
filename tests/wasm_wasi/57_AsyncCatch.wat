(module
  ...
  (func $__then_tramp_0 (param $env i32) (param $src i32) (param $result i32)
    ...
    (i32.store offset=24 (local.get $result) (i32.load offset=24 (local.get $src))))
      (else
    (i32.store offset=16 (local.get $result) (call $recover (i32.load offset=16 (local.get $src)) (i32.load offset=24 (local.get $src))))
  ...
  (func $__then_tramp_4 (param $env i32) (param $src i32) (param $result i32)
    (if (i32.eqz (i32.load offset=8 (local.get $src)))
      (then
    (i32.store offset=16 (local.get $result) (call $dbl (i32.load offset=16 (local.get $src))))
    (i32.store (local.get $result) (i32.const 1)))
      (else
    (i32.store (local.get $result) (i32.load (local.get $src)))
    (i32.store offset=4 (local.get $result) (i32.load offset=4 (local.get $src)))
    ...
    (i64.store offset=16 (local.get $result) (i64.load offset=16 (local.get $src)))
    (i32.store offset=24 (local.get $result) (i32.load offset=24 (local.get $src))))))
  (func $recover (param $e_ptr i32) (param $e_len i32) (result i32)
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 142) (i32.const 102))
          (i32.store8 (i32.const 143) (i32.const 114))
          (i32.store8 (i32.const 144) (i32.const 111))
          (i32.store8 (i32.const 145) (i32.const 109))
          (i32.store8 (i32.const 146) (i32.const 58))
          (i32.store8 (i32.const 147) (i32.const 32))
          (call $__str_gather (local.get $e_ptr) (local.get $e_len) (i32.const 148))
          (i32.store (i32.const 4) (i32.add (i32.const 16) (local.get $e_len)))
  ...
  (func $dbl (param $v i32) (result i32)
  ...
  (func $main  
    ...
    (local $d i32)
    (local $__iface_tmp i32)
    (local.set $a (call $__promise_await_i32 (call $__promise_then (call $__promise_reject (i32.const 268) (i32.const 4)) (i32.const 0) (i32.const 0))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $b (call $__promise_await_i32 (call $__promise_then (call $__promise_resolve_i32 (i32.const 7)) (i32.const 1) (i32.const 0))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 98))
          (i32.store8 (i32.const 133) (i32.const 58))
          (i32.store8 (i32.const 134) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 3) (call $__i32_to_str (local.get $b) (i32.const 135))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $c (call $__promise_await_i32 (call $__promise_then (call $__promise_resolve_i32 (i32.const 5)) (i32.const 2) (i32.const 0))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $d (call $__promise_await_i32 (call $__promise_then (call $__promise_then (call $__promise_resolve_i32 (i32.const 4)) (i32.const 4) (i32.const 0)) (i32.const 3) (i32.const 0))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 100))
          (i32.store8 (i32.const 133) (i32.const 58))
          (i32.store8 (i32.const 134) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 3) (call $__i32_to_str (local.get $d) (i32.const 135))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (table 5 funcref)
  (elem (i32.const 0) $__then_tramp_0 $__then_tramp_1 $__then_tramp_2 $__then_tramp_3 $__then_tramp_4)
  (data (i32.const 260) "\66\69\6e\61\6c\6c\79\0a")
  (data (i32.const 268) "\72\65\6a\41")
  (data (i32.const 272) "\64\6f\6e\65\0a")
)