(module
  ...
  (func $main  
    ...
    (local $d i32)
    (local $__iface_tmp i32)
    (local.set $a (call $__promise_await_i32 (call $__promise_then (call $__promise_reject (i32.const 268) (i32.const 4)) (i32.const 0))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $b (call $__promise_await_i32 (call $__promise_then (call $__promise_resolve_i32 (i32.const 7)) (i32.const 1))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $c (call $__promise_await_i32 (call $__promise_then (call $__promise_resolve_i32 (i32.const 5)) (i32.const 2))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $d (call $__promise_await_i32 (call $__promise_then (call $__promise_then (call $__promise_resolve_i32 (i32.const 4)) (i32.const 4)) (i32.const 3))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
