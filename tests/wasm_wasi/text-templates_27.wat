(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 415))
  ...
  (func $renderDot (param $tmpl_ptr i32) (param $tmpl_len i32) (param $val_ptr i32) (param $val_len i32) 
    (local $__iface_tmp i32)
    (local $__ret_str_ptr i32)
    (local $__ret_str_len i32)
    (call $__str_replace (local.get $tmpl_ptr) (local.get $tmpl_len) (i32.const 294) (i32.const 5) (local.get $val_ptr) (local.get $val_len))
  ...
  (func $renderField (param $tmpl_ptr i32) (param $tmpl_len i32) (param $field_ptr i32) (param $field_len i32) (param $val_ptr i32) (param $val_len i32) 
    ...
    (local.set $needle_ptr (i32.const 299))
      (local.set $needle_len (i32.const 3))
      (call $__str_concat (local.get $needle_ptr) (local.get $needle_len) (local.get $field_ptr) (local.get $field_len))
      (local.set $needle_len)
      (local.set $needle_ptr)
      (call $__str_concat (local.get $needle_ptr) (local.get $needle_len) (i32.const 302) (i32.const 2))
      (local.set $needle_len)
      (local.set $needle_ptr)
    (call $__str_replace (local.get $tmpl_ptr) (local.get $tmpl_len) (local.get $needle_ptr) (local.get $needle_len) (local.get $val_ptr) (local.get $val_len))
      (local.set $__ret_str_len)
      (local.set $__ret_str_ptr)
      (global.set $__str_ret_ptr (local.get $__ret_str_ptr))
      (global.set $__str_ret_len (local.get $__ret_str_len))
  ...
  (func $joinArr (param $arr i32) (param $sep_ptr i32) (param $sep_len i32) 
    (local $s_ptr i32)
    (local $s_len i32)
    (local $i f64)
    (local $__ret_str_ptr i32)
    ...
    (block $break_0
      ...
      (call $__str_concat (local.get $s_ptr) (local.get $s_len) (local.get $sep_ptr) (local.get $sep_len))
      (local.set $s_len)
      (local.set $s_ptr)
            )
          )
    ...
    (local.set $t1_ptr (i32.const 260))
      (local.set $t1_len (i32.const 12))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (call $renderDot (local.get $t1_ptr) (local.get $t1_len) (i32.const 355) (i32.const 9))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $renderDot (local.get $t1_ptr) (local.get $t1_len) (i32.const 364) (i32.const 1))
          (call $__str_gather (global.get $__str_ret_ptr) (global.get $__str_ret_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (global.get $__str_ret_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $renderDot (local.get $t1_ptr) (local.get $t1_len) (i32.const 365) (i32.const 16))
          (call $__str_gather (global.get $__str_ret_ptr) (global.get $__str_ret_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (global.get $__str_ret_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $t2_ptr (i32.const 272))
      (local.set $t2_len (i32.const 15))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $renderField (local.get $t2_ptr) (local.get $t2_len) (i32.const 381) (i32.const 4) (i32.const 385) (i32.const 8))
          (call $__str_gather (global.get $__str_ret_ptr) (global.get $__str_ret_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (global.get $__str_ret_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $renderField (local.get $t2_ptr) (local.get $t2_len) (i32.const 381) (i32.const 4) (i32.const 393) (i32.const 12))
          (call $__str_gather (global.get $__str_ret_ptr) (global.get $__str_ret_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (global.get $__str_ret_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
        ...
        (i32.store (i32.const 0) (i32.const 405))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 410))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $items (i32.const 315))
    (local.set $rangeOut_ptr (i32.const 287))
      (local.set $rangeOut_len (i32.const 7))
    (local.set $i (f64.const 0))
    (block $break_1
      (loop $loop_1
        (br_if $break_1 (i32.eqz (f64.lt (local.get $i) (f64.convert_i32_s (i32.const 4)))))
        (block $cont_1
          (local.set $rangeOut_ptr (local.get $rangeOut_ptr))
      (local.set $rangeOut_len (local.get $rangeOut_len))
      (call $__str_concat (local.get $rangeOut_ptr) (local.get $rangeOut_len) (i32.load (i32.add (i32.add (i32.const 315) (i32.const 8)) (i32.shl (i32.trunc_f64_s (local.get $i)) (i32.const 3)))) (i32.load offset=4 (i32.add (i32.add (i32.const 315) (i32.const 8)) (i32.shl (i32.trunc_f64_s (local.get $i)) (i32.const 3)))))
      (local.set $rangeOut_len)
      (local.set $rangeOut_ptr)
      (call $__str_concat (local.get $rangeOut_ptr) (local.get $rangeOut_len) (i32.const 414) (i32.const 1))
      (local.set $rangeOut_len)
      (local.set $rangeOut_ptr)
        )
        (local.set $i (f64.add (local.get $i) (f64.const 1)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (local.get $rangeOut_ptr) (local.get $rangeOut_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $rangeOut_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 294) "\7b\7b\2e\7d\7d")
  (data (i32.const 299) "\7b\7b\2e")
  (data (i32.const 302) "\7d\7d")
  (data (i32.const 304) "")
  (data (i32.const 304) "\47\6f")
  (data (i32.const 306) "\52\75\73\74")
  (data (i32.const 310) "\43\2b\2b")
  (data (i32.const 313) "\43\23")
  (data (i32.const 355) "\73\6f\6d\65\20\74\65\78\74")
  (data (i32.const 364) "\35")
  (data (i32.const 365) "\5b\47\6f\20\52\75\73\74\20\43\2b\2b\20\43\23\5d")
  (data (i32.const 381) "\4e\61\6d\65")
  (data (i32.const 385) "\4a\61\6e\65\20\44\6f\65")
  (data (i32.const 393) "\4d\69\63\6b\65\79\20\4d\6f\75\73\65")
  (data (i32.const 405) "\79\65\73\20\0a")
  (data (i32.const 410) "\6e\6f\20\0a")
  (data (i32.const 414) "\20")
  (data (i32.const 315) "\04\00\00\00\04\00\00\00\30\01\00\00\02\00\00\00\32\01\00\00\04\00\00\00\36\01\00\00\03\00\00\00\39\01\00\00\02\00\00\00")
)