(module
  ...
  (func $headersHandler (param $hdrs i32) 
    ...
    (block $break_0
      (loop $loop_0
        (br_if $break_0 (i32.eqz (f64.lt (local.get $i) (f64.convert_i32_s (i32.load (local.get $hdrs))))))
        (block $cont_0
          (local.set $result_ptr (local.get $result_ptr))
      (local.set $result_len (local.get $result_len))
      (call $__str_concat (local.get $result_ptr) (local.get $result_len) (i32.load offset=0 (i32.load (i32.add (i32.add (local.get $hdrs) (i32.const 8)) (i32.shl (i32.trunc_f64_s (local.get $i)) (i32.const 2))))) (i32.load offset=4 (i32.load (i32.add (i32.add (local.get $hdrs) (i32.const 8)) (i32.shl (i32.trunc_f64_s (local.get $i)) (i32.const 2))))))
      (local.set $result_len)
      (local.set $result_ptr)
      (call $__str_concat (local.get $result_ptr) (local.get $result_len) (i32.const 265) (i32.const 2))
      (local.set $result_len)
      (local.set $result_ptr)
      (call $__str_concat (local.get $result_ptr) (local.get $result_len) (i32.load offset=8 (i32.load (i32.add (i32.add (local.get $hdrs) (i32.const 8)) (i32.shl (i32.trunc_f64_s (local.get $i)) (i32.const 2))))) (i32.load offset=12 (i32.load (i32.add (i32.add (local.get $hdrs) (i32.const 8)) (i32.shl (i32.trunc_f64_s (local.get $i)) (i32.const 2))))))
      (local.set $result_len)
      (local.set $result_ptr)
      (call $__str_concat (local.get $result_ptr) (local.get $result_len) (i32.const 267) (i32.const 2))
      (local.set $result_len)
      (local.set $result_ptr)
        )
