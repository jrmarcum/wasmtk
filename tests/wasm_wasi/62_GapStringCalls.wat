(module
  ...
  (func $_start (export "_start")
    (local $both_ptr i32)
    (local $both_len i32)
    (local $framed_ptr i32)
    (local $framed_len i32)
    (local $__iface_tmp i32)
    (call $n1)
      (local.set $both_ptr (global.get $__str_ret_ptr))
      (local.set $both_len (global.get $__str_ret_len))
      (call $n2)
      (call $__str_concat (local.get $both_ptr) (local.get $both_len) (global.get $__str_ret_ptr) (global.get $__str_ret_len))
      (local.set $both_len)
      (local.set $both_ptr)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (local.get $both_ptr) (local.get $both_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $both_len)))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $framed_ptr (i32.const 268))
      (local.set $framed_len (i32.const 1))
      (call $n1)
      (call $__str_concat (local.get $framed_ptr) (local.get $framed_len) (global.get $__str_ret_ptr) (global.get $__str_ret_len))
      (local.set $framed_len)
      (local.set $framed_ptr)
      (call $__str_concat (local.get $framed_ptr) (local.get $framed_len) (i32.const 269) (i32.const 1))
      (local.set $framed_len)
      (local.set $framed_ptr)
      (call $n2)
      (call $__str_concat (local.get $framed_ptr) (local.get $framed_len) (global.get $__str_ret_ptr) (global.get $__str_ret_len))
      (local.set $framed_len)
      (local.set $framed_ptr)
      (call $__str_concat (local.get $framed_ptr) (local.get $framed_len) (i32.const 270) (i32.const 1))
      (local.set $framed_len)
      (local.set $framed_ptr)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (local.get $framed_ptr) (local.get $framed_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $framed_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 260) "\41\6c\69\63\65")
  (data (i32.const 265) "\42\6f\62")
  (data (i32.const 268) "\5b")
  (data (i32.const 269) "\2d")
  (data (i32.const 270) "\5d")
)