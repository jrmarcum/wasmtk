(module
  ...
  (func $_start (export "_start")
    (local $myColor_ptr i32)
    (local $myColor_len i32)
    (local $s1_ptr i32)
    (local $s1_len i32)
    (local $s2_ptr i32)
    (local $s2_len i32)
    (local $chosen_ptr i32)
    (local $chosen_len i32)
    (local $__iface_tmp i32)
        ...
        (i32.store (i32.const 0) (i32.const 270))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $myColor_ptr (i32.const 275))
      (local.set $myColor_len (i32.const 4))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (local.get $myColor_ptr) (local.get $myColor_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $myColor_len)))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $s1_ptr (i32.const 279))
      (local.set $s1_len (i32.const 6))
    (local.set $s2_ptr (i32.const 285))
      (local.set $s2_len (i32.const 7))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (local.get $s1_ptr) (local.get $s1_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $s1_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (local.get $s2_ptr) (local.get $s2_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $s2_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.const 0) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.const 2) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 303))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $chosen_ptr (i32.const 320))
      (local.set $chosen_len (i32.const 5))
    (if (i32.eqz (call $__str_cmp (local.get $chosen_ptr) (local.get $chosen_len) (i32.const 320) (i32.const 5)))
      (then
  ...
  (data (i32.const 260) "\72\65\64\0a")
  (data (i32.const 264) "\67\72\65\65\6e\0a")
  (data (i32.const 270) "\62\6c\75\65\0a")
  (data (i32.const 275) "\62\6c\75\65")
  (data (i32.const 279) "\61\63\74\69\76\65")
  (data (i32.const 285) "\70\65\6e\64\69\6e\67")
  (data (i32.const 292) "\43\6f\6c\6f\72\3a\20\72\65\64\0a")
  (data (i32.const 303) "\53\74\61\74\75\73\3a\20\69\6e\61\63\74\69\76\65\0a")
  (data (i32.const 320) "\67\72\65\65\6e")
  (data (i32.const 325) "\69\74\20\69\73\20\67\72\65\65\6e\0a")
  (data (i32.const 337) "\6e\6f\74\20\67\72\65\65\6e\0a")
)