(module
  ...
  (func $testDoWhileLogic (export "testDoWhileLogic") (param $limit i32) (result i32)
    (local $result i32)
    (local $i i32)
    ...
    (block $break_0
      (loop $loop_0
        (block $cont_0
          ...
          (if (i32.gt_s (local.get $result) (i32.const 100))
            (then
            (br $break_0)
            )
          )
        ...
        (br_if $loop_0 (i32.lt_s (local.get $i) (local.get $limit)))
      )
    )
  ...
  (func $_start (export "_start")
    (;; type i32 = number;;)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $testDoWhileLogic (i32.const 10)) (i32.const 132)))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $testDoWhileLogic (i32.const 20)) (i32.const 132)))
          (i32.store (i32.const 8) (i32.const 260))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
