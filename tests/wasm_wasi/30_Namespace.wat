(module
  ...
  (global $MathUtils_PI f64 (f64.const 3.141592653589793))
  (global $MathUtils_TWO i32 (i32.const 2))
  ...
  (func $MathUtils_add (param $a i32) (param $b i32) (result i32)
    (return (i32.add (local.get $a) (local.get $b)))
  )

  (func $MathUtils_multiply (param $a i32) (param $b i32) (result i32)
    (return (i32.mul (local.get $a) (local.get $b)))
  )

  (func $MathUtils_square (param $n i32) (result i32)
    (return (i32.mul (local.get $n) (local.get $n)))
  )
  ...
  (func $main  
    ...
    (local.set $sum (call $MathUtils_add (i32.const 3) (i32.const 4)))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 5) (call $__i32_to_str (local.get $sum) (i32.const 137))))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $product (call $MathUtils_multiply (i32.const 5) (i32.const 6)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 9) (call $__i32_to_str (local.get $product) (i32.const 141))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $sq (call $MathUtils_square (i32.const 7)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 115))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 8) (call $__i32_to_str (local.get $sq) (i32.const 140))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 133) (i32.const 73))
          (i32.store8 (i32.const 134) (i32.const 58))
          (i32.store8 (i32.const 135) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 4) (call $__f64_to_str (global.get $MathUtils_PI) (i32.const 136))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 133) (i32.const 87))
          (i32.store8 (i32.const 134) (i32.const 79))
          (i32.store8 (i32.const 135) (i32.const 58))
          (i32.store8 (i32.const 136) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 5) (call $__i32_to_str (global.get $MathUtils_TWO) (i32.const 137))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $area (f64.mul (global.get $MathUtils_PI) (f64.const 9.0)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store8 (i32.const 149) (i32.const 120))
          (i32.store8 (i32.const 150) (i32.const 58))
          (i32.store8 (i32.const 151) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 20) (call $__f64_to_str (local.get $area) (i32.const 152))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (drop (call $MathUtils_add (i32.const 10) (i32.const 20)))
  )
