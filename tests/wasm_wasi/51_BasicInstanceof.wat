(module
  ...
  (func $Animal_constructor (param $__self i32) (param $a i32) 
    (i32.store (i32.add (local.get $__self) (i32.const 4)) (local.get $a))
  )

  (func $Dog_constructor (param $__self i32) (param $a i32) 
    (call $Animal_constructor (local.get $__self) (local.get $a))
  )

  (func $Cat_constructor (param $__self i32) (param $a i32) 
    (call $Animal_constructor (local.get $__self) (local.get $a))
  )

  (func $Puppy_constructor (param $__self i32) (param $a i32) 
    (call $Dog_constructor (local.get $__self) (local.get $a))
  )
  ...
  (func $main  
    ...
    (local $realDog i32)
    (local $__iface_tmp i32)
    (local.set $d (i32.const 260))
      (call $Dog_constructor (i32.const 260) (i32.const 3))
    (local.set $c (i32.const 268))
      (call $Cat_constructor (i32.const 268) (i32.const 5))
    (local.set $p (i32.const 276))
      (call $Puppy_constructor (i32.const 276) (i32.const 1))
    (call $check (if (result i32) (i32.or (i32.eq (i32.load (i32.const 260)) (i32.const 2)) (i32.eq (i32.load (i32.const 260)) (i32.const 4))) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.or (i32.or (i32.or (i32.eq (i32.load (i32.const 260)) (i32.const 1)) (i32.eq (i32.load (i32.const 260)) (i32.const 2))) (i32.eq (i32.load (i32.const 260)) (i32.const 3))) (i32.eq (i32.load (i32.const 260)) (i32.const 4))) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (i32.load (i32.const 260)) (i32.const 3)) (then (i32.const 0)) (else (i32.const 1))))
    (call $check (if (result i32) (i32.eq (i32.load (i32.const 260)) (i32.const 4)) (then (i32.const 0)) (else (i32.const 1))))
    (call $check (if (result i32) (i32.eq (i32.load (i32.const 268)) (i32.const 3)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.or (i32.or (i32.or (i32.eq (i32.load (i32.const 268)) (i32.const 1)) (i32.eq (i32.load (i32.const 268)) (i32.const 2))) (i32.eq (i32.load (i32.const 268)) (i32.const 3))) (i32.eq (i32.load (i32.const 268)) (i32.const 4))) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.or (i32.eq (i32.load (i32.const 268)) (i32.const 2)) (i32.eq (i32.load (i32.const 268)) (i32.const 4))) (then (i32.const 0)) (else (i32.const 1))))
    (call $check (if (result i32) (i32.eq (i32.load (i32.const 276)) (i32.const 4)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.or (i32.eq (i32.load (i32.const 276)) (i32.const 2)) (i32.eq (i32.load (i32.const 276)) (i32.const 4))) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.or (i32.or (i32.or (i32.eq (i32.load (i32.const 276)) (i32.const 1)) (i32.eq (i32.load (i32.const 276)) (i32.const 2))) (i32.eq (i32.load (i32.const 276)) (i32.const 3))) (i32.eq (i32.load (i32.const 276)) (i32.const 4))) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (i32.load (i32.const 276)) (i32.const 3)) (then (i32.const 0)) (else (i32.const 1))))
    (local.set $realDog (i32.const 284))
      (call $Dog_constructor (i32.const 284) (i32.const 7))
    (call $check (if (result i32) (i32.or (i32.eq (i32.load (i32.const 284)) (i32.const 2)) (i32.eq (i32.load (i32.const 284)) (i32.const 4))) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.or (i32.or (i32.or (i32.eq (i32.load (i32.const 284)) (i32.const 1)) (i32.eq (i32.load (i32.const 284)) (i32.const 2))) (i32.eq (i32.load (i32.const 284)) (i32.const 3))) (i32.eq (i32.load (i32.const 284)) (i32.const 4))) (then (i32.const 1)) (else (i32.const 0))))
        (i32.store (i32.const 0) (i32.const 292))
          (i32.store (i32.const 4) (i32.const 18))
          (i32.store (i32.const 8) (if (result i32) (i32.or (i32.eq (i32.load (i32.const 260)) (i32.const 2)) (i32.eq (i32.load (i32.const 260)) (i32.const 4))) (then (i32.const 310)) (else (i32.const 314))))
          (i32.store (i32.const 12) (if (result i32) (i32.or (i32.eq (i32.load (i32.const 260)) (i32.const 2)) (i32.eq (i32.load (i32.const 260)) (i32.const 4))) (then (i32.const 4)) (else (i32.const 5))))
          (i32.store (i32.const 16) (i32.const 319))
        ...
        (i32.store (i32.const 0) (i32.const 320))
          (i32.store (i32.const 4) (i32.const 18))
          (i32.store (i32.const 8) (if (result i32) (i32.eq (i32.load (i32.const 260)) (i32.const 3)) (then (i32.const 310)) (else (i32.const 314))))
          (i32.store (i32.const 12) (if (result i32) (i32.eq (i32.load (i32.const 260)) (i32.const 3)) (then (i32.const 4)) (else (i32.const 5))))
          (i32.store (i32.const 16) (i32.const 319))
          (i32.store (i32.const 20) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 338))
          ...
          (i32.store (i32.const 8) (if (result i32) (i32.or (i32.or (i32.or (i32.eq (i32.load (i32.const 276)) (i32.const 1)) (i32.eq (i32.load (i32.const 276)) (i32.const 2))) (i32.eq (i32.load (i32.const 276)) (i32.const 3))) (i32.eq (i32.load (i32.const 276)) (i32.const 4))) (then (i32.const 310)) (else (i32.const 314))))
          (i32.store (i32.const 12) (if (result i32) (i32.or (i32.or (i32.or (i32.eq (i32.load (i32.const 276)) (i32.const 1)) (i32.eq (i32.load (i32.const 276)) (i32.const 2))) (i32.eq (i32.load (i32.const 276)) (i32.const 3))) (i32.eq (i32.load (i32.const 276)) (i32.const 4))) (then (i32.const 4)) (else (i32.const 5))))
          (i32.store (i32.const 16) (i32.const 319))
          (i32.store (i32.const 20) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 292) "\64\20\69\6e\73\74\61\6e\63\65\6f\66\20\44\6f\67\3a\20")
  (data (i32.const 310) "\74\72\75\65")
  (data (i32.const 314) "\66\61\6c\73\65")
  (data (i32.const 319) "\0a")
  (data (i32.const 320) "\64\20\69\6e\73\74\61\6e\63\65\6f\66\20\43\61\74\3a\20")
  (data (i32.const 338) "\70\20\69\6e\73\74\61\6e\63\65\6f\66\20\41\6e\69\6d\61\6c\3a\20")
  (data (i32.const 359) "\62\61\73\69\63\20\69\6e\73\74\61\6e\63\65\6f\66\20\6f\6b\0a")
  (data (i32.const 260) "\02\00\00\00\00\00\00\00")
  (data (i32.const 268) "\03\00\00\00\00\00\00\00")
  (data (i32.const 276) "\04\00\00\00\00\00\00\00")
  (data (i32.const 284) "\02\00\00\00\00\00\00\00")
)