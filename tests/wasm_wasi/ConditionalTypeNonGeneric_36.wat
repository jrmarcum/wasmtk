(module
  ...
  (func $printStr (param $label_ptr i32) (param $label_len i32) (param $s_ptr i32) (param $s_len i32) 
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (local.get $label_ptr) (local.get $label_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $label_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (call $__str_gather (local.get $s_ptr) (local.get $s_len) (i32.add (i32.const 132) (i32.load (i32.const 4))))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (local.get $s_len)))
  ...
  (func $main  
    ...
    (local.set $a_ptr (i32.const 260))
      (local.set $a_len (i32.const 5))
    (local.set $b (f64.const 9.99))
    (local.set $c (i32.const 42))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $printStr (i32.const 265) (i32.const 6) (i32.const 271) (i32.const 5))
  )
  ...
  (data (i32.const 265) "\6c\61\62\65\6c\3a")
  (data (i32.const 271) "\77\61\73\69\63")
)