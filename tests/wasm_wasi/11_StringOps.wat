(module
  ...
  (global $n i32 (i32.const 42))
  (global $x f64 (f64.const 3.14))
  ...
  (func $_start (export "_start")
    ...
    (local.set $idx (call $__str_indexof (local.get $greeting_ptr) (local.get $greeting_len) (i32.const 291) (i32.const 5)))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $missing (call $__str_indexof (local.get $greeting_ptr) (local.get $greeting_len) (i32.const 296) (i32.const 3)))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $hasHello (i32.ne (call $__str_indexof (local.get $greeting_ptr) (local.get $greeting_len) (i32.const 273) (i32.const 5)) (i32.const -1)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (if (result i32) (local.get $hasHello) (then (i32.const 299)) (else (i32.const 303))) (if (result i32) (local.get $hasHello) (then (i32.const 4)) (else (i32.const 5))) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $hasXyz (i32.ne (call $__str_indexof (local.get $greeting_ptr) (local.get $greeting_len) (i32.const 296) (i32.const 3)) (i32.const -1)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (if (result i32) (local.get $hasXyz) (then (i32.const 299)) (else (i32.const 303))) (if (result i32) (local.get $hasXyz) (then (i32.const 4)) (else (i32.const 5))) (i32.const 132))
    ...
    (call $__str_slice (local.get $greeting_ptr) (local.get $greeting_len) (i32.const 5) (i32.const 5))
      ...
      (local.set $empty_ptr)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (local.get $empty_len) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $first_ptr (i32.const 273))
      (local.set $first_len (i32.const 5))
    (local.set $second_ptr (i32.const 278))
      (local.set $second_len (i32.const 2))
    (local.set $third_ptr (i32.const 280))
      (local.set $third_len (i32.const 5))
    (local.set $full_ptr (local.get $first_ptr))
      (local.set $full_len (local.get $first_len))
      (call $__str_concat (local.get $full_ptr) (local.get $full_len) (local.get $second_ptr) (local.get $second_len))
      (local.set $full_len)
      (local.set $full_ptr)
      ...
      (local.set $full_ptr)
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $prefixed_ptr (i32.const 308))
      (local.set $prefixed_len (i32.const 8))
      (call $__str_concat (local.get $prefixed_ptr) (local.get $prefixed_len) (local.get $first_ptr) (local.get $first_len))
    ...
    (local.set $ns_ptr (call $__malloc (i32.const 32)))
      (local.set $ns_len (call $__i32_to_str (global.get $n) (local.get $ns_ptr)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
    ...
    (local.set $xs_ptr (call $__malloc (i32.const 32)))
      (local.set $xs_len (call $__f64_to_str (global.get $x) (local.get $xs_ptr)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $target_ptr (i32.const 285))
    ...
    (local.set $found (call $__str_indexof (local.get $sliced_ptr) (local.get $sliced_len) (i32.const 316) (i32.const 2)))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $cat_ptr (i32.const 318))
      (local.set $cat_len (i32.const 3))
      (call $__str_concat (local.get $cat_ptr) (local.get $cat_len) (i32.const 321) (i32.const 3))
      (local.set $cat_len)
      (local.set $cat_ptr)
    (local.set $hasFoo (i32.ne (call $__str_indexof (local.get $cat_ptr) (local.get $cat_len) (i32.const 318) (i32.const 3)) (i32.const -1)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (if (result i32) (local.get $hasFoo) (then (i32.const 299)) (else (i32.const 303))) (if (result i32) (local.get $hasFoo) (then (i32.const 4)) (else (i32.const 5))) (i32.const 132))
  ...
  (data (i32.const 273) "\48\65\6c\6c\6f")
  (data (i32.const 278) "\2c\20")
  (data (i32.const 280) "\44\65\6e\6f\21")
  (data (i32.const 285) "\61\62\63\64\65\66")
  (data (i32.const 291) "\57\6f\72\6c\64")
  (data (i32.const 296) "\78\79\7a")
  (data (i32.const 299) "\74\72\75\65")
  (data (i32.const 303) "\66\61\6c\73\65")
  (data (i32.const 308) "\52\65\73\75\6c\74\3a\20")
