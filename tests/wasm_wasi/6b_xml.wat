(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 488))
  ...
  (func $printPlantXml (param $plant i32) (param $indent_ptr i32) (param $indent_len i32) 
    (local $__iface_tmp i32)
    (local $__tmpl_num_ptr i32)
    (local $__tmpl_num_len i32)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (local.get $indent_ptr) (local.get $indent_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $indent_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 60))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 1))) (i32.const 112))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 2))) (i32.const 108))
          ...
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 7))) (i32.const 105))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 8))) (i32.const 100))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 9))) (i32.const 61))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 10))) (i32.const 34))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 11)))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (call $__f64_to_str (f64.load (i32.add (local.get $plant) (i32.const 0))) (i32.add (i32.const 132) (i32.load (i32.const 4))))))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 34))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 1))) (i32.const 62))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 2))) (i32.const 60))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 3))) (i32.const 110))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 4))) (i32.const 97))
          ...
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 7))) (i32.const 62))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 8)))
          (call $__str_gather (i32.load offset=8 (local.get $plant)) (i32.load offset=12 (local.get $plant)) (i32.add (i32.const 132) (i32.load (i32.const 4))))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.load offset=12 (local.get $plant))))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 60))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 1))) (i32.const 47))
          ...
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 6))) (i32.const 62))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 7))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 8)))
          (drop (call $fd_write
            (i32.const 1)
            (i32.const 0)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 5))) (i32.const 105))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 6))) (i32.const 103))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 7))) (i32.const 105))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 8))) (i32.const 110))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 9))) (i32.const 62))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 10)))
          (call $__str_gather (i32.load offset=16 (local.get $plant)) (i32.load offset=20 (local.get $plant)) (i32.add (i32.const 132) (i32.load (i32.const 4))))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.load offset=20 (local.get $plant))))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 60))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 1))) (i32.const 47))
          ...
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 8))) (i32.const 62))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 9))) (i32.const 62))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 10)))
          (call $__str_gather (i32.load offset=24 (local.get $plant)) (i32.load offset=28 (local.get $plant)) (i32.add (i32.const 132) (i32.load (i32.const 4))))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.load offset=28 (local.get $plant))))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 60))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 1))) (i32.const 47))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 2))) (i32.const 111))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 3))) (i32.const 114))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 60))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 1))) (i32.const 47))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 2))) (i32.const 112))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 3))) (i32.const 108))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 4))) (i32.const 97))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 5))) (i32.const 110))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 6))) (i32.const 116))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 7))) (i32.const 62))
  ...
  (func $_start (export "_start")
    ...
    (local $__tmpl_num_ptr i32)
    (local $__tmpl_num_len i32)
    (local.set $coffee (i32.const 260))
    (local.set $tomato (i32.const 312))
    (call $printPlantXml (local.get $coffee) (i32.const 366) (i32.const 1))
        (i32.store (i32.const 0) (i32.const 367))
    ...
    (call $printPlantXml (local.get $coffee) (i32.const 366) (i32.const 1))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (call $__str_gather (i32.load offset=8 (i32.const 260)) (i32.load offset=12 (i32.const 260)) (i32.add (i32.const 132) (i32.load (i32.const 4))))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.load offset=12 (i32.const 260))))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 44))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 1))) (i32.const 32))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 2))) (i32.const 111))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 3))) (i32.const 114))
          ...
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 10)))
          (call $__str_gather (i32.load offset=16 (i32.const 260)) (i32.load offset=20 (i32.const 260)) (i32.add (i32.const 132) (i32.load (i32.const 4))))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.load offset=20 (i32.const 260))))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (call $__str_gather (i32.load offset=24 (i32.const 260)) (i32.load offset=28 (i32.const 260)) (i32.add (i32.const 132) (i32.load (i32.const 4))))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.load offset=28 (i32.const 260))))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 406))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 417))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 429))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $printPlantXml (local.get $coffee) (i32.const 442) (i32.const 7))
    (call $printPlantXml (local.get $tomato) (i32.const 442) (i32.const 7))
        (i32.store (i32.const 0) (i32.const 449))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 463))
          (i32.store (i32.const 4) (i32.const 13))
          (drop (call $fd_write
            (i32.const 1)
            (i32.const 0)
            (i32.const 1)
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 476))
          (i32.store (i32.const 4) (i32.const 12))
          (drop (call $fd_write
            (i32.const 1)
            (i32.const 0)
  ...
  (data (i32.const 292) "\43\6f\66\66\65\65")
  (data (i32.const 298) "\45\74\68\69\6f\70\69\61")
  (data (i32.const 306) "\42\72\61\7a\69\6c")
  (data (i32.const 344) "\54\6f\6d\61\74\6f")
  (data (i32.const 350) "\4d\65\78\69\63\6f")
  (data (i32.const 356) "\43\61\6c\69\66\6f\72\6e\69\61")
  (data (i32.const 366) "\20")
  (data (i32.const 367) "\3c\3f\78\6d\6c\20\76\65\72\73\69\6f\6e\3d\22\31\2e\30\22\20\65\6e\63\6f\64\69\6e\67\3d\22\55\54\46\2d\38\22\3f\3e\0a")
  (data (i32.const 406) "\20\3c\6e\65\73\74\69\6e\67\3e\0a")
  (data (i32.const 417) "\20\20\20\3c\70\61\72\65\6e\74\3e\0a")
  (data (i32.const 429) "\20\20\20\20\20\3c\63\68\69\6c\64\3e\0a")
  (data (i32.const 442) "\20\20\20\20\20\20\20")
  (data (i32.const 449) "\20\20\20\20\20\3c\2f\63\68\69\6c\64\3e\0a")
  (data (i32.const 463) "\20\20\20\3c\2f\70\61\72\65\6e\74\3e\0a")
  (data (i32.const 476) "\20\3c\2f\6e\65\73\74\69\6e\67\3e\0a")
  (data (i32.const 260) "\00\00\00\00\00\00\3b\40\24\01\00\00\06\00\00\00\2a\01\00\00\08\00\00\00\32\01\00\00\06\00\00\00")
  (data (i32.const 312) "\00\00\00\00\00\40\54\40\58\01\00\00\06\00\00\00\5e\01\00\00\06\00\00\00\64\01\00\00\0a\00\00\00")
)