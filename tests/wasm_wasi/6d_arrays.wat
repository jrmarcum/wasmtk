(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 358))
  ...
  (func $_start (export "_start")
    ...
    (local.set $a (i32.const 261))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (f64.store (i32.add (i32.add (i32.const 261) (i32.const 8)) (i32.shl (i32.const 4) (i32.const 3))) (f64.const 100))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 135) (i32.const 58))
          (i32.store8 (i32.const 136) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 5) (call $__f64_to_str (f64.load (i32.add (i32.add (i32.const 261) (i32.const 8)) (i32.shl (i32.const 4) (i32.const 3)))) (i32.const 137))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (block $break_2
      ...
      (call $__str_concat (local.get $twoDStr_ptr) (local.get $twoDStr_len) (i32.const 357) (i32.const 1))
    ...
    (;; string assignment from complex expression not yet supported: twoDStr = twoDStr + "]";)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
  ...
  (data (i32.const 357) "\20")
  (data (i32.const 261) "\05\00\00\00\05\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
  (data (i32.const 309) "\05\00\00\00\05\00\00\00\00\00\00\00\00\00\f0\3f\00\00\00\00\00\00\00\40\00\00\00\00\00\00\08\40\00\00\00\00\00\00\10\40\00\00\00\00\00\00\14\40")
)