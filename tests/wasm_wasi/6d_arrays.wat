(module
  ...
  (func $_start (export "_start")
    ...
    (local.set $a (i32.const 262))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (f64.store (i32.add (i32.add (i32.const 262) (i32.const 8)) (i32.shl (i32.const 4) (i32.const 3))) (f64.const 100))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 135) (i32.const 58))
          (i32.store8 (i32.const 136) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 5) (call $__f64_to_str (f64.load (i32.add (i32.add (i32.const 262) (i32.const 8)) (i32.shl (i32.const 4) (i32.const 3)))) (i32.const 137))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (block $break_0
      (loop $loop_0
        (br_if $break_0 (i32.eqz (f64.lt (local.get $row) (f64.const 2))))
        (block $cont_0
          (local.set $col (f64.const 0))
          (block $break_1
            (loop $loop_1
              (br_if $break_1 (i32.eqz (f64.lt (local.get $col) (f64.const 3))))
              (block $cont_1
                (f64.store (i32.add (i32.add (i32.load (i32.add (i32.add (local.get $twoD) (i32.const 8)) (i32.shl (i32.trunc_f64_s (local.get $row)) (i32.const 2)))) (i32.const 8)) (i32.shl (i32.trunc_f64_s (local.get $col)) (i32.const 3))) (f64.add (local.get $row) (local.get $col)))
              )
    ...
    (block $break_2
      (loop $loop_2
        (br_if $break_2 (i32.eqz (f64.lt (local.get $r) (f64.convert_i32_s (i32.load (local.get $twoD))))))
        (block $cont_2
          (if (f64.gt (local.get $r) (f64.const 0))
            (then
            (local.set $twoDStr_ptr (local.get $twoDStr_ptr))
      (local.set $twoDStr_len (local.get $twoDStr_len))
      (call $__str_concat (local.get $twoDStr_ptr) (local.get $twoDStr_len) (i32.const 358) (i32.const 1))
      ...
      (local.set $twoDStr_ptr)
          ...
          (local.set $twoDStr_ptr (local.get $twoDStr_ptr))
      (local.set $twoDStr_len (local.get $twoDStr_len))
      (call $__str_concat (local.get $twoDStr_ptr) (local.get $twoDStr_len) (call $numArrStr (i32.load (i32.add (i32.add (local.get $twoD) (i32.const 8)) (i32.shl (i32.trunc_f64_s (local.get $r)) (i32.const 2))))) (global.get $__str_ret_ptr) (global.get $__str_ret_len))
      (local.set $twoDStr_len)
      (local.set $twoDStr_ptr)
        )
  ...
  (data (i32.const 261) "\5d")
  (data (i32.const 358) "\20")
  (data (i32.const 262) "\05\00\00\00\05\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
  (data (i32.const 310) "\05\00\00\00\05\00\00\00\00\00\00\00\00\00\f0\3f\00\00\00\00\00\00\00\40\00\00\00\00\00\00\08\40\00\00\00\00\00\00\10\40\00\00\00\00\00\00\14\40")
)