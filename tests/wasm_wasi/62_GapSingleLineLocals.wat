(module
  ...
  (func $check (param $c i32) (param $base i32) 
    ...
    (if (i32.eq (local.get $c) (i32.const 0))
      (then
      (local.set $x (i32.mul (local.get $base) (i32.const 2)))
  ...
  (func $_start (export "_start")
    (call $check (i32.const 0) (i32.const 10))
    (call $check (i32.const 9) (i32.const 0))
