(module
  ...
  (func $testDestructuring (export "testDestructuring")  (result f64)
    (local $v i32)
    (local $x f64)
    (local $y f64)
  ...
  (func $_start (export "_start")
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (call $testDestructuring) (i32.const 132)))
  ...
  (data (i32.const 260) "\00\00\00\00\00\00\25\40\00\00\00\00\00\80\34\40")
)