(module
  ...
  (global $big i32 (i32.const 255))
  (global $radix i32 (i32.const 16))
  (global $neg i32 (i32.const -255))
  ...
  (func $fmtHex (param $x i32) 
    (local $__iface_tmp i32)
    (local $__ret_str_ptr i32)
    (local $__ret_str_len i32)
    (local $__str_op_ptr i32)
    (local $__str_op_len i32)
    (local.set $__ret_str_ptr (call $__malloc (i32.const 36)))
      (local.set $__ret_str_len (call $__i32_to_str_radix (local.get $x) (i32.const 16) (local.get $__ret_str_ptr)))
  ...
  (func $_start (export "_start")
    ...
    (local $__str_op_len i32)
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (call $__str_gather (block (result i32) (block (result i32) (local.set $__str_op_ptr (call $__malloc (i32.const 36))) (local.set $__str_op_len (call $__i32_to_str_radix (global.get $n) (i32.const 2) (local.get $__str_op_ptr))) (local.get $__str_op_ptr)) (local.get $__str_op_len) (local.set $__str_op_len)) (local.get $__str_op_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $__str_op_len)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (block (result i32) (block (result i32) (local.set $__str_op_ptr (call $__malloc (i32.const 36))) (local.set $__str_op_len (call $__i32_to_str_radix (global.get $big) (i32.const 16) (local.get $__str_op_ptr))) (local.get $__str_op_ptr)) (local.get $__str_op_len) (local.set $__str_op_len)) (local.get $__str_op_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $__str_op_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (block (result i32) (block (result i32) (local.set $__str_op_ptr (call $__malloc (i32.const 36))) (local.set $__str_op_len (call $__i32_to_str_radix (global.get $big) (global.get $radix) (local.get $__str_op_ptr))) (local.get $__str_op_ptr)) (local.get $__str_op_len) (local.set $__str_op_len)) (local.get $__str_op_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $__str_op_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (block (result i32) (block (result i32) (local.set $__str_op_ptr (call $__malloc (i32.const 36))) (local.set $__str_op_len (call $__i32_to_str_radix (global.get $n) (i32.const 8) (local.get $__str_op_ptr))) (local.get $__str_op_ptr)) (local.get $__str_op_len) (local.set $__str_op_len)) (local.get $__str_op_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $__str_op_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
        ...
        (i32.store (i32.const 0) (i32.const 260))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $s_ptr (call $__malloc (i32.const 36)))
      (local.set $s_len (call $__i32_to_str_radix (global.get $big) (i32.const 2) (local.get $s_ptr)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (call $__str_gather (block (result i32) (block (result i32) (local.set $__str_op_ptr (call $__malloc (i32.const 36))) (local.set $__str_op_len (call $__i32_to_str_radix (global.get $big) (i32.const 16) (local.get $__str_op_ptr))) (local.get $__str_op_ptr)) (local.get $__str_op_len) (local.set $__str_op_len)) (local.get $__str_op_len) (i32.const 136))
          (i32.store (i32.const 4) (i32.add (i32.const 4) (local.get $__str_op_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (block (result i32) (block (result i32) (local.set $__str_op_ptr (call $__malloc (i32.const 36))) (local.set $__str_op_len (call $__i32_to_str_radix (global.get $neg) (i32.const 16) (local.get $__str_op_ptr))) (local.get $__str_op_ptr)) (local.get $__str_op_len) (local.set $__str_op_len)) (local.get $__str_op_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $__str_op_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
