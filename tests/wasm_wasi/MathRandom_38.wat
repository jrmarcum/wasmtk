(module
  ...
  (func $_start (export "_start")
    ...
    (if (i32.or (f64.lt (local.get $r0) (f64.const 0)) (f64.ge (local.get $r0) (f64.const 1)))
      (then
      (global.set $allInRange (i32.const 0))
      )
    )
    (local.set $r1 (call $mathlib_random))
    (if (i32.or (f64.lt (local.get $r1) (f64.const 0)) (f64.ge (local.get $r1) (f64.const 1)))
      (then
      (global.set $allInRange (i32.const 0))
      )
    )
    (local.set $r2 (call $mathlib_random))
    (if (i32.or (f64.lt (local.get $r2) (f64.const 0)) (f64.ge (local.get $r2) (f64.const 1)))
      (then
      (global.set $allInRange (i32.const 0))
      )
    )
    (local.set $r3 (call $mathlib_random))
    (if (i32.or (f64.lt (local.get $r3) (f64.const 0)) (f64.ge (local.get $r3) (f64.const 1)))
      (then
      (global.set $allInRange (i32.const 0))
      )
    )
    (local.set $r4 (call $mathlib_random))
    (if (i32.or (f64.lt (local.get $r4) (f64.const 0)) (f64.ge (local.get $r4) (f64.const 1)))
      (then
      (global.set $allInRange (i32.const 0))
      )
    )
