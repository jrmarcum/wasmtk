(module
  ...
  (func $intSeq__inner (param $__closure_ptr i32) (result f64)
    (f64.store offset=4 (local.get $__closure_ptr) (f64.add (f64.load offset=4 (local.get $__closure_ptr)) (f64.const 1)))
    (return (f64.load offset=4 (local.get $__closure_ptr)))
  )

  (func $intSeq  (result i32)
    ...
    (f64.store offset=4 (local.get $__closure_ptr) (local.get $i))
    (local.get $__closure_ptr)
  )

  (func $intSeq__trampoline (param $__closure_ptr i32) (result f64)
    (call $intSeq__inner (local.get $__closure_ptr))
  )
  (func $_start (export "_start")
    (local $nextInt i32)
    (local $newInts i32)
    (local $__iface_tmp i32)
    (local.set $nextInt (call $intSeq ))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (call_indirect (type $ftype_i32_r_f64) (local.get $nextInt) (i32.load (local.get $nextInt))) (i32.const 132)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $newInts (call $intSeq ))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (call_indirect (type $ftype_i32_r_f64) (local.get $newInts) (i32.load (local.get $newInts))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (table 1 funcref)
  (elem (i32.const 0) $intSeq__trampoline)
)