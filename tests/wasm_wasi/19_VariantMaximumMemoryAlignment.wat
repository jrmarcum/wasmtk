(module
  ...
  (func $testUnionAlignment (export "testUnionAlignment")  
    ...
    (local.set $ev1 (i32.const 260))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 144) (i32.const 69))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 23) (call $__f64_to_str (call $processEvent (local.get $ev1)) (i32.const 155))))
    ...
    (local.set $ev2 (i32.const 288))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 20) (call $__f64_to_str (call $processEvent (local.get $ev2)) (i32.const 152))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    (call $testUnionAlignment )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 316) "\2d\2d\2d\20\54\65\73\74\20\31\3a\20\55\6e\69\6f\6e\20\46\6f\6f\74\70\72\69\6e\74\20\41\6c\69\67\6e\6d\65\6e\74\20\2d\2d\2d\0a")
  (data (i32.const 260) "\00\00\00\00\c8\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
  (data (i32.const 288) "\01\00\00\00\00\00\00\00\00\00\00\00\00\00\25\40\00\00\00\00\00\80\34\40\32\00\00\00")
)