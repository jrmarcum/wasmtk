(module
  ...
  (func $isTruthyString (export "isTruthyString") (param $a_ptr i32) (param $a_len i32) (result i32)
    (if (i32.gt_s (local.get $a_len) (i32.const 0))
      (then
      (return (i32.const 1))
      )
    )
  ...
  (func $ternaryCompare (export "ternaryCompare") (param $a f64) (param $b f64) (result i32)
    ...
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (if (result i32) (call $isTruthyString (i32.const 260) (i32.const 0)) (then (i32.const 260)) (else (i32.const 264))))
          ...
          (drop (call $fd_write
            ...
            (i32.const 2)
            (i32.const 128)))
        (i32.store (i32.const 0) (if (result i32) (call $isTruthyString (i32.const 270) (i32.const 5)) (then (i32.const 260)) (else (i32.const 264))))
          (i32.store (i32.const 4) (if (result i32) (call $isTruthyString (i32.const 270) (i32.const 5)) (then (i32.const 4)) (else (i32.const 5))))
          (i32.store (i32.const 8) (i32.const 269))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $ternaryCompare (f64.const 5) (f64.const 3)) (i32.const 132)))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $ternaryCompare (f64.const 2) (f64.const 4)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 270) "\68\65\6c\6c\6f")
)