(module
  ...
  (func $get1  (result i32)
    (return (i32.load (i32.add (i32.add (global.get $arr) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 2)))))
  )

  (func $setAt (param $i i32) (param $v i32) 
    (i32.store (i32.add (i32.add (global.get $arr) (i32.const 8)) (i32.shl (local.get $i) (i32.const 2))) (local.get $v))
  )
  ...
  (func $sum  (result i32)
    ...
    (block $break_0
      (loop $loop_0
        (br_if $break_0 (i32.eqz (i32.lt_s (local.get $i) (i32.load (global.get $arr)))))
        (block $cont_0
          (local.set $t (i32.add (local.get $t) (i32.load (i32.add (i32.add (global.get $arr) (i32.const 8)) (i32.shl (local.get $i) (i32.const 2))))))
        )
        (local.set $i (i32.add (local.get $i) (i32.const 1)))
        (br $loop_0)
      )
  ...
  (func $_start (export "_start")
    ...
    (global.set $arr (call $__malloc (i32.const 40)))
      (i32.store (global.get $arr) (i32.const 3))
      (i32.store offset=4 (global.get $arr) (i32.const 8))
      (i32.store offset=8 (global.get $arr) (i32.const 10))
      (i32.store offset=12 (global.get $arr) (i32.const 20))
      (i32.store offset=16 (global.get $arr) (i32.const 30))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $get1) (i32.const 132)))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $setAt (i32.const 1) (i32.const 99))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.add (global.get $arr) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 2)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $sum) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
