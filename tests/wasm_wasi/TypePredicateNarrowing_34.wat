(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 317))
  ...
  (func $isPlayer (param $e i32) (result i32)
    (return (i32.eq (i32.load (i32.add (local.get $e) (i32.const 0))) (i32.const 1)))
  )

  (func $isEnemy (param $e i32) (result i32)
    (return (i32.eq (i32.load (i32.add (local.get $e) (i32.const 0))) (i32.const 2)))
  )

  (func $processEntity (param $e i32) 
    (local $__iface_tmp i32)
    (if (call $isPlayer (local.get $e))
      (then
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 14) (call $__i32_to_str (i32.load (i32.add (local.get $e) (i32.const 8))) (i32.const 146))))
  ...
  (func $main  
    ...
    (local $ent i32)
    (local $__iface_tmp i32)
    (local.set $p (i32.const 275))
    (local.set $enem (i32.const 287))
    (local.set $ent (i32.const 299))
        (i32.store (i32.const 0) (if (result i32) (call $isPlayer (local.get $p)) (then (i32.const 307)) (else (i32.const 311))))
          (i32.store (i32.const 4) (if (result i32) (call $isPlayer (local.get $p)) (then (i32.const 4)) (else (i32.const 5))))
          (i32.store (i32.const 8) (i32.const 316))
          ...
          (drop (call $fd_write
            ...
            (i32.const 2)
            (i32.const 128)))
        (i32.store (i32.const 0) (if (result i32) (call $isPlayer (local.get $enem)) (then (i32.const 307)) (else (i32.const 311))))
          (i32.store (i32.const 4) (if (result i32) (call $isPlayer (local.get $enem)) (then (i32.const 4)) (else (i32.const 5))))
          (i32.store (i32.const 8) (i32.const 316))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 2)
            (i32.const 128)))
        (i32.store (i32.const 0) (if (result i32) (call $isEnemy (local.get $enem)) (then (i32.const 307)) (else (i32.const 311))))
          (i32.store (i32.const 4) (if (result i32) (call $isEnemy (local.get $enem)) (then (i32.const 4)) (else (i32.const 5))))
          (i32.store (i32.const 8) (i32.const 316))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 2)
            (i32.const 128)))
    (call $processEntity (local.get $p))
    (call $processEntity (local.get $enem))
    (call $processEntity (local.get $ent))
  )
  (func $_start (export "_start")
    (call $main)
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 260) "\75\6e\6b\6e\6f\77\6e\20\65\6e\74\69\74\79\0a")
  (data (i32.const 307) "\74\72\75\65")
  (data (i32.const 311) "\66\61\6c\73\65")
  (data (i32.const 316) "\0a")
  (data (i32.const 275) "\01\00\00\00\0a\00\00\00\64\00\00\00")
  (data (i32.const 287) "\02\00\00\00\05\00\00\00\32\00\00\00")
  (data (i32.const 299) "\03\00\00\00\07\00\00\00")
)