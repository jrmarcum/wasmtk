(module
  ...
  (func $makeRect (param $width i32) (param $height i32) (result i32)
    (local $__obj_ret i32)
    (local $__nested_ptr i32)
    (local.set $__obj_ret (call $__malloc (i32.const 8)))
      (i32.store offset=0 (local.get $__obj_ret) (local.get $width))
      (i32.store offset=4 (local.get $__obj_ret) (local.get $height))
      (return (local.get $__obj_ret))
  )

  (func $scaleVec (param $v i32) (param $factor f64) (result i32)
    (local $x f64)
    (local $y f64)
    (local $__obj_ret i32)
    (local $__nested_ptr i32)
    (local.set $x (f64.mul (f64.load (i32.add (local.get $v) (i32.const 0))) (local.get $factor)))
    (local.set $y (f64.mul (f64.load (i32.add (local.get $v) (i32.const 8))) (local.get $factor)))
    (local.set $__obj_ret (call $__malloc (i32.const 16)))
      (f64.store offset=0 (local.get $__obj_ret) (local.get $x))
      (f64.store offset=8 (local.get $__obj_ret) (local.get $y))
      (return (local.get $__obj_ret))
  ...
  (func $main  
    ...
    (local.set $v (call $makeVec (f64.const 3.0) (f64.const 4.0)))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 3) (call $__f64_to_str (f64.load (i32.add (local.get $v) (i32.const 0))) (i32.const 135))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 133) (i32.const 58))
          (i32.store8 (i32.const 134) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 3) (call $__f64_to_str (f64.load (i32.add (local.get $v) (i32.const 8))) (i32.const 135))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $r (call $makeRect (i32.const 10) (i32.const 20)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 7) (call $__i32_to_str (i32.load (i32.add (local.get $r) (i32.const 0))) (i32.const 139))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 8) (call $__i32_to_str (i32.load (i32.add (local.get $r) (i32.const 4))) (i32.const 140))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $v2 (call $scaleVec (local.get $v) (f64.const 2.0)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 10) (call $__f64_to_str (f64.load (i32.add (local.get $v2) (i32.const 0))) (i32.const 142))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 140) (i32.const 58))
          (i32.store8 (i32.const 141) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 10) (call $__f64_to_str (f64.load (i32.add (local.get $v2) (i32.const 8))) (i32.const 142))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
