(module
  ...
  (func $_start (export "_start")
    ...
    (local.set $sl (call $__malloc (i32.const 72)))
      ...
      (i32.store offset=24 (local.get $sl) (i32.const 0))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (i32.store (i32.add (i32.add (local.get $sl) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 3))) (i32.const 297))
      (i32.store offset=4 (i32.add (i32.add (local.get $sl) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 3))) (i32.const 1))
    (i32.store (i32.add (i32.add (local.get $sl) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 3))) (i32.const 298))
      (i32.store offset=4 (i32.add (i32.add (local.get $sl) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 3))) (i32.const 1))
    (i32.store (i32.add (i32.add (local.get $sl) (i32.const 8)) (i32.shl (i32.const 2) (i32.const 3))) (i32.const 299))
      (i32.store offset=4 (i32.add (i32.add (local.get $sl) (i32.const 8)) (i32.shl (i32.const 2) (i32.const 3))) (i32.const 1))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 135) (i32.const 58))
          (i32.store8 (i32.const 136) (i32.const 32))
          (call $__str_gather (i32.load (i32.add (i32.add (local.get $sl) (i32.const 8)) (i32.shl (i32.const 2) (i32.const 3)))) (i32.load offset=4 (i32.add (i32.add (local.get $sl) (i32.const 8)) (i32.shl (i32.const 2) (i32.const 3)))) (i32.const 137))
          (i32.store (i32.const 4) (i32.add (i32.const 5) (i32.load offset=4 (i32.add (i32.add (local.get $sl) (i32.const 8)) (i32.shl (i32.const 2) (i32.const 3))))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $sl (call $__dynarr_push_string (local.get $sl) (i32.const 300) (i32.const 1)))
    (local.set $sl (call $__dynarr_push_string (local.get $sl) (i32.const 301) (i32.const 1)))
    (local.set $sl (call $__dynarr_push_string (local.get $sl) (i32.const 302) (i32.const 1)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
    ...
    (block $break_0
      ...
      (i32.store offset=4 (local.get $inner) (i32.const 8))
          ...
          (block $break_1
            (loop $loop_1
              (br_if $break_1 (i32.eqz (f64.le (local.get $j) (local.get $i))))
              (block $cont_1
          ...
          (local.set $twoD (call $__dynarr_push_i32 (local.get $twoD) (local.get $inner)))
        )
    ...
    (block $break_2
      (loop $loop_2
        (br_if $break_2 (i32.eqz (f64.lt (local.get $i) (f64.convert_i32_s (i32.load (local.get $twoD))))))
        (block $cont_2
          (if (f64.gt (local.get $i) (f64.const 0))
            (then
            (local.set $twoDStr_ptr (local.get $twoDStr_ptr))
      (local.set $twoDStr_len (local.get $twoDStr_len))
      (call $__str_concat (local.get $twoDStr_ptr) (local.get $twoDStr_len) (i32.const 303) (i32.const 1))
  ...
  (data (i32.const 262) "\67")
  (data (i32.const 263) "\68")
  (data (i32.const 264) "\69")
  (data (i32.const 297) "\61")
  (data (i32.const 298) "\62")
  (data (i32.const 299) "\63")
  (data (i32.const 300) "\64")
  (data (i32.const 301) "\65")
  (data (i32.const 302) "\66")
  (data (i32.const 303) "\20")
  (data (i32.const 265) "\03\00\00\00\03\00\00\00\06\01\00\00\01\00\00\00\07\01\00\00\01\00\00\00\08\01\00\00\01\00\00\00")
)