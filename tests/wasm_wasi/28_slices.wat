(module
  ...
  (func $_start (export "_start")
      ...
      (i32.store offset=24 (local.get $sl) (i32.const 0))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (i32.store (i32.add (i32.add (local.get $sl) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 3))) (i32.const 296))
      (i32.store offset=4 (i32.add (i32.add (local.get $sl) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 3))) (i32.const 1))
    (i32.store (i32.add (i32.add (local.get $sl) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 3))) (i32.const 297))
      (i32.store offset=4 (i32.add (i32.add (local.get $sl) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 3))) (i32.const 1))
    (i32.store (i32.add (i32.add (local.get $sl) (i32.const 8)) (i32.shl (i32.const 2) (i32.const 3))) (i32.const 298))
      (i32.store offset=4 (i32.add (i32.add (local.get $sl) (i32.const 8)) (i32.shl (i32.const 2) (i32.const 3))) (i32.const 1))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $sl (call $__dynarr_push_string (local.get $sl) (i32.const 299) (i32.const 1)))
    ...
    (block $break_2
      ...
      (call $__str_concat (local.get $twoDStr_ptr) (local.get $twoDStr_len) (i32.const 302) (i32.const 1))
  ...
  (data (i32.const 261) "\67")
  (data (i32.const 262) "\68")
  (data (i32.const 263) "\69")
  (data (i32.const 296) "\61")
  (data (i32.const 297) "\62")
  (data (i32.const 298) "\63")
  (data (i32.const 299) "\64")
  (data (i32.const 300) "\65")
  (data (i32.const 301) "\66")
  (data (i32.const 302) "\20")
