(module
  ...
  (func $testIdiomaticCatch (export "testIdiomaticCatch")  
    (local $e_ptr i32)
    (local $e_len i32)
    (local $msg1_ptr i32)
    (local $msg1_len i32)
    ...
    (try
      (do
        (throw $__exn_tag (i32.const 260) (i32.const 24))
      )
      (catch $__exn_tag
        (local.set $e_len)
        (local.set $e_ptr)
        (local.set $msg1_ptr (local.get $e_ptr))
      (local.set $msg1_len (local.get $e_len))
        (call $__str_concat (i32.const 284) (i32.const 7) (local.get $e_ptr) (local.get $e_len))
      (local.set $msg2_len)
      (local.set $msg2_ptr)
          ...
          (i32.store8 (i32.const 140) (i32.const 82))
          ...
          (call $__str_gather (local.get $msg1_ptr) (local.get $msg1_len) (i32.const 148))
          (i32.store (i32.const 4) (i32.add (i32.const 16) (local.get $msg1_len)))
          ...
          (call $__str_gather (local.get $msg2_ptr) (local.get $msg2_len) (i32.const 147))
          (i32.store (i32.const 4) (i32.add (i32.const 15) (local.get $msg2_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 291))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $testIdiomaticCatch )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 260) "\53\74\72\75\63\74\75\72\61\6c\20\45\72\72\6f\72\20\4d\65\73\73\61\67\65")
  (data (i32.const 284) "\45\72\72\6f\72\3a\20")
  (data (i32.const 291) "\2d\2d\2d\20\54\65\73\74\20\33\3a\20\49\64\69\6f\6d\61\74\69\63\20\43\68\65\63\6b\69\6e\67\20\2d\2d\2d\0a")
)