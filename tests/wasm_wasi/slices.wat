(module
  ...
  ;; Dynamic array slice_string: alloc new array from [start,end), clamp to bounds.
  ...
  (func $_start (export "_start")
    ...
    (local.set $sl (call $__malloc (i32.const 40)))
      ...
      (i32.store offset=16 (local.get $sl) (i32.const 0))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (i32.store (i32.add (i32.add (local.get $sl) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 2))) (;? "a" ;) (i32.const 0))
    (i32.store (i32.add (i32.add (local.get $sl) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 2))) (;? "b" ;) (i32.const 0))
    (i32.store (i32.add (i32.add (local.get $sl) (i32.const 8)) (i32.shl (i32.const 2) (i32.const 2))) (;? "c" ;) (i32.const 0))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 135) (i32.const 58))
          (i32.store8 (i32.const 136) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 5) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $sl) (i32.const 8)) (i32.shl (i32.const 2) (i32.const 2)))) (i32.const 137))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 135) (i32.const 58))
          (i32.store8 (i32.const 136) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 5) (call $__i32_to_str (i32.load (local.get $sl)) (i32.const 137))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $sl (call $__dynarr_push_string (local.get $sl) (;? "d" ;) (i32.const 0)))
    (local.set $sl (call $__dynarr_push_string (local.get $sl) (;? "e" ;) (i32.const 0)))
    (local.set $sl (call $__dynarr_push_string (local.get $sl) (;? "f" ;) (i32.const 0)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $c (call $__dynarr_slice_string (local.get $sl) (i32.const 0) (i32.load (local.get $sl))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $l1 (call $__dynarr_slice_string (local.get $sl) (i32.const 2) (i32.const 5)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 115))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $l2 (call $__dynarr_slice_string (local.get $sl) (i32.const 0) (i32.const 5)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 115))
          (i32.store8 (i32.const 133) (i32.const 108))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $l3 (call $__dynarr_slice_string (local.get $sl) (i32.const 2) (i32.load (local.get $sl))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 115))
          (i32.store8 (i32.const 133) (i32.const 108))
          (i32.store8 (i32.const 134) (i32.const 51))
          (i32.store8 (i32.const 135) (i32.const 58))
          (i32.store8 (i32.const 136) (i32.const 32))
          (call $strArrStr (local.get $l3))
          (call $__str_gather (global.get $__str_ret_ptr) (global.get $__str_ret_len) (i32.const 137))
          (i32.store (i32.const 4) (i32.add (i32.const 5) (global.get $__str_ret_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
    ...
    (local.set $twoD (call $__malloc (i32.const 40)))
      (i32.store (local.get $twoD) (i32.const 0))
      (i32.store offset=4 (local.get $twoD) (i32.const 8))
    (local.set $i (f64.const 0))
    (block $break_2
      (loop $loop_2
        (br_if $break_2 (i32.eqz (f64.lt (local.get $i) (f64.const 3))))
        (block $cont_2
          (local.set $inner (call $__malloc (i32.const 72)))
      (i32.store (local.get $inner) (i32.const 0))
      (i32.store offset=4 (local.get $inner) (i32.const 8))
          (local.set $j (f64.const 0))
          (block $break_3
            (loop $loop_3
              (br_if $break_3 (i32.eqz (f64.le (local.get $j) (local.get $i))))
              (block $cont_3
                (local.set $inner (call $__dynarr_push_f64 (local.get $inner) (f64.add (local.get $i) (local.get $j))))
              )
              (local.set $j (f64.add (local.get $j) (f64.const 1)))
              (br $loop_3)
            )
          )
          (local.set $twoD (call $__dynarr_push_f64 (local.get $twoD) (f64.convert_i32_s (local.get $inner))))
        )
        (local.set $i (f64.add (local.get $i) (f64.const 1)))
        (br $loop_2)
      )
    ...
    (block $break_4
      (loop $loop_4
        (br_if $break_4 (i32.eqz (f64.lt (local.get $i) (f64.convert_i32_s (i32.load (local.get $twoD))))))
        (block $cont_4
          (if (f64.gt (local.get $i) (f64.const 0))
            (then
      ...
      (local.set $twoDStr_ptr)
          ...
          (call $__str_concat (local.get $twoDStr_ptr) (local.get $twoDStr_len) (call $numArrStr (i32.load (i32.add (i32.add (local.get $twoD) (i32.const 8)) (i32.shl (i32.trunc_f64_s (i32.trunc_f64_s (local.get $i))) (i32.const 2))))) (global.get $__str_ret_ptr) (global.get $__str_ret_len))
      (local.set $twoDStr_len)
      (local.set $twoDStr_ptr)
        )
        (local.set $i (f64.add (local.get $i) (f64.const 1)))
