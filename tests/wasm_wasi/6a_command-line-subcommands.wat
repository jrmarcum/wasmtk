(module
  ...
  (func $strArrStr (param $arr i32) 
    ...
    (block $break_0
      ...
      (call $__str_concat (local.get $s_ptr) (local.get $s_len) (i32.const 264) (i32.const 1))
      (local.set $s_len)
      (local.set $s_ptr)
            )
          )
    ...
    (local.set $__ret_str_ptr (local.get $s_ptr))
      ...
      (call $__str_concat (local.get $__ret_str_ptr) (local.get $__ret_str_len) (i32.const 265) (i32.const 1))
  ...
  (func $_start (export "_start")
    (local $fooEnable i32)
    (local $fooName_ptr i32)
    (local $fooName_len i32)
    (local $fooTail i32)
    (local $__iface_tmp i32)
    (local.set $fooEnable (i32.const 1))
    (local.set $fooName_ptr (i32.const 260))
      (local.set $fooName_len (i32.const 3))
    (local.set $fooTail (i32.const 270))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (call $__str_gather (if (result i32) (local.get $fooEnable) (then (i32.const 311)) (else (i32.const 315))) (if (result i32) (local.get $fooEnable) (then (i32.const 4)) (else (i32.const 5))) (i32.const 142))
          (i32.store (i32.const 4) (i32.add (i32.const 10) (if (result i32) (local.get $fooEnable) (then (i32.const 4)) (else (i32.const 5)))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (call $__str_gather (local.get $fooName_ptr) (local.get $fooName_len) (i32.const 140))
          (i32.store (i32.const 4) (i32.add (i32.const 8) (local.get $fooName_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 138) (i32.const 58))
          (i32.store8 (i32.const 139) (i32.const 32))
          (call $strArrStr (local.get $fooTail))
  ...
  (data (i32.const 260) "\6a\6f\65")
  (data (i32.const 263) "\5b")
  (data (i32.const 264) "\20")
  (data (i32.const 265) "\5d")
  (data (i32.const 266) "\61\31")
  (data (i32.const 268) "\61\32")
  (data (i32.const 294) "\73\75\62\63\6f\6d\6d\61\6e\64\20\27\66\6f\6f\27\0a")
  (data (i32.const 311) "\74\72\75\65")
  (data (i32.const 315) "\66\61\6c\73\65")
  (data (i32.const 270) "\02\00\00\00\02\00\00\00\0a\01\00\00\02\00\00\00\0c\01\00\00\02\00\00\00")
)