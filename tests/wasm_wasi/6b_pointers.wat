(module
  ...
  (func $zeroval (param $ival f64) 
    (local.set $ival (f64.const 0))
  )

  (func $zeroref (param $obj i32) 
    (f64.store (i32.add (local.get $obj) (i32.const 0)) (f64.const 0))
  )
  (func $_start (export "_start")
    ...
    (local $__tmpl_num_len i32)
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 9) (call $__f64_to_str (global.get $i) (i32.const 141))))
    ...
    (call $zeroval (global.get $i))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $iRef (i32.const 260))
    (call $zeroref (local.get $iRef))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 122))
          (i32.store8 (i32.const 133) (i32.const 101))
          ...
          (i32.store8 (i32.const 139) (i32.const 58))
          (i32.store8 (i32.const 140) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 9) (call $__f64_to_str (f64.load (i32.add (i32.const 260) (i32.const 0))) (i32.const 141))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 143) (i32.const 123))
          (i32.store8 (i32.const 144) (i32.const 118))
          (i32.store8 (i32.const 145) (i32.const 97))
          (i32.store8 (i32.const 146) (i32.const 108))
          (i32.store8 (i32.const 147) (i32.const 58))
          (i32.store (i32.const 4) (i32.add (i32.const 16) (call $__f64_to_str (f64.load (i32.add (i32.const 260) (i32.const 0))) (i32.const 148))))
