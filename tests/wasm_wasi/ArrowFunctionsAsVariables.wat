(module
  ...
  (func $testFunctionAssignment (export "testFunctionAssignment") (param $op i32) (result i32)
    (local $mathOp i32)
    
    (if (i32.eq (local.get $op) (i32.const 1))
      (then
      (local.set $mathOp (i32.const 0))
      )
      (else
      (local.set $mathOp (i32.const 1))
      )
    )
    (return (call_indirect (type $ftype_i32_i32_r_i32) (i32.const 10) (i32.const 5) (local.get $mathOp)))
  )
  ...
  (func $__anon_1 (param $a i32) (param $b i32) (result i32)
    (return (i32.mul (local.get $a) (local.get $b)))
  )
  (func $_start (export "_start")
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $testFunctionAssignment (i32.const 1)) (i32.const 132)))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $testFunctionAssignment (i32.const 2)) (i32.const 132)))
          (i32.store (i32.const 8) (i32.const 260))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
