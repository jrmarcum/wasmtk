(module
  ...
  (func $testArrayRest (export "testArrayRest")  (result i32)
    ...
    (local.set $_first (i32.load (i32.const 268)))
      ...
      (i32.store offset=8 (local.get $rest) (i32.load (i32.const 272)))
      (i32.store offset=12 (local.get $rest) (i32.load (i32.const 276)))
