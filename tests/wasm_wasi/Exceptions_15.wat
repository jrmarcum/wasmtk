    ...
    (try
      ...
      (catch $__exn_tag
        ...
        (local.set $e_ptr)
          ...
          (i32.store (i32.const 4) (call $__f64_to_str (if (result f64) (;? e instanceof Error ;) (i32.const 0) (then (;? e.message ;) (f64.const 0)) (else (call $String (local.get $e)))) (i32.const 132)))
  ...
  (func $testThrowString  
    ...
    (try
      ...
      (catch $__exn_tag
        ...
        (local.set $e_ptr)
            (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $String (local.get $e)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
