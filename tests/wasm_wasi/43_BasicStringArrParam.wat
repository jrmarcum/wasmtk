(module
  ...
  (func $strIncludes (param $arr i32) (param $v_ptr i32) (param $v_len i32) (result i32)
    (return (i32.ge_s (call $strIndexOf (local.get $arr) (local.get $v_ptr) (local.get $v_len)) (i32.const 0)))
  )
  (func $_start (export "_start")
    (local $fruits i32)
    (local $__iface_tmp i32)
    (local.set $fruits (i32.const 281))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $strIndexOf (local.get $fruits) (i32.const 271) (i32.const 6)) (i32.const 132)))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $strIndexOf (local.get $fruits) (i32.const 321) (i32.const 5)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
        (i32.store (i32.const 0) (if (result i32) (call $strIncludes (local.get $fruits) (i32.const 265) (i32.const 6)) (then (i32.const 326)) (else (i32.const 330))))
          (i32.store (i32.const 4) (if (result i32) (call $strIncludes (local.get $fruits) (i32.const 265) (i32.const 6)) (then (i32.const 4)) (else (i32.const 5))))
          ...
          (drop (call $fd_write
            ...
            (i32.const 2)
            (i32.const 128)))
        (i32.store (i32.const 0) (if (result i32) (call $strIncludes (local.get $fruits) (i32.const 336) (i32.const 5)) (then (i32.const 326)) (else (i32.const 330))))
          (i32.store (i32.const 4) (if (result i32) (call $strIncludes (local.get $fruits) (i32.const 336) (i32.const 5)) (then (i32.const 4)) (else (i32.const 5))))
          (i32.store (i32.const 8) (i32.const 335))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 271) "\63\68\65\72\72\79")
  (data (i32.const 277) "\64\61\74\65")
  (data (i32.const 321) "\67\72\61\70\65")
  (data (i32.const 326) "\74\72\75\65")
  (data (i32.const 330) "\66\61\6c\73\65")
  (data (i32.const 335) "\0a")
  (data (i32.const 336) "\6d\61\6e\67\6f")
  (data (i32.const 281) "\04\00\00\00\04\00\00\00\04\01\00\00\05\00\00\00\09\01\00\00\06\00\00\00\0f\01\00\00\06\00\00\00\15\01\00\00\04\00\00\00")
)