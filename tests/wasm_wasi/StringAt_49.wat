(module
  ...
  (func $main  
    ...
    (local.set $s_ptr (i32.const 260))
      (local.set $s_len (i32.const 11))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (i32.add (local.get $s_ptr) (select (i32.const -2) (i32.add (local.get $s_len) (i32.const -2)) (i32.ge_s (i32.const -2) (i32.const 0)))) (i32.const 1) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (i32.const 1)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $t_ptr (i32.const 271))
      (local.set $t_len (i32.const 3))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (i32.add (local.get $t_ptr) (select (i32.const 0) (i32.add (local.get $t_len) (i32.const 0)) (i32.ge_s (i32.const 0) (i32.const 0)))) (i32.const 1) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (i32.const 1)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (i32.add (local.get $t_ptr) (select (i32.const -1) (i32.add (local.get $t_len) (i32.const -1)) (i32.ge_s (i32.const -1) (i32.const 0)))) (i32.const 1) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (i32.const 1)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (i32.add (local.get $t_ptr) (select (i32.const -2) (i32.add (local.get $t_len) (i32.const -2)) (i32.ge_s (i32.const -2) (i32.const 0)))) (i32.const 1) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (i32.const 1)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
  ...
  (data (i32.const 260) "\68\65\6c\6c\6f\20\77\6f\72\6c\64")
  (data (i32.const 271) "\61\62\63")
)