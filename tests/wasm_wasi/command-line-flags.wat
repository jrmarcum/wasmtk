(module
  ...
  (func $strArrStr (param $arr i32) 
      ...
      (loop $loop_0
        ...
        (block $cont_0
          (if (f64.gt (local.get $i) (f64.const 0))
            (then
            (call $__str_concat (local.get $s_ptr) (local.get $s_len) (i32.const 268) (i32.const 1))
      (local.set $s_len)
      (local.set $s_ptr)
            )
          )
    ...
    (call $__str_concat (local.get $s_ptr) (local.get $s_len) (i32.const 269) (i32.const 1))
  ...
  (func $_start (export "_start")
    ...
    (local.set $tail (i32.const 270))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 136) (i32.const 58))
          (i32.store8 (i32.const 137) (i32.const 32))
          (call $__str_gather (if (result i32) (local.get $fork) (then (i32.const 278)) (else (i32.const 282))) (if (result i32) (local.get $fork) (then (i32.const 4)) (else (i32.const 5))) (i32.const 138))
  ...
  (data (i32.const 267) "\5b")
  (data (i32.const 268) "\20")
  (data (i32.const 269) "\5d")
  (data (i32.const 278) "\74\72\75\65")
  (data (i32.const 282) "\66\61\6c\73\65")
  (data (i32.const 270) "\00\00\00\00\00\00\00\00")
)