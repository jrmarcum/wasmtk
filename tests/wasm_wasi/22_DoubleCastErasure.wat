(module
  ...
  (func $identI32 (param $n i32) (result i32)
    (return (local.get $n))
  )

  (func $identF64 (param $x f64) (result f64)
    (return (local.get $x))
  )

  (func $passThroughAny (param $n i32) (result i32)
    (return (local.get $n))
  )
  ...
  (func $_start (export "_start")  
    ...
    (local.set $a (call $identI32 (i32.const 7)))
    ...
    (local.set $b (i32.const 42))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $c (call $identF64 (f64.const 3.5)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $d (call $passThroughAny (i32.const 99)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
    ...
    (local.set $e (i32.const 5))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 133) (i32.const 58))
          (i32.store8 (i32.const 134) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 3) (call $__i32_to_str (local.get $e) (i32.const 135))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
