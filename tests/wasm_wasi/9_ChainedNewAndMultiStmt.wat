(module
  ...
  (func $Box_unwrap (param $__self i32) (result i32)
    (return (i32.load (i32.add (local.get $__self) (i32.const 0))))
  )

  (func $Box_dbl (param $__self i32) (result i32)
    (return (i32.mul (i32.load (i32.add (local.get $__self) (i32.const 0))) (i32.const 2)))
  )

  (func $firstOf (param $x i32) (result i32)
    (local $__iface_tmp i32)
    (return (block (result i32) (call $Box_constructor (i32.const 260) (local.get $x)) (call $Box_unwrap (i32.const 260) )))
  )
  (func $_start (export "_start")
    (local $z i32)
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.add (global.get $a) (global.get $b)) (i32.const 132)))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (block (result i32) (call $Box_constructor (i32.const 264) (i32.const 5)) (call $Box_unwrap (i32.const 264) )) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (block (result i32) (call $Box_constructor (i32.const 268) (i32.const 7)) (call $Box_dbl (i32.const 268) )) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.add (block (result i32) (call $Box_constructor (i32.const 272) (i32.const 5)) (call $Box_unwrap (i32.const 272) )) (block (result i32) (call $Box_constructor (i32.const 276) (i32.const 6)) (call $Box_unwrap (i32.const 276) ))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $z (block (result i32) (call $Box_constructor (i32.const 280) (i32.const 9)) (call $Box_dbl (i32.const 280) )))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (local.get $z) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $firstOf (i32.const 42)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 280) "\00\00\00\00")
)