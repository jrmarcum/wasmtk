(module
  ...
  (func $_start (export "_start")
    ...
    (local.set $sl (i32.const 272))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 14) (call $__f64_to_str (call $slicesIndexStr (local.get $sl) (i32.const 269) (i32.const 3)) (i32.const 146))))
  ...
  (data (i32.const 263) "\66\6f\6f")
  (data (i32.const 266) "\62\61\72")
  (data (i32.const 269) "\7a\6f\6f")
  (data (i32.const 272) "\03\00\00\00\03\00\00\00\07\01\00\00\03\00\00\00\0a\01\00\00\03\00\00\00\0d\01\00\00\03\00\00\00")
)