(module
  ...
  (func $main  
        (i32.store (i32.const 0) (i32.const 260))
          ...
          (i32.store (i32.const 12) (call $__f64_to_str (f64.add (f64.const 5) (f64.const -3)) (i32.const 132)))
          (i32.store (i32.const 16) (i32.const 269))
          (i32.store (i32.const 20) (i32.const 2))
          (i32.store (i32.const 24) (i32.const 164))
          (i32.store (i32.const 28) (call $__f64_to_str (f64.mul (f64.const 4) (f64.const -3)) (i32.const 164)))
          (i32.store (i32.const 32) (i32.const 269))
          (i32.store (i32.const 36) (i32.const 2))
          (i32.store (i32.const 40) (i32.const 196))
          (i32.store (i32.const 44) (call $__f64_to_str (f64.div (f64.const 12) (f64.const -3)) (i32.const 196)))
          (i32.store (i32.const 48) (i32.const 269))
          (i32.store (i32.const 52) (i32.const 2))
          (i32.store (i32.const 56) (i32.const 228))
          (i32.store (i32.const 60) (call $__f64_to_str (f64.sub (f64.const 5) (f64.const 8)) (i32.const 228)))
          (i32.store (i32.const 64) (i32.const 271))
  ...
  (data (i32.const 260) "\52\65\73\75\6c\74\73\3a\20")
  (data (i32.const 269) "\2c\20")
