(module
  ...
  (func $mayPanic  
    ...
    (local.set $__throw_msg_ptr (i32.const 260))
      (local.set $__throw_msg_len (i32.const 10))
      (local.set $__tmpl_num_ptr (call $__malloc (i32.const 32)))
      (local.set $__tmpl_num_len (call $__i32_to_str (i32.const 1) (local.get $__tmpl_num_ptr)))
  ...
  (func $safe  
    ...
    (try
      ...
      (local.set $msg_len (local.get $r_len))
          ...
          (call $__str_gather (local.get $msg_ptr) (local.get $msg_len) (i32.const 143))
          (i32.store (i32.const 4) (i32.add (i32.const 11) (local.get $msg_len)))
  ...
  (data (i32.const 260) "\61\20\70\72\6f\62\6c\65\6d\20")
)