(module
  ...
  (func $Item_constructor (param $__self i32) (param $w i32) 
    (i32.store (i32.add (local.get $__self) (i32.const 4)) (local.get $w))
  )

  (func $Item_getWeight (param $__self i32) (result i32)
    (return (i32.load (i32.add (local.get $__self) (i32.const 4))))
  )

  (func $HeavyItem_constructor (param $__self i32) (param $w i32) (param $b i32) 
    (call $Item_constructor (local.get $__self) (local.get $w))
    (i32.store (i32.add (local.get $__self) (i32.const 8)) (local.get $b))
  )

  (func $HeavyItem_getWeight (param $__self i32) (result i32)
    (return (i32.add (i32.load (i32.add (local.get $__self) (i32.const 4))) (i32.load (i32.add (local.get $__self) (i32.const 8)))))
  )

  (func $inspectItem (param $item i32) (result i32)
    (local $__iface_tmp i32)
    (return (call $Item_getWeight (local.get $item) ))
  )

  (func $inspectHeavy (param $item i32) (result i32)
    (local $__iface_tmp i32)
    (return (call $HeavyItem_getWeight (local.get $item) ))
  )

  (func $testGenericConstraints (export "testGenericConstraints")  
    (local $baseItem i32)
    (local $heavyItem i32)
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 280))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $baseItem (i32.const 260))
      (call $Item_constructor (i32.const 260) (i32.const 15))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 137) (i32.const 83))
          ...
          (i32.store8 (i32.const 143) (i32.const 87))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 19) (call $__i32_to_str (call $inspectItem (local.get $baseItem)) (i32.const 151))))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $heavyItem (i32.const 268))
      (call $HeavyItem_constructor (i32.const 268) (i32.const 100) (i32.const 50))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 72))
          (i32.store8 (i32.const 133) (i32.const 101))
          (i32.store8 (i32.const 134) (i32.const 97))
          (i32.store8 (i32.const 135) (i32.const 118))
          ...
          (i32.store8 (i32.const 144) (i32.const 87))
          (i32.store8 (i32.const 145) (i32.const 101))
          (i32.store8 (i32.const 146) (i32.const 105))
          (i32.store8 (i32.const 147) (i32.const 103))
          (i32.store8 (i32.const 148) (i32.const 104))
          (i32.store8 (i32.const 149) (i32.const 116))
          (i32.store8 (i32.const 150) (i32.const 58))
          (i32.store8 (i32.const 151) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 20) (call $__i32_to_str (call $inspectHeavy (local.get $heavyItem)) (i32.const 152))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    (call $testGenericConstraints )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 280) "\2d\2d\2d\20\54\65\73\74\20\33\3a\20\47\65\6e\65\72\69\63\20\43\6f\6e\73\74\72\61\69\6e\74\73\20\2d\2d\2d\0a")
