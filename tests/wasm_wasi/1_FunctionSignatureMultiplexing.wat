(module
  ...
  (func $square (param $n f64) (result f64)
    (return (f64.mul (local.get $n) (local.get $n)))
  )

  (func $complex (param $a i32) (param $b f64) (param $c i32) (result f64)
    (return (f64.add (f64.add (f64.mul (local.get $b) (local.get $b)) (f64.convert_i32_s (local.get $a))) (f64.convert_i32_s (local.get $c))))
  )

  (func $_start (export "_start")  
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $add (i32.const 1) (i32.const 2)) (i32.const 132)))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (call $square (f64.const 3.0)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (call $complex (i32.const 1) (f64.const 2.0) (i32.const 3)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 2)
