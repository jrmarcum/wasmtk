(module
  ...
  (func $getInt (export "getInt")  (result i32)
    (return (i32.const 42))
  )

  (func $getFloat (export "getFloat")  (result f64)
    (return (f64.const 3.14))
  )

  (func $getFlag (export "getFlag")  (result i32)
    (return (i32.const 1))
  )

  (func $noReturn (export "noReturn")  
    (local $_x i32)
    (local.set $_x (i32.const 1))
  )
  (func $_start (export "_start")
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $getInt) (i32.const 132)))
