(module
  ...
  (func $_start (export "_start")
    ...
    (local.set $matrix (call $__malloc (i32.const 40)))
      ...
      (i32.store offset=4 (local.get $__2d_tmp) (i32.const 8))
      (i32.store offset=8 (local.get $__2d_tmp) (i32.const 6))
    (local.set $flat (call $__dynarr_flat_i32 (local.get $matrix)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $flat) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 2)))) (i32.const 132)))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $flat) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 2)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $flat) (i32.const 8)) (i32.shl (i32.const 2) (i32.const 2)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $flat) (i32.const 8)) (i32.shl (i32.const 3) (i32.const 2)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $flat) (i32.const 8)) (i32.shl (i32.const 4) (i32.const 2)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $flat) (i32.const 8)) (i32.shl (i32.const 5) (i32.const 2)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $single (call $__malloc (i32.const 40)))
      (i32.store (local.get $single) (i32.const 1))
      (i32.store offset=4 (local.get $single) (i32.const 8))
      (i32.store offset=8 (local.get $single) (local.tee $__2d_tmp (call $__malloc (i32.const 40))))
      (i32.store (local.get $__2d_tmp) (i32.const 3))
      (i32.store offset=4 (local.get $__2d_tmp) (i32.const 8))
      (i32.store offset=8 (local.get $__2d_tmp) (i32.const 10))
      (i32.store offset=12 (local.get $__2d_tmp) (i32.const 20))
      (i32.store offset=16 (local.get $__2d_tmp) (i32.const 30))
    (local.set $fs (call $__dynarr_flat_i32 (local.get $single)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $fs) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 2)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $fs) (i32.const 8)) (i32.shl (i32.const 2) (i32.const 2)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $ones (call $__malloc (i32.const 40)))
      (i32.store (local.get $ones) (i32.const 3))
      (i32.store offset=4 (local.get $ones) (i32.const 8))
      (i32.store offset=8 (local.get $ones) (local.tee $__2d_tmp (call $__malloc (i32.const 40))))
      (i32.store (local.get $__2d_tmp) (i32.const 1))
      (i32.store offset=4 (local.get $__2d_tmp) (i32.const 8))
      (i32.store offset=8 (local.get $__2d_tmp) (i32.const 7))
      (i32.store offset=12 (local.get $ones) (local.tee $__2d_tmp (call $__malloc (i32.const 40))))
      (i32.store (local.get $__2d_tmp) (i32.const 1))
      (i32.store offset=4 (local.get $__2d_tmp) (i32.const 8))
      (i32.store offset=8 (local.get $__2d_tmp) (i32.const 8))
      (i32.store offset=16 (local.get $ones) (local.tee $__2d_tmp (call $__malloc (i32.const 40))))
      (i32.store (local.get $__2d_tmp) (i32.const 1))
      (i32.store offset=4 (local.get $__2d_tmp) (i32.const 8))
      (i32.store offset=8 (local.get $__2d_tmp) (i32.const 9))
    (local.set $fo (call $__dynarr_flat_i32 (local.get $ones)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $fo) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 2)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $fo) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 2)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $fo) (i32.const 8)) (i32.shl (i32.const 2) (i32.const 2)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (local.set $dyn (call $__malloc (i32.const 40)))
      (i32.store (local.get $dyn) (i32.const 2))
      (i32.store offset=4 (local.get $dyn) (i32.const 8))
      (i32.store offset=8 (local.get $dyn) (local.tee $__2d_tmp (call $__malloc (i32.const 40))))
      (i32.store (local.get $__2d_tmp) (i32.const 2))
      (i32.store offset=4 (local.get $__2d_tmp) (i32.const 8))
      (i32.store offset=8 (local.get $__2d_tmp) (i32.const 100))
      (i32.store offset=12 (local.get $__2d_tmp) (i32.const 200))
      (i32.store offset=12 (local.get $dyn) (local.tee $__2d_tmp (call $__malloc (i32.const 40))))
      (i32.store (local.get $__2d_tmp) (i32.const 1))
      (i32.store offset=4 (local.get $__2d_tmp) (i32.const 8))
      (i32.store offset=8 (local.get $__2d_tmp) (i32.const 300))
    (i32.store (i32.add (i32.add (local.get $dyn) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 2))) (call $__dynarr_push_i32 (i32.load (i32.add (i32.add (local.get $dyn) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 2)))) (i32.const 250)))
    (local.set $fd (call $__dynarr_flat_i32 (local.get $dyn)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $fd) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 2)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $fd) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 2)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $fd) (i32.const 8)) (i32.shl (i32.const 2) (i32.const 2)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $fd) (i32.const 8)) (i32.shl (i32.const 3) (i32.const 2)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
