(module
  ...
  (func $describePoint (param $p i32) 
    ...
    (local.set $__ret_str_ptr (i32.const 260))
      ...
      (local.set $__tmpl_num_len (call $__f64_to_str (f64.load (i32.add (local.get $p) (i32.const 0))) (local.get $__tmpl_num_ptr)))
      ...
      (call $__str_concat (local.get $__ret_str_ptr) (local.get $__ret_str_len) (i32.const 261) (i32.const 1))
      (local.set $__ret_str_len)
      (local.set $__ret_str_ptr)
      (local.set $__tmpl_num_ptr (call $__malloc (i32.const 32)))
      (local.set $__tmpl_num_len (call $__f64_to_str (f64.load (i32.add (local.get $p) (i32.const 8))) (local.get $__tmpl_num_ptr)))
      (call $__str_concat (local.get $__ret_str_ptr) (local.get $__ret_str_len) (local.get $__tmpl_num_ptr) (local.get $__tmpl_num_len))
      (local.set $__ret_str_len)
      (local.set $__ret_str_ptr)
  ...
  (func $addCoords (param $a i32) (param $b i32) 
    (local $__ret_str_ptr i32)
    (local $__ret_str_len i32)
    (local $__tmpl_num_ptr i32)
    (local $__tmpl_num_len i32)
    (local.set $__ret_str_ptr (i32.const 263))
      ...
      (local.set $__tmpl_num_ptr (call $__malloc (i32.const 32)))
      (local.set $__tmpl_num_len (call $__f64_to_str (f64.add (f64.load (i32.add (local.get $a) (i32.const 0))) (f64.load (i32.add (local.get $b) (i32.const 0)))) (local.get $__tmpl_num_ptr)))
      (call $__str_concat (local.get $__ret_str_ptr) (local.get $__ret_str_len) (local.get $__tmpl_num_ptr) (local.get $__tmpl_num_len))
      (local.set $__ret_str_len)
      (local.set $__ret_str_ptr)
      (call $__str_concat (local.get $__ret_str_ptr) (local.get $__ret_str_len) (i32.const 261) (i32.const 1))
      ...
      (local.set $__ret_str_ptr)
      (local.set $__tmpl_num_ptr (call $__malloc (i32.const 32)))
      (local.set $__tmpl_num_len (call $__f64_to_str (f64.add (f64.load (i32.add (local.get $a) (i32.const 8))) (f64.load (i32.add (local.get $b) (i32.const 8)))) (local.get $__tmpl_num_ptr)))
      (call $__str_concat (local.get $__ret_str_ptr) (local.get $__ret_str_len) (local.get $__tmpl_num_ptr) (local.get $__tmpl_num_len))
      (local.set $__ret_str_len)
      (local.set $__ret_str_ptr)
      (call $__str_concat (local.get $__ret_str_ptr) (local.get $__ret_str_len) (i32.const 262) (i32.const 1))
  ...
  (func $_start (export "_start")
    ...
    (local $__tmpl_num_ptr i32)
    (local $__tmpl_num_len i32)
    (local.set $origin (i32.const 268))
    (local.set $p1 (i32.const 284))
    (local.set $seg (i32.const 300))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $describePoint (local.get $origin))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $describePoint (local.get $p1))
          (call $__str_gather (global.get $__str_ret_ptr) (global.get $__str_ret_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (global.get $__str_ret_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $describePoint (i32.load (i32.add (i32.const 300) (i32.const 0))))
          (call $__str_gather (global.get $__str_ret_ptr) (global.get $__str_ret_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (global.get $__str_ret_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $describePoint (i32.load (i32.add (i32.const 300) (i32.const 4))))
          (call $__str_gather (global.get $__str_ret_ptr) (global.get $__str_ret_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (global.get $__str_ret_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (f64.load (i32.add (i32.load (i32.add (i32.const 300) (i32.const 0))) (i32.const 0))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (f64.load (i32.add (i32.load (i32.add (i32.const 300) (i32.const 4))) (i32.const 8))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $addCoords (i32.load (i32.add (i32.const 300) (i32.const 0))) (i32.load (i32.add (i32.const 300) (i32.const 4))))
          (call $__str_gather (global.get $__str_ret_ptr) (global.get $__str_ret_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (global.get $__str_ret_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $msg_ptr (i32.const 340))
      (local.set $msg_len (i32.const 5))
      (call $describePoint (i32.load (i32.add (i32.const 300) (i32.const 0))))
      (call $__str_concat (local.get $msg_ptr) (local.get $msg_len) (global.get $__str_ret_ptr) (global.get $__str_ret_len))
      (local.set $msg_len)
      (local.set $msg_ptr)
      (call $__str_concat (local.get $msg_ptr) (local.get $msg_len) (i32.const 345) (i32.const 4))
      (local.set $msg_len)
      (local.set $msg_ptr)
      (call $describePoint (i32.load (i32.add (i32.const 300) (i32.const 4))))
      (call $__str_concat (local.get $msg_ptr) (local.get $msg_len) (global.get $__str_ret_ptr) (global.get $__str_ret_len))
      ...
      (local.set $msg_ptr)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (local.get $msg_ptr) (local.get $msg_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $msg_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 260) "\28")
  (data (i32.const 261) "\2c")
  (data (i32.const 262) "\29")
  (data (i32.const 263) "\73\75\6d\3d\28")
  (data (i32.const 340) "\66\72\6f\6d\3d")
  (data (i32.const 345) "\20\74\6f\3d")
  (data (i32.const 268) "\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
  (data (i32.const 284) "\00\00\00\00\00\00\08\40\00\00\00\00\00\00\10\40")
  (data (i32.const 308) "\00\00\00\00\00\00\f0\3f\00\00\00\00\00\00\00\40")
  (data (i32.const 324) "\00\00\00\00\00\00\1c\40\00\00\00\00\00\00\20\40")
  (data (i32.const 300) "\34\01\00\00\44\01\00\00")
)