(module
  ...
  (func $testBigIntComparisons (export "testBigIntComparisons") (param $val i64) 
    ...
    (local.set $isLarge (i64.ge_s (local.get $val) (local.get $limit)))
        (i32.store (i32.const 0) (if (result i32) (local.get $isLarge) (then (i32.const 261)) (else (i32.const 265))))
          (i32.store (i32.const 4) (if (result i32) (local.get $isLarge) (then (i32.const 4)) (else (i32.const 5))))
          (i32.store (i32.const 8) (i32.const 260))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 261) "\74\72\75\65")
  (data (i32.const 265) "\66\61\6c\73\65")
)