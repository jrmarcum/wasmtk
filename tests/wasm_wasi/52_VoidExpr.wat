(module
  ...
  (func $addAndGet (param $n i32) (result i32)
    (global.set $counter (i32.add (global.get $counter) (local.get $n)))
    (return (global.get $counter))
  )

  (func $inFunc  (result i32)
    (local $local i32)
    (local.set $local (i32.const 5))
    (drop (f64.convert_i32_s (i32.add (local.get $local) (i32.const 100))))
  ...
  (func $_start (export "_start")
    ...
    (call $bump )
    (drop (call $addAndGet (i32.const 10)))
    (drop (i32.const 0))
    (drop (global.get $counter))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 9) (call $__i32_to_str (global.get $counter) (i32.const 141))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 134) (i32.const 70))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 8) (call $__i32_to_str (call $inFunc) (i32.const 140))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $ctr (i32.const 260))
      (call $Counter_constructor (i32.const 260) )
    (call $Counter_bump (i32.const 260) )
    (call $Counter_bump (i32.const 260) )
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 99))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 5) (call $__i32_to_str (call $Counter_value (i32.const 260) ) (i32.const 137))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
