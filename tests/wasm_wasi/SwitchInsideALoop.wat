(module
  ...
  (func $testStateMachine (export "testStateMachine") (param $input i32) (result i32)
    (local $state i32)
    (local $counter i32)
    (local $i i32)
    ...
    (block $break_0
      (loop $loop_0
        (br_if $break_0 (i32.eqz (i32.lt_s (local.get $i) (local.get $input))))
        (block $cont_0
          (block $switch_exit_1
            (block $case_default_1
              (block $case_1_2
                (block $case_1_1
                  (block $case_1_0
                    (br_if $case_1_0 (i32.eq (local.get $state) (i32.const 0)))
                    (br_if $case_1_1 (i32.eq (local.get $state) (i32.const 1)))
                    (br_if $case_1_2 (i32.eq (local.get $state) (i32.const 2)))
                    (br $case_default_1)
                  )
                  ...
                  (local.set $counter (i32.add (local.get $counter) (i32.const 10)))
                  (local.set $state (i32.const 2))
                  (br $switch_exit_1)
              )
                (local.set $state (i32.const 0))
            )
              (local.set $counter (i32.add (local.get $counter) (i32.const 100)))
              (br $switch_exit_1)
          )
        )
  ...
  (func $_start (export "_start")
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $testStateMachine (i32.const 5)) (i32.const 132)))
