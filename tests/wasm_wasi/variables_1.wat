(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 281))
  (global $b (mut f64) (f64.const 1))
  (global $c (mut f64) (f64.const 2))
  (global $e (mut f64) (f64.const 0))
  ...
  (func $_start (export "_start")
    ...
    (local.set $a_ptr (i32.const 260))
      (local.set $a_len (i32.const 7))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (local.get $a_ptr) (local.get $a_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $a_len)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (call $__f64_to_str (global.get $b) (i32.const 132))))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (call $__f64_to_str (global.get $c) (i32.add (i32.const 132) (i32.load (i32.const 4))))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (local.set $d (i32.const 1))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (if (result i32) (local.get $d) (then (i32.const 272)) (else (i32.const 276))) (if (result i32) (local.get $d) (then (i32.const 4)) (else (i32.const 5))) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (if (result i32) (local.get $d) (then (i32.const 4)) (else (i32.const 5)))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (global.get $e) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $f_ptr (i32.const 267))
      (local.set $f_len (i32.const 5))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (local.get $f_ptr) (local.get $f_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $f_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 260) "\69\6e\69\74\69\61\6c")
  (data (i32.const 267) "\61\70\70\6c\65")
  (data (i32.const 272) "\74\72\75\65")
  (data (i32.const 276) "\66\61\6c\73\65")
)