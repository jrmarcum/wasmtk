(module
  ...
  (func $_start (export "_start")
      ...
      (i32.store offset=24 (local.get $sl) (i32.const 0))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (i32.store (i32.add (i32.add (local.get $sl) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 3))) (i32.const 298))
      (i32.store offset=4 (i32.add (i32.add (local.get $sl) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 3))) (i32.const 1))
    (i32.store (i32.add (i32.add (local.get $sl) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 3))) (i32.const 299))
      (i32.store offset=4 (i32.add (i32.add (local.get $sl) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 3))) (i32.const 1))
    (i32.store (i32.add (i32.add (local.get $sl) (i32.const 8)) (i32.shl (i32.const 2) (i32.const 3))) (i32.const 300))
    ...
    (local.set $sl (call $__dynarr_push_string (local.get $sl) (i32.const 303) (i32.const 1)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
  ...
  (data (i32.const 263) "\67")
  (data (i32.const 264) "\68")
  (data (i32.const 265) "\69")
  (data (i32.const 298) "\61")
  (data (i32.const 299) "\62")
  (data (i32.const 300) "\63")
  (data (i32.const 301) "\64")
  (data (i32.const 302) "\65")
  (data (i32.const 303) "\66")
