(module
  ...
  (func $_start (export "_start")
    ...
    (local.set $j (f64.const 7))
    (block $break_1
      (loop $loop_1
        (br_if $break_1 (i32.eqz (f64.le (local.get $j) (f64.const 9))))
        (block $cont_1
              (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (local.get $j) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (block $break_2
      (loop $loop_2
        (br_if $break_2 (i32.eqz (i32.const 1)))
        (block $cont_2
  ...
  (data (i32.const 260) "\6c\6f\6f\70\0a")
)