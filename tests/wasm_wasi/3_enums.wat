(module
  ...
  (func $transition (param $s i32) (result i32)
    ...
    (block $switch_exit_1
      (block $case_default_1
        ...
        (local.set $__throw_msg_ptr (i32.const 293))
      (local.set $__throw_msg_len (i32.const 15))
      (call $stateName (local.get $s))
      (call $__str_concat (local.get $__throw_msg_ptr) (local.get $__throw_msg_len) (global.get $__str_ret_ptr) (global.get $__str_ret_len))
  ...
  (data (i32.const 293) "\75\6e\6b\6e\6f\77\6e\20\73\74\61\74\65\3a\20")
)