(module
  ...
  (func $describeShape (param $s i32) 
    ...
    (block $switch_exit_0
      (block $case_0_1
        (block $case_0_0
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 15) (call $__f64_to_str (f64.load (i32.add (local.get $s) (i32.const 8))) (i32.const 147))))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 12) (call $__f64_to_str (f64.load (i32.add (local.get $s) (i32.const 16))) (i32.const 144))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 13) (call $__f64_to_str (f64.load (i32.add (local.get $s) (i32.const 24))) (i32.const 145))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $getArea (param $s i32) (result f64)
    (block $switch_exit_1
      (block $case_default_1
        (block $case_1_1
          (block $case_1_0
            (br_if $case_1_0 (i32.eq (i32.load (local.get $s)) (i32.const 0)))
            (br_if $case_1_1 (i32.eq (i32.load (local.get $s)) (i32.const 1)))
            (br $case_default_1)
          )
            (return (f64.mul (f64.mul (f64.load (i32.add (local.get $s) (i32.const 8))) (f64.load (i32.add (local.get $s) (i32.const 8)))) (f64.const 3.1415926535897931)))
        )
    ...
    (local.set $c (i32.const 260))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $describeShape (local.get $c))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (call $getArea (local.get $c)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (local.set $r (i32.const 292))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $describeShape (local.get $r))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (call $getArea (local.get $r)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 292) "\01\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\08\40\00\00\00\00\00\00\10\40")
)