(module
  ...
  (func $_start (export "_start")
    ...
    (local.set $grid (call $__malloc (i32.const 40)))
      (i32.store (local.get $grid) (i32.const 0))
      (i32.store offset=4 (local.get $grid) (i32.const 8))
    (local.set $i (i32.const 0))
    (block $break_0
      (loop $loop_0
        (br_if $break_0 (i32.eqz (i32.lt_s (local.get $i) (i32.const 3))))
        (block $cont_0
          (local.set $row (call $__malloc (i32.const 40)))
      (i32.store (local.get $row) (i32.const 0))
      (i32.store offset=4 (local.get $row) (i32.const 8))
          (local.set $row (call $__dynarr_push_i32 (local.get $row) (local.get $i)))
          (local.set $row (call $__dynarr_push_i32 (local.get $row) (i32.mul (local.get $i) (i32.const 10))))
          (local.set $grid (call $__dynarr_push_i32 (local.get $grid) (local.get $row)))
        )
        (local.set $i (i32.add (local.get $i) (i32.const 1)))
        (br $loop_0)
      )
    )
    (local.set $a (i32.load (i32.add (i32.add (i32.load (i32.add (i32.add (local.get $grid) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 2)))) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 2)))))
    (local.set $b (i32.load (i32.add (i32.add (i32.load (i32.add (i32.add (local.get $grid) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 2)))) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 2)))))
    (local.set $c (i32.load (i32.add (i32.add (i32.load (i32.add (i32.add (local.get $grid) (i32.const 8)) (i32.shl (i32.const 2) (i32.const 2)))) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 2)))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (local.get $grid)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
