(module
  ...
  (func $inFunc  
    ...
    (local.set $src_ptr (i32.const 268))
      (local.set $src_len (i32.const 5))
        (i32.store (i32.const 0) (i32.const 273))
          (i32.store (i32.const 4) (i32.const 10))
          (i32.store (i32.const 8) (if (result i32) (i32.eqz (call $__str_cmp (local.get $s_ptr) (local.get $s_len) (block (result i32) (call $__str_slice (local.get $src_ptr) (local.get $src_len) (i32.const 0) (i32.const 3)) (local.set $__str_op_len)) (local.get $__str_op_len))) (then (i32.const 283)) (else (i32.const 287))))
          (i32.store (i32.const 12) (if (result i32) (i32.eqz (call $__str_cmp (local.get $s_ptr) (local.get $s_len) (block (result i32) (call $__str_slice (local.get $src_ptr) (local.get $src_len) (i32.const 0) (i32.const 3)) (local.set $__str_op_len)) (local.get $__str_op_len))) (then (i32.const 4)) (else (i32.const 5))))
          (i32.store (i32.const 16) (i32.const 292))
        ...
        (i32.store (i32.const 0) (i32.const 293))
          (i32.store (i32.const 4) (i32.const 10))
          (i32.store (i32.const 8) (if (result i32) (i32.ne (call $__str_cmp (local.get $s_ptr) (local.get $s_len) (block (result i32) (call $__str_slice (local.get $src_ptr) (local.get $src_len) (i32.const 0) (i32.const 4)) (local.set $__str_op_len)) (local.get $__str_op_len)) (i32.const 0)) (then (i32.const 283)) (else (i32.const 287))))
          (i32.store (i32.const 12) (if (result i32) (i32.ne (call $__str_cmp (local.get $s_ptr) (local.get $s_len) (block (result i32) (call $__str_slice (local.get $src_ptr) (local.get $src_len) (i32.const 0) (i32.const 4)) (local.set $__str_op_len)) (local.get $__str_op_len)) (i32.const 0)) (then (i32.const 4)) (else (i32.const 5))))
          (i32.store (i32.const 16) (i32.const 292))
          (i32.store (i32.const 20) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 3)
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 303))
          (i32.store (i32.const 4) (i32.const 8))
          (i32.store (i32.const 8) (if (result i32) (i32.eq (local.get $s_len) (block (result i32) (drop (block (result i32) (call $__str_slice (local.get $src_ptr) (local.get $src_len) (i32.const 0) (i32.const 3)) (local.set $__str_op_len))) (local.get $__str_op_len))) (then (i32.const 283)) (else (i32.const 287))))
          (i32.store (i32.const 12) (if (result i32) (i32.eq (local.get $s_len) (block (result i32) (drop (block (result i32) (call $__str_slice (local.get $src_ptr) (local.get $src_len) (i32.const 0) (i32.const 3)) (local.set $__str_op_len))) (local.get $__str_op_len))) (then (i32.const 4)) (else (i32.const 5))))
          (i32.store (i32.const 16) (i32.const 292))
          (i32.store (i32.const 20) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 311))
          (i32.store (i32.const 4) (i32.const 8))
          (i32.store (i32.const 8) (if (result i32) (i32.ne (local.get $s_len) (local.get $src_len)) (then (i32.const 283)) (else (i32.const 287))))
          (i32.store (i32.const 12) (if (result i32) (i32.ne (local.get $s_len) (local.get $src_len)) (then (i32.const 4)) (else (i32.const 5))))
          (i32.store (i32.const 16) (i32.const 292))
          (i32.store (i32.const 20) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    ...
    (local $__str_op_ptr i32)
    (local $__str_op_len i32)
    (local.set $p (i32.const 319))
    (local.set $a_ptr (i32.const 260))
      (local.set $a_len (i32.const 3))
    (local.set $c_ptr (i32.const 263))
      (local.set $c_len (i32.const 5))
        (i32.store (i32.const 0) (i32.const 327))
          (i32.store (i32.const 4) (i32.const 7))
          (i32.store (i32.const 8) (if (result i32) (i32.eqz (call $__str_cmp (local.get $a_ptr) (local.get $a_len) (block (result i32) (call $getName) (global.get $__str_ret_ptr) (global.get $__str_ret_len) (local.set $__str_op_len)) (local.get $__str_op_len))) (then (i32.const 283)) (else (i32.const 287))))
          (i32.store (i32.const 12) (if (result i32) (i32.eqz (call $__str_cmp (local.get $a_ptr) (local.get $a_len) (block (result i32) (call $getName) (global.get $__str_ret_ptr) (global.get $__str_ret_len) (local.set $__str_op_len)) (local.get $__str_op_len))) (then (i32.const 4)) (else (i32.const 5))))
          (i32.store (i32.const 16) (i32.const 292))
          (i32.store (i32.const 20) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 334))
          (i32.store (i32.const 4) (i32.const 7))
          (i32.store (i32.const 8) (if (result i32) (i32.ne (call $__str_cmp (local.get $c_ptr) (local.get $c_len) (block (result i32) (call $getName) (global.get $__str_ret_ptr) (global.get $__str_ret_len) (local.set $__str_op_len)) (local.get $__str_op_len)) (i32.const 0)) (then (i32.const 283)) (else (i32.const 287))))
          (i32.store (i32.const 12) (if (result i32) (i32.ne (call $__str_cmp (local.get $c_ptr) (local.get $c_len) (block (result i32) (call $getName) (global.get $__str_ret_ptr) (global.get $__str_ret_len) (local.set $__str_op_len)) (local.get $__str_op_len)) (i32.const 0)) (then (i32.const 4)) (else (i32.const 5))))
          (i32.store (i32.const 16) (i32.const 292))
          (i32.store (i32.const 20) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 341))
          (i32.store (i32.const 4) (i32.const 8))
          (i32.store (i32.const 8) (if (result i32) (i32.eqz (call $__str_cmp (local.get $c_ptr) (local.get $c_len) (block (result i32) (call $getName) (global.get $__str_ret_ptr) (global.get $__str_ret_len) (local.set $__str_op_len)) (local.get $__str_op_len))) (then (i32.const 283)) (else (i32.const 287))))
          (i32.store (i32.const 12) (if (result i32) (i32.eqz (call $__str_cmp (local.get $c_ptr) (local.get $c_len) (block (result i32) (call $getName) (global.get $__str_ret_ptr) (global.get $__str_ret_len) (local.set $__str_op_len)) (local.get $__str_op_len))) (then (i32.const 4)) (else (i32.const 5))))
          (i32.store (i32.const 16) (i32.const 292))
          (i32.store (i32.const 20) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 3)
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 349))
          (i32.store (i32.const 4) (i32.const 10))
          (i32.store (i32.const 8) (if (result i32) (i32.eqz (call $__str_cmp (local.get $a_ptr) (local.get $a_len) (block (result i32) (i32.load offset=0 (i32.const 319)) (i32.load offset=4 (i32.const 319)) (local.set $__str_op_len)) (local.get $__str_op_len))) (then (i32.const 283)) (else (i32.const 287))))
          (i32.store (i32.const 12) (if (result i32) (i32.eqz (call $__str_cmp (local.get $a_ptr) (local.get $a_len) (block (result i32) (i32.load offset=0 (i32.const 319)) (i32.load offset=4 (i32.const 319)) (local.set $__str_op_len)) (local.get $__str_op_len))) (then (i32.const 4)) (else (i32.const 5))))
          (i32.store (i32.const 16) (i32.const 292))
          (i32.store (i32.const 20) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 362))
          (i32.store (i32.const 4) (i32.const 10))
          (i32.store (i32.const 8) (if (result i32) (i32.eqz (call $__str_cmp (i32.const 359) (i32.const 3) (block (result i32) (call $__str_to_upper (local.get $a_ptr) (local.get $a_len)) (local.set $__str_op_len)) (local.get $__str_op_len))) (then (i32.const 283)) (else (i32.const 287))))
          (i32.store (i32.const 12) (if (result i32) (i32.eqz (call $__str_cmp (i32.const 359) (i32.const 3) (block (result i32) (call $__str_to_upper (local.get $a_ptr) (local.get $a_len)) (local.set $__str_op_len)) (local.get $__str_op_len))) (then (i32.const 4)) (else (i32.const 5))))
          (i32.store (i32.const 16) (i32.const 292))
          (i32.store (i32.const 20) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 260) "\62\6f\62")
  (data (i32.const 263) "\63\61\72\6f\6c")
  (data (i32.const 268) "\62\6f\62\62\79")
  (data (i32.const 273) "\73\6c\69\63\65\2d\65\71\3a\20")
  (data (i32.const 283) "\74\72\75\65")
  (data (i32.const 287) "\66\61\6c\73\65")
  (data (i32.const 292) "\0a")
  (data (i32.const 293) "\73\6c\69\63\65\2d\6e\65\3a\20")
  (data (i32.const 303) "\6c\65\6e\2d\65\71\3a\20")
  (data (i32.const 311) "\6c\65\6e\2d\6e\65\3a\20")
  (data (i32.const 327) "\66\6e\2d\65\71\3a\20")
  (data (i32.const 334) "\66\6e\2d\6e\65\3a\20")
  (data (i32.const 341) "\66\6e\2d\65\71\32\3a\20")
  (data (i32.const 349) "\66\69\65\6c\64\2d\65\71\3a\20")
  (data (i32.const 359) "\42\4f\42")
  (data (i32.const 362) "\75\70\70\65\72\2d\65\71\3a\20")
  (data (i32.const 319) "\04\01\00\00\03\00\00\00")
)