(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 314))
  ...
  (func $Box_constructor (param $__self i32) (param $w i32) (param $h i32) 
    (i32.store (i32.add (local.get $__self) (i32.const 0)) (local.get $w))
    (i32.store (i32.add (local.get $__self) (i32.const 4)) (local.get $h))
  )
  (func $_start (export "_start")
    ...
    (local.set $pt (i32.const 260))
    (local.set $hasX (i32.const 1))
    (local.set $hasZ (i32.const 0))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 135) (i32.const 88))
          (i32.store8 (i32.const 136) (i32.const 58))
          (i32.store8 (i32.const 137) (i32.const 32))
          (call $__str_gather (if (result i32) (local.get $hasX) (then (i32.const 276)) (else (i32.const 280))) (if (result i32) (local.get $hasX) (then (i32.const 4)) (else (i32.const 5))) (i32.const 138))
          (i32.store (i32.const 4) (i32.add (i32.const 6) (if (result i32) (local.get $hasX) (then (i32.const 4)) (else (i32.const 5)))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 133) (i32.const 97))
          (i32.store8 (i32.const 134) (i32.const 115))
          (i32.store8 (i32.const 135) (i32.const 90))
          (i32.store8 (i32.const 136) (i32.const 58))
          (i32.store8 (i32.const 137) (i32.const 32))
          (call $__str_gather (if (result i32) (local.get $hasZ) (then (i32.const 276)) (else (i32.const 280))) (if (result i32) (local.get $hasZ) (then (i32.const 4)) (else (i32.const 5))) (i32.const 138))
          (i32.store (i32.const 4) (i32.add (i32.const 6) (if (result i32) (local.get $hasZ) (then (i32.const 4)) (else (i32.const 5)))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (local.set $b (i32.const 268))
      (call $Box_constructor (i32.const 268) (i32.const 3) (i32.const 4))
    (local.set $hasW (i32.const 1))
    (local.set $hasArea (i32.const 0))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 104))
          (i32.store8 (i32.const 133) (i32.const 97))
          ...
          (i32.store8 (i32.const 136) (i32.const 58))
          (i32.store8 (i32.const 137) (i32.const 32))
          (call $__str_gather (if (result i32) (local.get $hasW) (then (i32.const 276)) (else (i32.const 280))) (if (result i32) (local.get $hasW) (then (i32.const 4)) (else (i32.const 5))) (i32.const 138))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (call $__str_gather (if (result i32) (local.get $hasArea) (then (i32.const 276)) (else (i32.const 280))) (if (result i32) (local.get $hasArea) (then (i32.const 4)) (else (i32.const 5))) (i32.const 141))
          (i32.store (i32.const 4) (i32.add (i32.const 9) (if (result i32) (local.get $hasArea) (then (i32.const 4)) (else (i32.const 5)))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 285) "\79\20\70\72\65\73\65\6e\74\0a")
  (data (i32.const 295) "\71\20\70\72\65\73\65\6e\74\0a")
  (data (i32.const 305) "\71\20\61\62\73\65\6e\74\0a")
  (data (i32.const 260) "\01\00\00\00\02\00\00\00")
