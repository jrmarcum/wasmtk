(module
  ...
  (func $f (param $arg f64) (result i32)
    ...
    (local.set $__obj_ret (call $__malloc (i32.const 16)))
      ...
      (i32.store offset=8 (local.get $__obj_ret) (;? { arg: 0, msg: "" } ;) (i32.const 0))
    ...
    (if (i32.load (i32.add (local.get $r) (i32.const 12)))
      (then
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
          (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.load (i32.add (local.get $r) (i32.const 8))) (i32.const 8))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
