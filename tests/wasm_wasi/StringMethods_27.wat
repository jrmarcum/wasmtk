(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 375))
  ...
  (func $testStartsEndsWith  
    ...
    (local.set $sw1 (call $__str_starts_with (local.get $s_ptr) (local.get $s_len) (i32.const 297) (i32.const 5)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (local.get $sw1) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $sw2 (call $__str_starts_with (local.get $s_ptr) (local.get $s_len) (i32.const 313) (i32.const 5)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (local.get $sw2) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $ew1 (call $__str_ends_with (local.get $s_ptr) (local.get $s_len) (i32.const 313) (i32.const 5)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (local.get $ew1) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (local.set $ew2 (call $__str_ends_with (local.get $s_ptr) (local.get $s_len) (i32.const 297) (i32.const 5)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (local.get $ew2) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $testReplace  
    ...
    (local $r2_len i32)
    (local $__iface_tmp i32)
    (local.set $s_ptr (i32.const 329))
      (local.set $s_len (i32.const 11))
    (call $__str_replace (local.get $s_ptr) (local.get $s_len) (i32.const 340) (i32.const 3) (i32.const 343) (i32.const 3))
      (local.set $r1_len)
      (local.set $r1_ptr)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $__str_replace_all (local.get $s_ptr) (local.get $s_len) (i32.const 340) (i32.const 3) (i32.const 343) (i32.const 3))
      (local.set $r2_len)
      (local.set $r2_ptr)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
  ...
  (func $testPad  
    ...
    (local $pe_len i32)
    (local $__iface_tmp i32)
    (local.set $s_ptr (i32.const 346))
      (local.set $s_len (i32.const 2))
    (call $__str_pad_start (local.get $s_ptr) (local.get $s_len) (i32.const 5) (i32.const 348) (i32.const 1))
      (local.set $ps_len)
      (local.set $ps_ptr)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $__str_pad_end (local.get $s_ptr) (local.get $s_len) (i32.const 5) (i32.const 349) (i32.const 1))
      (local.set $pe_len)
      (local.set $pe_ptr)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
      ...
      (local.set $r_ptr)
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $s2_ptr (i32.const 352))
  ...
  (func $testSplit  
    ...
    (local $w_len i32)
    (local $__iface_tmp i32)
    (local.set $s_ptr (i32.const 353))
      (local.set $s_len (i32.const 5))
    (local.set $parts (call $__str_split (local.get $s_ptr) (local.get $s_len) (i32.const 358) (i32.const 1)))
    ...
    (local.set $s2_ptr (i32.const 359))
      (local.set $s2_len (i32.const 15))
    (local.set $words (call $__str_split (local.get $s2_ptr) (local.get $s2_len) (i32.const 374) (i32.const 1)))
    (local.set $__forof_idx (i32.const 0))
    (block $break_1
      (loop $loop_1
  ...
  (data (i32.const 313) "\77\6f\72\6c\64")
  (data (i32.const 318) "\48\65\6c\6c\6f\20\57\6f\72\6c\64")
  (data (i32.const 329) "\66\6f\6f\20\62\61\72\20\66\6f\6f")
  (data (i32.const 340) "\66\6f\6f")
  (data (i32.const 343) "\62\61\7a")
  (data (i32.const 346) "\34\32")
  (data (i32.const 348) "\30")
  (data (i32.const 349) "\2e")
  (data (i32.const 350) "\61\62")
  (data (i32.const 352) "\78")
  (data (i32.const 353) "\61\2c\62\2c\63")
  (data (i32.const 358) "\2c")
  (data (i32.const 359) "\68\65\6c\6c\6f\20\77\6f\72\6c\64\20\66\6f\6f")
  (data (i32.const 374) "\20")
)