(module
    ...
    (block $break_0
      (loop $loop_0
        ...
        (block $cont_0
          ...
          (call $__str_gather (block (result i32) (call $__str_to_upper (i32.load (i32.add (i32.add (i32.const 271) (i32.const 8)) (i32.shl (i32.trunc_f64_s (local.get $i)) (i32.const 3)))) (i32.load offset=4 (i32.add (i32.add (i32.const 271) (i32.const 8)) (i32.shl (i32.trunc_f64_s (local.get $i)) (i32.const 3))))) (local.set $__str_op_len)) (local.get $__str_op_len) (i32.const 132))
  ...
  (data (i32.const 265) "\66\69\6c\74\65\72")
  (data (i32.const 271) "\02\00\00\00\02\00\00\00\04\01\00\00\05\00\00\00\09\01\00\00\06\00\00\00")
)