(module
  ...
  (import "env" "storage_write" (func $storage_write (param i32) (param i32)))
  (import "env" "storage_read" (func $storage_read (param i32) (result i32)))
  ...
  (func $storeValue (export "storeValue") (param $key i32) (param $value i32) 
    (local $__iface_tmp i32)
    (call $storage_write (local.get $key) (local.get $value))
  )

  (func $loadValue (export "loadValue") (param $key i32) (result i32)
    (local $__iface_tmp i32)
    (return (call $storage_read (local.get $key)))
  )
  ...
  (data (i32.const 260) "\33\30\30\0a")
)