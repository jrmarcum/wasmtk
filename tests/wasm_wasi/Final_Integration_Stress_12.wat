(module
  ...
  (func $_start (export "_start")  
    ...
    (local.set $manager (call $createManager (block (result i32) (local.set $__arr_tmp (call $__malloc (i32.const 40))) (i32.store (local.get $__arr_tmp) (i32.const 2)) (i32.store offset=4 (local.get $__arr_tmp) (i32.const 8)) (local.set $__arr_tmp2 (call $__malloc (i32.const 40))) (i32.store (local.get $__arr_tmp2) (i32.const 2)) (i32.store offset=4 (local.get $__arr_tmp2) (i32.const 8)) (i32.store offset=8 (local.get $__arr_tmp2) (i32.const 1)) (i32.store offset=12 (local.get $__arr_tmp2) (i32.const 2)) (i32.store offset=8 (local.get $__arr_tmp) (local.get $__arr_tmp2)) (local.set $__arr_tmp2 (call $__malloc (i32.const 40))) (i32.store (local.get $__arr_tmp2) (i32.const 3)) (i32.store offset=4 (local.get $__arr_tmp2) (i32.const 8)) (i32.store offset=8 (local.get $__arr_tmp2) (i32.const 3)) (i32.store offset=12 (local.get $__arr_tmp2) (i32.const 4)) (i32.store offset=16 (local.get $__arr_tmp2) (i32.const 5)) (i32.store offset=12 (local.get $__arr_tmp) (local.get $__arr_tmp2)) (local.get $__arr_tmp))))
    (drop (call_indirect (type $ftype_i32_i32_r_i32) (local.tee $__iface_tmp (i32.load (local.get $manager))) (block (result i32) (local.set $__arr_tmp (call $__malloc (i32.const 40))) (i32.store (local.get $__arr_tmp) (i32.const 1)) (i32.store offset=4 (local.get $__arr_tmp) (i32.const 8)) (i32.store offset=8 (local.get $__arr_tmp) (i32.const 6)) (local.get $__arr_tmp)) (i32.load (local.get $__iface_tmp))))
    (local.set $stats (call_indirect (type $ftype_i32_r_i32) (local.tee $__iface_tmp (i32.load (i32.add (local.get $manager) (i32.const 4))))  (i32.load (local.get $__iface_tmp))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (local.get $stats)) (i32.const 132)))
  ...
  (func $__anon_0 (param $vals i32) (param $data i32) (result i32)
    (local $__iface_tmp i32)
    (local.set $data (call $__dynarr_push_i32 (local.get $data) (local.get $vals)))
    (return (i32.load (local.get $data)))
  )
  ...
  (func $__anon_0__factory__trampoline (param $__closure_ptr i32) (param $vals i32) (result i32)
    (local $__cap_data i32)
    (local.set $__cap_data (i32.load offset=4 (local.get $__closure_ptr)))
    (call $__anon_0 (local.get $vals) (local.get $__cap_data))
  )

  (func $__anon_1 (param $data i32) (result i32)
    (local $summary i32)
    (local $i i32)
    (local $__iface_tmp i32)
    (local.set $summary (call $__malloc (i32.const 40)))
      (i32.store (local.get $summary) (i32.const 0))
      (i32.store offset=4 (local.get $summary) (i32.const 8))
    (local.set $i (i32.const 0))
    (block $break_0
      (loop $loop_0
        (br_if $break_0 (i32.eqz (i32.lt_s (local.get $i) (i32.load (local.get $data)))))
        (block $cont_0
          (local.set $summary (call $__dynarr_push_i32 (local.get $summary) (i32.load (i32.load (i32.add (i32.add (local.get $data) (i32.const 8)) (i32.shl (local.get $i) (i32.const 2)))))))
        )
        (local.set $i (i32.add (local.get $i) (i32.const 1)))
        (br $loop_0)
      )
  ...
  (func $__anon_1__factory__trampoline (param $__closure_ptr i32) (result i32)
    (local $__cap_data i32)
    (local.set $__cap_data (i32.load offset=4 (local.get $__closure_ptr)))
    (call $__anon_1 (local.get $__cap_data))
  )
  (table 2 funcref)
