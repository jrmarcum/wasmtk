(module
  ...
  (func $runDenoPhase18Test  
    ...
    (local $namePtr i32)
    (local $typeId f64)
    (local $actualAddr f64)
    (local $shadowedNamePtr i32)
    (local $localShadowAddr f64)
    (local $i i32)
    (local $target i32)
    (local $resolvedAddr f64)
    (local $activeLookupAddr f64)
    (local $error_ptr i32)
    (local $error_len i32)
    ...
    (try
      (do
              ...
              (block $break_3
                (loop $loop_3
                  ...
                  (block $cont_3
                    ...
                    (local.set $actualAddr (call $18_symbol_table_insert_symbol (f64.convert_i32_s (local.get $namePtr)) (local.get $typeId) (f64.convert_i32_s (local.get $depth))))
        ...
        (i32.store offset=12 (local.get $__rt_struct_ptr) (i32.trunc_f64_s (local.get $actualAddr)))
        ...
        (local.set $localShadowAddr (call $18_symbol_table_insert_symbol (f64.convert_i32_s (local.get $shadowedNamePtr)) (f64.const 4) (f64.const 100)))
        ...
        (block $break_4
          (loop $loop_4
            ...
            (block $cont_4
              ...
              (if (f64.ne (local.get $resolvedAddr) (i32.load (i32.add (local.get $target) (i32.const 12))))
                (then
      ...
      (unreachable)
        ...
        (local.set $activeLookupAddr (call $18_symbol_table_lookup_symbol (f64.convert_i32_s (local.get $shadowedNamePtr))))
        (if (f64.ne (local.get $activeLookupAddr) (local.get $localShadowAddr))
          (then
          (call $proc_exit (i32.const 0))
      (unreachable)
          )
