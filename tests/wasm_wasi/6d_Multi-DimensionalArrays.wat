(module
  ...
  ;; Phase 6d: print a 2D i32 array as "[ [ e, ... ], ... ]", returns bytes written.
  ...
  (func $_start (export "_start")
    ...
    (i32.store (i32.add (i32.add (local.get $matrix) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 2))) (call $__dynarr_push_i32 (i32.load (i32.add (i32.add (local.get $matrix) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 2)))) (i32.const 5)))
        (i32.store (i32.const 0) (i32.const 132))
    (i32.store (i32.const 4) (call $__print_2d_i32_arr (local.get $matrix) (i32.const 132)))
