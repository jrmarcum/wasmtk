(module
  ...
  (func $createCounter  (result i32)
    ...
    (local.set $__obj_ret (call $__malloc (i32.const 8)))
      (i32.store offset=0 (local.get $__obj_ret) (call $__anon_0__factory (local.get $count)))
      (i32.store offset=4 (local.get $__obj_ret) (call $__anon_1__factory (local.get $count)))
      (return (local.get $__obj_ret))
  )

  (func $__anon_0 (param $count i32) (result i32)
    (i32.store (local.get $count) (i32.add (i32.load (local.get $count)) (i32.const 1)))
    (return (i32.load (local.get $count)))
  )

  (func $__anon_0__factory (param $count i32) (result i32)
    (local $__closure_ptr i32)
    (local.set $__closure_ptr (call $__malloc (i32.const 8)))
    (i32.store (local.get $__closure_ptr) (i32.const 0))
    (i32.store offset=4 (local.get $__closure_ptr) (local.get $count))
    (local.get $__closure_ptr)
  )

  (func $__anon_0__factory__trampoline (param $__closure_ptr i32) (result i32)
    (local $__cap_count i32)
    (local.set $__cap_count (i32.load offset=4 (local.get $__closure_ptr)))
    (call $__anon_0 (local.get $__cap_count))
  )

  (func $__anon_1 (param $count i32) (result i32)
    (i32.store (local.get $count) (i32.sub (i32.load (local.get $count)) (i32.const 1)))
    (return (i32.load (local.get $count)))
  )

  (func $__anon_1__factory (param $count i32) (result i32)
    (local $__closure_ptr i32)
    (local.set $__closure_ptr (call $__malloc (i32.const 8)))
  ...
  (func $__anon_1__factory__trampoline (param $__closure_ptr i32) (result i32)
    (local $__cap_count i32)
    (local.set $__cap_count (i32.load offset=4 (local.get $__closure_ptr)))
    (call $__anon_1 (local.get $__cap_count))
  )
  (func $_start (export "_start")
    ...
    (local $__struct_tmp i32)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call_indirect (type $ftype_i32_r_i32) (local.tee $__iface_tmp (i32.load (call $createCounter )))  (i32.load (local.get $__iface_tmp))) (i32.const 132)))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call_indirect (type $ftype_i32_r_i32) (local.tee $__iface_tmp (i32.load (i32.add (local.tee $__iface_tmp (call $createCounter )) (i32.const 4))))  (i32.load (local.get $__iface_tmp))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (local.set $counter1 (call $createCounter ))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call_indirect (type $ftype_i32_r_i32) (local.tee $__iface_tmp (i32.load (local.get $counter1)))  (i32.load (local.get $__iface_tmp))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (local.set $counter2 (call $createCounter ))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call_indirect (type $ftype_i32_r_i32) (local.tee $__iface_tmp (i32.load (local.get $counter2)))  (i32.load (local.get $__iface_tmp))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call_indirect (type $ftype_i32_r_i32) (local.tee $__iface_tmp (i32.load (i32.add (local.get $counter1) (i32.const 4))))  (i32.load (local.get $__iface_tmp))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call_indirect (type $ftype_i32_r_i32) (local.tee $__iface_tmp (i32.load (i32.add (local.get $counter2) (i32.const 4))))  (i32.load (local.get $__iface_tmp))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
