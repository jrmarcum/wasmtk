(module
  ...
  (func $testBigIntLogging (export "testBigIntLogging")  
    (local $positive i64)
    (local $negative i64)
    (local $zero i64)
    (local $a i64)
    ...
    (local.set $zero (i64.const 0))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i64_to_str (local.get $positive) (i32.const 132)))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i64_to_str (local.get $negative) (i32.const 132)))
          (i32.store (i32.const 8) (i32.const 260))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i64_to_str (local.get $zero) (i32.const 132)))
          (i32.store (i32.const 8) (i32.const 260))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (local.set $b (i64.const 200))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i64_to_str (i64.add (local.get $a) (local.get $b)) (i32.const 132)))
          (i32.store (i32.const 8) (i32.const 260))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
