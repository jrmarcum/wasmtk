(module
  ...
  (global $mz (mut i32) (i32.const 0))
  (global $ew (mut i32) (i32.const 0))
  ...
  (func $_start (export "_start")
    ...
    (global.set $mz (i32.const 5))
      (i32.store (i32.add (i32.const 260) (i32.const 0)) (global.get $mz))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 4) (call $__i32_to_str (global.get $mz) (i32.const 136))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $arr (i32.const 268))
    (global.set $ew (i32.const 9))
      (i32.store (i32.add (i32.add (i32.const 268) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 2))) (global.get $ew))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 97))
          ...
          (i32.store8 (i32.const 137) (i32.const 93))
          (i32.store8 (i32.const 138) (i32.const 58))
          (i32.store8 (i32.const 139) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 8) (call $__i32_to_str (i32.load (i32.add (i32.add (i32.const 268) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 2)))) (i32.const 140))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 134) (i32.const 58))
          (i32.store8 (i32.const 135) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 4) (call $__i32_to_str (global.get $ew) (i32.const 136))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 268) "\03\00\00\00\03\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
)