(module
        ...
        (block $cont_0
          ...
          (block $break_1
            (loop $loop_1
              ...
              (block $cont_1
                (if (i32.gt_s (call $__str_cmp (i32.const 0) (i32.const 0) (i32.const 0) (i32.const 0)) (i32.const 0))
                  (then
                  (;; string assignment from complex expression not yet supported: tmp = arr[j];)
                  (i32.store (i32.add (i32.add (local.get $arr) (i32.const 8)) (i32.shl (i32.trunc_f64_s (i32.trunc_f64_s (local.get $j))) (i32.const 2))) (i32.load (i32.add (i32.add (local.get $arr) (i32.const 8)) (i32.shl (i32.trunc_f64_s (f64.add (local.get $j) (f64.const 1))) (i32.const 2)))))
                  (i32.store (i32.add (i32.add (local.get $arr) (i32.const 8)) (i32.shl (i32.trunc_f64_s (f64.add (local.get $j) (f64.const 1))) (i32.const 2))) (local.get $tmp_ptr))
                  )
                )
              )
        ...
        (block $cont_2
          ...
          (block $break_3
            (loop $loop_3
              ...
              (block $cont_3
                (if (f64.gt (f64.load (i32.add (i32.add (local.get $arr) (i32.const 8)) (i32.shl (i32.trunc_f64_s (i32.trunc_f64_s (local.get $j))) (i32.const 3)))) (f64.load (i32.add (i32.add (local.get $arr) (i32.const 8)) (i32.shl (i32.trunc_f64_s (f64.add (local.get $j) (f64.const 1))) (i32.const 3)))))
                  (then
                  (local.set $tmp (f64.load (i32.add (i32.add (local.get $arr) (i32.const 8)) (i32.shl (i32.trunc_f64_s (i32.trunc_f64_s (local.get $j))) (i32.const 3)))))
                  (f64.store (i32.add (i32.add (local.get $arr) (i32.const 8)) (i32.shl (i32.trunc_f64_s (i32.trunc_f64_s (local.get $j))) (i32.const 3))) (f64.load (i32.add (i32.add (local.get $arr) (i32.const 8)) (i32.shl (i32.trunc_f64_s (f64.add (local.get $j) (f64.const 1))) (i32.const 3)))))
  ...
  (func $_start (export "_start")
    ...
    (block $break_6
      (loop $loop_6
        ...
        (block $cont_6
          (if (f64.gt (f64.load (i32.add (i32.add (i32.const 283) (i32.const 8)) (i32.shl (i32.trunc_f64_s (f64.sub (local.get $i) (f64.const 1))) (i32.const 3)))) (f64.load (i32.add (i32.add (i32.const 283) (i32.const 8)) (i32.shl (i32.trunc_f64_s (i32.trunc_f64_s (local.get $i))) (i32.const 3)))))
            (then
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 139) (i32.const 32))
          (i32.store8 (i32.const 140) (i32.const 32))
          (call $__str_gather (if (result i32) (local.get $isSorted) (then (i32.const 315)) (else (i32.const 319))) (if (result i32) (local.get $isSorted) (then (i32.const 4)) (else (i32.const 5))) (i32.const 141))
  ...
  (data (i32.const 315) "\74\72\75\65")
  (data (i32.const 319) "\66\61\6c\73\65")
  (data (i32.const 263) "\03\00\00\00\03\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
  (data (i32.const 283) "\03\00\00\00\03\00\00\00\00\00\00\00\00\00\1c\40\00\00\00\00\00\00\00\40\00\00\00\00\00\00\10\40")
)