(module
  ...
  (global $day f64 (f64.const 2))
  (global $hour f64 (f64.const 15))
  ...
  (func $whatAmI (param $tag_ptr i32) (param $tag_len i32) 
    ...
    (block $switch_exit_0
      ...
      (local.set $__ret_str_len (i32.const 13))
      (call $__str_concat (local.get $__ret_str_ptr) (local.get $__ret_str_len) (local.get $tag_ptr) (local.get $tag_len))
  ...
  (func $_start (export "_start")
    (local $writeResult_ptr i32)
    (local $writeResult_len i32)
    (local $__iface_tmp i32)
    (local.set $writeResult_ptr (i32.const 260))
      (local.set $writeResult_len (i32.const 0))
    (block $switch_exit_1
      (block $case_1_2
        (block $case_1_1
          (block $case_1_0
            (br_if $case_1_0 (f64.eq (global.get $i) (f64.const 1)))
            (br_if $case_1_1 (f64.eq (global.get $i) (f64.const 2)))
      ...
      (local.set $writeResult_len (i32.const 5))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 6) (call $__f64_to_str (global.get $i) (i32.const 138))))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 32))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 1))) (i32.const 97))
          ...
          (call $__str_gather (local.get $writeResult_ptr) (local.get $writeResult_len) (i32.add (i32.const 132) (i32.load (i32.const 4))))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (local.get $writeResult_len)))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
    (block $switch_exit_2
      (block $case_default_2
        (block $case_2_1
          (block $case_2_0
            (br_if $case_2_0 (f64.eq (global.get $day) (f64.const 0)))
            (br_if $case_2_1 (f64.eq (global.get $day) (f64.const 6)))
            (br $case_default_2)
          )
        )
    ...
    (if (f64.lt (global.get $hour) (f64.const 12))
      ...
      (else
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $whatAmI (i32.const 260) (i32.const 4))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $whatAmI (i32.const 264) (i32.const 3))
          (call $__str_gather (global.get $__str_ret_ptr) (global.get $__str_ret_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (global.get $__str_ret_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
