(module
  ...
  (func $mulberry32__inner (param $__closure_ptr i32) (result f64)
    ...
    (;; s = (s + 0x6D2B79F5) | 0;;)
    (local.set $t (i32.mul (i32.xor (i32.trunc_f64_s (f64.load offset=4 (local.get $__closure_ptr))) (i32.shr_u (i32.trunc_f64_s (f64.load offset=4 (local.get $__closure_ptr))) (i32.const 15))) (i32.or (i32.const 1) (i32.trunc_f64_s (f64.load offset=4 (local.get $__closure_ptr))))))
    (local.set $t (i32.xor (f64.add (local.get $t) (i32.mul (i32.xor (i32.trunc_f64_s (local.get $t)) (i32.shr_u (i32.trunc_f64_s (local.get $t)) (i32.const 7))) (i32.or (i32.const 61) (i32.trunc_f64_s (local.get $t))))) (i32.trunc_f64_s (local.get $t))))
    (return (f64.div (i32.shr_u (i32.xor (i32.trunc_f64_s (local.get $t)) (i32.shr_u (i32.trunc_f64_s (local.get $t)) (i32.const 14))) (i32.const 0)) (f64.const 4294967296)))
  )
  ...
  (func $_start (export "_start")
    ...
    (local.set $v1 (f64.floor (f64.convert_i32_s (i32.mul (call_indirect (type $ftype_i32_r_f64) (local.get $r1)  (i32.load (local.get $r1))) (i32.const 100)))))
    (local.set $v2 (f64.floor (f64.convert_i32_s (i32.mul (call_indirect (type $ftype_i32_r_f64) (local.get $r1)  (i32.load (local.get $r1))) (i32.const 100)))))
    ...
    (local.set $v3 (f64.convert_i32_s (i32.add (i32.mul (call_indirect (type $ftype_i32_r_f64) (local.get $r3)  (i32.load (local.get $r3))) (i32.const 5)) (i32.const 5))))
    (local.set $v4 (f64.convert_i32_s (i32.add (i32.mul (call_indirect (type $ftype_i32_r_f64) (local.get $r3)  (i32.load (local.get $r3))) (i32.const 5)) (i32.const 5))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
    ...
    (local.set $a1 (f64.floor (f64.convert_i32_s (i32.mul (call_indirect (type $ftype_i32_r_f64) (local.get $r4)  (i32.load (local.get $r4))) (i32.const 100)))))
    (local.set $a2 (f64.floor (f64.convert_i32_s (i32.mul (call_indirect (type $ftype_i32_r_f64) (local.get $r4)  (i32.load (local.get $r4))) (i32.const 100)))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
    ...
    (local.set $b1 (f64.floor (f64.convert_i32_s (i32.mul (call_indirect (type $ftype_i32_r_f64) (local.get $r5)  (i32.load (local.get $r5))) (i32.const 100)))))
    (local.set $b2 (f64.floor (f64.convert_i32_s (i32.mul (call_indirect (type $ftype_i32_r_f64) (local.get $r5)  (i32.load (local.get $r5))) (i32.const 100)))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
