(module
  ...
  (func $greet (param $name_ptr i32) (param $name_len i32) 
    ...
    (local.set $__ret_str_ptr (i32.const 260))
      ...
      (call $__str_concat (local.get $__ret_str_ptr) (local.get $__ret_str_len) (local.get $name_ptr) (local.get $name_len))
  ...
  (func $formatNum (param $n i32) 
    (local $__ret_str_ptr i32)
    (local $__ret_str_len i32)
    (local $__tmpl_num_ptr i32)
    (local $__tmpl_num_len i32)
    (local.set $__ret_str_ptr (i32.const 267))
      (local.set $__ret_str_len (i32.const 6))
      (local.set $__tmpl_num_ptr (call $__malloc (i32.const 32)))
      (local.set $__tmpl_num_len (call $__i32_to_str (local.get $n) (local.get $__tmpl_num_ptr)))
  ...
  (func $describe (param $label_ptr i32) (param $label_len i32) (param $n i32) 
    (local $__ret_str_ptr i32)
    (local $__ret_str_len i32)
    (local.set $__ret_str_ptr (local.get $label_ptr))
      (local.set $__ret_str_len (local.get $label_len))
      (call $__str_concat (local.get $__ret_str_ptr) (local.get $__ret_str_len) (i32.const 273) (i32.const 1))
      (local.set $__ret_str_len)
      (local.set $__ret_str_ptr)
      (call $__str_concat (local.get $__ret_str_ptr) (local.get $__ret_str_len) (call $formatNum (local.get $n)) (global.get $__str_ret_ptr) (global.get $__str_ret_len))
      (local.set $__ret_str_len)
      (local.set $__ret_str_ptr)
      (global.set $__str_ret_ptr (local.get $__ret_str_ptr))
      (global.set $__str_ret_len (local.get $__ret_str_len))
  ...
  (func $_start (export "_start")
    ...
    (call $greet (i32.const 274) (i32.const 5))
(local.set $msg_ptr (global.get $__str_ret_ptr))
      (local.set $msg_len (global.get $__str_ret_len))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $greet (i32.const 279) (i32.const 5))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (call $greet (i32.const 284) (i32.const 3))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $describe (i32.const 287) (i32.const 1) (i32.const 7))
          (call $__str_gather (global.get $__str_ret_ptr) (global.get $__str_ret_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (global.get $__str_ret_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
  ...
  (data (i32.const 267) "\76\61\6c\75\65\3d")
  (data (i32.const 273) "\3d")
  (data (i32.const 274) "\57\6f\72\6c\64")
  (data (i32.const 279) "\41\6c\69\63\65")
  (data (i32.const 284) "\42\6f\62")
  (data (i32.const 287) "\78")
)