(module
  ...
  (func $tryDivide (export "tryDivide") (param $a i32) (param $b i32) (result i32)
    ...
    (if (i32.eq (local.get $b) (i32.const 0))
      ...
      (i32.store offset=0 (local.get $__obj_ret) (i32.const 0))
      (i32.store offset=4 (local.get $__obj_ret) (i32.const 1))
      (return (local.get $__obj_ret))
      )
    )
    (local.set $__obj_ret (call $__malloc (i32.const 8)))
      (i32.store offset=0 (local.get $__obj_ret) (i32.div_s (local.get $a) (local.get $b)))
      (i32.store offset=4 (local.get $__obj_ret) (i32.const 0))
      (return (local.get $__obj_ret))
  )
  (func $_start (export "_start")
    ...
    (local $__struct_tmp i32)
        (local.set $__struct_tmp (call $tryDivide (i32.const 10) (i32.const 2)))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 9) (call $__i32_to_str (i32.load offset=0 (local.get $__struct_tmp)) (i32.const 141))))
          ...
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 2))) (i32.const 104))
          ...
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 5))) (i32.const 69))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 6))) (i32.const 114))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 7))) (i32.const 114))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 8))) (i32.const 111))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 9))) (i32.const 114))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 10))) (i32.const 58))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 11))) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 12)))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (call $__i32_to_str (i32.load offset=4 (local.get $__struct_tmp)) (i32.add (i32.const 132) (i32.load (i32.const 4))))))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 32))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 1))) (i32.const 125))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
        (local.set $__struct_tmp (call $tryDivide (i32.const 10) (i32.const 0)))
          (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 123))
          (i32.store8 (i32.const 133) (i32.const 32))
