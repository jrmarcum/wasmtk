(module
  ...
  (func $getF (param $x i32) (result f64)
    (return (f64.add (f64.const 3.7) (f64.convert_i32_s (local.get $x))))
  )

  (func $takeF (param $x f64) (result f64)
    (return (f64.add (local.get $x) (f64.const 0.5)))
  )

  (func $cmp (param $a i32) (param $i i32) (param $j i32) (result i32)
    (if (f64.eq (f64.load (i32.add (i32.add (local.get $a) (i32.const 8)) (i32.shl (local.get $i) (i32.const 3)))) (f64.load (i32.add (i32.add (local.get $a) (i32.const 8)) (i32.shl (local.get $j) (i32.const 3)))))
      (then
      (return (i32.const 1))
      )
    )
  ...
  (func $_start (export "_start")
    ...
    (global.set $s (i32.add (global.get $s) (i32.or (i32.trunc_f64_s (call $getF (i32.const 2))) (i32.const 0))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (global.get $s) (i32.const 132)))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $rg (call $takeF (f64.convert_i32_s (global.get $g))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (local.get $rg) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $ia (call $__malloc (i32.const 20)))
      (i32.store (local.get $ia) (i32.const 3))
      (i32.store (i32.add (local.get $ia) (i32.const 8)) (i32.const 10))
      (i32.store (i32.add (local.get $ia) (i32.const 12)) (i32.const 20))
      (i32.store (i32.add (local.get $ia) (i32.const 16)) (i32.const 30))
    (local.set $re (call $takeF (f64.convert_i32_s (i32.load (i32.add (i32.add (local.get $ia) (i32.const 8)) (i32.shl (i32.const 2) (i32.const 2)))))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (local.get $re) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $fa (call $__malloc (i32.const 32)))
      (i32.store (local.get $fa) (i32.const 3))
      (f64.store (i32.add (local.get $fa) (i32.const 8)) (f64.const 1.5))
      (f64.store (i32.add (local.get $fa) (i32.const 16)) (f64.const 1.9))
      (f64.store (i32.add (local.get $fa) (i32.const 24)) (f64.const 1.5))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $cmp (local.get $fa) (i32.const 0) (i32.const 1)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $cmp (local.get $fa) (i32.const 0) (i32.const 2)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
