(module
  ...
  (func $main  
    ...
    (call $Counter_decrement (i32.const 260) )
        (i32.store (i32.const 0) (i32.const 280))
          ...
          (i32.store (i32.const 8) (i32.const 288))
          (i32.store (i32.const 12) (i32.const 1))
          (i32.store (i32.const 16) (i32.const 132))
          (i32.store (i32.const 20) (call $__i32_to_str (call $Counter_getCount (i32.const 260) ) (i32.const 132)))
          (i32.store (i32.const 24) (i32.const 289))
    ...
    (local.set $doubled (call $Counter_create (i32.const 5)))
        (i32.store (i32.const 0) (i32.const 290))
          ...
          (i32.store (i32.const 12) (i32.const 1))
          (i32.store (i32.const 16) (i32.const 132))
          (i32.store (i32.const 20) (call $__i32_to_str (local.get $doubled) (i32.const 132)))
          (i32.store (i32.const 24) (i32.const 289))
          (i32.store (i32.const 28) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (local.set $distSq (call $Point_distanceSquared (i32.const 264) ))
        (i32.store (i32.const 0) (i32.const 305))
          ...
          (i32.store (i32.const 12) (i32.const 1))
          (i32.store (i32.const 16) (i32.const 132))
          (i32.store (i32.const 20) (call $__f64_to_str (local.get $distSq) (i32.const 132)))
          (i32.store (i32.const 24) (i32.const 289))
          (i32.store (i32.const 28) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (call $Point_scale (i32.const 264) (f64.const 2.0))
        (i32.store (i32.const 0) (i32.const 322))
          ...
          (i32.store (i32.const 12) (i32.const 1))
          (i32.store (i32.const 16) (i32.const 132))
          (i32.store (i32.const 20) (call $__f64_to_str (f64.load (i32.add (i32.const 264) (i32.const 0))) (i32.const 132)))
          (i32.store (i32.const 24) (i32.const 289))
          (i32.store (i32.const 28) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 331))
          ...
          (i32.store (i32.const 12) (i32.const 1))
          (i32.store (i32.const 16) (i32.const 132))
          (i32.store (i32.const 20) (call $__f64_to_str (f64.load (i32.add (i32.const 264) (i32.const 8))) (i32.const 132)))
          (i32.store (i32.const 24) (i32.const 289))
          (i32.store (i32.const 28) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 280) "\43\6f\75\6e\74\65\72\3a")
  (data (i32.const 288) "\20")
  (data (i32.const 289) "\0a")
  (data (i32.const 290) "\53\74\61\74\69\63\20\64\6f\75\62\6c\65\64\3a")
  (data (i32.const 305) "\44\69\73\74\61\6e\63\65\20\73\71\75\61\72\65\64\3a")
  (data (i32.const 322) "\53\63\61\6c\65\64\20\78\3a")
  (data (i32.const 331) "\53\63\61\6c\65\64\20\79\3a")
