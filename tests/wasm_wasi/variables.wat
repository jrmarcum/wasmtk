(module
  ...
  (func $main  
    ...
    (local.set $y (f64.add (local.get $x) (f64.const 10)))
        (i32.store (i32.const 0) (i32.const 260))
          ...
          (i32.store (i32.const 12) (call $__f64_to_str (local.get $y) (i32.const 132)))
          (i32.store (i32.const 16) (i32.const 268))
  ...
  (data (i32.const 260) "\52\65\73\75\6c\74\3a\20")
  (data (i32.const 268) "\0a")
)