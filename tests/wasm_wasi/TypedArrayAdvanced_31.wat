(module
  ...
  (func $sumArray (param $arr i32) (result i32)
    (local $total i32)
    (local $i i32)
    (local $len i32)
    (local $j i32)
    ...
    (block $break_0
      (loop $loop_0
        (br_if $break_0 (i32.eqz (i32.lt_s (local.get $j) (local.get $len))))
        (block $cont_0
          (local.set $total (i32.add (local.get $total) (i32.load (i32.add (i32.add (local.get $arr) (i32.const 8)) (i32.shl (local.get $j) (i32.const 2))))))
        )
  ...
  (func $_start (export "_start")
    ...
    (local.set $rt (call $__malloc (i32.add (i32.const 8) (i32.shl (global.get $n) (i32.const 2)))))
      (i32.store (local.get $rt) (global.get $n))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (local.get $rt)) (i32.const 132)))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (i32.store (i32.add (i32.add (local.get $rt) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 2))) (i32.const 100))
    (i32.store (i32.add (i32.add (local.get $rt) (i32.const 8)) (i32.shl (i32.const 3) (i32.const 2))) (i32.const 200))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $rt) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 2)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $rt) (i32.const 8)) (i32.shl (i32.const 3) (i32.const 2)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $u8 (call $__malloc (i32.const 11)))
      (i32.store (local.get $u8) (i32.const 3))
    (i32.store8 (i32.add (i32.add (local.get $u8) (i32.const 8)) (i32.const 0)) (i32.const 255))
    (i32.store8 (i32.add (i32.add (local.get $u8) (i32.const 8)) (i32.const 1)) (i32.const 128))
    (i32.store8 (i32.add (i32.add (local.get $u8) (i32.const 8)) (i32.const 2)) (i32.const 0))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load8_u (i32.add (i32.add (local.get $u8) (i32.const 8)) (i32.const 0))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load8_u (i32.add (i32.add (local.get $u8) (i32.const 8)) (i32.const 1))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load8_u (i32.add (i32.add (local.get $u8) (i32.const 8)) (i32.const 2))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (local.get $u8)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $u8b (call $__malloc (i32.const 11)))
      (i32.store (local.get $u8b) (i32.const 3))
      (i32.store8 (i32.add (local.get $u8b) (i32.const 8)) (i32.const 10))
      (i32.store8 (i32.add (local.get $u8b) (i32.const 9)) (i32.const 20))
      (i32.store8 (i32.add (local.get $u8b) (i32.const 10)) (i32.const 30))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load8_u (i32.add (i32.add (local.get $u8b) (i32.const 8)) (i32.const 0))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load8_u (i32.add (i32.add (local.get $u8b) (i32.const 8)) (i32.const 1))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load8_u (i32.add (i32.add (local.get $u8b) (i32.const 8)) (i32.const 2))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $dst (call $__malloc (i32.const 28)))
      (i32.store (local.get $dst) (i32.const 5))
    (local.set $src (call $__malloc (i32.const 20)))
      (i32.store (local.get $src) (i32.const 3))
      (i32.store (i32.add (local.get $src) (i32.const 8)) (i32.const 1))
      (i32.store (i32.add (local.get $src) (i32.const 12)) (i32.const 2))
      (i32.store (i32.add (local.get $src) (i32.const 16)) (i32.const 3))
    (call $__ta_set_i32 (local.get $dst) (local.get $src) (i32.const 0))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $dst) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 2)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $dst) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 2)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $dst) (i32.const 8)) (i32.shl (i32.const 2) (i32.const 2)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $dst) (i32.const 8)) (i32.shl (i32.const 3) (i32.const 2)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $dst2 (call $__malloc (i32.const 28)))
      (i32.store (local.get $dst2) (i32.const 5))
    (local.set $src2 (call $__malloc (i32.const 20)))
      (i32.store (local.get $src2) (i32.const 3))
      (i32.store (i32.add (local.get $src2) (i32.const 8)) (i32.const 7))
      (i32.store (i32.add (local.get $src2) (i32.const 12)) (i32.const 8))
      (i32.store (i32.add (local.get $src2) (i32.const 16)) (i32.const 9))
    (call $__ta_set_i32 (local.get $dst2) (local.get $src2) (i32.const 2))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $dst2) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 2)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $dst2) (i32.const 8)) (i32.shl (i32.const 2) (i32.const 2)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $dst2) (i32.const 8)) (i32.shl (i32.const 3) (i32.const 2)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $dst2) (i32.const 8)) (i32.shl (i32.const 4) (i32.const 2)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $vals (call $__malloc (i32.const 28)))
      (i32.store (local.get $vals) (i32.const 5))
      (i32.store (i32.add (local.get $vals) (i32.const 8)) (i32.const 1))
      (i32.store (i32.add (local.get $vals) (i32.const 12)) (i32.const 2))
      (i32.store (i32.add (local.get $vals) (i32.const 16)) (i32.const 3))
      (i32.store (i32.add (local.get $vals) (i32.const 20)) (i32.const 4))
      (i32.store (i32.add (local.get $vals) (i32.const 24)) (i32.const 5))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $sumArray (local.get $vals)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
