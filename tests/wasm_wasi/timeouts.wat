(module
  ...
  (func $simulateWork (param $ms f64) (param $result_ptr i32) (param $result_len i32) (param $timeoutMs f64) 
    (local $__ret_str_ptr i32)
    (local $__ret_str_len i32)
    (local $__tmpl_num_ptr i32)
    (local $__tmpl_num_len i32)
    (if (f64.gt (local.get $ms) (local.get $timeoutMs))
      (then
      ...
      (local.set $__tmpl_num_len (call $__f64_to_str (f64.div (local.get $timeoutMs) (f64.const 100)) (local.get $__tmpl_num_ptr)))
  ...
  (func $_start (export "_start")
    ...
    (call $simulateWork (f64.const 200) (i32.const 268) (i32.const 8) (f64.const 100))
(local.set $r1_ptr (global.get $__str_ret_ptr))
      (local.set $r1_len (global.get $__str_ret_len))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $simulateWork (f64.const 200) (i32.const 276) (i32.const 8) (f64.const 300))
(local.set $r2_ptr (global.get $__str_ret_ptr))
      (local.set $r2_len (global.get $__str_ret_len))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
  ...
  (data (i32.const 260) "\74\69\6d\65\6f\75\74\20")
  (data (i32.const 268) "\72\65\73\75\6c\74\20\31")
  (data (i32.const 276) "\72\65\73\75\6c\74\20\32")
)