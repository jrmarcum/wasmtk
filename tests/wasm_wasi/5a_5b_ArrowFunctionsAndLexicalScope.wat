(module
  ...
  (func $testLexicalCapture (export "testLexicalCapture") (param $multiplier i32) (result i32)
    (local $simpleScale i32)
    (local.set $simpleScale (call $__anon_0__factory (local.get $multiplier)))
    (return (call_indirect (type $ftype_i32_i32_r_i32) (local.get $simpleScale) (i32.const 10) (i32.load (local.get $simpleScale))))
  )

  (func $__anon_0 (param $val i32) (param $multiplier i32) (result i32)
    (return (i32.mul (local.get $val) (local.get $multiplier)))
  )

  (func $__anon_0__factory (param $multiplier i32) (result i32)
  ...
  (func $__anon_0__factory__trampoline (param $__closure_ptr i32) (param $val i32) (result i32)
    (local $__cap_multiplier i32)
    (local.set $__cap_multiplier (i32.load offset=4 (local.get $__closure_ptr)))
    (call $__anon_0 (local.get $val) (local.get $__cap_multiplier))
  )
  (func $_start (export "_start")
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $testLexicalCapture (i32.const 5)) (i32.const 132)))
