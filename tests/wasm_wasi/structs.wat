(module
  ...
  (func $_start (export "_start")
    ...
    (local $__tmpl_num_len i32)
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (call $fmtPerson (call $newPerson (i32.const 271) (i32.const 3) (f64.const 20)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $fmtPerson (call $newPerson (i32.const 274) (i32.const 5) (f64.const 30)))
          (call $__str_gather (global.get $__str_ret_ptr) (global.get $__str_ret_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (global.get $__str_ret_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $fmtPerson (call $newPersonWithAge (i32.const 279) (i32.const 3)))
          (call $__str_gather (global.get $__str_ret_ptr) (global.get $__str_ret_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (global.get $__str_ret_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $fmtPerson (call $newPersonWithAge (i32.const 282) (i32.const 3)))
          (call $__str_gather (global.get $__str_ret_ptr) (global.get $__str_ret_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (global.get $__str_ret_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $s (call $newPerson (i32.const 285) (i32.const 4) (f64.const 50)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (local.get $s) (i32.const 0))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (local.set $dog (i32.const 263))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 1) (call $__i32_to_str (i32.load (i32.add (i32.const 263) (i32.const 0))) (i32.const 133))))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (call $__i32_to_str (i32.load (i32.add (i32.const 263) (i32.const 4))) (i32.add (i32.const 132) (i32.load (i32.const 4))))))
  ...
  (data (i32.const 271) "\42\6f\62")
  (data (i32.const 274) "\41\6c\69\63\65")
  (data (i32.const 279) "\41\6e\6e")
  (data (i32.const 282) "\4a\6f\6e")
  (data (i32.const 285) "\53\65\61\6e")
  (data (i32.const 263) "\00\00\00\00\00\00\00\00")
)