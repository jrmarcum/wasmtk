(module
    ...
    (local.set $box (i32.const 276))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (f64.load (i32.add (i32.const 276) (i32.const 8))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (f64.load (i32.add (i32.load (i32.add (i32.const 276) (i32.const 0))) (i32.const 0))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (f64.load (i32.add (i32.load (i32.add (i32.const 276) (i32.const 0))) (i32.const 8))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (f64.load (i32.add (i32.load (i32.add (i32.const 276) (i32.const 4))) (i32.const 0))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (f64.load (i32.add (i32.load (i32.add (i32.const 276) (i32.const 4))) (i32.const 8))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $desc_ptr (i32.const 324))
      (local.set $desc_len (i32.const 9))
      (local.set $__tmpl_num_ptr (call $__malloc (i32.const 32)))
      (local.set $__tmpl_num_len (call $__f64_to_str (f64.load (i32.add (i32.load (i32.add (i32.const 276) (i32.const 0))) (i32.const 0))) (local.get $__tmpl_num_ptr)))
      (call $__str_concat (local.get $desc_ptr) (local.get $desc_len) (local.get $__tmpl_num_ptr) (local.get $__tmpl_num_len))
      (local.set $desc_len)
      (local.set $desc_ptr)
      (call $__str_concat (local.get $desc_ptr) (local.get $desc_len) (i32.const 333) (i32.const 1))
      (local.set $desc_len)
      (local.set $desc_ptr)
      (local.set $__tmpl_num_ptr (call $__malloc (i32.const 32)))
      (local.set $__tmpl_num_len (call $__f64_to_str (f64.load (i32.add (i32.load (i32.add (i32.const 276) (i32.const 0))) (i32.const 8))) (local.get $__tmpl_num_ptr)))
      (call $__str_concat (local.get $desc_ptr) (local.get $desc_len) (local.get $__tmpl_num_ptr) (local.get $__tmpl_num_len))
      (local.set $desc_len)
      (local.set $desc_ptr)
      (call $__str_concat (local.get $desc_ptr) (local.get $desc_len) (i32.const 334) (i32.const 1))
      (local.set $desc_len)
      (local.set $desc_ptr)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (local.get $desc_ptr) (local.get $desc_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $desc_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 324) "\74\6f\70\4c\65\66\74\3d\28")
  (data (i32.const 333) "\2c")
  (data (i32.const 334) "\29")
  (data (i32.const 260) "\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
  (data (i32.const 292) "\00\00\00\00\00\00\00\40\00\00\00\00\00\00\08\40")
  (data (i32.const 308) "\00\00\00\00\00\00\20\40\00\00\00\00\00\00\1c\40")
  (data (i32.const 276) "\24\01\00\00\34\01\00\00\00\00\00\00\00\00\18\40")
)