(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 359))
  ...
  (func $numArrStr (param $arr i32) 
    ...
    (block $break_0
      ...
      (local.set $s_ptr)
          ...
          (call $__str_concat (local.get $s_ptr) (local.get $s_len) (local.tee $s_ptr (call $__malloc (i32.const 32))) (call $__f64_to_str (f64.load (i32.add (i32.add (local.get $arr) (i32.const 8)) (i32.shl (i32.trunc_f64_s (i32.trunc_f64_s (local.get $i))) (i32.const 3)))) (local.get $s_ptr)))
      (local.set $s_len)
      (local.set $s_ptr)
        )
    ...
    (call $__str_concat (local.get $s_ptr) (local.get $s_len) (i32.const 262) (i32.const 1))
  ...
  (func $_start (export "_start")
    ...
    (local.set $a (i32.const 263))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (f64.store (i32.add (i32.add (i32.const 263) (i32.const 8)) (i32.shl (i32.const 4) (i32.const 3))) (f64.const 100))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 135) (i32.const 58))
          (i32.store8 (i32.const 136) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 5) (call $__f64_to_str (f64.load (i32.add (i32.add (i32.const 263) (i32.const 8)) (i32.shl (i32.const 4) (i32.const 3)))) (i32.const 137))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 135) (i32.const 58))
          (i32.store8 (i32.const 136) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 5) (call $__i32_to_str (i32.const 5) (i32.const 137))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (local.set $b (i32.const 311))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $twoD (call $__malloc (i32.const 40)))
      (i32.store (local.get $twoD) (i32.const 2))
      (i32.store offset=4 (local.get $twoD) (i32.const 8))
      (i32.store offset=8 (local.get $twoD) (local.tee $__2d_tmp (call $__malloc (i32.const 72))))
      (i32.store (local.get $__2d_tmp) (i32.const 3))
      (i32.store offset=4 (local.get $__2d_tmp) (i32.const 8))
      (f64.store offset=8 (local.get $__2d_tmp) (f64.const 0))
      (f64.store offset=16 (local.get $__2d_tmp) (f64.const 0))
      (f64.store offset=24 (local.get $__2d_tmp) (f64.const 0))
      (i32.store offset=12 (local.get $twoD) (local.tee $__2d_tmp (call $__malloc (i32.const 72))))
      (i32.store (local.get $__2d_tmp) (i32.const 3))
      (i32.store offset=4 (local.get $__2d_tmp) (i32.const 8))
      (f64.store offset=8 (local.get $__2d_tmp) (f64.const 0))
      (f64.store offset=16 (local.get $__2d_tmp) (f64.const 0))
    ...
    (block $break_1
      (loop $loop_1
        (br_if $break_1 (i32.eqz (f64.lt (local.get $row) (f64.const 2))))
        (block $cont_1
          (local.set $col (f64.const 0))
          (block $break_2
            (loop $loop_2
              (br_if $break_2 (i32.eqz (f64.lt (local.get $col) (f64.const 3))))
              (block $cont_2
                (f64.store (i32.add (i32.add (i32.load (i32.add (i32.add (local.get $twoD) (i32.const 8)) (i32.shl (i32.trunc_f64_s (i32.trunc_f64_s (local.get $row))) (i32.const 2)))) (i32.const 8)) (i32.shl (i32.trunc_f64_s (i32.trunc_f64_s (local.get $col))) (i32.const 3))) (f64.add (local.get $row) (local.get $col)))
              )
              (local.set $col (f64.add (local.get $col) (f64.const 1)))
              (br $loop_2)
            )
          )
        )
        (local.set $row (f64.add (local.get $row) (f64.const 1)))
        (br $loop_1)
      )
    )
    (local.set $twoDStr_ptr (i32.const 260))
      (local.set $twoDStr_len (i32.const 1))
    (local.set $r (f64.const 0))
    (block $break_3
      (loop $loop_3
        (br_if $break_3 (i32.eqz (f64.lt (local.get $r) (f64.convert_i32_s (i32.load (local.get $twoD))))))
        (block $cont_3
          (if (f64.gt (local.get $r) (f64.const 0))
            (then
            (call $__str_concat (local.get $twoDStr_ptr) (local.get $twoDStr_len) (i32.const 261) (i32.const 1))
      (local.set $twoDStr_len)
      (local.set $twoDStr_ptr)
            )
          )
          (call $__str_concat (local.get $twoDStr_ptr) (local.get $twoDStr_len) (call $numArrStr (i32.load (i32.add (i32.add (local.get $twoD) (i32.const 8)) (i32.shl (i32.trunc_f64_s (i32.trunc_f64_s (local.get $r))) (i32.const 2))))) (global.get $__str_ret_ptr) (global.get $__str_ret_len))
      (local.set $twoDStr_len)
      (local.set $twoDStr_ptr)
        )
        (local.set $r (f64.add (local.get $r) (f64.const 1)))
        (br $loop_3)
      )
    )
    (call $__str_concat (local.get $twoDStr_ptr) (local.get $twoDStr_len) (i32.const 262) (i32.const 1))
      (local.set $twoDStr_len)
      (local.set $twoDStr_ptr)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 50))
          (i32.store8 (i32.const 133) (i32.const 100))
          (i32.store8 (i32.const 134) (i32.const 58))
          (i32.store8 (i32.const 135) (i32.const 32))
          (call $__str_gather (local.get $twoDStr_ptr) (local.get $twoDStr_len) (i32.const 136))
          (i32.store (i32.const 4) (i32.add (i32.const 4) (local.get $twoDStr_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 263) "\05\00\00\00\05\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
  (data (i32.const 311) "\05\00\00\00\05\00\00\00\00\00\00\00\00\00\f0\3f\00\00\00\00\00\00\00\40\00\00\00\00\00\00\08\40\00\00\00\00\00\00\10\40\00\00\00\00\00\00\14\40")
)