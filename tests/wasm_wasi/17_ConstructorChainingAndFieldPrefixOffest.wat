(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 319))
  ...
  (func $Vector2D_constructor (param $__self i32) (param $x i32) (param $y i32) 
    (i32.store (i32.add (local.get $__self) (i32.const 4)) (local.get $x))
    (i32.store (i32.add (local.get $__self) (i32.const 8)) (local.get $y))
  )

  (func $Vector3D_constructor (param $__self i32) (param $x i32) (param $y i32) (param $z i32) 
    (call $Vector2D_constructor (local.get $__self) (local.get $x) (local.get $y))
    (i32.store (i32.add (local.get $__self) (i32.const 12)) (local.get $z))
  )

  (func $NamedVector3D_constructor (param $__self i32) (param $x i32) (param $y i32) (param $z i32) (param $id i32) 
    (call $Vector3D_constructor (local.get $__self) (local.get $x) (local.get $y) (local.get $z))
    (i32.store (i32.add (local.get $__self) (i32.const 16)) (local.get $id))
  )

  (func $NamedVector3D_printCoords (param $__self i32) 
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 73))
          (i32.store8 (i32.const 133) (i32.const 68))
          (i32.store8 (i32.const 134) (i32.const 58))
          (i32.store8 (i32.const 135) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 4) (call $__i32_to_str (i32.load (i32.add (local.get $__self) (i32.const 16))) (i32.const 136))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 88))
          (i32.store8 (i32.const 133) (i32.const 58))
          (i32.store8 (i32.const 134) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 3) (call $__i32_to_str (i32.load (i32.add (local.get $__self) (i32.const 4))) (i32.const 135))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 89))
          (i32.store8 (i32.const 133) (i32.const 58))
          (i32.store8 (i32.const 134) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 3) (call $__i32_to_str (i32.load (i32.add (local.get $__self) (i32.const 8))) (i32.const 135))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 133) (i32.const 58))
          (i32.store8 (i32.const 134) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 3) (call $__i32_to_str (i32.load (i32.add (local.get $__self) (i32.const 12))) (i32.const 135))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $testMemoryLayout (export "testMemoryLayout")  
    (local $vec i32)
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 280))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $vec (i32.const 260))
      (call $NamedVector3D_constructor (i32.const 260) (i32.const 11) (i32.const 22) (i32.const 33) (i32.const 999))
    (call $NamedVector3D_printCoords (i32.const 260) )
  )
  (func $_start (export "_start")
    (call $testMemoryLayout )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 280) "\2d\2d\2d\20\54\65\73\74\20\32\3a\20\46\69\65\6c\64\20\4f\66\66\73\65\74\20\41\6c\69\67\6e\6d\65\6e\74\20\2d\2d\2d\0a")
  (data (i32.const 260) "\03\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
)