(module
  ...
  (func $_start (export "_start")
    ...
    (local.set $fooTail (i32.const 266))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (call $__str_gather (if (result i32) (local.get $fooEnable) (then (i32.const 299)) (else (i32.const 303))) (if (result i32) (local.get $fooEnable) (then (i32.const 4)) (else (i32.const 5))) (i32.const 142))
  ...
  (data (i32.const 282) "\73\75\62\63\6f\6d\6d\61\6e\64\20\27\66\6f\6f\27\0a")
  (data (i32.const 299) "\74\72\75\65")
  (data (i32.const 303) "\66\61\6c\73\65")
  (data (i32.const 266) "\02\00\00\00\02\00\00\00\00\00\00\00\00\00\00\00")
)