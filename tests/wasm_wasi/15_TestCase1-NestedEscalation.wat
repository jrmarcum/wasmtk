(module
  ...
  (global $globalTrace (mut i32) (i32.const 0))
  ...
  (func $levelThree (param $fail i32) 
    (local $__throw_msg_ptr i32)
    (local $__throw_msg_len i32)
    (if (i32.eq (local.get $fail) (i32.const 1))
      (then
      (throw $__exn_tag (i32.const 260) (i32.const 15))
      )
    )
  )

  (func $levelTwo (param $fail i32) 
    (try
      (do
        (global.set $globalTrace (i32.add (global.get $globalTrace) (i32.const 10)))
        (call $levelThree (local.get $fail))
        (global.set $globalTrace (i32.add (global.get $globalTrace) (i32.const 5)))
        (global.set $globalTrace (i32.add (global.get $globalTrace) (i32.const 2)))
      )
      (catch_all
        (global.set $globalTrace (i32.add (global.get $globalTrace) (i32.const 2)))
        (rethrow 0)
  ...
  (func $testNestedEscalation (export "testNestedEscalation") (param $fail i32) (result i32)
    (local $e_ptr i32)
    (local $e_len i32)
    (local $__iface_tmp i32)
    (global.set $globalTrace (i32.const 0))
    (try
      (do
        (call $levelTwo (local.get $fail))
      )
      (catch $__exn_tag
        (local.set $e_len)
        (local.set $e_ptr)
          ...
          (call $__str_gather (local.get $e_ptr) (local.get $e_len) (i32.const 140))
          (i32.store (i32.const 4) (i32.add (i32.const 8) (local.get $e_len)))
    ...
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 275))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $score1 (call $testNestedEscalation (i32.const 0)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 19) (call $__i32_to_str (local.get $score1) (i32.const 151))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 304))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $score2 (call $testNestedEscalation (i32.const 1)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 70))
          (i32.store8 (i32.const 133) (i32.const 105))
          ...
          (i32.store8 (i32.const 149) (i32.const 58))
          (i32.store8 (i32.const 150) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 19) (call $__i32_to_str (local.get $score2) (i32.const 151))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 260) "\4c\65\76\65\6c\20\33\20\46\61\69\6c\75\72\65")
  (data (i32.const 275) "\2d\2d\2d\20\54\65\73\74\20\31\3a\20\53\75\63\63\65\73\73\20\50\61\74\68\20\2d\2d\2d\0a")
  (data (i32.const 304) "\2d\2d\2d\20\54\65\73\74\20\31\3a\20\46\61\69\6c\75\72\65\20\50\61\74\68\20\2d\2d\2d\0a")
)