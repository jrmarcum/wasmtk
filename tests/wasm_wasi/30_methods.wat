(module
  ...
  (func $newRect (param $width f64) (param $height f64) (result i32)
    (local $__obj_ret i32)
    (local $__nested_ptr i32)
    (local.set $__obj_ret (call $__malloc (i32.const 16)))
      (f64.store offset=0 (local.get $__obj_ret) (local.get $width))
      (f64.store offset=8 (local.get $__obj_ret) (local.get $height))
      (return (local.get $__obj_ret))
  )

  (func $area (param $r i32) (result f64)
    (return (f64.mul (f64.load (i32.add (local.get $r) (i32.const 0))) (f64.load (i32.add (local.get $r) (i32.const 8)))))
  )

  (func $perim (param $r i32) (result f64)
    (return (f64.add (f64.mul (f64.const 2) (f64.load (i32.add (local.get $r) (i32.const 0)))) (f64.mul (f64.const 2) (f64.load (i32.add (local.get $r) (i32.const 8))))))
  )
  (func $_start (export "_start")
    (local $r i32)
    (local $__iface_tmp i32)
    (local.set $r (call $newRect (f64.const 10) (f64.const 5)))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 6) (call $__f64_to_str (call $area (local.get $r)) (i32.const 138))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 7) (call $__f64_to_str (call $perim (local.get $r)) (i32.const 139))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
