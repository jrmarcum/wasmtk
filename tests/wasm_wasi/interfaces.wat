(module
  ...
  (func $newRect (param $w f64) (param $h f64) (result i32)
    ...
    (local.set $__obj_ret (call $__malloc (i32.const 24)))
      (i32.store offset=0 (local.get $__obj_ret) (;? "rect" ;) (i32.const 0))
  ...
  (func $newCircle (param $r f64) (result i32)
    (local $__obj_ret i32)
    (local.set $__obj_ret (call $__malloc (i32.const 24)))
      (i32.store offset=0 (local.get $__obj_ret) (;? "circle" ;) (i32.const 0))
  ...
  (func $area (param $g i32) (result f64)
    (if (i32.eq (i32.load (i32.add (local.get $g) (i32.const 0))) (;? "rect" ;) (i32.const 0))
      (then
      (return (f64.mul (f64.load (i32.add (local.get $g) (i32.const 8))) (f64.load (i32.add (local.get $g) (i32.const 16)))))
      )
    )
    (if (i32.eq (i32.load (i32.add (local.get $g) (i32.const 0))) (;? "circle" ;) (i32.const 0))
      (then
