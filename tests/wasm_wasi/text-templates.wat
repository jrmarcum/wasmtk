(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 388))
  ...
  (func $_start (export "_start")
    ...
    (local.set $t1_ptr (i32.const 260))
      (local.set $t1_len (i32.const 12))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (call $renderDot (local.get $t1_ptr) (local.get $t1_len) (i32.const 328) (i32.const 9))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $renderDot (local.get $t1_ptr) (local.get $t1_len) (i32.const 337) (i32.const 1))
          (call $__str_gather (global.get $__str_ret_ptr) (global.get $__str_ret_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (global.get $__str_ret_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $renderDot (local.get $t1_ptr) (local.get $t1_len) (i32.const 338) (i32.const 16))
          (call $__str_gather (global.get $__str_ret_ptr) (global.get $__str_ret_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (global.get $__str_ret_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
    ...
    (local.set $t2_ptr (i32.const 272))
      (local.set $t2_len (i32.const 15))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $renderField (local.get $t2_ptr) (local.get $t2_len) (i32.const 354) (i32.const 4) (i32.const 358) (i32.const 8))
          (call $__str_gather (global.get $__str_ret_ptr) (global.get $__str_ret_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (global.get $__str_ret_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $renderField (local.get $t2_ptr) (local.get $t2_len) (i32.const 354) (i32.const 4) (i32.const 366) (i32.const 12))
          (call $__str_gather (global.get $__str_ret_ptr) (global.get $__str_ret_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (global.get $__str_ret_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
    ...
    (block $break_1
      (loop $loop_1
        ...
        (block $cont_1
          (call $__str_concat (local.get $rangeOut_ptr) (local.get $rangeOut_len) (i32.const 0) (i32.const 0))
      (local.set $rangeOut_len)
      (local.set $rangeOut_ptr)
      (call $__str_concat (local.get $rangeOut_ptr) (local.get $rangeOut_len) (i32.const 387) (i32.const 1))
      (local.set $rangeOut_len)
      (local.set $rangeOut_ptr)
        )
        (local.set $i (f64.add (local.get $i) (f64.const 1)))
  ...
  (data (i32.const 304) "")
  (data (i32.const 328) "\73\6f\6d\65\20\74\65\78\74")
  (data (i32.const 337) "\35")
  (data (i32.const 338) "\5b\47\6f\20\52\75\73\74\20\43\2b\2b\20\43\23\5d")
  (data (i32.const 354) "\4e\61\6d\65")
  (data (i32.const 358) "\4a\61\6e\65\20\44\6f\65")
  (data (i32.const 366) "\4d\69\63\6b\65\79\20\4d\6f\75\73\65")
  (data (i32.const 378) "\79\65\73\20\0a")
  (data (i32.const 383) "\6e\6f\20\0a")
  (data (i32.const 387) "\20")
  (data (i32.const 304) "\04\00\00\00\04\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
)