(module
  ...
  (func $main  
    ...
    (call $check (if (result i32) (i32.eq (call $__str_char_code_at (local.get $s_ptr) (local.get $s_len) (select (i32.const 0) (i32.add (local.get $s_len) (i32.const 0)) (i32.ge_s (i32.const 0) (i32.const 0)))) (i32.const 104)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $__str_char_code_at (local.get $s_ptr) (local.get $s_len) (select (i32.const 1) (i32.add (local.get $s_len) (i32.const 1)) (i32.ge_s (i32.const 1) (i32.const 0)))) (i32.const 101)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $__str_char_code_at (local.get $s_ptr) (local.get $s_len) (select (i32.const -1) (i32.add (local.get $s_len) (i32.const -1)) (i32.ge_s (i32.const -1) (i32.const 0)))) (i32.const 111)) (then (i32.const 1)) (else (i32.const 0))))
    (call $check (if (result i32) (i32.eq (call $__str_char_code_at (local.get $s_ptr) (local.get $s_len) (select (i32.const -2) (i32.add (local.get $s_len) (i32.const -2)) (i32.ge_s (i32.const -2) (i32.const 0)))) (i32.const 108)) (then (i32.const 1)) (else (i32.const 0))))
    (local.set $sum (i32.add (call $__str_char_code_at (local.get $s_ptr) (local.get $s_len) (select (i32.const 0) (i32.add (local.get $s_len) (i32.const 0)) (i32.ge_s (i32.const 0) (i32.const 0)))) (call $__str_char_code_at (local.get $s_ptr) (local.get $s_len) (select (i32.const -1) (i32.add (local.get $s_len) (i32.const -1)) (i32.ge_s (i32.const -1) (i32.const 0))))))
    (call $check (if (result i32) (i32.eq (local.get $sum) (i32.const 215)) (then (i32.const 1)) (else (i32.const 0))))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 7) (call $__i32_to_str (call $__str_char_code_at (local.get $s_ptr) (local.get $s_len) (select (i32.const 0) (i32.add (local.get $s_len) (i32.const 0)) (i32.ge_s (i32.const 0) (i32.const 0)))) (i32.const 139))))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (call $__i32_to_str (call $__str_char_code_at (local.get $s_ptr) (local.get $s_len) (select (i32.const -1) (i32.add (local.get $s_len) (i32.const -1)) (i32.ge_s (i32.const -1) (i32.const 0)))) (i32.add (i32.const 132) (i32.load (i32.const 4))))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 265) "\61\74\2d\63\68\61\72\63\6f\64\65\20\63\68\61\69\6e\20\6f\6b\0a")
)