(module
  ...
  (func $newPerson (param $name_ptr i32) (param $name_len i32) (param $age f64) (result i32)
    ...
    (local.set $__obj_ret (call $__malloc (i32.const 16)))
      ...
      (f64.store offset=8 (local.get $__obj_ret) (local.get $age))
  ...
  (func $newPersonWithAge (param $name_ptr i32) (param $name_len i32) (result i32)
    ...
    (local.set $__obj_ret (call $__malloc (i32.const 16)))
      (i32.store offset=0 (local.get $__obj_ret) (local.get $name_ptr))
      (i32.store offset=4 (local.get $__obj_ret) (local.get $name_len))
      (f64.store offset=8 (local.get $__obj_ret) (f64.const 42))
      (return (local.get $__obj_ret))
  )

  (func $fmtPerson (param $p i32) 
    ...
    (local.set $__ret_str_ptr (i32.const 260))
      ...
      (call $__str_concat (local.get $__ret_str_ptr) (local.get $__ret_str_len) (i32.load offset=0 (local.get $p)) (i32.load offset=4 (local.get $p)))
  ...
  (func $_start (export "_start")
    ...
    (local $__tmpl_num_len i32)
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (call $fmtPerson (call $newPerson (i32.const 278) (i32.const 3) (f64.const 20)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $fmtPerson (call $newPerson (i32.const 281) (i32.const 5) (f64.const 30)))
          (call $__str_gather (global.get $__str_ret_ptr) (global.get $__str_ret_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (global.get $__str_ret_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $fmtPerson (call $newPersonWithAge (i32.const 306) (i32.const 3)))
          (call $__str_gather (global.get $__str_ret_ptr) (global.get $__str_ret_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (global.get $__str_ret_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $fmtPerson (call $newPersonWithAge (i32.const 309) (i32.const 3)))
          (call $__str_gather (global.get $__str_ret_ptr) (global.get $__str_ret_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (global.get $__str_ret_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $s (call $newPerson (i32.const 312) (i32.const 4) (f64.const 50)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (i32.load offset=0 (local.get $s)) (i32.load offset=4 (local.get $s)) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (i32.load offset=4 (local.get $s))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (f64.load (i32.add (local.get $s) (i32.const 8))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (f64.store (i32.add (local.get $s) (i32.const 8)) (f64.const 51))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (f64.load (i32.add (local.get $s) (i32.const 8))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $dog (i32.const 263))
        (i32.store (i32.const 0) (i32.const 260))
          (i32.store (i32.const 4) (i32.const 1))
          (i32.store (i32.const 8) (i32.load offset=0 (i32.const 263)))
          (i32.store (i32.const 12) (i32.load offset=4 (i32.const 263)))
          (i32.store (i32.const 16) (i32.const 261))
          (i32.store (i32.const 20) (i32.const 1))
          (i32.store (i32.const 24) (if (result i32) (i32.load (i32.add (i32.const 263) (i32.const 8))) (then (i32.const 316)) (else (i32.const 320))))
          (i32.store (i32.const 28) (if (result i32) (i32.load (i32.add (i32.const 263) (i32.const 8))) (then (i32.const 4)) (else (i32.const 5))))
          (i32.store (i32.const 32) (i32.const 325))
  ...
  (data (i32.const 260) "\7b")
  (data (i32.const 261) "\20")
  (data (i32.const 262) "\7d")
  (data (i32.const 275) "\52\65\78")
  (data (i32.const 278) "\42\6f\62")
  (data (i32.const 281) "\41\6c\69\63\65")
  (data (i32.const 302) "\46\72\65\64")
  (data (i32.const 306) "\41\6e\6e")
  (data (i32.const 309) "\4a\6f\6e")
  (data (i32.const 312) "\53\65\61\6e")
  (data (i32.const 316) "\74\72\75\65")
  (data (i32.const 320) "\66\61\6c\73\65")
  (data (i32.const 325) "\7d\0a")
  (data (i32.const 263) "\13\01\00\00\03\00\00\00\01\00\00\00")
  (data (i32.const 286) "\2e\01\00\00\04\00\00\00\00\00\00\00\00\00\00\00")
)