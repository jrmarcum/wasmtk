(module
  ...
  (func $compose__inner (param $y i32) (param $inner i32) (result i32)
    (return (i32.mul (call_indirect (type $ftype_i32_i32_r_i32) (local.get $inner) (local.get $y) (i32.load (local.get $inner))) (i32.const 2)))
  )

  (func $compose (param $initial i32) (result i32)
    (local $__closure_ptr i32)
    (local $inner i32)
    (local.set $inner (call $__anon_0__factory (local.get $initial)))
    (local.set $__closure_ptr (call $__malloc (i32.const 8)))
    (i32.store (local.get $__closure_ptr) (i32.const 0))
    (i32.store offset=4 (local.get $__closure_ptr) (local.get $inner))
    (local.get $__closure_ptr)
  )

  (func $compose__trampoline (param $__closure_ptr i32) (param $y i32) (result i32)
    (local $__cap_inner i32)
    (local.set $__cap_inner (i32.load offset=4 (local.get $__closure_ptr)))
    (call $compose__inner (local.get $y) (local.get $__cap_inner))
  )

  (func $__anon_0 (param $x i32) (param $initial i32) (result i32)
    (return (i32.add (local.get $x) (local.get $initial)))
  )

  (func $__anon_0__factory (param $initial i32) (result i32)
    (local $__closure_ptr i32)
    (local.set $__closure_ptr (call $__malloc (i32.const 8)))
    (i32.store (local.get $__closure_ptr) (i32.const 1))
    (i32.store offset=4 (local.get $__closure_ptr) (local.get $initial))
    (local.get $__closure_ptr)
  )

  (func $__anon_0__factory__trampoline (param $__closure_ptr i32) (param $x i32) (result i32)
    (local $__cap_initial i32)
    (local.set $__cap_initial (i32.load offset=4 (local.get $__closure_ptr)))
    (call $__anon_0 (local.get $x) (local.get $__cap_initial))
  )
  (func $_start (export "_start")
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $compose__trampoline (call $compose (i32.const 5)) (i32.const 10)) (i32.const 132)))
  ...
  (table 2 funcref)
  (elem (i32.const 0) $compose__trampoline $__anon_0__factory__trampoline)
)