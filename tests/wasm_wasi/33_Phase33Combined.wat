(module
  ...
  (func $describeParticle (param $p i32) 
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 6) (call $__f64_to_str (f64.load (i32.add (local.get $p) (i32.const 0))) (i32.const 138))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 4) (call $__i32_to_str (i32.load (i32.add (local.get $p) (i32.const 16))) (i32.const 136))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $totalEnergy (param $p i32) (result f64)
    (return (f64.mul (f64.load (i32.add (local.get $p) (i32.const 0))) (f64.load (i32.add (local.get $p) (i32.const 8)))))
  )
  (func $_start (export "_start")
    (local $cp i32)
    (local $p i32)
    (local $__iface_tmp i32)
    (local.set $cp (i32.const 260))
    (call $describeParticle (local.get $cp))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (call $totalEnergy (local.get $cp)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 134) (i32.const 58))
          (i32.store8 (i32.const 135) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.const 260) (i32.const 20))) (i32.const 136))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 3) (call $__i32_to_str (i32.load (i32.add (i32.const 260) (i32.const 24))) (i32.const 135))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 133) (i32.const 58))
          (i32.store8 (i32.const 134) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 3) (call $__i32_to_str (i32.load (i32.add (i32.const 260) (i32.const 28))) (i32.const 135))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 133) (i32.const 58))
          (i32.store8 (i32.const 134) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 3) (call $__i32_to_str (i32.load (i32.add (i32.const 260) (i32.const 32))) (i32.const 135))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $p (i32.const 296))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (call $totalEnergy (local.get $p)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 134) (i32.const 58))
          (i32.store8 (i32.const 135) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.const 296) (i32.const 16))) (i32.const 136))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 260) "\00\00\00\00\00\00\00\40\00\00\00\00\00\00\14\40\0a\00\00\00\14\00\00\00\ff\00\00\00\80\00\00\00\40\00\00\00")
  (data (i32.const 296) "\00\00\00\00\00\00\e0\3f\00\00\00\00\00\00\08\40\01\00\00\00\02\00\00\00")
)