(module
  ...
  (func $_start (export "_start")
    ...
    (call $mapSet (i32.const 320) (i32.const 2) (f64.const 7))
    (call $mapSet (i32.const 322) (i32.const 2) (f64.const 13))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $v1 (call $mapGet (i32.const 320) (i32.const 2)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $v3 (call $mapGet (i32.const 324) (i32.const 2)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 118))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $mapDel (i32.const 322) (i32.const 2))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 109))
          (i32.store8 (i32.const 133) (i32.const 97))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $prs (call $mapHas (i32.const 322) (i32.const 2)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store8 (i32.const 135) (i32.const 58))
          (i32.store8 (i32.const 136) (i32.const 32))
          (call $__str_gather (if (result i32) (local.get $prs) (then (i32.const 326)) (else (i32.const 330))) (if (result i32) (local.get $prs) (then (i32.const 4)) (else (i32.const 5))) (i32.const 137))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $n2Keys (i32.const 272))
    (local.set $n2Vals (i32.const 296))
    ...
    (block $break_5
      (loop $loop_5
        ...
        (block $cont_5
          (local.set $__str_push_ptr (i32.load (i32.add (i32.add (i32.const 272) (i32.const 8)) (i32.shl (i32.trunc_f64_s (local.get $i)) (i32.const 3)))))
      (local.set $__str_push_len (i32.load offset=4 (i32.add (i32.add (i32.const 272) (i32.const 8)) (i32.shl (i32.trunc_f64_s (local.get $i)) (i32.const 3)))))
      (call $__str_concat (local.get $__str_push_ptr) (local.get $__str_push_len) (i32.const 264) (i32.const 1))
      (local.set $__str_push_len)
      (local.set $__str_push_ptr)
      (local.set $__tmpl_num_ptr (call $__malloc (i32.const 32)))
      (local.set $__tmpl_num_len (call $__f64_to_str (f64.load (i32.add (i32.add (i32.const 296) (i32.const 8)) (i32.shl (i32.trunc_f64_s (local.get $i)) (i32.const 3)))) (local.get $__tmpl_num_ptr)))
      (call $__str_concat (local.get $__str_push_ptr) (local.get $__str_push_len) (local.get $__tmpl_num_ptr) (local.get $__tmpl_num_len))
      (local.set $__str_push_len)
      (local.set $__str_push_ptr)
    ...
    (block $break_6
      ...
      (call $__str_concat (local.get $n2Str_ptr) (local.get $n2Str_len) (i32.const 335) (i32.const 1))
      (local.set $n2Str_len)
      (local.set $n2Str_ptr)
            )
          )
  ...
  (data (i32.const 265) "\5d")
  (data (i32.const 266) "\66\6f\6f")
  (data (i32.const 269) "\62\61\72")
  (data (i32.const 320) "\6b\31")
  (data (i32.const 322) "\6b\32")
  (data (i32.const 324) "\6b\33")
  (data (i32.const 326) "\74\72\75\65")
  (data (i32.const 330) "\66\61\6c\73\65")
  (data (i32.const 335) "\20")
  (data (i32.const 272) "\02\00\00\00\02\00\00\00\0a\01\00\00\03\00\00\00\0d\01\00\00\03\00\00\00")
  (data (i32.const 296) "\02\00\00\00\02\00\00\00\00\00\00\00\00\00\f0\3f\00\00\00\00\00\00\00\40")
)