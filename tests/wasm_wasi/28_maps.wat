(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 335))
  ...
  (func $mapStr  
    ...
    (;; string assignment from complex expression not yet supported: s = "map["; for (let i: number = 0; i < pairs.length; i++) { if (i > 0) s += " "; s += pairs[i]; } return s + "]";)
  )
  (func $_start (export "_start")
    ...
    (call $mapSet (i32.const 319) (i32.const 2) (f64.const 7))
    (call $mapSet (i32.const 321) (i32.const 2) (f64.const 13))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $v1 (call $mapGet (i32.const 319) (i32.const 2)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $v3 (call $mapGet (i32.const 323) (i32.const 2)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 118))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $mapDel (i32.const 321) (i32.const 2))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 109))
          (i32.store8 (i32.const 133) (i32.const 97))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $prs (call $mapHas (i32.const 321) (i32.const 2)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store8 (i32.const 135) (i32.const 58))
          (i32.store8 (i32.const 136) (i32.const 32))
          (call $__str_gather (if (result i32) (local.get $prs) (then (i32.const 325)) (else (i32.const 329))) (if (result i32) (local.get $prs) (then (i32.const 4)) (else (i32.const 5))) (i32.const 137))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $n2Keys (i32.const 271))
    (local.set $n2Vals (i32.const 295))
    ...
    (block $break_5
      (loop $loop_5
        (br_if $break_5 (i32.eqz (f64.lt (local.get $i) (f64.convert_i32_s (i32.const 2)))))
        (block $cont_5
          (local.set $__str_push_ptr (i32.load (i32.add (i32.add (i32.const 271) (i32.const 8)) (i32.shl (i32.trunc_f64_s (local.get $i)) (i32.const 3)))))
      (local.set $__str_push_len (i32.load offset=4 (i32.add (i32.add (i32.const 271) (i32.const 8)) (i32.shl (i32.trunc_f64_s (local.get $i)) (i32.const 3)))))
      (call $__str_concat (local.get $__str_push_ptr) (local.get $__str_push_len) (i32.const 264) (i32.const 1))
      (local.set $__str_push_len)
      (local.set $__str_push_ptr)
      (local.set $__tmpl_num_ptr (call $__malloc (i32.const 32)))
      (local.set $__tmpl_num_len (call $__f64_to_str (f64.load (i32.add (i32.add (i32.const 295) (i32.const 8)) (i32.shl (i32.trunc_f64_s (local.get $i)) (i32.const 3)))) (local.get $__tmpl_num_ptr)))
      (call $__str_concat (local.get $__str_push_ptr) (local.get $__str_push_len) (local.get $__tmpl_num_ptr) (local.get $__tmpl_num_len))
      (local.set $__str_push_len)
      (local.set $__str_push_ptr)
    ...
    (block $break_6
      (loop $loop_6
        (br_if $break_6 (i32.eqz (f64.lt (local.get $i) (f64.convert_i32_s (i32.load (local.get $n2Pairs))))))
        (block $cont_6
          (if (f64.gt (local.get $i) (f64.const 0))
            (then
            (local.set $n2Str_ptr (local.get $n2Str_ptr))
      (local.set $n2Str_len (local.get $n2Str_len))
      (call $__str_concat (local.get $n2Str_ptr) (local.get $n2Str_len) (i32.const 334) (i32.const 1))
      (local.set $n2Str_len)
      (local.set $n2Str_ptr)
            )
          )
    ...
    (;; string assignment from complex expression not yet supported: n2Str = n2Str + "]";)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 109))
          (i32.store8 (i32.const 133) (i32.const 97))
  ...
  (data (i32.const 265) "\66\6f\6f")
  (data (i32.const 268) "\62\61\72")
  (data (i32.const 319) "\6b\31")
  (data (i32.const 321) "\6b\32")
  (data (i32.const 323) "\6b\33")
  (data (i32.const 325) "\74\72\75\65")
  (data (i32.const 329) "\66\61\6c\73\65")
  (data (i32.const 334) "\20")
  (data (i32.const 271) "\02\00\00\00\02\00\00\00\09\01\00\00\03\00\00\00\0c\01\00\00\03\00\00\00")
  (data (i32.const 295) "\02\00\00\00\02\00\00\00\00\00\00\00\00\00\f0\3f\00\00\00\00\00\00\00\40")
)