(module
  ...
  (func $sumABC (param $v i32) (result f64)
    (return (f64.add (f64.add (f64.convert_i32_s (i32.load (i32.add (local.get $v) (i32.const 0)))) (f64.convert_i32_s (i32.load (i32.add (local.get $v) (i32.const 4))))) (f64.load (i32.add (local.get $v) (i32.const 8)))))
  )
  (func $_start (export "_start")
    (local $abc i32)
    (local $__iface_tmp i32)
    (local.set $abc (i32.const 260))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (call $sumABC (local.get $abc)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 260) "\01\00\00\00\02\00\00\00\1f\85\eb\51\b8\1e\09\40")
)