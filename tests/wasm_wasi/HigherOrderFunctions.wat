(module
  ...
  (func $applyLogic (param $val i32) (param $callback i32) (result i32)
    (return (call_indirect (type $ftype_i32_r_i32) (local.get $val) (local.get $callback)))
  )
    ...
    (local.set $result (call $applyLogic (i32.const 10) (i32.const 0)))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 2)
            (i32.const 128)))
    (local.set $increment (i32.const 1))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $applyLogic (i32.const 10) (local.get $increment)) (i32.const 132)))
          (i32.store (i32.const 8) (i32.const 260))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $__anon_0 (param $n i32) (result i32)
  ...
  (table 2 funcref)
  (elem (i32.const 0) $__anon_0 $increment)
