(module
  ...
  (func $startsWithR (param $s_ptr i32) (param $s_len i32) (result i32)
    (return (i32.eq (call $__str_char_code_at (local.get $s_ptr) (local.get $s_len) (i32.const 0)) (i32.const 114)))
  )

  (func $longerThan3 (param $s_ptr i32) (param $s_len i32) (result i32)
  ...
  (func $_start (export "_start")
    ...
    (local.set $longWords (call $strFilter (local.get $words) (i32.const 1)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (local.get $rWords)) (i32.const 132)))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (local.get $longWords)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
        (i32.store (i32.const 0) (if (result i32) (i32.eqz (call $__str_cmp (i32.load (i32.add (i32.add (local.get $rWords) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 3)))) (i32.load offset=4 (i32.add (i32.add (local.get $rWords) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 3)))) (i32.const 260) (i32.const 3))) (then (i32.const 329)) (else (i32.const 333))))
          (i32.store (i32.const 4) (if (result i32) (i32.eqz (call $__str_cmp (i32.load (i32.add (i32.add (local.get $rWords) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 3)))) (i32.load offset=4 (i32.add (i32.add (local.get $rWords) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 3)))) (i32.const 260) (i32.const 3))) (then (i32.const 4)) (else (i32.const 5))))
          (i32.store (i32.const 8) (i32.const 338))
  ...
  (table 2 funcref)
  (elem (i32.const 0) $startsWithR $longerThan3)
  (data (i32.const 260) "\72\65\64")
  (data (i32.const 263) "\67\72\65\65\6e")
  (data (i32.const 268) "\62\6c\75\65")
  (data (i32.const 272) "\72\6f\75\67\65")
  (data (i32.const 277) "\72\6f\73\65")
  (data (i32.const 329) "\74\72\75\65")
  (data (i32.const 333) "\66\61\6c\73\65")
  (data (i32.const 338) "\0a")
  (data (i32.const 281) "\05\00\00\00\05\00\00\00\04\01\00\00\03\00\00\00\07\01\00\00\05\00\00\00\0c\01\00\00\04\00\00\00\10\01\00\00\05\00\00\00\15\01\00\00\04\00\00\00")
)