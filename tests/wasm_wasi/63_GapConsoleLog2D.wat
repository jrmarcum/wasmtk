(module
  ...
  (func $_start (export "_start")
    ...
    (local.set $grid (call $__malloc (i32.const 40)))
      (i32.store (local.get $grid) (i32.const 2))
      (i32.store offset=4 (local.get $grid) (i32.const 8))
      (i32.store offset=8 (local.get $grid) (local.tee $__2d_tmp (call $__malloc (i32.const 40))))
      ...
      (i32.store offset=12 (local.get $grid) (local.tee $__2d_tmp (call $__malloc (i32.const 40))))
      (i32.store (local.get $__2d_tmp) (i32.const 3))
      (i32.store offset=4 (local.get $__2d_tmp) (i32.const 8))
    ...
    (local.set $fg (call $__malloc (i32.const 40)))
      (i32.store (local.get $fg) (i32.const 2))
      (i32.store offset=4 (local.get $fg) (i32.const 8))
      (i32.store offset=8 (local.get $fg) (local.tee $__2d_tmp (call $__malloc (i32.const 72))))
      (i32.store (local.get $__2d_tmp) (i32.const 2))
      (i32.store offset=4 (local.get $__2d_tmp) (i32.const 8))
      (f64.store offset=8 (local.get $__2d_tmp) (f64.const 1.5))
      (f64.store offset=16 (local.get $__2d_tmp) (f64.const 2.5))
      (i32.store offset=12 (local.get $fg) (local.tee $__2d_tmp (call $__malloc (i32.const 72))))
      (i32.store (local.get $__2d_tmp) (i32.const 2))
      (i32.store offset=4 (local.get $__2d_tmp) (i32.const 8))
      (f64.store offset=8 (local.get $__2d_tmp) (f64.const 3.5))
      (f64.store offset=16 (local.get $__2d_tmp) (f64.const 4.5))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.add (i32.load (i32.add (i32.add (local.get $grid) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 2)))) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 2)))) (i32.const 132)))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.add (i32.load (i32.add (i32.add (local.get $grid) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 2)))) (i32.const 8)) (i32.shl (i32.const 2) (i32.const 2)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (f64.load (i32.add (i32.add (i32.load (i32.add (i32.add (local.get $fg) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 2)))) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 3)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 5) (call $__i32_to_str (i32.add (i32.load (i32.add (i32.add (i32.load (i32.add (i32.add (local.get $grid) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 2)))) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 2)))) (i32.load (i32.add (i32.add (i32.load (i32.add (i32.add (local.get $grid) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 2)))) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 2))))) (i32.const 137))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
