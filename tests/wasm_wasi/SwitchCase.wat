(module
  ...
  (func $testSwitch (export "testSwitch") (param $value i32) (result i32)
    (local $result i32)
        ...
        (block $case_0_4
          (block $case_0_3
            (block $case_0_2
              (block $case_0_1
                (block $case_0_0
                  (br_if $case_0_0 (i32.eq (local.get $value) (i32.const 1)))
                  (br_if $case_0_1 (i32.eq (local.get $value) (i32.const 2)))
                  (br_if $case_0_2 (i32.eq (local.get $value) (i32.const 3)))
                  (br_if $case_0_3 (i32.eq (local.get $value) (i32.const 4)))
                  (br_if $case_0_4 (i32.eq (local.get $value) (i32.const 100)))
                  (br $case_default_0)
                )
  ...
  (func $_start (export "_start")
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $testSwitch (i32.const 1)) (i32.const 132)))
