(module
  ...
  (func $__ta_fill_f64 (param $arr i32) (param $val f64) (param $start i32) (param $end i32)
    (local $i i32)
    (local $data i32)
    ...
    (block $done
      (loop $loop
        ...
        (f64.store (i32.add (local.get $data) (i32.shl (local.get $i) (i32.const 3))) (local.get $val))
  ...
  (func $_start (export "_start")
    ...
    (local.set $a (call $__malloc (i32.const 32)))
      (i32.store (local.get $a) (i32.const 3))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (f64.store (i32.add (i32.add (local.get $a) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 3))) (f64.const 1.5))
    (f64.store (i32.add (i32.add (local.get $a) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 3))) (f64.const 2.5))
    (f64.store (i32.add (i32.add (local.get $a) (i32.const 8)) (i32.shl (i32.const 2) (i32.const 3))) (f64.const 3.5))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (f64.load (i32.add (i32.add (local.get $a) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 3)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (f64.load (i32.add (i32.add (local.get $a) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 3)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (f64.load (i32.add (i32.add (local.get $a) (i32.const 8)) (i32.shl (i32.const 2) (i32.const 3)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (i32.shl (i32.load (local.get $a)) (i32.const 3)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 13) (call $__i32_to_str (i32.load (local.get $a)) (i32.const 145))))
          ...
          (call $__write_f64arr_to_scratch (local.get $a) (i32.const 132) (i32.const 4))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $b (call $__malloc (i32.const 32)))
      (i32.store (local.get $b) (i32.const 3))
      (f64.store (i32.add (local.get $b) (i32.const 8)) (f64.const 0.1))
      (f64.store (i32.add (local.get $b) (i32.const 16)) (f64.const 0.2))
      (f64.store (i32.add (local.get $b) (i32.const 24)) (f64.const 0.3))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (f64.load (i32.add (i32.add (local.get $b) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 3)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (f64.load (i32.add (i32.add (local.get $b) (i32.const 8)) (i32.shl (i32.const 2) (i32.const 3)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 143) (i32.const 121))
          (i32.store8 (i32.const 144) (i32.const 40))
          (i32.store (i32.const 4) (i32.add (i32.const 13) (call $__i32_to_str (i32.load (local.get $b)) (i32.const 145))))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 41))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 1))) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 2)))
          (call $__write_f64arr_to_scratch (local.get $b) (i32.const 132) (i32.const 4))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (call $__ta_fill_f64 (local.get $c) (f64.const 3.14) (i32.const 0) (i32.load (local.get $c)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (f64.load (i32.add (i32.add (local.get $c) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 3)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (f64.load (i32.add (i32.add (local.get $c) (i32.const 8)) (i32.shl (i32.const 3) (i32.const 3)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $d (call $__malloc (i32.const 40)))
      (i32.store (local.get $d) (i32.const 4))
      (f64.store (i32.add (local.get $d) (i32.const 8)) (f64.const 1.0))
      (f64.store (i32.add (local.get $d) (i32.const 16)) (f64.const 2.0))
      (f64.store (i32.add (local.get $d) (i32.const 24)) (f64.const 3.0))
      (f64.store (i32.add (local.get $d) (i32.const 32)) (f64.const 4.0))
    (call $__ta_fill_f64 (local.get $d) (f64.const 0.0) (i32.const 1) (i32.const 3))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (f64.load (i32.add (i32.add (local.get $d) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 3)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (f64.load (i32.add (i32.add (local.get $d) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 3)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (f64.load (i32.add (i32.add (local.get $d) (i32.const 8)) (i32.shl (i32.const 2) (i32.const 3)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (f64.load (i32.add (i32.add (local.get $d) (i32.const 8)) (i32.shl (i32.const 3) (i32.const 3)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
