(module
  ...
  (func $_start (export "_start")  
    ...
    (if (i64.gt_s (local.get $result) (i64.extend_i32_s (i32.const 100)))
      (then
          (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i64_to_str (local.get $result) (i32.const 132)))
      ...
      (else
          (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i64_to_str (i64.const 0) (i32.const 132)))
          (i32.store (i32.const 8) (i32.const 260))
          (i32.store (i32.const 12) (i32.const 1))
          (drop (call $fd_write
            (i32.const 1)
