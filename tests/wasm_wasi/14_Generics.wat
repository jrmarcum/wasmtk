(module
  ...
  (func $_start (export "_start")
    ...
    (local.set $sl (i32.const 270))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 14) (call $__f64_to_str (call $slicesIndexStr (local.get $sl) (i32.const 267) (i32.const 3)) (i32.const 146))))
  ...
  (data (i32.const 260) "\5d")
  (data (i32.const 261) "\66\6f\6f")
  (data (i32.const 264) "\62\61\72")
  (data (i32.const 267) "\7a\6f\6f")
  (data (i32.const 270) "\03\00\00\00\03\00\00\00\05\01\00\00\03\00\00\00\08\01\00\00\03\00\00\00\0b\01\00\00\03\00\00\00")
)