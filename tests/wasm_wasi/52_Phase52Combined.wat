(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 315))
  ...
  (func $acc (param $n i32) (result i32)
    (global.set $total (i32.add (global.get $total) (local.get $n)))
    (return (global.get $total))
  )
  (func $_start (export "_start")
    ...
    (drop (call $acc (i32.const 5)))
    (drop (i32.const 0))
    (global.set $q (call $acc (i32.const 3)))
      (global.set $p (global.get $q))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 7) (call $__i32_to_str (global.get $total) (i32.const 139))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 3) (call $__i32_to_str (global.get $p) (i32.const 135))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 113))
          (i32.store8 (i32.const 133) (i32.const 58))
          (i32.store8 (i32.const 134) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 3) (call $__i32_to_str (global.get $q) (i32.const 135))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $cfg (i32.const 260))
    (local.set $hasW (i32.const 1))
    (local.set $hasDepth (i32.const 0))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 104))
          (i32.store8 (i32.const 133) (i32.const 97))
          (i32.store8 (i32.const 134) (i32.const 115))
          (i32.store8 (i32.const 135) (i32.const 87))
          (i32.store8 (i32.const 136) (i32.const 58))
          (i32.store8 (i32.const 137) (i32.const 32))
          (call $__str_gather (if (result i32) (local.get $hasW) (then (i32.const 304)) (else (i32.const 308))) (if (result i32) (local.get $hasW) (then (i32.const 4)) (else (i32.const 5))) (i32.const 138))
          (i32.store (i32.const 4) (i32.add (i32.const 6) (if (result i32) (local.get $hasW) (then (i32.const 4)) (else (i32.const 5)))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 133) (i32.const 97))
          (i32.store8 (i32.const 134) (i32.const 115))
          (i32.store8 (i32.const 135) (i32.const 68))
          ...
          (call $__str_gather (if (result i32) (local.get $hasDepth) (then (i32.const 304)) (else (i32.const 308))) (if (result i32) (local.get $hasDepth) (then (i32.const 4)) (else (i32.const 5))) (i32.const 142))
          (i32.store (i32.const 4) (i32.add (i32.const 10) (if (result i32) (local.get $hasDepth) (then (i32.const 4)) (else (i32.const 5)))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $nums (i32.const 268))
    (local.set $more (i32.const 288))
    (local.set $numsIsArr (i32.const 1))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store8 (i32.const 140) (i32.const 103))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 13) (call $__i32_to_str (i32.const 3) (i32.const 145))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 139) (i32.const 109))
          (i32.store8 (i32.const 140) (i32.const 58))
          (i32.store8 (i32.const 141) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 10) (call $__i32_to_str (i32.add (i32.load (i32.add (i32.add (i32.const 288) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 2)))) (i32.load (i32.add (i32.add (i32.const 288) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 2))))) (i32.const 142))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (call $__str_gather (if (result i32) (local.get $numsIsArr) (then (i32.const 304)) (else (i32.const 308))) (if (result i32) (local.get $numsIsArr) (then (i32.const 4)) (else (i32.const 5))) (i32.const 141))
          (i32.store (i32.const 4) (i32.add (i32.const 9) (if (result i32) (local.get $numsIsArr) (then (i32.const 4)) (else (i32.const 5)))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $ch_ptr (i32.const 313))
      (local.set $ch_len (i32.const 2))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (call $__str_gather (local.get $ch_ptr) (local.get $ch_len) (i32.const 136))
          (i32.store (i32.const 4) (i32.add (i32.const 4) (local.get $ch_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 304) "\74\72\75\65")
  (data (i32.const 308) "\66\61\6c\73\65")
  (data (i32.const 313) "\48\69")
  (data (i32.const 260) "\64\00\00\00\32\00\00\00")
  (data (i32.const 268) "\03\00\00\00\03\00\00\00\02\00\00\00\04\00\00\00\06\00\00\00")
  (data (i32.const 288) "\02\00\00\00\02\00\00\00\08\00\00\00\0a\00\00\00")
)