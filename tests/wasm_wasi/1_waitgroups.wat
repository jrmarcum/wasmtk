(module
  ...
  (func $worker (param $id f64) 
    ...
    (local $__tmpl_num_len i32)
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 8))) (i32.const 103))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 9))) (i32.const 10))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 7) (call $__f64_to_str (local.get $id) (i32.const 139))))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 32))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 1))) (i32.const 100))
          ...
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 5))) (i32.const 10))
  ...
  (func $_start (export "_start")
    ...
    (block $break_0
      (loop $loop_0
        (br_if $break_0 (i32.eqz (f64.le (local.get $i) (f64.const 5))))
        (block $cont_0
          (call $worker (local.get $i))
        )
