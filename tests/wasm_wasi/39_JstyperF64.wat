(module
  ...
  (func $area (export "area") (param $w f64) (param $h f64) (result f64)
    (return (f64.mul (local.get $w) (local.get $h)))
  )

  (func $perimeter (export "perimeter") (param $w f64) (param $h f64) (result f64)
    (return (f64.mul (f64.const 2.0) (f64.add (local.get $w) (local.get $h))))
  )

  (func $hypotenuse (export "hypotenuse") (param $a f64) (param $b f64) (result f64)
    (local $__iface_tmp i32)
    (return (f64.sqrt (f64.add (f64.mul (local.get $a) (local.get $a)) (f64.mul (local.get $b) (local.get $b)))))
  )
  (func $_start (export "_start")
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (call $area (f64.const 3.0) (f64.const 4.0)) (i32.const 132)))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (call $perimeter (f64.const 3.0) (f64.const 4.0)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (call $hypotenuse (f64.const 3.0) (f64.const 4.0)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
