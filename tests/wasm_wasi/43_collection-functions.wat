(module
  ...
  (func $_start (export "_start")
    (local $strs i32)
    (local $__iface_tmp i32)
    (local.set $strs (i32.const 279))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (call $indexOf (local.get $strs) (i32.const 271) (i32.const 4)) (i32.const 132)))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
        (i32.store (i32.const 0) (if (result i32) (call $includes (local.get $strs) (i32.const 319) (i32.const 5)) (then (i32.const 324)) (else (i32.const 328))))
          (i32.store (i32.const 4) (if (result i32) (call $includes (local.get $strs) (i32.const 319) (i32.const 5)) (then (i32.const 4)) (else (i32.const 5))))
          ...
          (drop (call $fd_write
            ...
            (i32.const 2)
            (i32.const 128)))
        (i32.store (i32.const 0) (if (result i32) (call $some (local.get $strs) (i32.const 0)) (then (i32.const 324)) (else (i32.const 328))))
          ...
          (drop (call $fd_write
            ...
            (i32.const 2)
            (i32.const 128)))
        (i32.store (i32.const 0) (if (result i32) (call $every (local.get $strs) (i32.const 1)) (then (i32.const 324)) (else (i32.const 328))))
  ...
  (data (i32.const 266) "\61\70\70\6c\65")
  (data (i32.const 271) "\70\65\61\72")
  (data (i32.const 275) "\70\6c\75\6d")
  (data (i32.const 319) "\67\72\61\70\65")
  (data (i32.const 324) "\74\72\75\65")
  (data (i32.const 328) "\66\61\6c\73\65")
  (data (i32.const 333) "\0a")
  (data (i32.const 279) "\04\00\00\00\04\00\00\00\05\01\00\00\05\00\00\00\0a\01\00\00\05\00\00\00\0f\01\00\00\04\00\00\00\13\01\00\00\04\00\00\00")
)