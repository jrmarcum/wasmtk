(module
  ...
  (func $_start (export "_start")
    (local $strs i32)
    (local $__iface_tmp i32)
    (local.set $strs (i32.const 278))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (call $indexOf (local.get $strs) (i32.const 270) (i32.const 4)) (i32.const 132)))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
        (i32.store (i32.const 0) (if (result i32) (call $includes (local.get $strs) (i32.const 318) (i32.const 5)) (then (i32.const 323)) (else (i32.const 327))))
          (i32.store (i32.const 4) (if (result i32) (call $includes (local.get $strs) (i32.const 318) (i32.const 5)) (then (i32.const 4)) (else (i32.const 5))))
          (i32.store (i32.const 8) (i32.const 332))
          ...
          (drop (call $fd_write
            ...
            (i32.const 2)
            (i32.const 128)))
        (i32.store (i32.const 0) (if (result i32) (call $some (local.get $strs) (i32.const 0)) (then (i32.const 323)) (else (i32.const 327))))
          ...
          (drop (call $fd_write
            ...
            (i32.const 2)
            (i32.const 128)))
        (i32.store (i32.const 0) (if (result i32) (call $every (local.get $strs) (i32.const 1)) (then (i32.const 323)) (else (i32.const 327))))
  ...
  (data (i32.const 260) "\70\65\61\63\68")
  (data (i32.const 265) "\61\70\70\6c\65")
  (data (i32.const 270) "\70\65\61\72")
  (data (i32.const 274) "\70\6c\75\6d")
  (data (i32.const 318) "\67\72\61\70\65")
  (data (i32.const 323) "\74\72\75\65")
  (data (i32.const 327) "\66\61\6c\73\65")
  (data (i32.const 332) "\0a")
  (data (i32.const 278) "\04\00\00\00\04\00\00\00\04\01\00\00\05\00\00\00\09\01\00\00\05\00\00\00\0e\01\00\00\04\00\00\00\12\01\00\00\04\00\00\00")
)