(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 437))
  ...
  (func $buildPlantXml (param $plant i32) (param $indent_ptr i32) (param $indent_len i32) 
    (local $s_ptr i32)
    (local $s_len i32)
    (local $i f64)
    ...
    (local.set $s_ptr (local.get $indent_ptr))
      (local.set $s_len (local.get $indent_len))
      (call $__str_concat (local.get $s_ptr) (local.get $s_len) (i32.const 260) (i32.const 11))
      (local.set $s_len)
      (local.set $s_ptr)
      (local.set $__tmpl_num_ptr (call $__malloc (i32.const 32)))
      (local.set $__tmpl_num_len (call $__f64_to_str (f64.load (i32.add (local.get $plant) (i32.const 0))) (local.get $__tmpl_num_ptr)))
      (call $__str_concat (local.get $s_ptr) (local.get $s_len) (local.get $__tmpl_num_ptr) (local.get $__tmpl_num_len))
      (local.set $s_len)
      (local.set $s_ptr)
      (call $__str_concat (local.get $s_ptr) (local.get $s_len) (i32.const 271) (i32.const 4))
      (local.set $s_len)
      (local.set $s_ptr)
    (call $__str_concat (local.get $s_ptr) (local.get $s_len) (i32.const 0) (i32.const 0))
      (local.set $s_len)
      (local.set $s_ptr)
    (local.set $i (f64.const 0))
    (block $break_0
      (loop $loop_0
        (br_if $break_0 (i32.eqz (f64.lt (local.get $i) (;? plant.origin.length ;) (f64.const 0))))
        (block $cont_0
          (call $__str_concat (local.get $s_ptr) (local.get $s_len) (i32.const 0) (i32.const 0))
      (local.set $s_len)
      (local.set $s_ptr)
  ...
  (func $_start (export "_start")
    (local $coffee i32)
    (local $tomato i32)
    (local $coffeeXml_ptr i32)
    (local $coffeeXml_len i32)
    (local $nestingXml_ptr i32)
    (local $nestingXml_len i32)
    (local $__iface_tmp i32)
    (local $__tmpl_num_ptr i32)
    (local $__tmpl_num_len i32)
    (local.set $coffee (i32.const 275))
    (local.set $tomato (i32.const 291))
    (call $buildPlantXml (local.get $coffee) (i32.const 307) (i32.const 1))
(local.set $coffeeXml_ptr (global.get $__str_ret_ptr))
      (local.set $coffeeXml_len (global.get $__str_ret_len))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (local.get $coffeeXml_ptr) (local.get $coffeeXml_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $coffeeXml_len)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 9) (call $__f64_to_str (f64.load (i32.add (i32.const 275) (i32.const 0))) (i32.const 141))))
          ...
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 2))) (i32.const 110))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 3))) (i32.const 97))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 4))) (i32.const 109))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 5))) (i32.const 101))
          ...
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (call $__i32_to_str (i32.load (i32.add (i32.const 275) (i32.const 8))) (i32.add (i32.const 132) (i32.load (i32.const 4))))))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 44))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 1))) (i32.const 32))
          ...
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 5))) (i32.const 103))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 6))) (i32.const 105))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 7))) (i32.const 110))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 8))) (i32.const 61))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 9))) (i32.const 91))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 10)))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (call $__i32_to_str (;? coffee.origin[0] ;) (i32.const 0) (i32.add (i32.const 132) (i32.load (i32.const 4))))))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (call $__i32_to_str (;? coffee.origin[1] ;) (i32.const 0) (i32.add (i32.const 132) (i32.load (i32.const 4))))))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $nestingXml_ptr (i32.const 347))
      (local.set $nestingXml_len (i32.const 39))
      (call $buildPlantXml (local.get $coffee) (i32.const 386) (i32.const 7))
      (call $__str_concat (local.get $nestingXml_ptr) (local.get $nestingXml_len) (global.get $__str_ret_ptr) (global.get $__str_ret_len))
      (local.set $nestingXml_len)
      (local.set $nestingXml_ptr)
      (call $__str_concat (local.get $nestingXml_ptr) (local.get $nestingXml_len) (i32.const 393) (i32.const 2))
      (local.set $nestingXml_len)
      (local.set $nestingXml_ptr)
      (call $buildPlantXml (local.get $tomato) (i32.const 386) (i32.const 7))
      (call $__str_concat (local.get $nestingXml_ptr) (local.get $nestingXml_len) (global.get $__str_ret_ptr) (global.get $__str_ret_len))
      (local.set $nestingXml_len)
      (local.set $nestingXml_ptr)
      (call $__str_concat (local.get $nestingXml_ptr) (local.get $nestingXml_len) (i32.const 395) (i32.const 42))
      (local.set $nestingXml_len)
      (local.set $nestingXml_ptr)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (local.get $nestingXml_ptr) (local.get $nestingXml_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $nestingXml_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 260) "\3c\70\6c\61\6e\74\20\69\64\3d\22")
  (data (i32.const 271) "\22\3e\5c\6e")
  (data (i32.const 307) "\20")
  (data (i32.const 308) "\3c\3f\78\6d\6c\20\76\65\72\73\69\6f\6e\3d\22\31\2e\30\22\20\65\6e\63\6f\64\69\6e\67\3d\22\55\54\46\2d\38\22\3f\3e\0a")
  (data (i32.const 347) "\20\3c\6e\65\73\74\69\6e\67\3e\5c\6e\20\20\20\3c\70\61\72\65\6e\74\3e\5c\6e\20\20\20\20\20\3c\63\68\69\6c\64\3e\5c\6e")
  (data (i32.const 386) "\20\20\20\20\20\20\20")
  (data (i32.const 393) "\5c\6e")
  (data (i32.const 395) "\5c\6e\20\20\20\20\20\3c\2f\63\68\69\6c\64\3e\5c\6e\20\20\20\3c\2f\70\61\72\65\6e\74\3e\5c\6e\20\3c\2f\6e\65\73\74\69\6e\67\3e")
  (data (i32.const 275) "\00\00\00\00\00\00\3b\40\00\00\00\00\00\00\00\00")
  (data (i32.const 291) "\00\00\00\00\00\40\54\40\00\00\00\00\00\00\00\00")
)