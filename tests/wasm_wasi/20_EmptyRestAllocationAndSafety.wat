(module
  ...
  (func $testEmptyRest (export "testEmptyRest")  
    (local $smallPair i32)
    (local $first i32)
    (local $second i32)
    (local $remainder i32)
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 276))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $smallPair (i32.const 260))
    (local.set $first (i32.load (i32.const 268)))
      (local.set $second (i32.load (i32.const 272)))
      (local.set $remainder (call $__malloc (i32.const 40)))
      (i32.store (local.get $remainder) (i32.const 0))
      (i32.store offset=4 (local.get $remainder) (i32.const 8))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 15) (call $__i32_to_str (local.get $first) (i32.const 147))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 139) (i32.const 69))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 16) (call $__i32_to_str (local.get $second) (i32.const 148))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 18) (call $__i32_to_str (i32.load (local.get $remainder)) (i32.const 150))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $remainder (call $__dynarr_push_i32 (local.get $remainder) (i32.const 77)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store8 (i32.const 137) (i32.const 80))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 17) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $remainder) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 2)))) (i32.const 149))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 276) "\2d\2d\2d\20\54\65\73\74\20\32\3a\20\45\6d\70\74\79\20\52\65\73\74\20\41\72\72\61\79\20\53\61\66\65\74\79\20\2d\2d\2d\0a")
  (data (i32.const 260) "\02\00\00\00\02\00\00\00\37\00\00\00\42\00\00\00")
)