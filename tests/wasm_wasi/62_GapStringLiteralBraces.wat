(module
  ...
  (func $_start (export "_start")
    ...
    (local.set $code_ptr (i32.const 260))
      (local.set $code_len (i32.const 33))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (local.get $code_len) (i32.const 132)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (call $__str_gather (local.get $code_ptr) (local.get $code_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $code_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 260) "\66\75\6e\63\74\69\6f\6e\20\66\28\29\20\7b\0a\20\20\72\65\74\75\72\6e\20\31\3b\0a\7d\0a\66\28\29\3b")
)