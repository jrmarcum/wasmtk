(module
  ...
  (func $__drain_microtasks
    ...
    (block $done
      (loop $L
        ...
        (br $L))))
  (func $__promise_all_0 (param $p0 i32) (param $p1 i32) (param $p2 i32) (result i32)
    (local $res i32) (local $arr i32)
    (call $__drain_microtasks)
    ...
    (if (i32.eq (i32.load offset=8 (local.get $p0)) (i32.const 1))
      (then
        ...
        (i32.store offset=4 (local.get $res) (i32.const 2))
        (i32.store offset=8 (local.get $res) (i32.const 1))
        (i64.store offset=16 (local.get $res) (i64.load offset=16 (local.get $p0)))
        (i32.store offset=24 (local.get $res) (i32.load offset=24 (local.get $p0)))
    ...
    (if (i32.eq (i32.load offset=8 (local.get $p1)) (i32.const 1))
      (then
        ...
        (i32.store offset=4 (local.get $res) (i32.const 2))
        (i32.store offset=8 (local.get $res) (i32.const 1))
        (i64.store offset=16 (local.get $res) (i64.load offset=16 (local.get $p1)))
        (i32.store offset=24 (local.get $res) (i32.load offset=24 (local.get $p1)))
        (return (local.get $res))))
    (if (i32.eq (i32.load offset=8 (local.get $p2)) (i32.const 1))
      (then
        ...
        (i32.store offset=4 (local.get $res) (i32.const 2))
        (i32.store offset=8 (local.get $res) (i32.const 1))
        (i64.store offset=16 (local.get $res) (i64.load offset=16 (local.get $p2)))
        (i32.store offset=24 (local.get $res) (i32.load offset=24 (local.get $p2)))
        (return (local.get $res))))
    (local.set $arr (call $__malloc (i32.const 20)))
    (i32.store (local.get $arr) (i32.const 3))
    (i32.store offset=4 (local.get $arr) (i32.const 3))
    (i32.store offset=8 (local.get $arr) (i32.load offset=16 (local.get $p0)))
    (i32.store offset=12 (local.get $arr) (i32.load offset=16 (local.get $p1)))
    (i32.store offset=16 (local.get $arr) (i32.load offset=16 (local.get $p2)))
    (i32.store (local.get $res) (i32.const 1))
    (i32.store offset=4 (local.get $res) (i32.const 3))
    (i32.store offset=16 (local.get $res) (local.get $arr))
    (local.get $res))
  (func $__promise_all_1 (param $p0 i32) (param $p1 i32) (param $p2 i32) (result i32)
    (local $res i32) (local $arr i32)
    (call $__drain_microtasks)
    (local.set $res (call $__promise_alloc))
    (if (i32.eq (i32.load offset=8 (local.get $p0)) (i32.const 1))
  ...
  (func $__then_tramp_0 (param $env i32) (param $src i32) (param $result i32)
    (if (i32.eqz (i32.load offset=8 (local.get $src)))
      (then
    (i32.store offset=16 (local.get $result) (call $addOne (i32.load offset=16 (local.get $src))))
  ...
  (func $__promise_all_2 (param $p0 i32) (param $p1 i32) (result i32)
    (local $res i32) (local $arr i32)
    (call $__drain_microtasks)
    (local.set $res (call $__promise_alloc))
    (if (i32.eq (i32.load offset=8 (local.get $p0)) (i32.const 1))
    ...
    (if (i32.eq (i32.load offset=8 (local.get $p1)) (i32.const 1))
      (then
        ...
        (i32.store offset=24 (local.get $res) (i32.load offset=24 (local.get $p1)))
        (return (local.get $res))))
    (local.set $arr (call $__malloc (i32.const 24)))
    (i32.store (local.get $arr) (i32.const 2))
    (i32.store offset=4 (local.get $arr) (i32.const 2))
    (f64.store offset=8 (local.get $arr) (f64.load offset=16 (local.get $p0)))
    (f64.store offset=16 (local.get $arr) (f64.load offset=16 (local.get $p1)))
    (i32.store (local.get $res) (i32.const 1))
    (i32.store offset=4 (local.get $res) (i32.const 3))
    (i32.store offset=16 (local.get $res) (local.get $arr))
    (local.get $res))
  (func $__promise_all_3 (param $p0 i32) (param $p1 i32) (param $p2 i32) (result i32)
    (local $res i32) (local $arr i32)
    (call $__drain_microtasks)
    (local.set $res (call $__promise_alloc))
    (if (i32.eq (i32.load offset=8 (local.get $p0)) (i32.const 1))
  ...
  (func $fcompute (param $x f64) (result i32)
    (return (call $__promise_resolve_f64 (f64.mul (local.get $x) (f64.const 2.0))))
  )
  ...
  (func $main  
    ...
    (local $__arr_tmp i32)
    (local.set $xs (call $__promise_await_i32 (call $__promise_all_0 (call $compute (i32.const 1)) (call $compute (i32.const 2)) (call $compute (i32.const 3)))))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $xs) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 2)))) (i32.const 136))))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $xs) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 2)))) (i32.add (i32.const 132) (i32.load (i32.const 4))))))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $xs) (i32.const 8)) (i32.shl (i32.const 2) (i32.const 2)))) (i32.add (i32.const 132) (i32.load (i32.const 4))))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 5) (call $__i32_to_str (i32.load (local.get $xs)) (i32.const 137))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $ys (call $__promise_await_i32 (call $__promise_all_1 (call $__promise_resolve_i32 (i32.const 5)) (call $compute (i32.const 4)) (call $__promise_then (call $__promise_resolve_i32 (i32.const 1)) (i32.const 0) (i32.const 0)))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store8 (i32.const 134) (i32.const 58))
          (i32.store8 (i32.const 135) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $ys) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 2)))) (i32.const 136))))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $ys) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 2)))) (i32.add (i32.const 132) (i32.load (i32.const 4))))))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $ys) (i32.const 8)) (i32.shl (i32.const 2) (i32.const 2)))) (i32.add (i32.const 132) (i32.load (i32.const 4))))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $fs (call $__promise_await_i32 (call $__promise_all_2 (call $fcompute (f64.const 1.5)) (call $fcompute (f64.const 2.5)))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store8 (i32.const 134) (i32.const 58))
          (i32.store8 (i32.const 135) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 4) (call $__f64_to_str (f64.load (i32.add (i32.add (local.get $fs) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 3)))) (i32.const 136))))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (call $__f64_to_str (f64.load (i32.add (i32.add (local.get $fs) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 3)))) (i32.add (i32.const 132) (i32.load (i32.const 4))))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (try
      (do
        (local.set $zs (call $__promise_await_i32 (call $__promise_all_3 (call $compute (i32.const 1)) (call $__promise_reject (i32.const 260) (i32.const 4)) (call $compute (i32.const 3)))))
            (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 11) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $zs) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 2)))) (i32.const 143))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 260) "\62\6f\6f\6d")
  (data (i32.const 264) "\64\6f\6e\65\0a")
)