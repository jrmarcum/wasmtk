(module
  ...
  (func $BoxI32_constructor (param $__self i32) (param $val i32) 
    (i32.store (i32.add (local.get $__self) (i32.const 0)) (local.get $val))
  )

  (func $BoxI32_unwrap (param $__self i32) (result i32)
    (return (i32.load (i32.add (local.get $__self) (i32.const 0))))
  )

  (func $BoxF64_constructor (param $__self i32) (param $val f64) 
    (f64.store (i32.add (local.get $__self) (i32.const 0)) (local.get $val))
  )

  (func $BoxF64_unwrap (param $__self i32) (result f64)
    (return (f64.load (i32.add (local.get $__self) (i32.const 0))))
  )

  (func $sumBoxII (param $a i32) (param $b i32) (result f64)
    (local $av i32)
    (local $bv i32)
    (local $__iface_tmp i32)
    (local.set $av (call $BoxI32_unwrap (local.get $a) ))
    (local.set $bv (call $BoxI32_unwrap (local.get $b) ))
    (return (f64.add (f64.convert_i32_s (local.get $av)) (f64.convert_i32_s (local.get $bv))))
  )

  (func $sumBoxFI (param $a i32) (param $b i32) (result f64)
    (local $av f64)
    (local $bv i32)
    (local $__iface_tmp i32)
    (local.set $av (call $BoxF64_unwrap (local.get $a) ))
    (local.set $bv (call $BoxI32_unwrap (local.get $b) ))
    (return (f64.add (local.get $av) (f64.convert_i32_s (local.get $bv))))
  )

  (func $testNestedGenerics (export "testNestedGenerics")  
    (local $box1 i32)
    (local $box2 i32)
    (local $box3 i32)
    (local $box4 i32)
    ...
    (local.set $box1 (i32.const 260))
      (call $BoxI32_constructor (i32.const 260) (i32.const 10))
    (local.set $box2 (i32.const 264))
      (call $BoxI32_constructor (i32.const 264) (i32.const 20))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 135) (i32.const 45))
          ...
          (i32.store8 (i32.const 142) (i32.const 109))
          (i32.store8 (i32.const 143) (i32.const 58))
          (i32.store8 (i32.const 144) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 13) (call $__f64_to_str (call $sumBoxII (local.get $box1) (local.get $box2)) (i32.const 145))))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $box3 (i32.const 268))
      (call $BoxF64_constructor (i32.const 268) (f64.const 5.5))
    (local.set $box4 (i32.const 276))
      (call $BoxI32_constructor (i32.const 276) (i32.const 4))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 15) (call $__f64_to_str (call $sumBoxFI (local.get $box3) (local.get $box4)) (i32.const 147))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    (call $testNestedGenerics )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 280) "\2d\2d\2d\20\54\65\73\74\20\31\3a\20\4e\65\73\74\65\64\20\4d\6f\6e\6f\6d\6f\72\70\68\69\7a\61\74\69\6f\6e\20\2d\2d\2d\0a")
  (data (i32.const 260) "\00\00\00\00")
  (data (i32.const 264) "\00\00\00\00")
  (data (i32.const 268) "\00\00\00\00\00\00\00\00")
  (data (i32.const 276) "\00\00\00\00")
)