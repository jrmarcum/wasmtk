(module
  ...
  (func $sumNested (param $__pd_0 i32) (result i32)
    (local $b i32)
    (local $c i32)
    (local $d i32)
    (local.set $b (i32.load (i32.add (i32.load (i32.add (local.get $__pd_0) (i32.const 0))) (i32.const 0))))
      (local.set $c (i32.load (i32.add (i32.load (i32.add (local.get $__pd_0) (i32.const 0))) (i32.const 4))))
      (local.set $d (i32.load (i32.add (local.get $__pd_0) (i32.const 4))))
    (return (i32.add (i32.add (local.get $b) (local.get $c)) (local.get $d)))
  )
  ...
  (func $main  
    ...
    (local.set $o (i32.const 260))
    (local.set $b (i32.load (i32.add (i32.load (i32.add (i32.const 260) (i32.const 0))) (i32.const 0))))
      (local.set $c (i32.load (i32.add (i32.load (i32.add (i32.const 260) (i32.const 0))) (i32.const 4))))
      (local.set $d (i32.load (i32.add (i32.const 260) (i32.const 4))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $bb (i32.load (i32.add (i32.load (i32.add (i32.const 260) (i32.const 0))) (i32.const 0))))
      (local.set $cc (i32.load (i32.add (i32.load (i32.add (i32.const 260) (i32.const 0))) (i32.const 4))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 98))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 4) (call $__i32_to_str (local.get $bb) (i32.const 136))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 134) (i32.const 58))
          (i32.store8 (i32.const 135) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 4) (call $__i32_to_str (local.get $cc) (i32.const 136))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $deep (i32.const 276))
    (local.set $db (i32.load (i32.add (i32.load (i32.add (i32.load (i32.add (i32.const 276) (i32.const 0))) (i32.const 0))) (i32.const 0))))
      (local.set $dc (i32.load (i32.add (i32.load (i32.add (i32.load (i32.add (i32.const 276) (i32.const 0))) (i32.const 0))) (i32.const 4))))
      (local.set $dd (i32.load (i32.add (i32.load (i32.add (i32.const 276) (i32.const 0))) (i32.const 4))))
      (local.set $tag (i32.load (i32.add (i32.const 276) (i32.const 4))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 100))
          (i32.store8 (i32.const 133) (i32.const 98))
          (i32.store8 (i32.const 134) (i32.const 58))
          (i32.store8 (i32.const 135) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 4) (call $__i32_to_str (local.get $db) (i32.const 136))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 134) (i32.const 58))
          (i32.store8 (i32.const 135) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 4) (call $__i32_to_str (local.get $dc) (i32.const 136))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 134) (i32.const 58))
          (i32.store8 (i32.const 135) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 4) (call $__i32_to_str (local.get $dd) (i32.const 136))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 5) (call $__i32_to_str (local.get $tag) (i32.const 137))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (local.set $src (i32.const 300))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 11) (call $__i32_to_str (call $sumNested (local.get $src)) (i32.const 143))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 268) "\05\00\00\00\07\00\00\00")
  (data (i32.const 260) "\0c\01\00\00\09\00\00\00")
  (data (i32.const 292) "\01\00\00\00\02\00\00\00")
  (data (i32.const 284) "\24\01\00\00\03\00\00\00")
  (data (i32.const 276) "\1c\01\00\00\63\00\00\00")
  (data (i32.const 308) "\0a\00\00\00\14\00\00\00")
  (data (i32.const 300) "\34\01\00\00\1e\00\00\00")
)