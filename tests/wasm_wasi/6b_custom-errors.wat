(module
  ...
  (func $f (param $arg f64) (result i32)
    (local $__obj_ret i32)
    (local $__nested_ptr i32)
    (if (f64.eq (local.get $arg) (f64.const 42))
      ...
      (i32.store offset=8 (local.get $__obj_ret) (call $newArgError (local.get $arg) (i32.const 260) (i32.const 18)))
  ...
  (func $_start (export "_start")
    ...
    (local.set $r (call $f (f64.const 42)))
    (if (i32.load (i32.add (local.get $r) (i32.const 12)))
      (then
          (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (f64.load (i32.add (i32.load (i32.add (local.get $r) (i32.const 8))) (i32.const 0))) (i32.const 132)))
          ...
          (call $__str_gather (i32.load offset=8 (i32.load (i32.add (local.get $r) (i32.const 8)))) (i32.load offset=12 (i32.load (i32.add (local.get $r) (i32.const 8)))) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (i32.load offset=12 (i32.load (i32.add (local.get $r) (i32.const 8))))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 260) "\63\61\6e\27\74\20\77\6f\72\6b\20\77\69\74\68\20\69\74")
  (data (i32.const 278) "")
  (data (i32.const 278) "\65\72\72\20\64\6f\65\73\6e\27\74\20\6d\61\74\63\68\20\41\72\67\45\72\72\6f\72\0a")
)