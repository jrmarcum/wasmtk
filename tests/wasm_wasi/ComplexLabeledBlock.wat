(module
  ...
  (func $testLabeledBlock (export "testLabeledBlock") (param $x i32) (result i32)
    (local $val i32)
    (local.set $val (i32.const 0))
    (block $break_my_logic
  ...
  (func $_start (export "_start")
    (;; type i32 = number;;)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $testLabeledBlock (i32.const -5)) (i32.const 132)))
