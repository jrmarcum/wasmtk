...
export async function loadModule(
  ...
  return {
    add(a: number, b: number): number { return (_ex("add") as (...a: unknown[]) => unknown)(a, b) as number; },
    multiply(a: number, b: number): number { return (_ex("multiply") as (...a: unknown[]) => unknown)(a, b) as number; },
    square(x: number): number { return (_ex("square") as (...a: unknown[]) => unknown)(x) as number; },
  };
}
